...
public:
	...
	void PlayUpDownAnim(); // Function UW-ListWidget_ItemBase.UW-ListWidget_ItemBase_C.PlayUpDownAnim(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetRemoveTimer(float RemainTime); // Function UW-ListWidget_ItemBase.UW-ListWidget_ItemBase_C.SetRemoveTimer(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnAnimationFinished(struct UWidgetAnimation Animation); // Function UW-ListWidget_ItemBase.UW-ListWidget_ItemBase_C.OnAnimationFinished(BlueprintCosmetic|Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void StartRemove(); // Function UW-ListWidget_ItemBase.UW-ListWidget_ItemBase_C.StartRemove(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-ListWidget_ItemBase(int32_t EntryPoint); // Function UW-ListWidget_ItemBase.UW-ListWidget_ItemBase_C.ExecuteUbergraph_UW-ListWidget_ItemBase(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
