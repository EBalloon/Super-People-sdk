...
public:
	...
	struct Unknown On_IMG-BG_MouseButtonDown_1(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.On_IMG-BG_MouseButtonDown_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void OnLoaded_F6A17E404AD1BD4EA73593A8AF9F47DF(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.OnLoaded_F6A17E404AD1BD4EA73593A8AF9F47DF(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void Construct(); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_135_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_135_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	...
	void BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_189_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_189_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	...
	void ExecuteUbergraph_UW-BlackMarket_Slot_Wearable(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Wearable.UW-BlackMarket_Slot_Wearable_C.ExecuteUbergraph_UW-BlackMarket_Slot_Wearable(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
