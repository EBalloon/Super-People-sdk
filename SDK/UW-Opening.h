...
public:
	...
	struct UButton Button_Focus; // 0x250 (8)
	struct UHorizontalBox HorizontalBox_1; // 0x258 (8)
	struct UImage Image_223; // 0x260 (8)
	struct UImage Img_Movie; // 0x268 (8)
	struct UMediaPlayer MediaPlayer; // 0x270 (8)
	char bPopup : 0; // 0x278 (1)
	struct UFileMediaSource Media; // 0x280 (8)
	struct UMediaSoundComponent MediaSoundComp; // 0x288 (8)
	struct UBP_GameSettings_C Game Settings; // 0x290 (8)
	float GammaIntensity; // 0x298 (4)
	struct FTimerHandle SkipNoticeTimer; // 0x2A0 (8)
	struct UMediaTexture MediaTexture; // 0x2A8 (8)
	struct FName OpeningFileName; // 0x2B0 (8)
	char End : 0; // 0x2B8 (1)
	char NextScene : 0; // 0x2B9 (1)

	void MoveNextScene(); // Function UW-Opening.UW-Opening_C.MoveNextScene(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FEventReply OnKeyDown(struct FGeometry MyGeometry, struct FKeyEvent InKeyEvent); // Function UW-Opening.UW-Opening_C.OnKeyDown(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Construct(); // Function UW-Opening.UW-Opening_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CustomEvent_1(); // Function UW-Opening.UW-Opening_C.CustomEvent_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UW-Opening.UW-Opening_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CustomEvent_2(); // Function UW-Opening.UW-Opening_C.CustomEvent_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void BndEvt__Button_Focus_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-Opening.UW-Opening_C.BndEvt__Button_Focus_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-Opening(int32_t EntryPoint); // Function UW-Opening.UW-Opening_C.ExecuteUbergraph_UW-Opening(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
...
inline struct FEventReply UUW-Opening_C::OnKeyDown(struct FGeometry MyGeometry, struct FKeyEvent InKeyEvent) {
...
inline void UUW-Opening_C::Tick(struct FGeometry MyGeometry, float InDeltaTime) {
