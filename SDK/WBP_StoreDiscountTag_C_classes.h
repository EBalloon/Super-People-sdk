// WBP_StoreDiscountTag_C WBP_StoreDiscountTag.WBP_StoreDiscountTag_C
...
struct UWBP_StoreDiscountTag_C : UUserWidget {
	...
	None background; // 0x238(0x08)
	None Background_Dimmer; // 0x240(0x08)
	None DiscountTag; // 0x248(0x08)
	None EndDecro; // 0x250(0x08)
	None GradientImage; // 0x258(0x08)
	...
	void SetSaleMessage(); // SetSaleMessage WBP_StoreDiscountTag.WBP_StoreDiscountTag_C.SetSaleMessage // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x260f470>
};
