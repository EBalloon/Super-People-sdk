// AnimBlueprintGeneratedClass Sting.ABP_StingRay_C
...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function Sting.ABP_StingRay_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B3180>
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function Sting.ABP_StingRay_C.BlueprintUpdateAnimation(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B3180>
	void ExecuteUbergraph_ABP_StingRay(int32_t EntryPoint); // Function Sting.ABP_StingRay_C.ExecuteUbergraph_ABP_StingRay(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B3180>
};

// BlueprintGeneratedClass Sting.B
class AB : public AB {
...
// Function Sting.ABP_StingRay_C.AnimGraph
inline void UABP_StingRay_C::AnimGraph(struct Unknown& AnimGraph) {
	static auto fn = UObject::FindObject<UFunction>("Function Sting.ABP_StingRay_C.AnimGraph");
...
// Function Sting.ABP_StingRay_C.BlueprintUpdateAnimation
inline void UABP_StingRay_C::BlueprintUpdateAnimation(float DeltaTimeX) {
	static auto fn = UObject::FindObject<UFunction>("Function Sting.ABP_StingRay_C.BlueprintUpdateAnimation");
...
// Function Sting.ABP_StingRay_C.ExecuteUbergraph_ABP_StingRay
inline void UABP_StingRay_C::ExecuteUbergraph_ABP_StingRay(int32_t EntryPoint) {
	static auto fn = UObject::FindObject<UFunction>("Function Sting.ABP_StingRay_C.ExecuteUbergraph_ABP_StingRay");
