...
public:
	...
	void OnLoaded_9DF86FA64782B378E42DBB813545BD34(struct Object Loaded); // Function UW-ListWidget_KillMessage_Item.UW-ListWidget_KillMessage_Item_C.OnLoaded_9DF86FA64782B378E42DBB813545BD34(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetPlayerInfo(struct ABravoHotelPlayerState PlayerState, struct FSlateColor InfoColor); // Function UW-ListWidget_KillMessage_Item.UW-ListWidget_KillMessage_Item_C.SetPlayerInfo(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-ListWidget_KillMessage_Item(int32_t EntryPoint); // Function UW-ListWidget_KillMessage_Item.UW-ListWidget_KillMessage_Item_C.ExecuteUbergraph_UW-ListWidget_KillMessage_Item(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnTimeOut__DelegateSignature(int32_t ArrayIndex, struct UUW-ListWidget_KillMessage_C Slot); // Function UW-ListWidget_KillMessage_Item.UW-ListWidget_KillMessage_Item_C.OnTimeOut__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
