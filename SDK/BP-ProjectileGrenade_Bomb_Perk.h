...
public:
	...
	struct FPointerToUberGraphFrame UberGraphFrame; // 0x680 (8)
	struct UAkComponent Ak; // 0x688 (8)

	void BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(struct UPrimitiveComponent HitComponent, struct UActor OtherActor, struct UPrimitiveComponent OtherComp, struct FVector NormalImpulse, struct FHitResult& Hit); // Function BP-ProjectileGrenade_Bomb_Perk.BP-ProjectileGrenade_Bomb_Perk_C.BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_BP-ProjectileGrenade_Bomb_Perk(int32_t EntryPoint); // Function BP-ProjectileGrenade_Bomb_Perk.BP-ProjectileGrenade_Bomb_Perk_C.ExecuteUbergraph_BP-ProjectileGrenade_Bomb_Perk(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
...
inline void ABP-ProjectileGrenade_Bomb_Perk_C::BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(struct UPrimitiveComponent HitComponent, struct UActor OtherActor, struct UPrimitiveComponent OtherComp, struct FVector NormalImpulse, struct FHitResult& Hit) {
