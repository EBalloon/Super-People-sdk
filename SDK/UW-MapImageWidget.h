...
public:
	...
	void UpdateWantedOpacity(); // Function UW-MapImageWidget.UW-MapImageWidget_C.UpdateWantedOpacity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckCanTextImage(char& CanText, char& CanImage); // Function UW-MapImageWidget.UW-MapImageWidget_C.CheckCanTextImage(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void StartShowAnim(); // Function UW-MapImageWidget.UW-MapImageWidget_C.StartShowAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ChangeShowAnim(); // Function UW-MapImageWidget.UW-MapImageWidget_C.ChangeShowAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateOpacity(); // Function UW-MapImageWidget.UW-MapImageWidget_C.UpdateOpacity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckWorldMapZoomLevel(char& Changed); // Function UW-MapImageWidget.UW-MapImageWidget_C.CheckWorldMapZoomLevel(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetWorldMapZoomLevel(int32_t& ZoomLevel); // Function UW-MapImageWidget.UW-MapImageWidget_C.GetWorldMapZoomLevel(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void CheckToggleWidgetType(char& Changed); // Function UW-MapImageWidget.UW-MapImageWidget_C.CheckToggleWidgetType(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckCanHide(char& CanHide); // Function UW-MapImageWidget.UW-MapImageWidget_C.CheckCanHide(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void SetMapInfo(char& SUCCESS); // Function UW-MapImageWidget.UW-MapImageWidget_C.SetMapInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_199F0E9743CFA7E806886E89E49C9E00(struct Unknown Loaded); // Function UW-MapImageWidget.UW-MapImageWidget_C.OnLoaded_199F0E9743CFA7E806886E89E49C9E00(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowMapImage(); // Function UW-MapImageWidget.UW-MapImageWidget_C.ShowMapImage(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HideMapImage(char SetTimer); // Function UW-MapImageWidget.UW-MapImageWidget_C.HideMapImage(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DoHideMapImage(); // Function UW-MapImageWidget.UW-MapImageWidget_C.DoHideMapImage(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AsyncMapImage(struct Unknown Image); // Function UW-MapImageWidget.UW-MapImageWidget_C.AsyncMapImage(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-MapImageWidget.UW-MapImageWidget_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ChangeMapImage(); // Function UW-MapImageWidget.UW-MapImageWidget_C.ChangeMapImage(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckOpacity(); // Function UW-MapImageWidget.UW-MapImageWidget_C.CheckOpacity(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-MapImageWidget(int32_t EntryPoint); // Function UW-MapImageWidget.UW-MapImageWidget_C.ExecuteUbergraph_UW-MapImageWidget(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
