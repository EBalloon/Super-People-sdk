...
struct UGameplayTasksComponent : UActorComponent {
	...
	None UberGraphFrame; // 0xc8(0x08)
	None LevelStateGroup; // 0xd0(0x08)
	None LevelToStateGroupMap; // 0xd8(0x50)
	None UberGraphFrame; // 0x520(0x08)
	None Hover_Selected; // 0x528(0x08)
	None Hover; // 0x530(0x08)
	None Select; // 0x538(0x08)
	None RadioButton; // 0x540(0x08)
	None RadioText; // 0x548(0x08)
	None DisplayText; // 0x550(0x18)
	None On Radio Button Selected; // 0x568(0x10)
	None bSelected; // 0x578(0x01)
	None HoverSettingsRadioSFX; // 0x580(0x08)
	None ClickSettingsRadioSFX; // 0x588(0x08)
	None UberGraphFrame; // 0x520(0x08)
	None ErrorMessageDisplay; // 0x528(0x08)
	None Image_144; // 0x530(0x08)
	None PlayerName; // 0x538(0x08)
	None PopupButton_C_371; // 0x540(0x08)
	None WarningIcon; // 0x548(0x08)
	None LoginDataFac; // 0x550(0x08)
	None UberGraphFrame; // 0x520(0x08)
	None ShowRankedChangeScreen; // 0x528(0x08)
	None ShowScreen_Defeat; // 0x530(0x08)
	None ShowScreen_Victory; // 0x538(0x08)
	None ShowScreen; // 0x540(0x08)
	None Blocker; // 0x548(0x08)
	None ContentWrapper; // 0x550(0x08)
	None ContextMenu; // 0x558(0x08)
	None GamepadBumperLeft; // 0x560(0x08)
	None GamepadBumperRight; // 0x568(0x08)
	None MatchEventBonuses; // 0x570(0x08)
	None MatchIDContainer; // 0x578(0x08)
	None MatchIdDisplay; // 0x580(0x08)
	None NavButton_MatchSummary; // 0x588(0x08)
	None NavButton_Progression; // 0x590(0x08)
	None NavButton_Scoreboard; // 0x598(0x08)
	None NavigationContainer; // 0x5a0(0x08)
	None Overlay_Progression; // 0x5a8(0x08)
	None Overlay_Scoreboard; // 0x5b0(0x08)
	None Progression; // 0x5b8(0x08)
	None ReportMenu; // 0x5c0(0x08)
	None ScoreboardOverview; // 0x5c8(0x08)
	None SecondaryInstanceIdDisplay; // 0x5d0(0x08)
	None TabLeftButtonImage; // 0x5d8(0x08)
	None TabRightButtonImage; // 0x5e0(0x08)
	None TeamStatus; // 0x5e8(0x08)
	None TimePlayedMessage; // 0x5f0(0x08)
	None VictoryDefeatGlow; // 0x5f8(0x08)
	None VictoryDefeatGlow_Anim; // 0x600(0x08)
	None VictoryDefeatLine; // 0x608(0x08)
	None VictoryDefeatScanlines; // 0x610(0x08)
	None WBP_ActiveBoosterShelf; // 0x618(0x08)
	None WBP_Header1; // 0x620(0x08)
	None WBP_MatchSummary; // 0x628(0x08)
	None WBP_RankChange; // 0x630(0x08)
	None WeaponsFeatureCalloutText; // 0x638(0x08)
	None TabScreens; // 0x640(0x10)
	None CurrentTabIndex; // 0x650(0x04)
	None DelayTimeHide; // 0x654(0x04)
	None ScoreboardStats; // 0x658(0x50)
	None PopulatedScoreboard; // 0x6a8(0x01)
	None PlayerId; // 0x6ac(0x04)
	None FirstPostMatch; // 0x6b0(0x01)
	None RouteName; // 0x6b4(0x08)
	None ShowResultsScreenSFX; // 0x6c0(0x08)
	None IsReturnView; // 0x6c8(0x01)
	None NavWidgets; // 0x6d0(0x10)
	None IsDiscFocused; // 0x6e0(0x01)
	None ExampleGUID; // 0x6e8(0x10)
	None UberGraphFrame; // 0x238(0x08)
	None GamepadIcon; // 0x240(0x08)
	None PromptText; // 0x248(0x08)
	None Prompt; // 0x250(0x18)
	None Action; // 0x268(0x08)
	None IsConfirmGamepad; // 0x270(0x01)
	None IsCancelGamepad; // 0x271(0x01)
	None FontColor; // 0x278(0x28)
	...
	None UberGraphFrame; // 0x520(0x08)
	None CodeEntry; // 0x528(0x08)
	None OnTextChanged; // 0x530(0x10)
	None OnTextCommitted; // 0x540(0x10)
	None UberGraphFrame; // 0x238(0x08)
	None QueueType; // 0x240(0x08)
	...
	None Image_42; // 0x540(0x08)
	None Image_305; // 0x548(0x08)
	None ShotgunReticle_2; // 0x550(0x08)
	None SettingsDataFactory; // 0x558(0x08)
	...
	void SetVertexPosition(None VertexID, None& Position); // SetVertexPosition MeshDescription.MeshDescriptionBase.SetVertexPosition // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <Game+0x35aea90>
	void SetVertexInstanceUV(None VertexInstanceID, None UV, None UVIndex); // SetVertexInstanceUV StaticMeshDescription.StaticMeshDescription.SetVertexInstanceUV // (Final|Native|Public|HasDefaults|BlueprintCallable) // <Game+0x35b7130>
	void OnEnvironmentChanged(None OldEnvironmentTag); // OnEnvironmentChanged DefaultEnvironmentListener.DefaultEnvironmentListener_C.OnEnvironmentChanged // (Event|Protected|BlueprintEvent) // <Game+0x260f470>
	None NavigateConfirmPressed(); // NavigateConfirmPressed WBP_SettingsRadio.WBP_SettingsRadio_C.NavigateConfirmPressed // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x260f470>
	void BndEvt__PlayerName_K2Node_ComponentBoundEvent_0_OnEditableTextBoxCommittedEvent__DelegateSignature(None& Text, None CommitMethod); // BndEvt__PlayerName_K2Node_ComponentBoundEvent_0_OnEditableTextBoxCommittedEvent__DelegateSignature NamePromptTempClone.NamePromptTempClone_C.BndEvt__PlayerName_K2Node_ComponentBoundEvent_0_OnEditableTextBoxCommittedEvent__DelegateSignature // (HasOutParms|BlueprintEvent) // <Game+0x260f470>
	void SetEyeTrackedPlayer(None PlayerController); // SetEyeTrackedPlayer EyeTracker.EyeTrackerFunctionLibrary.SetEyeTrackedPlayer // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3608e60>
	void IsFirstOrLastNavWidget(None Widget, None& FirstOrLast); // IsFirstOrLastNavWidget WBP_PostMatchLobby.WBP_PostMatchLobby_C.IsFirstOrLastNavWidget // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x260f470>
	void Construct(); // Construct GamepadPrompt_Bright.GamepadPrompt_Bright_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game+0x260f470>
	None IsCapturing(); // IsCapturing MovieSceneCapture.MovieSceneCaptureProtocolBase.IsCapturing // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x364ac90>
	void SetImageCaptureProtocolType(None ProtocolType); // SetImageCaptureProtocolType MovieSceneCapture.MovieSceneCapture.SetImageCaptureProtocolType // (Final|Native|Public|BlueprintCallable) // <Game+0x364aec0>
	None IsCaptureInProgress(); // IsCaptureInProgress MovieSceneCapture.MovieSceneCaptureEnvironment.IsCaptureInProgress // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x364ac60>
	void StopCapturingFinalPixels(); // StopCapturingFinalPixels MovieSceneCapture.UserDefinedCaptureProtocol.StopCapturingFinalPixels // (Final|Native|Public|BlueprintCallable) // <Game+0x364b030>
	void WriteImageToDisk(None& PixelData, None& StreamID, None& FrameMetrics, None bCopyImageData); // WriteImageToDisk MovieSceneCapture.UserDefinedImageCaptureProtocol.WriteImageToDisk // (Final|Native|Public|HasOutParms|BlueprintCallable) // <Game+0x364b050>
	void SetText(None Text); // SetText WBP_RedeemCodeField.WBP_RedeemCodeField_C.SetText // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x260f470>
	void Construct(); // Construct WBP_QuickPlay_QueueTypeHeader.WBP_QuickPlay_QueueTypeHeader_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game+0x260f470>
	void SetAnimDriveDamperStiffness(None InStiffness); // SetAnimDriveDamperStiffness ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness // (Final|Native|Public|BlueprintCallable) // <Game+0x3f1ed20>
	void GetPreviewValue(None& Value); // GetPreviewValue WBP_SettingsPreview_ShotgunReticleSize.WBP_SettingsPreview_ShotgunReticleSize_C.GetPreviewValue // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x260f470>
	void ReadyForActivation(); // ReadyForActivation GameplayTasks.GameplayTask.ReadyForActivation // (Final|Native|Public|BlueprintCallable) // <Game+0x3fe4bd0>
	None ClaimResources(None InTaskOwner, None ResourceClasses, None Priority, None TaskInstanceName); // ClaimResources GameplayTasks.GameplayTask_ClaimResource.ClaimResources // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3fe46e0>
	None SpawnActor(None TaskOwner, None SpawnLocation, None SpawnRotation, None Class, None bSpawnOnlyOnAuthority); // SpawnActor GameplayTasks.GameplayTask_SpawnActor.SpawnActor // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // <Game+0x3fe4bf0>
	None TaskWaitDelay(None TaskOwner, None Time, None Priority); // TaskWaitDelay GameplayTasks.GameplayTask_WaitDelay.TaskWaitDelay // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3fe4da0>
	void OnRep_SimulatedTasks(); // OnRep_SimulatedTasks GameplayTasks.GameplayTasksComponent.OnRep_SimulatedTasks // (Final|Native|Public) // <Game+0x3fe4bb0>
};
