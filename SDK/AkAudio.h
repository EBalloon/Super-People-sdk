...
struct UAkAssetData : Object {
	uint32_t CachedHash; //  0x28 Size(4)
};
...
struct UAkComponent : UAkGameObject {
	...
	float EarlyReflectionMaxPathLength; //  0x288 Size(4)
	float roomReverbAuxBusGain; //  0x28c Size(4)
	int32_t diffractionMaxEdges; //  0x290 Size(4)
	int32_t diffractionMaxPaths; //  0x294 Size(4)
	float diffractionMaxPathLength; //  0x298 Size(4)
...
struct UAkFolder : UAkAudioType {
	struct FString UnrealFolderPath; //  0x40 Size(10)
	struct FString WwiseFolderPath; //  0x50 Size(10)
};
...
struct UAkEventCallbackInfo : UAkCallbackInfo {
	...
	int32_t EventID; //  0x34 Size(4)
};

// Class AkAudio.AkMarkerCallbackInfo
struct UAkMarkerCallbackInfo : UAkEventCallbackInfo {
	int32_t Identifier; //  0x38 Size(4)
	int32_t Position; //  0x3c Size(4)
	struct FString Label; //  0x40 Size(10)
};

// Class AkAudio.AkDurationCallbackInfo
struct UAkDurationCallbackInfo : UAkEventCallbackInfo {
	float Duration; //  0x38 Size(4)
	float EstimatedDuration; //  0x3c Size(4)
	int32_t AudioNodeID; //  0x40 Size(4)
	int32_t MediaID; //  0x44 Size(4)
	char bStreaming; //  0x48 Size(1)
};
...
struct UAkSettingsPerUser : Object {
	...
	char AutoSyncSelection; //  0x75 Size(1)
	char SuppressWwiseProjectPathWarnings; //  0x76 Size(1)
	char SoundDataGenerationSkipLanguage; //  0x77 Size(1)
};
...
struct UInterpTrackAkAudioRTPC : UInterpTrackFloatBase {
	struct FString Param; //  0x90 Size(10)
	char bPlayOnReverse; //  0xa0 Size(1)
	char bContinueRTPCOnMatineeEnd; //  0xa0 Size(1)
};
...
struct UMovieSceneAkAudioEv : UMovieSceneSection {
	...
	struct FString EventName; //  0x138 Size(10)
	float MaxSourceDuration; //  0x168 Size(4)
	struct FString MaxDurationSourceID; //  0x170 Size(10)
};
