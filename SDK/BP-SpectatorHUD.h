...
public:
	...
	struct UBravoHotelInteractionWidget GetInteractiveWidget(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.GetInteractiveWidget(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetTargetPlayerInfo(struct ABravoHotelPlayerState PlayerState); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.SetTargetPlayerInfo(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	enum class ESlateVisibility GetVisibility_1(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.GetVisibility_1(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	struct FText GetText_1(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.GetText_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetReplayBtn(char bVisiable); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.SetReplayBtn(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetTargetBtn(char bVisiable); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.SetTargetBtn(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddCoreInfoRouteping(struct ABravoHotelPlayerState PlayerState); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddCoreInfoRouteping(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddCoreInfoSmartping(struct ABravoHotelPlayerState PlayerState); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddCoreInfoSmartping(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgByMolotovFlame(struct FText& Killer, struct FText& WeaponName, struct FText& Victim, char bHeasShot, char bLocalKiller, char bByTeam, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t KillerTierID, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgByMolotovFlame(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgByVehicle(struct FText& Killer, struct FText& Victim, char bLocalKiller, char bByTeam, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t KillerTierID, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgByVehicle(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgByWeapon(struct FText& Killer, struct FText& WeaponName, struct FText& Victim, char bHeasShot, char bLocalKiller, char bByTeam, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t KillerTierID, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgByWeapon(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgCrash(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgCrash(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgFallToDeath(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgFallToDeath(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void AddKillMsgMagneticField(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgMagneticField(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgNoOxygen(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgNoOxygen(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgRedZone(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgRedZone(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddKillMsgSuicide(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgSuicide(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddPerkMessage(struct FName PerkName, int32_t Level); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddPerkMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddPingMessage(struct FString MessageTag, char UsingBackGround); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddPingMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddRequestMessage(struct ABravoHotelPlayerState PlayerState, struct FString Message); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddRequestMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Close(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.Close(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void FinishPerkSpin(enum class EPerkLevelUpType LevelUpType); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.FinishPerkSpin(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HideAmplifier(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.HideAmplifier(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HideBlueZoneNotiMessage(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.HideBlueZoneNotiMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HideMinimapWidget(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.HideMinimapWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HideTeamPositionWidget(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.HideTeamPositionWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HideVehicleWidget(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.HideVehicleWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void LevelUpEvent(struct FPerkUIInfo PerkInfo, int32_t CurrentLevel, enum class EPerkLevelUpType LevelUpType, struct FDisplayAbility DisplayAbility, int32_t LastLevel); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.LevelUpEvent(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnChangedToggleType(enum class EToggleWidgetModeType PreType, enum class EToggleWidgetModeType CurrentType); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.OnChangedToggleType(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Open(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.Open(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OpenMainMenu(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.OpenMainMenu(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void PlaySupplyBoxMessage(struct FString Message); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.PlaySupplyBoxMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetMiniMapPlayers(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ResetMiniMapPlayers(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetWorldMap(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ResetWorldMap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetNickName(struct FText& NickName); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.SetNickName(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetToggleMinimap(char bToggle); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.SetToggleMinimap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowAmplifier(struct FString InText); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowAmplifier(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowBlueZoneNotiMessage(struct FString Title, struct FString Desc); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowBlueZoneNotiMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowCommonMessage(struct FCommonMessageInfo& MessageInfo); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowCommonMessage(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowDeathAndAliveMessage(struct FText& Victim, int32_t AliveCount); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowDeathAndAliveMessage(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowDeathUserWidget(struct FKillBroadcastUIInfo& Info); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowDeathUserWidget(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowEnergyItemUse(int32_t Type); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowEnergyItemUse(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowGameProgressMessage(int32_t Type, int32_t Time); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowGameProgressMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowGameWaitMessage(int32_t Time); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowGameWaitMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowHittedDamage(struct ABravoHotelCharacter InstigatorCharacter); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowHittedDamage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowInventoryNotEnoughSpaceMessage(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowInventoryNotEnoughSpaceMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowLineOfFire(struct FVector2D& Pos); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowLineOfFire(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowMinimapWidget(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowMinimapWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowMyKillInfo(struct FText& WeaponName, struct FText& Victim, int32_t KillCount, int32_t AliveCount, char bHeadShot, char bTeamKill); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowMyKillInfo(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowMyKnockOutInfo(struct FText& WeaponName, struct FText& Victim, char bHeadShot, char bTeamKill); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowMyKnockOutInfo(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowNuclearMessage(int32_t Count); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowNuclearMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowRedZoneBombMessage(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowRedZoneBombMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowRedZoneStartMessage(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowRedZoneStartMessage(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowReverseSideTeamPositionWidget(int32_t TeamIconIndex, float Angle, struct FVector2D ScreenMaxSize); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowReverseSideTeamPositionWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowTeamPositionWidget(int32_t TeamIndex, struct FVector2D ScreenPosition, char bNetCullDistance); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowTeamPositionWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowVehicleWidget(struct UBravoHotelVehicleSeatComponent VehicleSeat); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowVehicleWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void TeamInfoVisibility(char bState); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.TeamInfoVisibility(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ToggleMiniMap(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ToggleMiniMap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void UpdateLineOfFire(struct FVector2D& Pos, char LastUpdate, float delataTime); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.UpdateLineOfFire(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Btn-Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.BndEvt__Btn-Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void BndEvt__Btn-PreTarget_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.BndEvt__Btn-PreTarget_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Btn-Replay_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.BndEvt__Btn-Replay_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OpenPopup(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.OpenPopup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void StartBackGroundBlur(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.StartBackGroundBlur(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetBackGroundBlur(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ResetBackGroundBlur(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_Return_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.BndEvt__Button_Return_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddCoreInfoRequestResuscitation(struct ABravoHotelPlayerState PlayerState); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddCoreInfoRequestResuscitation(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ClosePopup(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ClosePopup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HideAnim(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.HideAnim(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowAnim(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ShowAnim(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_BP-SpectatorHUD(int32_t EntryPoint); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ExecuteUbergraph_BP-SpectatorHUD(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
