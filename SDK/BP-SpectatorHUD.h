...
public:
	...
	void AddKillMsgCrash(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgCrash(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void AddKillMsgFallToDeath(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgFallToDeath(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void AddKillMsgMagneticField(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgMagneticField(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void AddKillMsgNoOxygen(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgNoOxygen(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void AddKillMsgRedZone(struct FText& Victim, char bTeamDead, int32_t AliveCount, char bKnockOut, int32_t DiedTierID); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.AddKillMsgRedZone(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void ResetMiniMapPlayers(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ResetMiniMapPlayers(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ResetWorldMap(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ResetWorldMap(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetNickName(struct FText& NickName); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.SetNickName(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void BndEvt__Btn-Replay_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.BndEvt__Btn-Replay_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OpenPopup(); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.OpenPopup(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void ExecuteUbergraph_BP-SpectatorHUD(int32_t EntryPoint); // Function BP-SpectatorHUD.BP-SpectatorHUD_C.ExecuteUbergraph_BP-SpectatorHUD(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B80160>
};
