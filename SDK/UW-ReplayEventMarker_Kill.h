...
public:
	...
	void Construct(); // Function UW-ReplayEventMarker_Kill.UW-ReplayEventMarker_Kill_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-ReplayEventMarker_Kill(int32_t EntryPoint); // Function UW-ReplayEventMarker_Kill.UW-ReplayEventMarker_Kill_C.ExecuteUbergraph_UW-ReplayEventMarker_Kill(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
