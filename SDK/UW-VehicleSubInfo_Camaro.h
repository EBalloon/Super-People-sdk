...
public:
	...
	void Setup(struct Unknown VehicleInstance); // Function UW-VehicleSubInfo_Camaro.UW-VehicleSubInfo_Camaro_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-VehicleSubInfo_Camaro(int32_t EntryPoint); // Function UW-VehicleSubInfo_Camaro.UW-VehicleSubInfo_Camaro_C.ExecuteUbergraph_UW-VehicleSubInfo_Camaro(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
