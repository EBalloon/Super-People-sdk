...
public:
	...
	void ReceiveBeginPlay(); // Function BP-Projectile_MolotovFireTrapCell.BP-Projectile_MolotovFireTrapCell_C.ReceiveBeginPlay(Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_BP-Projectile_MolotovFireTrapCell(int32_t EntryPoint); // Function BP-Projectile_MolotovFireTrapCell.BP-Projectile_MolotovFireTrapCell_C.ExecuteUbergraph_BP-Projectile_MolotovFireTrapCell(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
