...
public:
	...
	void OnGameUserSettingsApply_Key_Event_1(struct TArray<Unknown>& List); // Function UW-GuideWidget.UW-GuideWidget_C.OnGameUserSettingsApply_Key_Event_1(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
