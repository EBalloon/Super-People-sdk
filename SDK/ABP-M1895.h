...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-M1895.ABP-M1895_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_ABP-M1895(int32_t EntryPoint); // Function ABP-M1895.ABP-M1895_C.ExecuteUbergraph_ABP-M1895(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
