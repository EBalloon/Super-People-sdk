...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M1895.ABP-M1895_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_ABP-M1895(int32_t EntryPoint); // Function ABP-M1895.ABP-M1895_C.ExecuteUbergraph_ABP-M1895(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
