...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-M1895.ABP-M1895_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_ABP-M1895(int32_t EntryPoint); // Function ABP-M1895.ABP-M1895_C.ExecuteUbergraph_ABP-M1895(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
