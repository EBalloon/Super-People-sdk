...
public:
	...
	void Setup(struct Unknown VehicleInstance); // Function UW-VehicleSubInfo_Motorcycle.UW-VehicleSubInfo_Motorcycle_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-VehicleSubInfo_Motorcycle(int32_t EntryPoint); // Function UW-VehicleSubInfo_Motorcycle.UW-VehicleSubInfo_Motorcycle_C.ExecuteUbergraph_UW-VehicleSubInfo_Motorcycle(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
