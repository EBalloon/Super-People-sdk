...
public:
	...
	void Setup(struct ABravoHotelVehicle VehicleInstance); // Function UW-VehicleSubInfo_Motorcycle.UW-VehicleSubInfo_Motorcycle_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-VehicleSubInfo_Motorcycle(int32_t EntryPoint); // Function UW-VehicleSubInfo_Motorcycle.UW-VehicleSubInfo_Motorcycle_C.ExecuteUbergraph_UW-VehicleSubInfo_Motorcycle(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
