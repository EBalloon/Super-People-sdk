...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-M16.ABP-M16_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_ABP-M16(int32_t EntryPoint); // Function ABP-M16.ABP-M16_C.ExecuteUbergraph_ABP-M16(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
