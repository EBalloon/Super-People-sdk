...
public:
	...
	void UserConstructionScript(); // Function BP-SUV_Appear.BP-SUV_Appear_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
};
