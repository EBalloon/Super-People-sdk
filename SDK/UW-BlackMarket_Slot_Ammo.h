...
public:
	...
	struct Unknown On_IMG-BG_MouseButtonDown_1(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.On_IMG-BG_MouseButtonDown_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_CF7AEC2246CE5FCA548190A8C8AE4FB8(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.OnLoaded_CF7AEC2246CE5FCA548190A8C8AE4FB8(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_160_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_160_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_179_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_179_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-BlackMarket_Slot_Ammo(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Ammo.UW-BlackMarket_Slot_Ammo_C.ExecuteUbergraph_UW-BlackMarket_Slot_Ammo(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
