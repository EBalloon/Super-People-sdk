...
public:
	...
	void Construct(); // Function UW-ReplayEventMarker_Resuscitated.UW-ReplayEventMarker_Resuscitated_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-ReplayEventMarker_Resuscitated(int32_t EntryPoint); // Function UW-ReplayEventMarker_Resuscitated.UW-ReplayEventMarker_Resuscitated_C.ExecuteUbergraph_UW-ReplayEventMarker_Resuscitated(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
