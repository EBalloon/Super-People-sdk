...
public:
	...
	void SetCoreInfoMessageType(struct FString Type); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetCoreInfoMessageType(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetResuscitationPingInfo(); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetResuscitationPingInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetCoreInfoResuscitation(struct ABravoHotelPlayerState PlayerState); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetCoreInfoResuscitation(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetRequestMessageInfo(struct ABravoHotelPlayerState PlayerState, struct FText Message); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetRequestMessageInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetRequestMessage(struct ABravoHotelPlayerState Player State, struct FText Message); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetRequestMessage(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetRoutePingInfo(); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetRoutePingInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetCoreInfoRoutePing(struct ABravoHotelPlayerState PlayerState); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetCoreInfoRoutePing(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetCoreInfoMessage(struct FText Message, struct FString Type); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetCoreInfoMessage(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetPlayerInfo(struct ABravoHotelPlayerState PlayerState); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetPlayerInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetPingType(struct FBravoHotelPingInfo PingInfo); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetPingType(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetCoreInfoSmartping(struct ABravoHotelPlayerState PlayerState); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.SetCoreInfoSmartping(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void PlayAddCoreInfoAnim(); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.PlayAddCoreInfoAnim(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_UW-ListWidget_CoreInfo(int32_t EntryPoint); // Function UW-ListWidget_CoreInfo.UW-ListWidget_CoreInfo_C.ExecuteUbergraph_UW-ListWidget_CoreInfo(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
