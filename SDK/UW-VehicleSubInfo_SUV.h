...
public:
	...
	void Setup(struct ABravoHotelVehicle VehicleInstance); // Function UW-VehicleSubInfo_SUV.UW-VehicleSubInfo_SUV_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-VehicleSubInfo_SUV(int32_t EntryPoint); // Function UW-VehicleSubInfo_SUV.UW-VehicleSubInfo_SUV_C.ExecuteUbergraph_UW-VehicleSubInfo_SUV(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
