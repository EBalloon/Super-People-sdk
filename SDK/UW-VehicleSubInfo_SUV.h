...
public:
	...
	void Setup(struct Unknown VehicleInstance); // Function UW-VehicleSubInfo_SUV.UW-VehicleSubInfo_SUV_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-VehicleSubInfo_SUV(int32_t EntryPoint); // Function UW-VehicleSubInfo_SUV.UW-VehicleSubInfo_SUV_C.ExecuteUbergraph_UW-VehicleSubInfo_SUV(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
