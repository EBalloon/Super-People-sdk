...
public:
	...
	struct FVector TouchingActorEntryPosition; // 0x340 (12)
	struct FVector FoliageVelocity; // 0x34C (12)
	struct FVector FoliageForce; // 0x358 (12)
	struct FVector FoliagePosition; // 0x364 (12)
	float FoliageDamageImpulseScale; // 0x370 (4)
	float FoliageTouchImpulseScale; // 0x374 (4)
	float FoliageStiffness; // 0x378 (4)
	float FoliageStiffnessQuadratic; // 0x37C (4)
	float FoliageDamping; // 0x380 (4)
	float MaxDamageImpulse; // 0x384 (4)
	float MaxTouchImpulse; // 0x388 (4)
	float MaxForce; // 0x38C (4)
	float Mass; // 0x390 (4)

	void CapsuleTouched(struct UPrimitiveComponent OverlappedComp, struct UActor Other, struct UPrimitiveComponent OtherComp, int32_t OtherBodyIndex, char bFromSweep, struct FHitResult& OverlapInfo); // Function Foliage.InteractiveFoliageActor.CapsuleTouched(Final|Native|Protected|HasOutParms) // <BravoHotelClient-Win64-Shipping.protected.exe+0x390BDE0>
};
...
public:
	...
	struct AProceduralFoliageVolume ProceduralFoliageVolume; // 0x360 (8)
};
...
public:
	...
	void Simulate(int32_t NumSteps); // Function Foliage.ProceduralFoliageSpawner.Simulate(Final|Native|Public|BlueprintCallable) // <BravoHotelClient-Win64-Shipping.protected.exe+0x390C260>
};
...
public:
	...
	struct UProceduralFoliageComponent ProceduralComponent; // 0x360 (8)
};
