...
public:
	...
	struct Unknown TouchingActorEntryPosition; // 0x330 (12)
	struct Unknown FoliageVelocity; // 0x33C (12)
	struct Unknown FoliageForce; // 0x348 (12)
	struct Unknown FoliagePosition; // 0x354 (12)
	float FoliageDamageImpulseScale; // 0x360 (4)
	float FoliageTouchImpulseScale; // 0x364 (4)
	float FoliageStiffness; // 0x368 (4)
	float FoliageStiffnessQuadratic; // 0x36C (4)
	float FoliageDamping; // 0x370 (4)
	float MaxDamageImpulse; // 0x374 (4)
	float MaxTouchImpulse; // 0x378 (4)
	float MaxForce; // 0x37C (4)
	float Mass; // 0x380 (4)

	void CapsuleTouched(struct Unknown OverlappedComp, struct Unknown Other, struct Unknown OtherComp, int32_t OtherBodyIndex, char bFromSweep, struct Unknown& OverlapInfo); // Function Foliage.InteractiveFoliageActor.CapsuleTouched(Final|Native|Protected|HasOutParms) // <Game_BE.exe+0x38EAF80>
};
...
public:
	...
	struct Unknown ProceduralFoliageVolume; // 0x350 (8)
};
...
public:
	...
	struct Unknown ProceduralComponent; // 0x350 (8)
};
