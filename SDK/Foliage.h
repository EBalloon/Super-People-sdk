...
struct UFoliageInstancedStaticMeshComponent : UHierarchicalInstancedStaticMeshComponent {
	...
	struct FMulticastInlineDelegate OnInstanceTakeRadial; //  0x728 Size(10)
	struct Unknown GenerationGuid; //  0x738 Size(10)
};

// Class Foliage.FoliageSettings
struct UFoliageSettings : UDeveloperSettings {
	struct TArray<Unknown> Cull; //  0x38 Size(10)
	int32_t DesiredMaxTrianglesToRender; //  0x48 Size(4)
	float MinimumScreenSize; //  0x4c Size(4)
	int32_t MaxOcclusionQueriesPerComponent; //  0x50 Size(4)
	int32_t MinOcclusionQueriesPerComponent; //  0x54 Size(4)
	int32_t MinInstancesPerOcclusionQuery; //  0x58 Size(4)
};

// Class Foliage.FoliageType
struct UFoliageType : Object {
	struct Unknown UpdateGuid; //  0x28 Size(10)
	float Density; //  0x38 Size(4)
	float DensityAdjustmentFactor; //  0x3c Size(4)
	float Radius; //  0x40 Size(4)
	char bSingleInstanceModeOverrideRadi; //  0x44 Size(1)
	float SingleInstanceModeRadius; //  0x48 Size(4)
	enum class Unknow Scaling; //  0x4c Size(1)
	struct Unknown ScaleX; //  0x50 Size(8)
	struct Unknown ScaleY; //  0x58 Size(8)
	struct Unknown ScaleZ; //  0x60 Size(8)
	struct Unknown VertexColorMaskByChannel; //  0x68 Size(30)
	char VertexColorMask; //  0x98 Size(1)
	float VertexColorMaskThreshold; //  0x9c Size(4)
	char VertexColorMaskInvert; //  0xa0 Size(1)
	struct Unknown ZOffset; //  0xa4 Size(8)
	...
	struct Unknown GroundSlopeAngle; //  0xbc Size(8)
	struct Unknown Height; //  0xc4 Size(8)
	struct TArray<Unknown> LandscapeLayers; //  0xd0 Size(10)
	float MinimumLayerWeight; //  0xe0 Size(4)
	struct TArray<Unknown> ExclusionLandscapeLayers; //  0xe8 Size(10)
	float MinimumExclusionLayerWeight; //  0xf8 Size(4)
	struct FName LandscapeLayer; //  0xfc Size(8)
	char CollisionWithWorld; //  0x104 Size(1)
	struct Unknown CollisionScale; //  0x108 Size(c)
	struct Unknown MeshBounds; //  0x114 Size(1c)
	struct Unknown LowBoundOriginRadius; //  0x130 Size(c)
	char Mobility; //  0x13c Size(1)
	enum class Unknow Cull; //  0x13d Size(1)
	char bOverrideCullDistance; //  0x13e Size(1)
	struct Unknown Cull; //  0x140 Size(8)
	...
	enum class Unknow LightmapType; //  0x154 Size(1)
	char bUseAsOccluder; //  0x158 Size(1)
	struct Unknown BodyInstance; //  0x160 Size(190)
	char CustomNavigableGeometry; //  0x2f0 Size(1)
	char InstanceBodiesSplitRatio; //  0x2f1 Size(1)
	struct Unknown LightingChannels; //  0x2f2 Size(1)
	...
	struct Unknown ProceduralScale; //  0x334 Size(8)
	struct Unknown ScaleCurve; //  0x340 Size(88)
	...
	struct TArray<Unknown> RuntimeVirtualTextures; //  0x3d0 Size(10)
	int32_t VirtualTextureCullMips; //  0x3e0 Size(4)
	enum class Unknow VirtualTextureRenderPassType; //  0x3e4 Size(1)
};

// Class Foliage.FoliageType_Actor
struct UFoliageType_Actor : UFoliageType {
	struct Unknown* ActorClass; //  0x3e8 Size(8)
	char bShouldAttachToBaseComponent; //  0x3f0 Size(1)
};

// Class Foliage.FoliageType_InstancedStaticMesh
struct UFoliageType_InstancedStaticMesh : UFoliageType {
	struct Unknown Mesh; //  0x3e8 Size(8)
	struct TArray<Unknown> OverrideMaterials; //  0x3f0 Size(10)
	struct Unknown* ComponentClass; //  0x400 Size(8)
};

// Class Foliage.InteractiveFoliageActor
struct AInteractiveFoliageActor : AStaticMeshActor {
	struct Unknown CapsuleComponent; //  0x320 Size(8)
	struct Unknown TouchingActorEntryPosition; //  0x328 Size(c)
	struct Unknown FoliageVelocity; //  0x334 Size(c)
	struct Unknown FoliageForce; //  0x340 Size(c)
	struct Unknown FoliagePosition; //  0x34c Size(c)
	...
	void CapsuleTouched(struct Unknown OverlappedComp, struct Unknown Other, struct Unknown OtherComp, int32_t OtherBodyIndex, char bFromSweep, struct Unknown& OverlapInfo); // Function Foliage.InteractiveFoliageActor.CapsuleTouched(Final|Native|Protected|HasOutParms) // <Game+0x311c3a0>
};

// Class Foliage.ProceduralFoliageBlockingVolume
struct AProceduralFoliageBlockingVolume : AVolume {
	struct Unknown ProceduralFoliageVolume; //  0x348 Size(8)
};

// Class Foliage.ProceduralFoliageComponent
struct UProceduralFoliageComponent : UActorComponent {
	struct Unknown FoliageSpawner; //  0xb0 Size(8)
	float TileOverlap; //  0xb8 Size(4)
	struct Unknown SpawningVolume; //  0xc0 Size(8)
	struct Unknown ProceduralGuid; //  0xc8 Size(10)
};
...
struct UProceduralFoliageSpawner : Object {
	...
	struct TArray<Unknown> FoliageTypes; //  0x40 Size(10)

	void Simulate(int32_t NumSteps); // Function Foliage.ProceduralFoliageSpawner.Simulate(Final|Native|Public|BlueprintCallable) // <Game+0x311c820>
};

// Class Foliage.ProceduralFoliageTile
struct UProceduralFoliageTile : Object {
	struct Unknown FoliageSpawner; //  0x28 Size(8)
	struct TArray<Unknown> InstancesArray; //  0xd0 Size(10)
};

// Class Foliage.ProceduralFoliageVolume
struct AProceduralFoliageVolume : AVolume {
	struct Unknown ProceduralComponent; //  0x348 Size(8)
};
