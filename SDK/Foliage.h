...
public:
	...
	struct FVector TouchingActorEntryPosition; // 0x330 (12)
	struct FVector FoliageVelocity; // 0x33C (12)
	struct FVector FoliageForce; // 0x348 (12)
	struct FVector FoliagePosition; // 0x354 (12)
...
public:
	...
	struct AProceduralFoliageVolume ProceduralFoliageVolume; // 0x350 (8)
};
...
public:
	...
	struct UProceduralFoliageComponent ProceduralComponent; // 0x350 (8)
};
