...
public:
	...
	void SetNew(char IsNew); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.SetNew(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetButtonEnabled(char Enabled); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.SetButtonEnabled(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void MakeCraftMaterialItemIDList(); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.MakeCraftMaterialItemIDList(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CheckOwn(char& OutIsOwn, char& OutIsOwnAny); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.CheckOwn(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetWeaponInfo(struct Unknown& CraftingInfo); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.SetWeaponInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_01779F6241D23AEE08F8DCBEA1B49997(struct Unknown Loaded); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.OnLoaded_01779F6241D23AEE08F8DCBEA1B49997(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadImg(struct Unknown Object); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.AsyncLoadImg(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void OnClickedWeapon(); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.OnClickedWeapon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ResetButtonEnabled(); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.ResetButtonEnabled(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void ExecuteUbergraph_UW-Lobby_Craft_List_Category_Slot(int32_t EntryPoint); // Function UW-Lobby_Craft_List_Category_Slot.UW-Lobby_Craft_List_Category_Slot_C.ExecuteUbergraph_UW-Lobby_Craft_List_Category_Slot(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
