...
public:
	...
	struct Unknown CP-SlotInfo; // 0x420 (8)
	struct Unknown IMG-BG; // 0x428 (8)
	struct Unknown IMG-BG-Border; // 0x430 (8)
	struct Unknown IMG-Item; // 0x438 (8)
	struct Unknown IMG-Mask; // 0x440 (8)
	struct Unknown IMG-Over; // 0x448 (8)
	struct Unknown IMG-Over-Border; // 0x450 (8)
	struct Unknown Menu02; // 0x458 (8)
	struct Unknown Menu03; // 0x460 (8)
	struct Unknown Menu04; // 0x468 (8)
	struct Unknown Menu05; // 0x470 (8)
	struct Unknown Menu06; // 0x478 (8)
	struct Unknown Menu07; // 0x480 (8)
	struct Unknown Menu08; // 0x488 (8)
	struct Unknown Menu09; // 0x490 (8)
	struct Unknown Overlay_Mask; // 0x498 (8)
	struct Unknown TXT-ContinuousSpeed; // 0x4A0 (8)
	struct Unknown TXT-Horizental; // 0x4A8 (8)
	struct Unknown TXT-ItemName; // 0x4B0 (8)
	struct Unknown TXT-Menu01; // 0x4B8 (8)
	struct Unknown TXT-Menu02; // 0x4C0 (8)
	struct Unknown TXT-Menu03; // 0x4C8 (8)
	struct Unknown TXT-Menu04; // 0x4D0 (8)
	struct Unknown TXT-Menu05; // 0x4D8 (8)
	struct Unknown TXT-Menu06; // 0x4E0 (8)
	struct Unknown TXT-Menu07; // 0x4E8 (8)
	struct Unknown TXT-Menu08; // 0x4F0 (8)
	struct Unknown TXT-Menu09; // 0x4F8 (8)
	struct Unknown TXT-MovingSpeed; // 0x500 (8)
	struct Unknown TXT-Reload; // 0x508 (8)
	struct Unknown TXT-Type; // 0x510 (8)
	struct Unknown TXT-Vertical; // 0x518 (8)
	struct Unknown TXT-Weight; // 0x520 (8)

	struct Unknown On_IMG-BG_MouseButtonDown_1(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.On_IMG-BG_MouseButtonDown_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void OnLoaded_F81B5B0343A0A1A16D1EBABD173C2F15(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.OnLoaded_F81B5B0343A0A1A16D1EBABD173C2F15(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void Construct(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_220_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_220_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu03_K2Node_ComponentBoundEvent_237_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu03_K2Node_ComponentBoundEvent_237_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_255_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_255_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_274_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_274_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu06_K2Node_ComponentBoundEvent_294_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu06_K2Node_ComponentBoundEvent_294_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu07_K2Node_ComponentBoundEvent_315_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu07_K2Node_ComponentBoundEvent_315_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu08_K2Node_ComponentBoundEvent_337_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu08_K2Node_ComponentBoundEvent_337_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void BndEvt__BTN-Menu09_K2Node_ComponentBoundEvent_360_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.BndEvt__BTN-Menu09_K2Node_ComponentBoundEvent_360_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_UW-BlackMarket_Slot_Attachment(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.ExecuteUbergraph_UW-BlackMarket_Slot_Attachment(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};

// Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.On_IMG-BG_MouseButtonDown_1
inline struct Unknown UUW-BlackMarket_Slot_Attachment_C::On_IMG-BG_MouseButtonDown_1(struct Unknown MyGeometry, struct Unknown& MouseEvent) {
...
inline void UUW-BlackMarket_Slot_Attachment_C::SetIconTexture(struct Unknown IconTexture) {
...
inline void UUW-BlackMarket_Slot_Attachment_C::OnLoaded_F81B5B0343A0A1A16D1EBABD173C2F15(struct Unknown Loaded) {
...
inline void UUW-BlackMarket_Slot_Attachment_C::OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent) {
...
inline void UUW-BlackMarket_Slot_Attachment_C::OnMouseLeave(struct Unknown& MouseEvent) {
...
inline void UUW-BlackMarket_Slot_Attachment_C::AysncLoading(struct Unknown IconTexture) {
