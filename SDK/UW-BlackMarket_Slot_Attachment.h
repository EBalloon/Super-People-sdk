...
public:
	...
	struct Unknown On_IMG-BG_MouseButtonDown_1(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.On_IMG-BG_MouseButtonDown_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnLoaded_F81B5B0343A0A1A16D1EBABD173C2F15(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.OnLoaded_F81B5B0343A0A1A16D1EBABD173C2F15(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Attachment.UW-BlackMarket_Slot_Attachment_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
