...
public:
	...
	void GetCraftingWeaponRarity(int32_t& OutRarity); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.GetCraftingWeaponRarity(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void OnChangedArmoryTab(); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.OnChangedArmoryTab(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetButtonEnabled(); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.SetButtonEnabled(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckOwn(); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.CheckOwn(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetCraftingInfo(struct Unknown ButtonRef); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.SetCraftingInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Crapting_Btn_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.BndEvt__Button_Crapting_Btn_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void RequestCraftWeapon(int32_t WeaponIndex, struct FString ItemId); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.RequestCraftWeapon(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Crapting_Btn_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature(); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.BndEvt__Button_Crapting_Btn_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SelectCancel(); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.SelectCancel(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Lobby_Armory_Recipe(int32_t EntryPoint); // Function UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.ExecuteUbergraph_UW-Lobby_Armory_Recipe(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
