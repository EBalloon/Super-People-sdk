...
public:
	...
	void IsEquipped(char& Return); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsEquipped(Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CheckNeedEmptyPerkWeaponTooltip(char& NewParam); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CheckNeedEmptyPerkWeaponTooltip(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowStatupAnim(struct FStatupAnimParameters& StatParams); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ShowStatupAnim(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetMaterialIcon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetMaterialIcon(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	enum class ESlateVisibility Get_btn_RecipeTree_Visibility_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_btn_RecipeTree_Visibility_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CheckSpecialWeapon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CheckSpecialWeapon(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetRarityInfo(struct FInventoryItemInfo ItemInfo); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetRarityInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetHoverWidgetRef(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetHoverWidgetRef(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void DisibleEquiped(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DisibleEquiped(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InitWeaponSlot(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.InitWeaponSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void DragStart_Imp(struct UDragDropOperation& DragDropOp); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragStart_Imp(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverSelectReset(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverSelectReset(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void IsDropableOnCarried(char& out_Result); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsDropableOnCarried(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void UnEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.UnEquip(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverEquipAttachment(enum class EWeaponAttachmentType WeaponAttachmentType); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverEquipAttachment(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void DragSelectSlot(enum class EWeaponType WeaponType, char& bReault); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragSelectSlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void IsDraging(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsDraging(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetHoverAllSlot(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetHoverAllSlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetHoverWeaponSlotList(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetHoverWeaponSlotList(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void DragFindAttachItemSlot(struct FInventoryItemInfo InventoryItemInfo, char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragFindAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void DragFindEquipAttachment(enum class EWeaponAttachmentType WeaponAttachmentType); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragFindEquipAttachment(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverResetAttachItemSlot(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverResetAttachItemSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverSelectEquipAttachment(enum class EWeaponAttachmentType WeaponAttachmentType); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverSelectEquipAttachment(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverSelectAttachItemSlot(struct FInventoryItemInfo InventoryItemInfo, char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverSelectAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void IsMainWeapon(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsMainWeapon(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnRButtonClick(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnRButtonClick(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetHoverInfo(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetHoverInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	struct FText Get_AmmoInfo02_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_AmmoInfo02_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	struct FText Get_AmmoInfo01_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_AmmoInfo01_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	struct FText Get_Ammo02_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_Ammo02_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	struct FText Get_Ammo01_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_Ammo01_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetSubWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetSubWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InitSubWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.InitSubWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetMainWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetMainWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InitMainWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.InitMainWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void GetAvailableWeaponAttachment(enum class EWeaponAttachmentType AttachmentType, char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.GetAvailableWeaponAttachment(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Reset(int32_t SlotIndex); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Reset(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Drop(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Drop(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetInfo(struct UUW-InventoryWidget_C InventoryWidget, struct ABravoHotelWeaponBase WeaponBaseObject, struct FInventoryItemInfo InventoryItemInfo); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnLoaded_12B755EE4F233763D6BD21B48D6176F0(struct Object Loaded); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnLoaded_12B755EE4F233763D6BD21B48D6176F0(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnLoaded_D1195FCF4E38C6E811F1FCBC38F521B6(struct Object Loaded); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnLoaded_D1195FCF4E38C6E811F1FCBC38F521B6(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Init(int32_t SlotIndex); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Init(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CanEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CanEquip(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Construct(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Hover(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Hover(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnDragEnter(struct FGeometry MyGeometry, struct FPointerEvent PointerEvent, struct UDragDropOperation Operation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnDragEnter(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnDragLeave(struct FPointerEvent PointerEvent, struct UDragDropOperation Operation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnDragLeave(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SelectEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SelectEquip(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetHover(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetHover(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetCanEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetCanEquip(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetSelectEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetSelectEquip(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AsyncLoadWeaponIcon(struct TSoftObjectPtr<Object> IconTexture); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.AsyncLoadWeaponIcon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AsyncLoadAmmoIcon(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.AsyncLoadAmmoIcon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Event_WeaponInfo(int32_t Idx, int32_t Ammo, int32_t MaxAmmo); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Event_WeaponInfo(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void NotifyMainWeapon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.NotifyMainWeapon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void NotifySubWeapon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.NotifySubWeapon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnAnimationFinished(struct UWidgetAnimation Animation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnAnimationFinished(BlueprintCosmetic|Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CheckInventoryRef(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CheckInventoryRef(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void StopNotify(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.StopNotify(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void CompleteCombine(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CompleteCombine(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CompleteCombineOnRecipeTree(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CompleteCombineOnRecipeTree(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverRecipeTree(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverRecipeTree(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnUpdateCastingDelegateEvent(struct FCastingInfo& CastingInfo, float CastingPercent); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnUpdateCastingDelegateEvent(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-Inventory_WeaponSlot(int32_t EntryPoint); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ExecuteUbergraph_UW-Inventory_WeaponSlot(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
