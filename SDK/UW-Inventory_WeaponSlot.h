...
public:
	...
	void IsEquipped(char& Return); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsEquipped(Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // <Game_BE.exe+0x2B812B0>
	void CheckNeedEmptyPerkWeaponTooltip(char& NewParam); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CheckNeedEmptyPerkWeaponTooltip(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <Game_BE.exe+0x2B812B0>
	void ShowStatupAnim(struct Unknown& StatParams); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ShowStatupAnim(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetMaterialIcon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetMaterialIcon(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	enum class Unknow Get_btn_RecipeTree_Visibility_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_btn_RecipeTree_Visibility_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void CheckSpecialWeapon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CheckSpecialWeapon(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRarityInfo(struct Unknown ItemInfo); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetRarityInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetHoverWidgetRef(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetHoverWidgetRef(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DisibleEquiped(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DisibleEquiped(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void InitWeaponSlot(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.InitWeaponSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DragStart_Imp(struct Unknown& DragDropOp); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragStart_Imp(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverSelectReset(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverSelectReset(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsDropableOnCarried(char& out_Result); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsDropableOnCarried(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void UnEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.UnEquip(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverEquipAttachment(enum class Unknow WeaponAttachmentType); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverEquipAttachment(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DragSelectSlot(enum class Unknow WeaponType, char& bReault); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragSelectSlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsDraging(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsDraging(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void ResetHoverAllSlot(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetHoverAllSlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetHoverWeaponSlotList(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetHoverWeaponSlotList(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	char OnDrop(struct Unknown MyGeometry, struct Unknown PointerEvent, struct Unknown Operation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnDrop(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnDragDetected(struct Unknown MyGeometry, struct Unknown& PointerEvent, struct Unknown& Operation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnDragDetected(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DragFindAttachItemSlot(struct Unknown InventoryItemInfo, char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragFindAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DragFindEquipAttachment(enum class Unknow WeaponAttachmentType); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.DragFindEquipAttachment(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetAttachItemSlot(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverResetAttachItemSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverSelectEquipAttachment(enum class Unknow WeaponAttachmentType); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverSelectEquipAttachment(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverSelectAttachItemSlot(struct Unknown InventoryItemInfo, char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverSelectAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsMainWeapon(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.IsMainWeapon(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnRButtonClick(char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnRButtonClick(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetHoverInfo(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetHoverInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct FText Get_AmmoInfo02_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_AmmoInfo02_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	struct FText Get_AmmoInfo01_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_AmmoInfo01_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	struct FText Get_Ammo02_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_Ammo02_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	struct FText Get_Ammo01_Text_1(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Get_Ammo01_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void SetSubWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetSubWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void InitSubWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.InitSubWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetMainWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetMainWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void InitMainWeaponAttachment(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.InitMainWeaponAttachment(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetAvailableWeaponAttachment(enum class Unknow AttachmentType, char& bResult); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.GetAvailableWeaponAttachment(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Reset(int32_t SlotIndex); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Reset(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Drop(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Drop(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetInfo(struct Unknown InventoryWidget, struct Unknown WeaponBaseObject, struct Unknown InventoryItemInfo); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SetInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_12B755EE4F233763D6BD21B48D6176F0(struct Unknown Loaded); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnLoaded_12B755EE4F233763D6BD21B48D6176F0(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_D1195FCF4E38C6E811F1FCBC38F521B6(struct Unknown Loaded); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnLoaded_D1195FCF4E38C6E811F1FCBC38F521B6(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Init(int32_t SlotIndex); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Init(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CanEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CanEquip(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Hover(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Hover(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnDragEnter(struct Unknown MyGeometry, struct Unknown PointerEvent, struct Unknown Operation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnDragEnter(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnDragLeave(struct Unknown PointerEvent, struct Unknown Operation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnDragLeave(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SelectEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.SelectEquip(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetHover(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetHover(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetCanEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetCanEquip(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetSelectEquip(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ResetSelectEquip(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AsyncLoadWeaponIcon(struct Unknown IconTexture); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.AsyncLoadWeaponIcon(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AsyncLoadAmmoIcon(struct Unknown IconTexture); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.AsyncLoadAmmoIcon(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Event_WeaponInfo(int32_t Idx, int32_t Ammo, int32_t MaxAmmo); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.Event_WeaponInfo(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void NotifyMainWeapon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.NotifyMainWeapon(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void NotifySubWeapon(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.NotifySubWeapon(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnAnimationFinished(struct Unknown Animation); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnAnimationFinished(BlueprintCosmetic|Event|Protected|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckInventoryRef(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CheckInventoryRef(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void StopNotify(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.StopNotify(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__btn_RecipeTree_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.BndEvt__btn_RecipeTree_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CompleteCombine(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CompleteCombine(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CompleteCombineOnRecipeTree(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.CompleteCombineOnRecipeTree(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverRecipeTree(); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.HoverRecipeTree(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnUpdateCastingDelegateEvent(struct Unknown& CastingInfo, float CastingPercent); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.OnUpdateCastingDelegateEvent(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Inventory_WeaponSlot(int32_t EntryPoint); // Function UW-Inventory_WeaponSlot.UW-Inventory_WeaponSlot_C.ExecuteUbergraph_UW-Inventory_WeaponSlot(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
