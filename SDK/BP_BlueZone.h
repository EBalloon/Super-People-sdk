...
// Function BP_BlueZone.BP_BlueZone_C.On
inline void ABP_BlueZone_C::On(int32_t PrevPhase, int32_t CurrentPhase) {
	static auto fn = UObject::FindObject<UFunction>("Function BP_BlueZone.BP_BlueZone_C.On");
