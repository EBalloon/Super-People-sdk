...
public:
	...
	void Construct(); // Function UW-CastingWidget_CancelText.UW-CastingWidget_CancelText_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-CastingWidget_CancelText(int32_t EntryPoint); // Function UW-CastingWidget_CancelText.UW-CastingWidget_CancelText_C.ExecuteUbergraph_UW-CastingWidget_CancelText(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
