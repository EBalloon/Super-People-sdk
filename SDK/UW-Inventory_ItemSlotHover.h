...
public:
	...
	struct Unknown ItemSlot-BG; // 0x418 (8)
	struct Unknown ItemSlot-Capacity; // 0x420 (8)
	struct Unknown ItemSlot-Capacity_2; // 0x428 (8)
	struct Unknown ItemSlot-Description; // 0x430 (8)
	struct Unknown ItemSlot-Description_2; // 0x438 (8)
	struct Unknown ItemSlot-ItemImage; // 0x440 (8)
	struct Unknown ItemSlot-ItemName; // 0x448 (8)
	struct Unknown ItemSlot-ItemType; // 0x450 (8)
	struct Unknown ItemSlot-ItemTypeMark; // 0x458 (8)
	...
	struct Unknown PopupHover-BG_2; // 0x490 (8)
	...
	struct Unknown T_UnlockUltimateLevel; // 0x530 (8)
	...
	struct Unknown UW-Inventory_ItemSlotHover_WeaponSlot; // 0x568 (8)
	struct Unknown UW-Inventory_ItemSlotHover_WeaponSlot_2; // 0x570 (8)
	struct Unknown UW-Inventory_ItemSlotHover_WeaponSlot_C; // 0x578 (8)
	struct Unknown UW-Inventory_ItemSlotHover_WeaponSlot_C_2; // 0x580 (8)
	struct Unknown UW-Inventory_ItemSlotHover_WeaponSlot_C_3; // 0x588 (8)
	struct Unknown UW-Inventory_ItemSlotHover_WeaponSlot_C_4; // 0x590 (8)
	...
	struct Unknown VerticalBox_ItemDivide; // 0x5C0 (8)
	...
	struct Unknown WeaponItemSlot-BG; // 0x5F0 (8)
	...
	float GetDisplayAccuracy(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetDisplayAccuracy(Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	float GetDisplayDamage(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetDisplayDamage(Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	int32_t GetDisplayEffectiveRange(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetDisplayEffectiveRange(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	int32_t GetDisplayLevel(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetDisplayLevel(Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	int32_t GetDisplayMagSize(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetDisplayMagSize(Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	int32_t GetDisplayRateofFire(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetDisplayRateofFire(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetCurrentClassSpecialWeaponPerkData(char& Find, struct Unknown& OutPerkData); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetCurrentClassSpecialWeaponPerkData(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetCurrentPerkWeaponInfoSlot(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetCurrentPerkWeaponInfoSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetTooltipSlot(enum class Unknow DragType, struct FText BuffInfo); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetTooltipSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetVisualMode(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetVisualMode(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetBuffSlot(enum class Unknow DragType, struct Unknown BuffInfo); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetBuffSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetOptionSlot(enum class Unknow DragType, struct Unknown ItemOptionInfo); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetOptionSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetMaterialSlot(enum class Unknow DragType, struct Unknown MaterialInfo); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetMaterialSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Hide(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Hide(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Show(struct Unknown HoverWidget, char ShowItemDivideInfo, char IsRandomPerk, char& SUCCESS); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Show(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Vertical Box Buff List 2 Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Vertical Box Buff List 2 Visibility(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Buff List 1 Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Buff List 1 Visibility(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Size Box Comparing Text Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Size Box Comparing Text Visibility(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Vertical Box Combine Target Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Vertical Box Combine Target Visibility(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Item Slot- Description 1 Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Item Slot- Description 1 Visibility(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Visibility Item Divide(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Visibility Item Divide(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetItemWeaponData(struct Unknown& ItemWeaponData); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetItemWeaponData(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetBuffList(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetBuffList(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Horizontal Box Weapon Binded Info Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Horizontal Box Weapon Binded Info Visibility(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get Image Weapon Lock Color And Opacity(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Image Weapon Lock Color And Opacity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Image Weapon Lock Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Image Weapon Lock Visibility(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetStatSlot(enum class Unknow StatusType, int32_t Value, enum class Unknow DragType); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetStatSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get_ItemBg_ColorAndOpacity(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get_ItemBg_ColorAndOpacity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get Perk BG Color And Opacity(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Perk BG Color And Opacity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get_ItemBg_01_ColorAndOpacity(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get_ItemBg_01_ColorAndOpacity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetUltimatePerkDesc(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetUltimatePerkDesc(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown GetSlotColor(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetSlotColor(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get Perk Name Color And Opacity(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Perk Name Color And Opacity(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get Unlock Ultimate Level Visibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Unlock Ultimate Level Visibility(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkDesc(int32_t Level); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetPerkDesc(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerksDesc(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetPerksDesc(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void HideHover(enum class Unknow DragType, char Force); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.HideHover(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get Perk Image Brush(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Perk Image Brush(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Perk Name Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Perk Name Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkSlot(struct Unknown NewPerkInfo, enum class Unknow DragType, char IsUltimatePerk); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetPerkSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get_WeaponItemCapacity_Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get_WeaponItemCapacity_Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get_ItemSlot-Capacity_Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get_ItemSlot-Capacity_Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetItemType(struct FText& ItemTypeText, struct Unknown& ItemTypeTexture); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetItemType(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Item Slot- Item Type Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Item Slot- Item Type Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Weapon Item Type Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Weapon Item Type Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetWeaponType(enum class Unknow& WeaponType, struct FText& WeaponTypeText, struct Unknown& WeaponTypeTexture); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetWeaponType(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetEquippedWeaponInfoByWeaponType(enum class Unknow WeaponType, char& bResult, struct Unknown& WeaponInfo); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetEquippedWeaponInfoByWeaponType(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Weapon Item Comparing Name Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Weapon Item Comparing Name Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Ammo Info Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Ammo Info Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get Ammo Icon Brush(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Ammo Icon Brush(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetCompareAmmo(struct Unknown& SlateColor, struct FText& valueText); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetCompareAmmo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetCompareFiringRate(struct Unknown& SlateColor, struct FText& valueText); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetCompareFiringRate(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetCompareStabillity(struct Unknown& SlateColor, struct FText& valueText); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetCompareStabillity(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetCompareEffectiveRange(struct Unknown& SlateColor, struct FText& valueText); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetCompareEffectiveRange(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetComparePower(struct Unknown& SlateColor, struct FText& valueText); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetComparePower(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Ammo Value Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Ammo Value Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Firing Rate Value Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Firing Rate Value Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Stability Value Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Stability Value Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Effective Range Value Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Effective Range Value Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Power Value Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Power Value Text(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void IsWeaponTooltip(char& bResult); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.IsWeaponTooltip(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void IsItemTooltip(char& bResult); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.IsItemTooltip(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetHoverCanvas(struct Unknown& CanvasPanel, char& bResult); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetHoverCanvas(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetWeaponItemSlot(struct Unknown WeaponItemInfo, struct Unknown InventoryItemInfo, enum class Unknow DragType, struct FName Ammo); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetWeaponItemSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Weapon Item Slot- Description Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Weapon Item Slot- Description Text(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown Get Weapon Item Slot- Item Image Brush(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Weapon Item Slot- Item Image Brush(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get Weapon Item Slot- Item Name Text(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Get Weapon Item Slot- Item Name Text(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetItemSlotInfo(struct Unknown InventoryItem, enum class Unknow DragType); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.SetItemSlotInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Show Hover(struct Unknown HoveredWidget, struct Unknown ShowingWidgetRef, char& SUCCESS); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Show Hover(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText GetWeight(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetWeight(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText GetDescription(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetDescription(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown GetItemImage(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetItemImage(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText GetName(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.GetName(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_5CB0A85D41BD4B88F0EAB29CA9DBDD0F(struct Unknown Loaded); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.OnLoaded_5CB0A85D41BD4B88F0EAB29CA9DBDD0F(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_A317A42643FCC3E3348F00AF47100D7C(struct Unknown Loaded); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.OnLoaded_A317A42643FCC3E3348F00AF47100D7C(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_BF365972409319D445BAF88D964EE916(struct Unknown Loaded); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.OnLoaded_BF365972409319D445BAF88D964EE916(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_90972E92490A36CFBC0DC4AD6ACA1B48(struct Unknown Loaded); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.OnLoaded_90972E92490A36CFBC0DC4AD6ACA1B48(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadIconTexture(struct Unknown IconTexture); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.AsyncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void DelayDestroy(float Delay); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.DelayDestroy(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadIconObject(struct Unknown IconObject); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.AsyncLoadIconObject(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadStatIcon(struct Unknown IconObject); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.AsyncLoadStatIcon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void HideHoverBP(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.HideHoverBP(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CheckHoverVisibility(); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.CheckHoverVisibility(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadMaterialIcon(struct Unknown IconObject); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.AsyncLoadMaterialIcon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-Inventory_ItemSlotHover(int32_t EntryPoint); // Function UW-Inventory_ItemSlotHover.UW-Inventory_ItemSlotHover_C.ExecuteUbergraph_UW-Inventory_ItemSlotHover(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
...
inline void UUW-Inventory_ItemSlotHover_C::GetCurrentClassSpecialWeaponPerkData(char& Find, struct Unknown& OutPerkData) {
...
inline void UUW-Inventory_ItemSlotHover_C::SetTooltipSlot(enum class Unknow DragType, struct FText BuffInfo) {
...
inline void UUW-Inventory_ItemSlotHover_C::SetBuffSlot(enum class Unknow DragType, struct Unknown BuffInfo) {
...
inline void UUW-Inventory_ItemSlotHover_C::SetOptionSlot(enum class Unknow DragType, struct Unknown ItemOptionInfo) {
...
inline void UUW-Inventory_ItemSlotHover_C::SetMaterialSlot(enum class Unknow DragType, struct Unknown MaterialInfo) {
...
inline void UUW-Inventory_ItemSlotHover_C::Show(struct Unknown HoverWidget, char ShowItemDivideInfo, char IsRandomPerk, char& SUCCESS) {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Vertical Box Buff List 2 Visibility() {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Buff List 1 Visibility() {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Size Box Comparing Text Visibility() {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Vertical Box Combine Target Visibility() {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Item Slot- Description 1 Visibility() {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Visibility Item Divide() {
...
inline void UUW-Inventory_ItemSlotHover_C::GetItemWeaponData(struct Unknown& ItemWeaponData) {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Horizontal Box Weapon Binded Info Visibility() {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get Image Weapon Lock Color And Opacity() {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Image Weapon Lock Visibility() {
...
inline void UUW-Inventory_ItemSlotHover_C::SetStatSlot(enum class Unknow StatusType, int32_t Value, enum class Unknow DragType) {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get_ItemBg_ColorAndOpacity() {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get Perk BG Color And Opacity() {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get_ItemBg_01_ColorAndOpacity() {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::GetSlotColor() {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get Perk Name Color And Opacity() {
...
inline enum class Unknow UUW-Inventory_ItemSlotHover_C::Get Unlock Ultimate Level Visibility() {
...
inline void UUW-Inventory_ItemSlotHover_C::HideHover(enum class Unknow DragType, char Force) {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get Perk Image Brush() {
...
inline void UUW-Inventory_ItemSlotHover_C::SetPerkSlot(struct Unknown NewPerkInfo, enum class Unknow DragType, char IsUltimatePerk) {
...
inline void UUW-Inventory_ItemSlotHover_C::GetItemType(struct FText& ItemTypeText, struct Unknown& ItemTypeTexture) {
	...
	struct GetItemType_Params {
		...
		struct Unknown& ItemTypeTexture;
...
inline void UUW-Inventory_ItemSlotHover_C::GetWeaponType(enum class Unknow& WeaponType, struct FText& WeaponTypeText, struct Unknown& WeaponTypeTexture) {
	...
	struct GetWeaponType_Params {
		...
		struct Unknown& WeaponTypeTexture;
...
inline void UUW-Inventory_ItemSlotHover_C::GetEquippedWeaponInfoByWeaponType(enum class Unknow WeaponType, char& bResult, struct Unknown& WeaponInfo) {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get Ammo Icon Brush() {
...
inline void UUW-Inventory_ItemSlotHover_C::GetCompareAmmo(struct Unknown& SlateColor, struct FText& valueText) {
...
inline void UUW-Inventory_ItemSlotHover_C::GetCompareFiringRate(struct Unknown& SlateColor, struct FText& valueText) {
...
inline void UUW-Inventory_ItemSlotHover_C::GetCompareStabillity(struct Unknown& SlateColor, struct FText& valueText) {
...
inline void UUW-Inventory_ItemSlotHover_C::GetCompareEffectiveRange(struct Unknown& SlateColor, struct FText& valueText) {
...
inline void UUW-Inventory_ItemSlotHover_C::GetComparePower(struct Unknown& SlateColor, struct FText& valueText) {
...
inline void UUW-Inventory_ItemSlotHover_C::GetHoverCanvas(struct Unknown& CanvasPanel, char& bResult) {
...
inline void UUW-Inventory_ItemSlotHover_C::SetWeaponItemSlot(struct Unknown WeaponItemInfo, struct Unknown InventoryItemInfo, enum class Unknow DragType, struct FName Ammo) {
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::Get Weapon Item Slot- Item Image Brush() {
...
inline void UUW-Inventory_ItemSlotHover_C::SetItemSlotInfo(struct Unknown InventoryItem, enum class Unknow DragType) {
...
inline void UUW-Inventory_ItemSlotHover_C::Show Hover(struct Unknown HoveredWidget, struct Unknown ShowingWidgetRef, char& SUCCESS) {
	...
	struct Show Hover_Params {
		...
		struct Unknown ShowingWidgetRef;
		char& SUCCESS;
...
inline struct Unknown UUW-Inventory_ItemSlotHover_C::GetItemImage() {
...
inline void UUW-Inventory_ItemSlotHover_C::OnLoaded_5CB0A85D41BD4B88F0EAB29CA9DBDD0F(struct Unknown Loaded) {
...
inline void UUW-Inventory_ItemSlotHover_C::OnLoaded_A317A42643FCC3E3348F00AF47100D7C(struct Unknown Loaded) {
...
inline void UUW-Inventory_ItemSlotHover_C::OnLoaded_BF365972409319D445BAF88D964EE916(struct Unknown Loaded) {
...
inline void UUW-Inventory_ItemSlotHover_C::OnLoaded_90972E92490A36CFBC0DC4AD6ACA1B48(struct Unknown Loaded) {
...
inline void UUW-Inventory_ItemSlotHover_C::AsyncLoadIconTexture(struct Unknown IconTexture) {
...
inline void UUW-Inventory_ItemSlotHover_C::AsyncLoadIconObject(struct Unknown IconObject) {
...
inline void UUW-Inventory_ItemSlotHover_C::AsyncLoadStatIcon(struct Unknown IconObject) {
...
inline void UUW-Inventory_ItemSlotHover_C::AsyncLoadMaterialIcon(struct Unknown IconObject) {
