...
public:
	...
	void AllHiddenMaterialWidget(); // Function UW-InventoryWidget.UW-InventoryWidget_C.AllHiddenMaterialWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetAllSlotScrollToStart(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ResetAllSlotScrollToStart(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeightText(struct Unknown& WeightTextRef, struct Unknown& SymbolTextRef, float Weight); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetWeightText(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetAllHoverEffect(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ResetAllHoverEffect(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverRecipeByItem(struct FName ItemKey); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverRecipeByItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckEndFirstTimeValues(); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckEndFirstTimeValues(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckFirstTimeCraft(char& Return); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckFirstTimeCraft(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void CheckFirstTimeCapsuleItem(char& Return); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckFirstTimeCapsuleItem(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void CheckAnyEquippableAttachmentEmptySlot(struct Unknown& NewAttachmentItemInfo, char& IsEmpty); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckAnyEquippableAttachmentEmptySlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HideItemArea(); // Function UW-InventoryWidget.UW-InventoryWidget_C.HideItemArea(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowItemArea(struct Unknown& ItemInfo, char CanEquip); // Function UW-InventoryWidget.UW-InventoryWidget_C.ShowItemArea(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckItemInfoHovered(); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckItemInfoHovered(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetCarriedSlotItems(struct TArray<Unknown>& Items); // Function UW-InventoryWidget.UW-InventoryWidget_C.GetCarriedSlotItems(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void IsInCarriedBound(char& State); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsInCarriedBound(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsInBound(struct Unknown Begin, struct Unknown End, char& State); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsInBound(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsInMaterialBound(char& State); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsInMaterialBound(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsInBackPackBound(char& State); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsInBackPackBound(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckCompleteItems(); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckCompleteItems(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetMaterial(); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverResetMaterial(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverRecipe(struct FName RecipeKey); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverRecipe(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AllHiddenRecipeWidget(); // Function UW-InventoryWidget.UW-InventoryWidget_C.AllHiddenRecipeWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsMaterialItem(struct Unknown InventoryItemInfo, char& out_Result); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsMaterialItem(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowItemDorpPopup(struct Unknown BaseSlot, struct Unknown MaterialSlot, char& State); // Function UW-InventoryWidget.UW-InventoryWidget_C.ShowItemDorpPopup(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	char CheckMaterialBound(struct Unknown DropPos, struct Unknown Operation); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckMaterialBound(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRecipeItem(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetRecipeItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetMaterialItem(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetMaterialItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	enum class Unknow Get_CombineRecipe_Visibility_1(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Get_CombineRecipe_Visibility_1(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void SetVisibleInventoryCharacter(char bVisible); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetVisibleInventoryCharacter(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetStealable(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetStealable(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	enum class Unknow Get_IMG-BG_Visibility_1(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Get_IMG-BG_Visibility_1(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void HoverResetKeepedSlot(); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverResetKeepedSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverKeepedSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverKeepedSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetKeepedItem(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetKeepedItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetMainWidget(struct Unknown& MainWidget); // Function UW-InventoryWidget.UW-InventoryWidget_C.GetMainWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void CheckPreViewWeapon(char& State); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckPreViewWeapon(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DropBoxCompareQuantity(struct TArray<Unknown>& InventoryItemInfo, struct Unknown DropBoxInfo, char& SlotUpdate); // Function UW-InventoryWidget.UW-InventoryWidget_C.DropBoxCompareQuantity(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckBoxState(char State, struct Unknown CheckBox); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckBoxState(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct FText Get_TextBlock_CurrentGold_Text_1(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Get_TextBlock_CurrentGold_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void RemoveDropBoxItem(struct Unknown Actor, struct Unknown Slot); // Function UW-InventoryWidget.UW-InventoryWidget_C.RemoveDropBoxItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AddDropBoxItem(struct Unknown Slotinfo, struct Unknown Actor); // Function UW-InventoryWidget.UW-InventoryWidget_C.AddDropBoxItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void FindDropBox(struct Unknown Actor, struct Unknown& DropBox, char& State); // Function UW-InventoryWidget.UW-InventoryWidget_C.FindDropBox(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateDropBoxItem(struct Unknown Actor); // Function UW-InventoryWidget.UW-InventoryWidget_C.UpdateDropBoxItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetPerkBoxIcon(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetPerkBoxIcon(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	char IsShowingDropPopup(); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsShowingDropPopup(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckDefaultPawn(char& NewDefaultPawn); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckDefaultPawn(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateCarriedSlotInfo(); // Function UW-InventoryWidget.UW-InventoryWidget_C.UpdateCarriedSlotInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AllHiddenCarriedWidget(); // Function UW-InventoryWidget.UW-InventoryWidget_C.AllHiddenCarriedWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateProximityGroundSlotInfo(); // Function UW-InventoryWidget.UW-InventoryWidget_C.UpdateProximityGroundSlotInfo(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateProximityGroundWidget(); // Function UW-InventoryWidget.UW-InventoryWidget_C.UpdateProximityGroundWidget(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AddProximityGroundPool(); // Function UW-InventoryWidget.UW-InventoryWidget_C.AddProximityGroundPool(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void InitProximityGroundPool(); // Function UW-InventoryWidget.UW-InventoryWidget_C.InitProximityGroundPool(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetChracterVisible(char State); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetChracterVisible(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	char OnDragOver(struct Unknown MyGeometry, struct Unknown PointerEvent, struct Unknown Operation); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnDragOver(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckWeaponBound(struct Unknown DropPos, struct Unknown Operation); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckWeaponBound(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	char CheckCarriedBound(struct Unknown DropPos, struct Unknown Operation); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckCarriedBound(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckProximityBound(struct Unknown DropPos, struct Unknown Operation); // Function UW-InventoryWidget.UW-InventoryWidget_C.CheckProximityBound(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	enum class Unknow ShowBlackMarketButton(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ShowBlackMarketButton(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void UpdateWeaponMesh(struct Unknown NewWeapon, int32_t SlotIndex); // Function UW-InventoryWidget.UW-InventoryWidget_C.UpdateWeaponMesh(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetWearbleItemInfo(enum class Unknow WearableType, char& bHas, struct Unknown& ItemInfo, struct Unknown& ItemDetailInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.GetWearbleItemInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CalcItemWeight(char IsAddOrRemove, struct Unknown ItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.CalcItemWeight(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeightPlus(float WeightPlus, float MaxWeightPlus); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetWeightPlus(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeightProgress(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetWeightProgress(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetDragWeaponAttachmentItemFromCarriedSlot(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ResetDragWeaponAttachmentItemFromCarriedSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragWeaponAttachmentItemFromCarriedSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetDragWeaponAttachmentItemFromCarriedSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragWeaponAttachmentSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetDragWeaponAttachmentSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetInventoryItemDetailInfo(struct Unknown InventoryItemInfo, struct Unknown& InventoryItemDetailInfo, char& bResult); // Function UW-InventoryWidget.UW-InventoryWidget_C.GetInventoryItemDetailInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragCarriedSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetDragCarriedSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragWeaponSlot(struct Unknown WeaponInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetDragWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetDragWeaponItemFromCarriedSlot(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ResetDragWeaponItemFromCarriedSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragWeaponItemFromCarriedSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetDragWeaponItemFromCarriedSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetDragWeaponItemFromEquippedSlot(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ResetDragWeaponItemFromEquippedSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragWeaponItemFromEquippedSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetDragWeaponItemFromEquippedSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragProximitySlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetDragProximitySlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetCarriedSlotList(); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverResetCarriedSlotList(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetEquipSlot(); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverResetEquipSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetAttachItemSlotList(); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverResetAttachItemSlotList(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetWeaponSlotList(); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverResetWeaponSlotList(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverAttachItemSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverAttachItemSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverWeaponSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetItemDrag(char bDrag); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetItemDrag(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsItemDrag(char& bResult); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsItemDrag(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetDrag(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ResetDrag(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown OnMouseButtonDown(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnMouseButtonDown(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	enum class Unknow Get_InputMaskImage_Visibility_1(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Get_InputMaskImage_Visibility_1(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void EnableInventory(); // Function UW-InventoryWidget.UW-InventoryWidget_C.EnableInventory(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DisableInventory(); // Function UW-InventoryWidget.UW-InventoryWidget_C.DisableInventory(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void EnableCarriedSlotList(); // Function UW-InventoryWidget.UW-InventoryWidget_C.EnableCarriedSlotList(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DisableCarriedSlotList(); // Function UW-InventoryWidget.UW-InventoryWidget_C.DisableCarriedSlotList(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverCarriedSlotList(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverCarriedSlotList(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetCharacter(char& Result, struct Unknown& CharacterRef); // Function UW-InventoryWidget.UW-InventoryWidget_C.GetCharacter(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetInventoryComponent(char& Result, struct Unknown& InventoryComponent); // Function UW-InventoryWidget.UW-InventoryWidget_C.GetInventoryComponent(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverEquipSlot(struct Unknown InventoryItemInfo); // Function UW-InventoryWidget.UW-InventoryWidget_C.HoverEquipSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	float Get_WeightProgess_Percent_1(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Get_WeightProgess_Percent_1(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	struct FText Get_WeightPerCent_Text_1(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Get_WeightPerCent_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void ResetHover(struct Unknown InventoryItemInfo, char& bResult); // Function UW-InventoryWidget.UW-InventoryWidget_C.ResetHover(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsCarriable(struct Unknown InventoryItemInfo, char& out_Result, char& InStrongbox); // Function UW-InventoryWidget.UW-InventoryWidget_C.IsCarriable(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	char OnDrop(struct Unknown MyGeometry, struct Unknown PointerEvent, struct Unknown Operation); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnDrop(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetCarriedItems(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetCarriedItems(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetProximityItems(char bResetDrag); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetProximityItems(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetEquippedItems(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetEquippedItems(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeaponItems(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetWeaponItems(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetPreview(); // Function UW-InventoryWidget.UW-InventoryWidget_C.SetPreview(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_SortByTime_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-InventoryWidget.UW-InventoryWidget_C.BndEvt__Button_SortByTime_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_SortByType_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-InventoryWidget.UW-InventoryWidget_C.BndEvt__Button_SortByType_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-InventoryWidget.UW-InventoryWidget_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__CheckBox_0_K2Node_ComponentBoundEvent_1_OnCheckBoxComponentStateChanged__DelegateSignature(char bIsChecked); // Function UW-InventoryWidget.UW-InventoryWidget_C.BndEvt__CheckBox_0_K2Node_ComponentBoundEvent_1_OnCheckBoxComponentStateChanged__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-BlackMarket_K2Node_ComponentBoundEvent_87_OnButtonClickedEvent__DelegateSignature(); // Function UW-InventoryWidget.UW-InventoryWidget_C.BndEvt__BTN-BlackMarket_K2Node_ComponentBoundEvent_87_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CharacterVisible_Event(); // Function UW-InventoryWidget.UW-InventoryWidget_C.CharacterVisible_Event(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Open(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Open(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Close(); // Function UW-InventoryWidget.UW-InventoryWidget_C.Close(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CloseDropPopup(); // Function UW-InventoryWidget.UW-InventoryWidget_C.CloseDropPopup(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AcceptDropPopup(); // Function UW-InventoryWidget.UW-InventoryWidget_C.AcceptDropPopup(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void WeaponAmmoDelegate_Event_1(int32_t SlotIdx, int32_t CurAmmo, int32_t MaxAmmo); // Function UW-InventoryWidget.UW-InventoryWidget_C.WeaponAmmoDelegate_Event_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void NotifyNewWeapon(); // Function UW-InventoryWidget.UW-InventoryWidget_C.NotifyNewWeapon(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowInventoryCharacter(char IsShow); // Function UW-InventoryWidget.UW-InventoryWidget_C.ShowInventoryCharacter(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__CheckBox_K2Node_ComponentBoundEvent_3_OnCheckBoxComponentStateChanged__DelegateSignature(char bIsChecked); // Function UW-InventoryWidget.UW-InventoryWidget_C.BndEvt__CheckBox_K2Node_ComponentBoundEvent_3_OnCheckBoxComponentStateChanged__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DelayCheckCompleteItems(); // Function UW-InventoryWidget.UW-InventoryWidget_C.DelayCheckCompleteItems(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowFirstTimeItemInfoTooltip(); // Function UW-InventoryWidget.UW-InventoryWidget_C.ShowFirstTimeItemInfoTooltip(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	...
	void ShowStatupAnim(struct Unknown& StatupParameters, enum class Unknow StatupType); // Function UW-InventoryWidget.UW-InventoryWidget_C.ShowStatupAnim(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateSearchMaterialItem(); // Function UW-InventoryWidget.UW-InventoryWidget_C.UpdateSearchMaterialItem(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateSearchExpertWeaponMaterialItem(); // Function UW-InventoryWidget.UW-InventoryWidget_C.UpdateSearchExpertWeaponMaterialItem(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void NotEnoughSpaceDelegate_Event_1(); // Function UW-InventoryWidget.UW-InventoryWidget_C.NotEnoughSpaceDelegate_Event_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnRefreshWeightProgress(); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnRefreshWeightProgress(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnChangeMaterial(); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnChangeMaterial(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnChangeWeapon(); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnChangeWeapon(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnChangeDetectedItems(); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnChangeDetectedItems(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnChangeWeaponAttachment(); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnChangeWeaponAttachment(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnChangeWearableItem(); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnChangeWearableItem(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnChangeBagpackItem(); // Function UW-InventoryWidget.UW-InventoryWidget_C.OnChangeBagpackItem(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-InventoryWidget(int32_t EntryPoint); // Function UW-InventoryWidget.UW-InventoryWidget_C.ExecuteUbergraph_UW-InventoryWidget(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
	void EventDispatcher_OnCloseInventory__DelegateSignature(); // Function UW-InventoryWidget.UW-InventoryWidget_C.EventDispatcher_OnCloseInventory__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
};
