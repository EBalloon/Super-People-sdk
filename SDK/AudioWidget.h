...
public:
	...
	void 鉹@t元_1(struct UBravoHotelSettingSlotWidget Value); // Function AudioWidget.AudioWidget_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
