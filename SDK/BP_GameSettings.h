...
public:
	...
	void SetAutoReloadSetting(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.SetAutoReloadSetting(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetAutoReloadSetting(char& autoReload); // Function BP_GameSettings.BP_GameSettings_C.GetAutoReloadSetting(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyAutoReloadSetting(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyAutoReloadSetting(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Smooth Frame Rate(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Smooth Frame Rate(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Smooth Frame Rate(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Smooth Frame Rate(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Smooth Frame Rate(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Smooth Frame Rate(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyScalabilityQuality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyScalabilityQuality(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetScalabilityQuality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.GetScalabilityQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetScalabilityQuality(int32_t Value, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.SetScalabilityQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetViewDistanceQuality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.GetViewDistanceQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetViewDistanceQuality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.SetViewDistanceQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyViewDistanceQuality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyViewDistanceQuality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Clear Fog(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Clear Fog(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Clear Fog(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Clear Fog(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Clear Fog(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Clear Fog(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get ColorGrading Global Gamma(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get ColorGrading Global Gamma(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set ColorGrading Global Gamma(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set ColorGrading Global Gamma(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify ColorGrading Global Gamma(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify ColorGrading Global Gamma(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Film Toe Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Film Toe Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Film Toe(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Film Toe(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Film Toe(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Film Toe(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Film Toe(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Film Toe(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify All Game Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Game Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetFireModeSetting(enum class EWeaponType WeaponType, enum class EWeaponFireMode NewWeaponFireMode, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.SetFireModeSetting(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetFireModeSetting(struct TMap<enum class EWeaponType, enum class EWeaponFireMode>& FireModeSettings); // Function BP_GameSettings.BP_GameSettings_C.GetFireModeSetting(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyFireModeSetting(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyFireModeSetting(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Post Process Volume(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Post Process Volume(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Post Process Volume(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Post Process Volume(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Post Process Volume(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Post Process Volume(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetContrast(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetContrast(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetContrast(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetContrast(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyContrast(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyContrast(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetMaxBrightness(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetMaxBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetMaxBrightness(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetMaxBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyMaxBrightness(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyMaxBrightness(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetMinBrightness(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetMinBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetMinBrightness(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetMinBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyMinBrightness(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyMinBrightness(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyTemporalAACurrentFrameWeight(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAACurrentFrameWeight(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetTemporalAACurrentFrameWeight(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAACurrentFrameWeight(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTemporalAACurrentFrameWeight(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAACurrentFrameWeight(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetTonemapperSharpen(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTonemapperSharpen(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetTemporalAASamples(int32_t& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAASamples(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetTemporalAAPauseCorrect(char& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAAPauseCorrect(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetTemporalAACatmullRom(char& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAACatmullRom(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTonemapperSharpen(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTonemapperSharpen(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTemporalAASamples(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAASamples(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTemporalAAPauseCorrect(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAAPauseCorrect(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTemporalAACatmullRom(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAACatmullRom(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyTonemapperSharpen(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTonemapperSharpen(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyTemporalAASamples(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAASamples(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyTemporalAAPauseCorrect(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAAPauseCorrect(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyTemporalAACatmullRom(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAACatmullRom(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ModifyTemporalAAFilterSize(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAAFilterSize(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetTemporalAAFilterSize(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAAFilterSize(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTemporalAAFilterSize(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAAFilterSize(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetSensitivityValue(enum class EMouseSensitivityState MouseSensitivityType, int32_t& Sensitivity); // Function BP_GameSettings.BP_GameSettings_C.GetSensitivityValue(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetSensitivityValue(enum class EMouseSensitivityState MouseSensitivityType, int32_t Sensitivity); // Function BP_GameSettings.BP_GameSettings_C.SetSensitivityValue(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Foliage Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Foliage Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Foliage Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Foliage Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Foliage Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Foliage Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Volume UI(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume UI(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Audio Multiplier UI(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier UI(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Audio Multiplier UI(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier UI(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Audio Multiplier UI(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier UI(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Save Ini Settings(); // Function BP_GameSettings.BP_GameSettings_C.Save Ini Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Load ini Settings(); // Function BP_GameSettings.BP_GameSettings_C.Load ini Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Init Save Game Settings(struct TScriptInterface<IBPI_GameSettingsInterface_C> Game Settings Interface); // Function BP_GameSettings.BP_GameSettings_C.Init Save Game Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Saved Key Inputs(struct TArray<struct FSKeyActionSave>& Saved Key Inputs); // Function BP_GameSettings.BP_GameSettings_C.Get Saved Key Inputs(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get All Key Actions(struct TArray<struct UBP_KeyAction_C>& Key Actions); // Function BP_GameSettings.BP_GameSettings_C.Get All Key Actions(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Save File User Index(int32_t Save File User Index); // Function BP_GameSettings.BP_GameSettings_C.Set Save File User Index(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Save File Name(struct FString Save File Name); // Function BP_GameSettings.BP_GameSettings_C.Set Save File Name(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Game Settings Interface(struct TScriptInterface<IBPI_GameSettingsInterface_C> Game Settings Interface); // Function BP_GameSettings.BP_GameSettings_C.Set Game Settings Interface(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get All Combinations(struct TArray<struct UBP_KeyCombination_C>& Combinations); // Function BP_GameSettings.BP_GameSettings_C.Get All Combinations(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Generate Keybinding Conflicts(); // Function BP_GameSettings.BP_GameSettings_C.Generate Keybinding Conflicts(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Keybindings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Keybindings(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Load Key Actions(); // Function BP_GameSettings.BP_GameSettings_C.Load Key Actions(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Save Key Actions(); // Function BP_GameSettings.BP_GameSettings_C.Save Key Actions(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Store Key Input(struct FSKeyActionSave& KeySave); // Function BP_GameSettings.BP_GameSettings_C.Store Key Input(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Key Action(struct FString Input Action Name, struct UBP_KeyAction_C& Input Action, char& SUCCESS); // Function BP_GameSettings.BP_GameSettings_C.Get Key Action(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Fill Float Axis Inputs List(); // Function BP_GameSettings.BP_GameSettings_C.Fill Float Axis Inputs List(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Init Key Bindings(); // Function BP_GameSettings.BP_GameSettings_C.Init Key Bindings(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Update Actions Input State(float Real Time Seconds, float World Delta Seconds, struct APlayerController PlayerController); // Function BP_GameSettings.BP_GameSettings_C.Update Actions Input State(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Delete Settings Save File(); // Function BP_GameSettings.BP_GameSettings_C.Delete Settings Save File(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Look Sensitivity Combined X(float Input Axis X, float World Delta, float& Horizontal X); // Function BP_GameSettings.BP_GameSettings_C.Get Look Sensitivity Combined X(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get My Custom Combobox(struct FString& Value); // Function BP_GameSettings.BP_GameSettings_C.Get My Custom Combobox(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set My Custom Combobox(struct FString Value, char Apply, struct FString& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Combobox(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify My Custom Combobox(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Combobox(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get My Custom Radiobox(int32_t& Value); // Function BP_GameSettings.BP_GameSettings_C.Get My Custom Radiobox(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set My Custom Radiobox(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Radiobox(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify My Custom Radiobox(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Radiobox(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get My Custom Slider(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get My Custom Slider(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set My Custom Slider(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Slider(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify My Custom Slider(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Slider(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get My Custom Checkbox(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get My Custom Checkbox(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set My Custom Checkbox(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Checkbox(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify My Custom Checkbox(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Checkbox(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify All MyCustom Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All MyCustom Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Resolution Scale(int32_t& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Resolution Scale(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Resolution Scale(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Resolution Scale(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Resolution Scale(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Resolution Scale(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Prepeare Previus Settings State(); // Function BP_GameSettings.BP_GameSettings_C.Prepeare Previus Settings State(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Save All Settings(); // Function BP_GameSettings.BP_GameSettings_C.Save All Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify All Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify All Audio Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Audio Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify All Look Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Look Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Look Sensitivity Combined Y(float Input Axis Y, float World Delta, float& Vertical Y); // Function BP_GameSettings.BP_GameSettings_C.Get Look Sensitivity Combined Y(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Volume Ambient(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Ambient(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Audio Multiplier Ambient(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Ambient(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Audio Multiplier Ambient(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Ambient(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Audio Multiplier Ambient(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Ambient(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Volume Effect(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Effect(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Audio Multiplier Effect(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Effect(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Audio Multiplier Effect(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Effect(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Audio Multiplier Effect(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Effect(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Volume Voice(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Voice(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Audio Multiplier Voice(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Voice(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Audio Multiplier Voice(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Voice(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Audio Multiplier Voice(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Voice(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Volume Music(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Music(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Audio Multiplier Music(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Music(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Audio Multiplier Music(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Music(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Audio Multiplier Music(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Music(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Volume Master(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Master(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Add Volume Control(struct UAudioComponent Audio Emittor, char Audio Channel); // Function BP_GameSettings.BP_GameSettings_C.Add Volume Control(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Apply Audio Settings(char Audio Channel, enum class EAudioSettingType Type); // Function BP_GameSettings.BP_GameSettings_C.Apply Audio Settings(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Audio Multiplier Master(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Master(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Audio Multiplier Master(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Master(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Audio Multiplier Master(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Master(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Look Vertical Invert(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Vertical Invert(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Look Vertical Invert(char Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Vertical Invert(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Look Vertical Invert(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Vertical Invert(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Look Horizontal Invert(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Horizontal Invert(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Look Horizontal Invert(char Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Horizontal Invert(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Look Horizontal Invert(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Horizontal Invert(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Look Vertical Sensitivity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Vertical Sensitivity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Look Vertical Sensitivity(float Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Vertical Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Look Vertical Sensitivity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Vertical Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Look Horizontal Sensitivity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Horizontal Sensitivity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Look Horizontal Sensitivity(float Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Horizontal Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Look Horizontal Sensitivity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Horizontal Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Apply Screen Settings(); // Function BP_GameSettings.BP_GameSettings_C.Apply Screen Settings(Private|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Screen Mode(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Screen Mode(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Screen Mode(char& Screen Mode, struct FString& Command); // Function BP_GameSettings.BP_GameSettings_C.Get Screen Mode(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Screen Resolution(struct FSVideoResolution& Resolution); // Function BP_GameSettings.BP_GameSettings_C.Get Screen Resolution(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Screen Mode(char Screen Mode, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Screen Mode(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Screen Resolution(struct FSVideoResolution Resolution, char Apply, struct FSVideoResolution& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Screen Resolution(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Screen Resolution(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Screen Resolution(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Motion Blur Strength(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Motion Blur Strength(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Motion Blur Strength(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Motion Blur Strength(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Motion Blur Strength(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Motion Blur Strength(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Gain Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Gain Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Gain Intensity(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Gain Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Gain Intensity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Gain Intensity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Gamma Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Gamma Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Gamma Intensity(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Gamma Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Gamma Intensity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Gamma Intensity(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Bloom Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Bloom Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Bloom Intensity(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Bloom Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Bloom Intensity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Bloom Intensity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Vsync(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Vsync(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Vsync(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Vsync(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Vsync(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Vsync(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Remove Field Of View Control From Camera(struct UCameraComponent Camera); // Function BP_GameSettings.BP_GameSettings_C.Remove Field Of View Control From Camera(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Add Field Of View Control To Camera(struct UCameraComponent Camera); // Function BP_GameSettings.BP_GameSettings_C.Add Field Of View Control To Camera(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Field Of View(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Field Of View(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Field Of View(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Field Of View(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Field Of View(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Field Of View(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get View Distance(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get View Distance(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set View Distance(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set View Distance(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify View Distance(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify View Distance(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Effect Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Effect Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Effect Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Effect Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Effect Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Effect Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Texture Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Texture Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Texture Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Texture Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Texture Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Texture Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Shadow Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Shadow Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Shadow Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Shadow Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Shadow Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Shadow Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify All Video Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Video Settings(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Anti Aliasing Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Anti Aliasing Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Anti Aliasing Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Anti Aliasing Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Anti Aliasing Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Anti Aliasing Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Text Format Quality Level(int32_t Quality Level, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Text Format Quality Level(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Get Post Process Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Post Process Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set Post Process Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Post Process Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Modify Post Process Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Post Process Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Update Audio Emittor(struct FSAudioUpdateStruct Emittor, char& Is Valid); // Function BP_GameSettings.BP_GameSettings_C.Update Audio Emittor(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Create Clone(struct UBP_GameSettings_C& Cloned Game Settings); // Function BP_GameSettings.BP_GameSettings_C.Create Clone(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
