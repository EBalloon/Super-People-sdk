...
public:
	...
	void SetAutoReloadSetting(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.SetAutoReloadSetting(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetAutoReloadSetting(char& autoReload); // Function BP_GameSettings.BP_GameSettings_C.GetAutoReloadSetting(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void ModifyAutoReloadSetting(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyAutoReloadSetting(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Smooth Frame Rate(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Smooth Frame Rate(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Smooth Frame Rate(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Smooth Frame Rate(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Smooth Frame Rate(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Smooth Frame Rate(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyScalabilityQuality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyScalabilityQuality(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetScalabilityQuality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.GetScalabilityQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void SetScalabilityQuality(int32_t Value, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.SetScalabilityQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetViewDistanceQuality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.GetViewDistanceQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void SetViewDistanceQuality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.SetViewDistanceQuality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyViewDistanceQuality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyViewDistanceQuality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Clear Fog(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Clear Fog(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Clear Fog(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Clear Fog(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Clear Fog(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Clear Fog(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get ColorGrading Global Gamma(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get ColorGrading Global Gamma(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set ColorGrading Global Gamma(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set ColorGrading Global Gamma(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify ColorGrading Global Gamma(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify ColorGrading Global Gamma(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Film Toe Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Film Toe Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Get Film Toe(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Film Toe(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	...
	void Modify Post Process Volume(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Post Process Volume(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetContrast(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetContrast(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void SetContrast(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetContrast(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyContrast(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyContrast(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetMaxBrightness(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetMaxBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void SetMaxBrightness(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetMaxBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyMaxBrightness(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyMaxBrightness(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetMinBrightness(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetMinBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void SetMinBrightness(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetMinBrightness(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyMinBrightness(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyMinBrightness(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyTemporalAACurrentFrameWeight(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAACurrentFrameWeight(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetTemporalAACurrentFrameWeight(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAACurrentFrameWeight(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void SetTemporalAACurrentFrameWeight(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAACurrentFrameWeight(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetTonemapperSharpen(float& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTonemapperSharpen(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void GetTemporalAASamples(int32_t& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAASamples(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void GetTemporalAAPauseCorrect(char& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAAPauseCorrect(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void GetTemporalAACatmullRom(char& Value); // Function BP_GameSettings.BP_GameSettings_C.GetTemporalAACatmullRom(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void SetTonemapperSharpen(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTonemapperSharpen(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetTemporalAASamples(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAASamples(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetTemporalAAPauseCorrect(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAAPauseCorrect(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetTemporalAACatmullRom(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.SetTemporalAACatmullRom(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyTonemapperSharpen(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTonemapperSharpen(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyTemporalAASamples(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAASamples(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyTemporalAAPauseCorrect(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAAPauseCorrect(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ModifyTemporalAACatmullRom(char Modify); // Function BP_GameSettings.BP_GameSettings_C.ModifyTemporalAACatmullRom(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void Get Volume UI(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume UI(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Get Audio Multiplier UI(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier UI(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Audio Multiplier UI(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier UI(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void Set My Custom Combobox(struct FString Value, char Apply, struct FString& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Combobox(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify My Custom Combobox(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Combobox(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get My Custom Radiobox(int32_t& Value); // Function BP_GameSettings.BP_GameSettings_C.Get My Custom Radiobox(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set My Custom Radiobox(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Radiobox(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify My Custom Radiobox(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Radiobox(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get My Custom Slider(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get My Custom Slider(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set My Custom Slider(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Slider(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify My Custom Slider(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Slider(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get My Custom Checkbox(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get My Custom Checkbox(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set My Custom Checkbox(char Value, char Apply, char& Result); // Function BP_GameSettings.BP_GameSettings_C.Set My Custom Checkbox(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify My Custom Checkbox(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify My Custom Checkbox(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify All MyCustom Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All MyCustom Settings(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Resolution Scale(int32_t& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Resolution Scale(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Resolution Scale(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Resolution Scale(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Resolution Scale(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Resolution Scale(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Prepeare Previus Settings State(); // Function BP_GameSettings.BP_GameSettings_C.Prepeare Previus Settings State(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Save All Settings(); // Function BP_GameSettings.BP_GameSettings_C.Save All Settings(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify All Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Settings(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify All Audio Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Audio Settings(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify All Look Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Look Settings(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Look Sensitivity Combined Y(float Input Axis Y, float World Delta, float& Vertical Y); // Function BP_GameSettings.BP_GameSettings_C.Get Look Sensitivity Combined Y(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Get Volume Ambient(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Ambient(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Get Audio Multiplier Ambient(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Ambient(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Audio Multiplier Ambient(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Ambient(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Audio Multiplier Ambient(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Ambient(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Volume Effect(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Effect(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Get Audio Multiplier Effect(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Effect(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Audio Multiplier Effect(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Effect(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Audio Multiplier Effect(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Effect(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Volume Voice(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Voice(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Get Audio Multiplier Voice(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Voice(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Audio Multiplier Voice(float Set Value, char Apply); // Function BP_GameSettings.BP_GameSettings_C.Set Audio Multiplier Voice(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Audio Multiplier Voice(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Audio Multiplier Voice(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Volume Music(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Volume Music(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Get Audio Multiplier Music(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Audio Multiplier Music(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	...
	void Get Look Vertical Invert(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Vertical Invert(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Look Vertical Invert(char Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Vertical Invert(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Look Vertical Invert(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Vertical Invert(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Look Horizontal Invert(char& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Horizontal Invert(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Look Horizontal Invert(char Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Horizontal Invert(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Look Horizontal Invert(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Horizontal Invert(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Look Vertical Sensitivity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Vertical Sensitivity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Look Vertical Sensitivity(float Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Vertical Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Look Vertical Sensitivity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Vertical Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Look Horizontal Sensitivity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Look Horizontal Sensitivity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Look Horizontal Sensitivity(float Set Value); // Function BP_GameSettings.BP_GameSettings_C.Set Look Horizontal Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Look Horizontal Sensitivity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Look Horizontal Sensitivity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void Modify Motion Blur Strength(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Motion Blur Strength(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Gain Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Gain Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Gain Intensity(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Gain Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Gain Intensity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Gain Intensity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Gamma Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Gamma Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Gamma Intensity(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Gamma Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Gamma Intensity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Gamma Intensity(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Bloom Intensity(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get Bloom Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Bloom Intensity(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Bloom Intensity(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Bloom Intensity(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Bloom Intensity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void Get View Distance(float& Value); // Function BP_GameSettings.BP_GameSettings_C.Get View Distance(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set View Distance(float Value, char Apply, float& Result); // Function BP_GameSettings.BP_GameSettings_C.Set View Distance(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify View Distance(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify View Distance(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Effect Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Effect Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Effect Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Effect Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Effect Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Effect Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Texture Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Texture Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Texture Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Texture Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Texture Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Texture Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Shadow Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Shadow Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Shadow Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Shadow Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Shadow Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Shadow Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify All Video Settings(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify All Video Settings(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Anti Aliasing Quality(int32_t& Value, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Anti Aliasing Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void Set Anti Aliasing Quality(int32_t Value, char Apply, int32_t& Result); // Function BP_GameSettings.BP_GameSettings_C.Set Anti Aliasing Quality(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Modify Anti Aliasing Quality(char Modify); // Function BP_GameSettings.BP_GameSettings_C.Modify Anti Aliasing Quality(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Get Text Format Quality Level(int32_t Quality Level, struct FString& Formatted); // Function BP_GameSettings.BP_GameSettings_C.Get Text Format Quality Level(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
