...
struct ACableActor : UActor {
	Unknown CableComponent; //  0x310 Size(8)
};
...
struct UCableComponent : UMeshComponent {
	...
	Unknown AttachEndTo; //  0x4f0 Size(28)
	struct FName AttachEndToSocketName; //  0x518 Size(8)
	Unknown EndLocation; //  0x520 Size(c)
	...
	Unknown CableForce; //  0x544 Size(c)
	...
	void SetAttachEndToComponent(Unknown Component, struct FName SocketName); // Function CableComponent.CableComponent.SetAttachEndToComponent(Final|Native|Public|BlueprintCallable) // <Game+0x1858cc0>
};
