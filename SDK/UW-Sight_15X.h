...
public:
	...
	void SetScopeImageAngle(float NewAngle); // Function UW-Sight_15X.UW-Sight_15X_C.SetScopeImageAngle(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Sight_15X(int32_t EntryPoint); // Function UW-Sight_15X.UW-Sight_15X_C.ExecuteUbergraph_UW-Sight_15X(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
