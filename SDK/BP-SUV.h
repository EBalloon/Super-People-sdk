...
public:
	...
	struct Unknown BP-DestructibleComponent4; // 0xD90 (8)
	struct Unknown BP-DestructibleComponent3; // 0xD98 (8)
	struct Unknown BP-DestructibleComponent2; // 0xDA0 (8)
	struct Unknown BP-DestructibleComponent1; // 0xDA8 (8)
	struct Unknown BravoHotelVehicleSeat04; // 0xDB0 (8)
	struct Unknown BravoHotelVehicleSeat03; // 0xDB8 (8)
	struct Unknown BravoHotelVehicleSeat02; // 0xDC0 (8)

	void ReceiveTick(float DeltaSeconds); // Function BP-SUV.BP-SUV_C.ReceiveTick(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ReceiveBeginPlay(); // Function BP-SUV.BP-SUV_C.ReceiveBeginPlay(Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_BP-SUV(int32_t EntryPoint); // Function BP-SUV.BP-SUV_C.ExecuteUbergraph_BP-SUV(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
