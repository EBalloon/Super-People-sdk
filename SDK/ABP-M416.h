...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-M416.ABP-M416_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_ABP-M416(int32_t EntryPoint); // Function ABP-M416.ABP-M416_C.ExecuteUbergraph_ABP-M416(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
