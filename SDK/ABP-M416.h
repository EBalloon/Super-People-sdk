...
public:
	...
	struct FAnimNode_RefPose AnimGraphNode_LocalRefPose_2; // 0x768 (24)
	struct FAnimNode_Slot AnimGraphNode_Slot_3; // 0x780 (72)
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M416.ABP-M416_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_ABP-M416(int32_t EntryPoint); // Function ABP-M416.ABP-M416_C.ExecuteUbergraph_ABP-M416(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
