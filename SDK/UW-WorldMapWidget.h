...
public:
	...
	void SetClassInfoBoardVisibilityByZoomLevel(int32_t LastZoomLevel, int32_t NewZoomLevel); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.SetClassInfoBoardVisibilityByZoomLevel(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetZoomLevel(int32_t& ZoomLevel); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.GetZoomLevel(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void StopRoutePing(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.StopRoutePing(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void UpdateRoutePing(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.UpdateRoutePing(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void IsFullRoutePing(char& NewParam); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.IsFullRoutePing(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CheckRoutePing(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.CheckRoutePing(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ResetRoutePing(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.ResetRoutePing(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AddRoutePing(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.AddRoutePing(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetRoutePing(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.SetRoutePing(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetVisiblePingMenu(char Visible); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.SetVisiblePingMenu(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void DebugStringOnMap(struct FString DebugString, struct Unknown WorldPosition, float RemainTime, float FontSize); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.DebugStringOnMap(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMapDragging(struct Unknown deltaOnViewport); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnMapDragging(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void RemoveMarker(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.RemoveMarker(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMapRightClick(struct Unknown PosOnViewport, char IsAgree, struct Unknown ForceLocation); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnMapRightClick(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetZoom(int32_t NewZoomLevel); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.SetZoom(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMapZoomOut(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnMapZoomOut(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMapZoomIn(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnMapZoomIn(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CalcScaleFactorByZoom(int32_t ZoomLevel, float& ScaleFactor); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.CalcScaleFactorByZoom(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void IsZoomLevelInRange(int32_t ZoomLevel, char& ret); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.IsZoomLevelInRange(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void BndEvt__Button_0_K2Node_ComponentBoundEvent_91_OnButtonClickedEvent__DelegateSignature(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.BndEvt__Button_0_K2Node_ComponentBoundEvent_91_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void AddAreaWidget(enum class Unknow WorldMapAreaWidgetType, struct Unknown& AreaWidgetInfo); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.AddAreaWidget(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void NotifyNeedRefreshToMap(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.NotifyNeedRefreshToMap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnAttackedWidget(int32_t UniquePlayerId); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnAttackedWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnFireWidget(int32_t UniquePlayerId, struct Unknown Rotation, float Length); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnFireWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ResetMapPlayers(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.ResetMapPlayers(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnViewportSized(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnViewportSized(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void NotifyTargetPawnPos(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.NotifyTargetPawnPos(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void RemoveAreaWidget(enum class Unknow WorldMapAreaWidgetType, struct Unknown& AreaWidgetInfo); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.RemoveAreaWidget(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void UpdateWorldMapClassInfo(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.UpdateWorldMapClassInfo(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnInputSmartPingAgreeWorldMap(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnInputSmartPingAgreeWorldMap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnInputStopSmartPingWorldMap(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnInputStopSmartPingWorldMap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnInputSmartPingMenuWorldMap(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnInputSmartPingMenuWorldMap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnInputSmartPingWorldMap(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnInputSmartPingWorldMap(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void 鉹@t元_1(char IsShow); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ShowPingMenu(); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.ShowPingMenu(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseButtonDownOnMap(struct Unknown Button, struct Unknown PosOnViewport); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnMouseButtonDownOnMap(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseButtonUpOnMap(struct Unknown Button, struct Unknown PosOnViewport); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnMouseButtonUpOnMap(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnDraggingOnMap(struct Unknown Delta); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnDraggingOnMap(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnWheelOnMap(float Delta, struct Unknown PosOnViewport); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnWheelOnMap(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnObjectClickOnMap(struct Unknown Button, char mapObjectID); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.OnObjectClickOnMap(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-WorldMapWidget(int32_t EntryPoint); // Function UW-WorldMapWidget.UW-WorldMapWidget_C.ExecuteUbergraph_UW-WorldMapWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
