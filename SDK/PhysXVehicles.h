...
// Class PhysXVehicles.WheeledVehicleMovementCompo
struct UWheeledVehicleMovementCompot : UPawnMovementComponent {
	...
	Unknown WheelSetups; //  0x150 Size(10)
	...
	Unknown InertiaTensorScale; //  0x17c Size(c)
	...
	Unknown Wheels; //  0x1a8 Size(10)
	Unknown WheelsCollisionChannel; //  0x1b8 Size(1)
	...
	Unknown AvoidanceGroup; //  0x1e8 Size(4)
	Unknown GroupsToAvoid; //  0x1ec Size(4)
	Unknown GroupsToIgnore; //  0x1f0 Size(4)
	float AvoidanceWeight; //  0x1f4 Size(4)
	Unknown PendingLaunchVelocity; //  0x1f8 Size(c)
	Unknown ReplicatedState; //  0x204 Size(14)
	...
	Unknown ThrottleInputRate; //  0x244 Size(8)
	Unknown BrakeInputRate; //  0x24c Size(8)
	Unknown HandbrakeInputRate; //  0x254 Size(8)
	Unknown SteeringInputRate; //  0x25c Size(8)
	Unknown OverrideController; //  0x288 Size(8)

	void SetUseAutoGears(char bUseAuto); // Function PhysXVehicles.WheeledVehicleMovementCompot.SetUseAutoGears(Final|Native|Public|BlueprintCallable) // <Game+0x18ab530>
};

// Class PhysXVehicles.TireConfig
struct UTireConfig : UDataAsset {
	float FrictionScale; //  0x30 Size(4)
	Unknown TireFrictionScales; //  0x38 Size(10)
};

// Class PhysXVehicles.VehicleAnimInstance
struct UVehicleAnimInstance : UAnimInstance {
	Unknown WheeledVehicleMovementCompo; //  0x970 Size(8)

	Unknown GetVehicle(); // Function PhysXVehicles.VehicleAnimInstance.GetVehicle(Final|Native|Public|BlueprintCallable) // <Game+0x18aa8b0>
};

// Class PhysXVehicles.VehicleWheel
struct UVehicleWheel : Object {
	Unknown CollisionMesh; //  0x28 Size(8)
	char bDontCreateShape; //  0x30 Size(1)
	char bAutoAdjustCollisionSize; //  0x31 Size(1)
	Unknown Offset; //  0x34 Size(c)
	...
	Unknown TireType; //  0x58 Size(8)
	Unknown TireConfig; //  0x60 Size(8)
	...
	Unknown Location; //  0xc0 Size(c)
	Unknown OldLocation; //  0xcc Size(c)
	Unknown Velocity; //  0xd8 Size(c)

	char IsInAir(); // Function PhysXVehicles.VehicleWheel.IsInAir(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x18aa910>
};

// Class PhysXVehicles.WheeledVehicle
struct AWheeledVehicle : APawn {
	Unknown Mesh; //  0x380 Size(8)
	Unknown VehicleMovement; //  0x388 Size(8)
};

// Class PhysXVehicles.WheeledVehicleMovementCompo
struct UWheeledVehicleMovementCompot : UWheeledVehicleMovementCompo {
	Unknown EngineSetup; //  0x290 Size(a0)
	Unknown DifferentialSetup; //  0x330 Size(1c)
	float AckermannAccuracy; //  0x34c Size(4)
	Unknown TransmissionSetup; //  0x350 Size(30)
	Unknown SteeringCurve; //  0x380 Size(88)
};

// Class PhysXVehicles.WheeledVehicleMovementCompo
struct UWheeledVehicleMovementCompot : UWheeledVehicleMovementCompo {
	Unknown EngineSetup; //  0x290 Size(a0)
	Unknown TransmissionSetup; //  0x330 Size(30)
	Unknown SteeringCurve; //  0x360 Size(88)
};
