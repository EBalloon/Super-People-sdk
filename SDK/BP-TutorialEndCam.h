...
public:
	...
	void GetFloorLocation(struct Unknown InLocation, struct Unknown& OutLocation); // Function BP-TutorialEndCam.BP-TutorialEndCam_C.GetFloorLocation(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	...
	void PlayWinAnimation(struct Unknown TargetCharacter); // Function BP-TutorialEndCam.BP-TutorialEndCam_C.PlayWinAnimation(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void GetWinMontage(struct Unknown TargetCharacter, struct Unknown& WinMontage); // Function BP-TutorialEndCam.BP-TutorialEndCam_C.GetWinMontage(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	...
	void GetActiveCamera(struct Unknown& ActiveCamera); // Function BP-TutorialEndCam.BP-TutorialEndCam_C.GetActiveCamera(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
