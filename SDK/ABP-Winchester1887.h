...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-Winchester1887.ABP-Winchester1887_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_ABP-Winchester1887(int32_t EntryPoint); // Function ABP-Winchester1887.ABP-Winchester1887_C.ExecuteUbergraph_ABP-Winchester1887(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
