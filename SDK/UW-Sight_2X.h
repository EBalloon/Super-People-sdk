...
public:
	...
	void SetScopeImageAngle(float NewAngle); // Function UW-Sight_2X.UW-Sight_2X_C.SetScopeImageAngle(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_UW-Sight_2X(int32_t EntryPoint); // Function UW-Sight_2X.UW-Sight_2X_C.ExecuteUbergraph_UW-Sight_2X(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
