...
public:
	...
	void UpdateQuestInfo(struct FQuestInfo QuestInfo); // Function UW-ScenarioQuest.UW-ScenarioQuest_C.UpdateQuestInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetQuestInfo(struct FQuestInfo QuestInfo); // Function UW-ScenarioQuest.UW-ScenarioQuest_C.SetQuestInfo(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
