...
public:
	...
	void Construct(); // Function UW-Revival_PayPopup.UW-Revival_PayPopup_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	...
	void ExecuteUbergraph_UW-Revival_PayPopup(int32_t EntryPoint); // Function UW-Revival_PayPopup.UW-Revival_PayPopup_C.ExecuteUbergraph_UW-Revival_PayPopup(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
