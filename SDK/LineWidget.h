...
public:
	...
	void Construct(); // Function LineWidget.LineWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void Set Color(int32_t IconIndex); // Function LineWidget.LineWidget_C.Set Color(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetScale(float Scale); // Function LineWidget.LineWidget_C.SetScale(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_LineWidget(int32_t EntryPoint); // Function LineWidget.LineWidget_C.ExecuteUbergraph_LineWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
