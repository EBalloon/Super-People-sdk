...
public:
	...
	void UserConstructionScript(); // Function BP-PlatedJeep_Blue_Disappear.BP-PlatedJeep_Blue_Disappear_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
