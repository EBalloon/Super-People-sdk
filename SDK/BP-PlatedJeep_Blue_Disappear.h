...
public:
	...
	void UserConstructionScript(); // Function BP-PlatedJeep_Blue_Disappear.BP-PlatedJeep_Blue_Disappear_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
};
