...
public:
	...
	void SetWeaponList(struct TArray<Unknown>& WeaponList, int32_t BaseItemID); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.SetWeaponList(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__btn_Reinforce_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.BndEvt__btn_Reinforce_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__btn_Repair_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.BndEvt__btn_Repair_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ChangeSelectedButton(struct Unknown SlotWidget); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.ChangeSelectedButton(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__btn_Cancel_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.BndEvt__btn_Cancel_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__btn_Ok_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.BndEvt__btn_Ok_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Lobby_Craft_WeaponSelect(int32_t EntryPoint); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.ExecuteUbergraph_UW-Lobby_Craft_WeaponSelect(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
	void EventDispatcher_Cancel__DelegateSignature(); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.EventDispatcher_Cancel__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void EventDispatcher_RequestItemCraft__DelegateSignature(int32_t BaseIndex, struct FString ItemId); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.EventDispatcher_RequestItemCraft__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
};
