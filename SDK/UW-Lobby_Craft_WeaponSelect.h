...
public:
	...
	void EventDispatcher_Cancel__DelegateSignature(); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.EventDispatcher_Cancel__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void EventDispatcher_RequestItemCraft__DelegateSignature(int32_t BaseIndex, struct FString ItemId); // Function UW-Lobby_Craft_WeaponSelect.UW-Lobby_Craft_WeaponSelect_C.EventDispatcher_RequestItemCraft__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
};
