...
public:
	...
	void Get Weapon Infoby Inventory Item Info(char& bResult, struct Unknown& WeaponInfo); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.Get Weapon Infoby Inventory Item Info(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetKeyNameFromKey(struct Unknown& Key, struct FString& Name, char& bRet); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.GetKeyNameFromKey(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void SetKeyText(); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetKeyText(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRightClickBig(); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetRightClickBig(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRightClickSmall(char IsVisible); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetRightClickSmall(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown OnMouseButtonDown(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnMouseButtonDown(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown OnMouseButtonUp(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnMouseButtonUp(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetInfo(struct FName RecipeKey, int32_t SlotIndex); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetItemRarityColor(enum class Unknow CurrentSlot, struct Unknown ImageWidget); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetItemRarityColor(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void MouseEnterImpl(); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.MouseEnterImpl(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeaponImage_Internal(struct Unknown IconTexture); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetWeaponImage_Internal(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown Set Item Image Internal(struct Unknown IconTexture); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.Set Item Image Internal(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void IsDraging(char& bResult); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.IsDraging(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	char OnDrop(struct Unknown MyGeometry, struct Unknown PointerEvent, struct Unknown Operation); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnDrop(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnDragDetected(struct Unknown MyGeometry, struct Unknown& PointerEvent, struct Unknown& Operation); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnDragDetected(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnRButtonClick(char& bResult); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnRButtonClick(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown Set_BGImage_Brush_1(); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.Set_BGImage_Brush_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown SetItemImage(); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetItemImage(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_DABF06DE406801A7910E4CB19855F653(struct Unknown Loaded); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnLoaded_DABF06DE406801A7910E4CB19855F653(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AsyncLoadIconTexture(struct Unknown IconTexture); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.AsyncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnUpdateCastingDelegateEvent(struct Unknown& CastingInfo, float CastingPercent); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.OnUpdateCastingDelegateEvent(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Inventory_RecipeSlot(int32_t EntryPoint); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.ExecuteUbergraph_UW-Inventory_RecipeSlot(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
	void SetSlotInfo__DelegateSignature(struct Unknown TargetActor, struct Unknown ItemInfo); // Function UW-Inventory_RecipeSlot.UW-Inventory_RecipeSlot_C.SetSlotInfo__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
};
