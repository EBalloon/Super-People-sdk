...
public:
	...
	void Setup(struct ABravoHotelVehicle VehicleInstance); // Function UW-VehicleSubInfo_Stingray.UW-VehicleSubInfo_Stingray_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-VehicleSubInfo_Stingray(int32_t EntryPoint); // Function UW-VehicleSubInfo_Stingray.UW-VehicleSubInfo_Stingray_C.ExecuteUbergraph_UW-VehicleSubInfo_Stingray(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
