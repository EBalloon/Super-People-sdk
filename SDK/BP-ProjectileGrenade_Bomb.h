...
public:
	...
	void BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(struct UPrimitiveComponent HitComponent, struct UActor OtherActor, struct UPrimitiveComponent OtherComp, struct FVector NormalImpulse, struct FHitResult& Hit); // Function BP-ProjectileGrenade_Bomb.BP-ProjectileGrenade_Bomb_C.BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_BP-ProjectileGrenade_Bomb(int32_t EntryPoint); // Function BP-ProjectileGrenade_Bomb.BP-ProjectileGrenade_Bomb_C.ExecuteUbergraph_BP-ProjectileGrenade_Bomb(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
