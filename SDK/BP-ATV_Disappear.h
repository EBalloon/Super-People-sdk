...
public:
	...
	void UserConstructionScript(); // Function BP-ATV_Disappear.BP-ATV_Disappear_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
};
