...
public:
	...
	void SetNew(); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.SetNew(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetButtonImage(); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.SetButtonImage(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckSlotAnim(); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.CheckSlotAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckOwn(char& OutIsOwn, char& IsOwnAny); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.CheckOwn(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AddCraftingWeapon(struct Unknown& CraftingID); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.AddCraftingWeapon(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void InitCategoryInfo(struct Unknown& CraftingInfo, struct Unknown ParentWidgetRef); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.InitCategoryInfo(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Category_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.BndEvt__Button_Category_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CloseList(); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.CloseList(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OpenList(); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.OpenList(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Category_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature(); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.BndEvt__Button_Category_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Lobby_Craft_List_Category(int32_t EntryPoint); // Function UW-Lobby_Craft_List_Category.UW-Lobby_Craft_List_Category_C.ExecuteUbergraph_UW-Lobby_Craft_List_Category(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
