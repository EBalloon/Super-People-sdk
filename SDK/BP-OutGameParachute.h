...
public:
	...
	struct Unknown ParachuteBag_SkeletalMesh; // 0x320 (8)
	struct Unknown Parachute_SkeletalMesh; // 0x328 (8)
	...
	void SetSkinMaterial(struct Unknown Material); // Function BP-OutGameParachute.BP-OutGameParachute_C.SetSkinMaterial(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
