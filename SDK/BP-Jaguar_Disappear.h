...
public:
	...
	void UserConstructionScript(); // Function BP-Jaguar_Disappear.BP-Jaguar_Disappear_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
};
