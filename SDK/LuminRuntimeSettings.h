...
struct ULuminRuntimeSettings : Object {
	...
	Unknown FrameTimingHint; //  0x48 Size(1)
	...
	Unknown Certificate; //  0x50 Size(10)
	Unknown IconModelPath; //  0x60 Size(10)
	Unknown IconPortalPath; //  0x70 Size(10)
	Unknown LocalizedIconInfos; //  0x80 Size(10)
	int32_t VersionCode; //  0x90 Size(4)
	int32_t MinimumAPILevel; //  0x94 Size(4)
	Unknown AppPrivileges; //  0x98 Size(10)
	Unknown ExtraComponentSubElements; //  0xa8 Size(10)
	Unknown ExtraComponentElements; //  0xb8 Size(10)
	...
	Unknown VulkanValidationLayerLibs; //  0x100 Size(10)
	char bFrameVignette; //  0x110 Size(1)
	Unknown LocalizedAppNames; //  0x118 Size(10)
};
