...
public:
	...
	struct FBravoHotelWeaponInfo WeaponInfo; // 0x780 (2864)
	struct UUW-Inventory_ItemSlotHover_C ItemSlotHoverWIdget; // 0x12B0 (8)
	struct UUW-InventoryWidget_C InventoryWidget; // 0x12B8 (8)
	struct UUW-Inventory_DragItem_C DraggedWidget; // 0x12C0 (8)
	enum class ItemWidgetDragType InventorySlotWidgetKind; // 0x12C8 (1)
	struct FSlateBrush DragItemBrush; // 0x12D0 (136)
	char RButtonDown : 0; // 0x1358 (1)
	char bEpuipped : 0; // 0x1359 (1)

	void IsEquipped(char& Return); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.IsEquipped(Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetInventoryWidget(); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.SetInventoryWidget(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetOverrideItemID(struct FName& ItemId); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.GetOverrideItemID(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void IsLockSlot(char& Lock); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.IsLockSlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void DragEnd(); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.DragEnd(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void DragStart(char LockSlot, struct UDragDropOperation& Operation); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.DragStart(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetInventoryComponent(char& bResult, struct UPlayerInventoryComponent& InventoryComponent); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.GetInventoryComponent(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetInventoryItemInfo(struct FInventoryItemInfo InventoryItemInfo); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.SetInventoryItemInfo(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetWeaponInfo(struct FBravoHotelWeaponInfo& WeaponInfo); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.GetWeaponInfo(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetWeaponInfo(struct FBravoHotelWeaponInfo WeaponInfo); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.SetWeaponInfo(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void OnRButtonClick(char& bResult); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.OnRButtonClick(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void GetInventoryItemDetailInfo(struct FInventoryItemDetailInfo& InventoryItemDeailInfo); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.GetInventoryItemDetailInfo(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetInventoryItemInfo(struct FInventoryItemInfo& InventoryItemInfo); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.GetInventoryItemInfo(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetInventoryItemDetailInfo(struct FInventoryItemDetailInfo InventoryItemDetailInfo); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.SetInventoryItemDetailInfo(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetInventoryItemInfoByPickup(struct ABravoHotelPickup Pickup, char& bResult); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.SetInventoryItemInfoByPickup(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetPlayerController(); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.SetPlayerController(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetItemSlotHoverWidget(struct UUW-Inventory_ItemSlotHover_C ItemSlotHoverWIdget, struct UUW-Inventory_ItemSlotHover_C& Out); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.SetItemSlotHoverWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetPlayerController(char& bResult, struct ABravoHotelPlayerController& Out); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.GetPlayerController(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetItemSlotHoverWidget(char& bResult, struct UUW-Inventory_ItemSlotHover_C& Out); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.GetItemSlotHoverWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void OnLoaded_29D4AD794F40F3517E11F7A14C55D6DD(struct Object Loaded); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.OnLoaded_29D4AD794F40F3517E11F7A14C55D6DD(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void AysncLoadIconTexture(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.AysncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-Inventory_SlotBase(int32_t EntryPoint); // Function UW-Inventory_SlotBase.UW-Inventory_SlotBase_C.ExecuteUbergraph_UW-Inventory_SlotBase(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
