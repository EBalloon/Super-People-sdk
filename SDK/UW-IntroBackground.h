...
public:
	...
	void destroy(); // Function UW-IntroBackground.UW-IntroBackground_C.destroy(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
