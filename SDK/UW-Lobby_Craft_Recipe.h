...
public:
	...
	struct Unknown UW-Lobby_Craft_Recipe_Weapon; // 0x260 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_2; // 0x268 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_3; // 0x270 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_4; // 0x278 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_5; // 0x280 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_6; // 0x288 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_7; // 0x290 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_8; // 0x298 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_9; // 0x2A0 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_10; // 0x2A8 (8)
	struct Unknown UW-Lobby_Weapon_Recipe_Item_11; // 0x2B0 (8)
	...
	void SetOpacity(); // Function UW-Lobby_Craft_Recipe.UW-Lobby_Craft_Recipe_C.SetOpacity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void CheckOwn(); // Function UW-Lobby_Craft_Recipe.UW-Lobby_Craft_Recipe_C.CheckOwn(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void InitRecipeItemArray(); // Function UW-Lobby_Craft_Recipe.UW-Lobby_Craft_Recipe_C.InitRecipeItemArray(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetRecipeInfo(int32_t BaseItemID, int32_t MaterialGroupItemID); // Function UW-Lobby_Craft_Recipe.UW-Lobby_Craft_Recipe_C.SetRecipeInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Construct(); // Function UW-Lobby_Craft_Recipe.UW-Lobby_Craft_Recipe_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-Lobby_Craft_Recipe.UW-Lobby_Craft_Recipe_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Lobby_Craft_Recipe(int32_t EntryPoint); // Function UW-Lobby_Craft_Recipe.UW-Lobby_Craft_Recipe_C.ExecuteUbergraph_UW-Lobby_Craft_Recipe(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
...
inline void UUW-Lobby_Craft_Recipe_C::Tick(struct Unknown MyGeometry, float InDeltaTime) {
