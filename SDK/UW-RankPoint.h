...
public:
	...
	void SetData(float StartPoint, float EndPoint, float Min, float MAX, float ShowTime, char Play); // Function UW-RankPoint.UW-RankPoint_C.SetData(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UW-RankPoint.UW-RankPoint_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_UW-RankPoint(int32_t EntryPoint); // Function UW-RankPoint.UW-RankPoint_C.ExecuteUbergraph_UW-RankPoint(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void Dispatcher_ProgressBarDone__DelegateSignature(); // Function UW-RankPoint.UW-RankPoint_C.Dispatcher_ProgressBarDone__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
