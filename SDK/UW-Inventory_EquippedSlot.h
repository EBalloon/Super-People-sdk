...
public:
	...
	void IsDraging(char& bResult); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.IsDraging(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ShowStatupAnim(struct Unknown& StatParams); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.ShowStatupAnim(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetMaterialIcon(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.SetMaterialIcon(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetHoverWidgetRef(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.SetHoverWidgetRef(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void SetBG(enum class Unknow WearableItemType); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.SetBG(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnRButtonClick(char& bResult); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.OnRButtonClick(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow Get_Abillity_Visibility_1(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.Get_Abillity_Visibility_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void RequestGetItem(struct Unknown Pickup, char& bResult); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.RequestGetItem(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Reset(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.Reset(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void InitData(enum class Unknow EquipType, enum class Unknow WearableItemType); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.InitData(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetInfo(struct Unknown InventoryWidget, struct Unknown InventoryItemInfoData); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.SetInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Drop(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.Drop(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_52197A594D73AE4B77D41DAA3A988F34(struct Unknown Loaded); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.OnLoaded_52197A594D73AE4B77D41DAA3A988F34(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Enable(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.Enable(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Disable(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.Disable(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AysncLoadIconTexture(struct Unknown IconTexture); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.AysncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void PreConstruct(char IsDesignTime); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.PreConstruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CompleteCombine(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.CompleteCombine(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void CompleteCombineOnRecipeTree(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.CompleteCombineOnRecipeTree(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void HoverRecipeTree(); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.HoverRecipeTree(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnUpdateCastingDelegateEvent(struct Unknown& CastingInfo, float CastingPercent); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.OnUpdateCastingDelegateEvent(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-Inventory_EquippedSlot(int32_t EntryPoint); // Function UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.ExecuteUbergraph_UW-Inventory_EquippedSlot(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
