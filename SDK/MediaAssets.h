...
public:
	...
	int32_t Get(); // Function MediaAssets.MediaTexture.Get(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <BravoHotelClient-Win64-Shipping.protected.exe+0x34F35D0>
...
// Function MediaAssets.MediaTexture.Get
inline int32_t UMediaTexture::Get() {
	static auto fn = UObject::FindObject<UFunction>("Function MediaAssets.MediaTexture.Get");
