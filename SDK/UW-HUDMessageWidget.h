...
public:
	...
	void GetMyKillCountMessageWidget(struct Unknown& KillCountWidget); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.GetMyKillCountMessageWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void ShowCustomAnim(struct Unknown PanelWidget, struct Unknown CustomAnim); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ShowCustomAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowResuscitatingWidget(); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ShowResuscitatingWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetRequestMessageWidget(struct Unknown& Result); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.GetRequestMessageWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void AddCoreInfoWidget(struct FText Message); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.AddCoreInfoWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetCoreInfoWidget(struct Unknown& CoreInfoWidget); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.GetCoreInfoWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void ShowGuideWidget(struct FText Message); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ShowGuideWidget(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void PlayTeamKillWarningAnim(); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.PlayTeamKillWarningAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ResetPriority(enum class Unknow MessageType, struct Unknown PanelWidget); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ResetPriority(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AddToTimerList(struct Unknown Panel, float Time); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.AddToTimerList(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CalcTimerCount(float DeltaTime); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.CalcTimerCount(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void PlayHideAnim(float DeltaTime); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.PlayHideAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void PlayShowAnim(float DeltaTime); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.PlayShowAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HideDefaultAnim(struct Unknown PanelWidget); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.HideDefaultAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowDefaultAnim(struct Unknown PanelWidget); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ShowDefaultAnim(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetMessageText(struct Unknown PanelWidget, struct FText Message); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.SetMessageText(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckPriority(enum class Unknow MessageType, int32_t Priority, char& CanMessage); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.CheckPriority(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetPanelWidget(enum class Unknow MessageType, struct Unknown& PanelWidget); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.GetPanelWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void HideHUDMessage(enum class Unknow MessageType); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.HideHUDMessage(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowHUDMessage(struct Unknown MessageRow); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ShowHUDMessage(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnAnimationFinished(struct Unknown Animation); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.OnAnimationFinished(BlueprintCosmetic|Event|Protected|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowHUDMessageAtNum(enum class Unknow MessageType); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ShowHUDMessageAtNum(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnGameUserSettingsApply_GamePlay_Event_1(struct TArray<Unknown>& List); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.OnGameUserSettingsApply_GamePlay_Event_1(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-HUDMessageWidget(int32_t EntryPoint); // Function UW-HUDMessageWidget.UW-HUDMessageWidget_C.ExecuteUbergraph_UW-HUDMessageWidget(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
