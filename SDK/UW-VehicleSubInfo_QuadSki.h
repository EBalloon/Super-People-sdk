...
public:
	...
	void Setup(struct ABravoHotelVehicle VehicleInstance); // Function UW-VehicleSubInfo_QuadSki.UW-VehicleSubInfo_QuadSki_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-VehicleSubInfo_QuadSki(int32_t EntryPoint); // Function UW-VehicleSubInfo_QuadSki.UW-VehicleSubInfo_QuadSki_C.ExecuteUbergraph_UW-VehicleSubInfo_QuadSki(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
