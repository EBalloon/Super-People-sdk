...
public:
	...
	void Setup(struct Unknown VehicleInstance); // Function UW-VehicleSubInfo_QuadSki.UW-VehicleSubInfo_QuadSki_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-VehicleSubInfo_QuadSki(int32_t EntryPoint); // Function UW-VehicleSubInfo_QuadSki.UW-VehicleSubInfo_QuadSki_C.ExecuteUbergraph_UW-VehicleSubInfo_QuadSki(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
