// GizmoStateTarget InteractiveToolsFramework.GizmoStateTarget
 struct UGizmoStateTarget : UInterface {
	...
	void UpdateHoverState(Unknown bHovering); // UpdateHoverState InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // <Game+0x40489f0>
	void EndUpdate(); // EndUpdate InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // <Game+0x1e89f30>
};
