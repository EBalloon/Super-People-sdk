...
public:
	...
	enum class EUdpMessageFormat MessageFormat; // 0x50 (1)
	char MulticastTimeToLive; // 0x51 (1)
	struct TArray<struct FString> StaticEndpoints; // 0x58 (16)
	char EnableTunnel : 0; // 0x68 (1)
	struct FString TunnelUnicastEndpoint; // 0x70 (16)
	struct FString TunnelMulticastEndpoint; // 0x80 (16)
	struct TArray<struct FString> RemoteTunnelEndpoints; // 0x90 (16)
};
