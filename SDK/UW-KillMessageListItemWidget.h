...
public:
	...
	void OnLoaded_9DF86FA64782B378E42DBB813545BD34(struct Unknown Loaded); // Function UW-KillMessageListItemWidget.UW-KillMessageListItemWidget_C.OnLoaded_9DF86FA64782B378E42DBB813545BD34(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetPlayerInfo(struct Unknown PlayerState, struct Unknown InfoColor); // Function UW-KillMessageListItemWidget.UW-KillMessageListItemWidget_C.SetPlayerInfo(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-KillMessageListItemWidget(int32_t EntryPoint); // Function UW-KillMessageListItemWidget.UW-KillMessageListItemWidget_C.ExecuteUbergraph_UW-KillMessageListItemWidget(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
	void OnTimeOut__DelegateSignature(int32_t ArrayIndex, struct Unknown Slot); // Function UW-KillMessageListItemWidget.UW-KillMessageListItemWidget_C.OnTimeOut__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
};
