...
public:
	...
	struct Unknown BTN-Menu07; // 0x408 (8)
	struct Unknown BTN-Menu08; // 0x410 (8)
	struct Unknown BTN-Menu09; // 0x418 (8)
	struct Unknown BTN-Menu10; // 0x420 (8)
	struct Unknown BTN-Menu11; // 0x428 (8)
	struct Unknown CP-SlotInfo; // 0x430 (8)
	struct Unknown IMG-BG; // 0x438 (8)
	struct Unknown IMG-BG-Border; // 0x440 (8)
	struct Unknown IMG-Item; // 0x448 (8)
	struct Unknown IMG-Mask; // 0x450 (8)
	struct Unknown IMG-Over; // 0x458 (8)
	struct Unknown IMG-Over-Border; // 0x460 (8)
	struct Unknown Menu02; // 0x468 (8)
	struct Unknown Menu03; // 0x470 (8)
	struct Unknown Menu04; // 0x478 (8)
	struct Unknown Menu05; // 0x480 (8)
	struct Unknown Menu06; // 0x488 (8)
	struct Unknown Menu07; // 0x490 (8)
	struct Unknown Menu08; // 0x498 (8)
	struct Unknown Menu09; // 0x4A0 (8)
	struct Unknown Menu10; // 0x4A8 (8)
	struct Unknown Menu11; // 0x4B0 (8)
	struct Unknown Overlay_Mask; // 0x4B8 (8)
	struct Unknown TXT-Ammo; // 0x4C0 (8)
	struct Unknown TXT-Damage; // 0x4C8 (8)
	struct Unknown TXT-FireMode; // 0x4D0 (8)
	struct Unknown TXT-FireRate; // 0x4D8 (8)
	struct Unknown TXT-ItemName; // 0x4E0 (8)
	struct Unknown TXT-MagSize; // 0x4E8 (8)
	struct Unknown TXT-Menu01; // 0x4F0 (8)
	struct Unknown TXT-Menu02; // 0x4F8 (8)
	struct Unknown TXT-Menu03; // 0x500 (8)
	struct Unknown TXT-Menu04; // 0x508 (8)
	struct Unknown TXT-Menu05; // 0x510 (8)
	struct Unknown TXT-Menu06; // 0x518 (8)
	struct Unknown TXT-Menu07; // 0x520 (8)
	struct Unknown TXT-Menu08; // 0x528 (8)
	struct Unknown TXT-Menu09; // 0x530 (8)
	struct Unknown TXT-Menu10; // 0x538 (8)
	struct Unknown TXT-Menu11; // 0x540 (8)
	struct Unknown TXT-MoveSpeed; // 0x548 (8)
	struct Unknown TXT-ProjectileVelocity; // 0x550 (8)
	struct Unknown TXT-ReloadTime; // 0x558 (8)
	struct Unknown TXT-Weight; // 0x560 (8)

	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown On_IMG-BG_MouseButtonDown_2(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.On_IMG-BG_MouseButtonDown_2(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_9693EBAC46E1F6BA769CC6A2AB0B68E0(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.OnLoaded_9693EBAC46E1F6BA769CC6A2AB0B68E0(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_95_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_95_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu03_K2Node_ComponentBoundEvent_118_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu03_K2Node_ComponentBoundEvent_118_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_572_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_572_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_589_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu05_K2Node_ComponentBoundEvent_589_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu06_K2Node_ComponentBoundEvent_609_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu06_K2Node_ComponentBoundEvent_609_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu07_K2Node_ComponentBoundEvent_630_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu07_K2Node_ComponentBoundEvent_630_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu08_K2Node_ComponentBoundEvent_652_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu08_K2Node_ComponentBoundEvent_652_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu09_K2Node_ComponentBoundEvent_675_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu09_K2Node_ComponentBoundEvent_675_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu10_K2Node_ComponentBoundEvent_699_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu10_K2Node_ComponentBoundEvent_699_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__BTN-Menu11_K2Node_ComponentBoundEvent_724_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu11_K2Node_ComponentBoundEvent_724_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-BlackMarket_Slot_Weapon(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.ExecuteUbergraph_UW-BlackMarket_Slot_Weapon(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};

// Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.SetIconTexture
inline void UUW-BlackMarket_Slot_Weapon_C::SetIconTexture(struct Unknown IconTexture) {
...
inline struct Unknown UUW-BlackMarket_Slot_Weapon_C::On_IMG-BG_MouseButtonDown_2(struct Unknown MyGeometry, struct Unknown& MouseEvent) {
...
inline void UUW-BlackMarket_Slot_Weapon_C::OnLoaded_9693EBAC46E1F6BA769CC6A2AB0B68E0(struct Unknown Loaded) {
...
inline void UUW-BlackMarket_Slot_Weapon_C::OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent) {
...
inline void UUW-BlackMarket_Slot_Weapon_C::OnMouseLeave(struct Unknown& MouseEvent) {
...
inline void UUW-BlackMarket_Slot_Weapon_C::AysncLoading(struct Unknown IconTexture) {
