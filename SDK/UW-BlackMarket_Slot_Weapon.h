...
public:
	...
	void SetIconTexture(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	struct FEventReply On_IMG-BG_MouseButtonDown_2(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.On_IMG-BG_MouseButtonDown_2(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void OnLoaded_9693EBAC46E1F6BA769CC6A2AB0B68E0(struct Object Loaded); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.OnLoaded_9693EBAC46E1F6BA769CC6A2AB0B68E0(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void Construct(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void AysncLoading(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	...
	void BndEvt__BTN-Menu10_K2Node_ComponentBoundEvent_699_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu10_K2Node_ComponentBoundEvent_699_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void BndEvt__BTN-Menu11_K2Node_ComponentBoundEvent_724_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.BndEvt__BTN-Menu11_K2Node_ComponentBoundEvent_724_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_UW-BlackMarket_Slot_Weapon(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Weapon.UW-BlackMarket_Slot_Weapon_C.ExecuteUbergraph_UW-BlackMarket_Slot_Weapon(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
