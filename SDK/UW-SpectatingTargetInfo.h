...
public:
	...
	void ReportSended(); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.ReportSended(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Check Report Enable From User Name(); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.Check Report Enable From User Name(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetTargetPlayerInfo(struct ABravoHotelPlayerState PlayerState); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.SetTargetPlayerInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnLoaded_4A4EF93A4D64362A89D43DA6D9BD2749(struct Object Loaded); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.OnLoaded_4A4EF93A4D64362A89D43DA6D9BD2749(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AsyncClassIcon(struct TSoftObjectPtr<Object> Image); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.AsyncClassIcon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_Report_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.BndEvt__Button_Report_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Construct(); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void SetReplayReportAbleDateTime(); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.SetReplayReportAbleDateTime(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CheckTargetValid(); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.CheckTargetValid(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-SpectatingTargetInfo(int32_t EntryPoint); // Function UW-SpectatingTargetInfo.UW-SpectatingTargetInfo_C.ExecuteUbergraph_UW-SpectatingTargetInfo(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
