...
struct APrefabToolActor : UActor {
	struct Unknown PrefabComponent; //  0x310 Size(8)

	void SetPrefab(struct Unknown NewPrefab, char bForceRevertEvenDisconnected); // Function PrefabAsset.PrefabToolActor.SetPrefab(Final|Native|Public|BlueprintCallable) // <Game+0x124cfd0>
};

// Class PrefabAsset.PrefabAsset
struct UPrefabAsset : Object {
	struct TMap<{}, {}>Unknown AssetReferences; //  0x28 Size(50)
	struct Unknown GeneratedBlueprintAssetReference; //  0x78 Size(18)
	struct Unknown SimplifiedMeshAssetReference; //  0x90 Size(18)
	struct Unknown PrefabId; //  0xa8 Size(10)
	struct FString PrefabContent; //  0xb8 Size(10)
	struct FString PrefabHash; //  0xc8 Size(10)
	int32_t NumActors; //  0xd8 Size(4)
	struct Unknown PrefabPivot; //  0xdc Size(c)

	void SetSimplifiedMeshAssetReference(struct Unknown& InAssetReference); // Function PrefabAsset.PrefabAsset.SetSimplifiedMeshAssetReference(Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <Game+0x124d0a0>
};

// Class PrefabAsset.PrefabVariantAsset
struct UPrefabVariantAsset : UPrefabAsset {
	struct Unknown Parent; //  0xe8 Size(8)
};
...
struct UPrefabToolComponent : UPrimitiveComponent {
	...
	struct Unknown Prefab; //  0x4c0 Size(8)
	struct Unknown GeneratedBlueprint; //  0x4c8 Size(8)
	struct Unknown SimplifiedMesh; //  0x4d0 Size(8)
	struct TMap<{}, {}>Unknown PrefabInstancesMap; //  0x4d8 Size(50)
	struct TArray<Unknown> VariantRulesOverwrite; //  0x528 Size(10)
	char bTransient; //  0x538 Size(1)
	struct Unknown* ParentClass; //  0x540 Size(8)
};
...
struct UPrefabToolSettings : Object {
	...
	enum class Unknow UITheme; //  0x40 Size(4)
	...
	char bAutoAddRemoveVariantActorPrefi; //  0x49 Size(1)
	struct FString VariantActorPrefix; //  0x50 Size(10)
	char bEnablePrefabComponentVisualizer; //  0x60 Size(1)
	enum class Unknow PrefabComponentVisualizerType; //  0x61 Size(1)
	char bDisplayPrefabComponentVisualizerEvenNotSelected; //  0x62 Size(1)
	struct Unknown PrefabViewVisualizerColor; //  0x64 Size(4)
	struct Unknown TargetActorColor; //  0x68 Size(4)
	struct Unknown UnLockedConnectedColor; //  0x6c Size(4)
	struct Unknown LockedConnectedColor; //  0x70 Size(4)
	struct Unknown UnLockedDisConnectedColor; //  0x74 Size(4)
	struct Unknown LockedDisConnectedColor; //  0x78 Size(4)
	struct Unknown UnLockedNoPrefabAssignedColor; //  0x7c Size(4)
	struct Unknown LockedNoPrefabAssignedColor; //  0x80 Size(4)
	struct Unknown PrefabMaterialPath; //  0x88 Size(18)
	...
	struct TArray<Unknown> ChangeComponentActor; //  0xd8 Size(10)
	struct Unknown* DefaultActorClass; //  0xe8 Size(8)
	char bEnabledAutoThumbnail; //  0xf0 Size(1)
	char bAutoOpenBlueprintEditor; //  0xf1 Size(1)
	struct Unknown* InteriorActorClass; //  0xf8 Size(8)
	struct Unknown* ExteriorActorClass; //  0x100 Size(8)
	struct Unknown* InteriorShowActorClass; //  0x108 Size(8)
	struct Unknown* HouseActorClass; //  0x110 Size(8)
	char bSupportGenerateBlueprint; //  0x118 Size(1)
	char bHarvestComponentsWhenGeneratingBluepriPr; //  0x119 Size(1)
	char bUseActorNameAsVariableNameWhenGenerati; //  0x11a Size(1)
	char bForceMobilityToMov; //  0x11b Size(1)
	struct TArray<Unknown> IgnoreActorClassesWhenGeneratingBluepri; //  0x120 Size(10)
	struct TArray<Unknown> IgnoreActorTagsWhenGeneratingBlueprint; //  0x130 Size(10)
	char bFlashPrefabWindowForTargetPrefabActor; //  0x140 Size(1)
	char bEnablePrefabTextEditor; //  0x141 Size(1)
	char bDebugMode; //  0x142 Size(1)
