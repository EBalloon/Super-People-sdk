...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M200.ABP-M200_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_ABP-M200(int32_t EntryPoint); // Function ABP-M200.ABP-M200_C.ExecuteUbergraph_ABP-M200(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
