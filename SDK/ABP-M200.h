...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-M200.ABP-M200_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_ABP-M200(int32_t EntryPoint); // Function ABP-M200.ABP-M200_C.ExecuteUbergraph_ABP-M200(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
