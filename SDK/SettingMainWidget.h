...
public:
	...
	void CreateWidgetImpl(struct UClass* WidgetClass, struct UBravoHotelSettingSubWidget& OutWidget, int32_t& OutSwitcherIndex, int32_t& RealIndex); // Function SettingMainWidget.SettingMainWidget_C.CreateWidgetImpl(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void CheckConfirmPopup(int32_t Index, enum class ESettingBigType Type); // Function SettingMainWidget.SettingMainWidget_C.CheckConfirmPopup(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	struct TArray<struct UBravoHotelSettingSubWidget> GetSubList(); // Function SettingMainWidget.SettingMainWidget_C.GetSubList(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void Select Menu(int32_t Index, enum class ESettingBigType Type); // Function SettingMainWidget.SettingMainWidget_C.Select Menu(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void BndEvt__Apply_K2Node_ComponentBoundEvent_0_OnClickEventDispatcher__DelegateSignature(struct UButtomButtonWidget_C Widget); // Function SettingMainWidget.SettingMainWidget_C.BndEvt__Apply_K2Node_ComponentBoundEvent_0_OnClickEventDispatcher__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void 鉹@ t元_1(struct UBravoHotelSettingSlotWidget Value); // Function SettingMainWidget.SettingMainWidget_C.鉹@ t元_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void BndEvt__Default_K2Node_ComponentBoundEvent_1_OnClickEventDispatcher__DelegateSignature(struct UButtomButtonWidget_C Widget); // Function SettingMainWidget.SettingMainWidget_C.BndEvt__Default_K2Node_ComponentBoundEvent_1_OnClickEventDispatcher__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void BndEvt__GoBack_K2Node_ComponentBoundEvent_2_OnClickEventDispatcher__DelegateSignature(struct UButtomButtonWidget_C Widget); // Function SettingMainWidget.SettingMainWidget_C.BndEvt__GoBack_K2Node_ComponentBoundEvent_2_OnClickEventDispatcher__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void CheckHaveApplyList(enum class ESettingBigType Type); // Function SettingMainWidget.SettingMainWidget_C.CheckHaveApplyList(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void CreateConfirmWidget(int32_t TabIdx, enum class ESettingBigType SelectTabType, int32_t PopupType); // Function SettingMainWidget.SettingMainWidget_C.CreateConfirmWidget(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void Set Desc(struct UBravoHotelSettingSlotWidget Slot); // Function SettingMainWidget.SettingMainWidget_C.Set Desc(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void 鉹@t元_1(struct UBravoHotelSettingSlotWidget Value, char IsSubKey); // Function SettingMainWidget.SettingMainWidget_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void KeyNotiMessage(char IsDuplicate, struct FInputChord Key, struct FText KeyName); // Function SettingMainWidget.SettingMainWidget_C.KeyNotiMessage(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
