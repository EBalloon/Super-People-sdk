...
public:
	...
	struct FPointerToUberGraphFrame UberGraphFrame; // 0x1F10 (8)
	struct UStaticMeshComponent StaticMesh_Ring; // 0x1F18 (8)
	struct UStaticMeshComponent StaticMesh_Lever; // 0x1F20 (8)
	...
	struct UTimelineComponent Timeline_1; // 0x1F30 (8)
	float Lerp_Lerp_EDD5977E4E850EC460B1E599F1FF45F8; // 0x1F38 (4)
	char Lerp__Direction_EDD5977E4E850EC460B1E599F1FF45F8; // 0x1F3C (1)
	struct UTimelineComponent Lerp; // 0x1F40 (8)
	struct FVector InterpOffset; // 0x1F48 (12)
	struct FVector DesiredLocation; // 0x1F54 (12)
	struct FVector InitalLocalVelocity; // 0x1F60 (12)
	struct FVector DesiredLocation_Ing; // 0x1F6C (12)
	struct FVector InitalLocalVelocity_Ing; // 0x1F78 (12)
	enum class EThrowingWeaponState ThrowingWeaponState; // 0x1F84 (1)
	char ThrowingAction_Bool : 0; // 0x1F85 (1)
	struct FVector DesiredLocation_3; // 0x1F88 (12)
	struct FVector DesiredLocation_2_Ing; // 0x1F94 (12)
	struct FVector InitalLocalVelocity_3; // 0x1FA0 (12)
	struct FVector InitalLocalVelocity_2_ing; // 0x1FAC (12)
	float PathLifeTime; // 0x1FB8 (4)
	float TimeInterval; // 0x1FBC (4)
	struct UStaticMeshComponent IndicatorComponent_2; // 0x1FC0 (8)
	struct UStaticMeshComponent IndicatorComponent_3; // 0x1FC8 (8)
	struct UProjectileTrajectoryComponent_C TrajectoryComponent_2; // 0x1FD0 (8)
	struct UProjectileTrajectoryComponent_C TrajectoryComponent_3; // 0x1FD8 (8)

	struct UBravoHotelDebugInfo GetDebugInfo(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.GetDebugInfo(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void GetProjectileLocationAndVelocity(int32_t Index, struct FVector& Location, struct FVector& Velocity); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.GetProjectileLocationAndVelocity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B80160>
	void ThrowingAction(enum class EThrowingWeaponState ThrowingWeaponState, char Condition); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.ThrowingAction(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	struct USplineMeshComponent Add Spline Mesh(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.Add Spline Mesh(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void CalcGrenadeWeaponLocationOffset(struct FVector Offest); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.CalcGrenadeWeaponLocationOffset(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void OnChangeThrowingWeaponStateDelegate_Event(enum class EThrowingWeaponState ThrowingWeaponState); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnChangeThrowingWeaponStateDelegate_Event(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnChangeThrowingTypeDelegate_Event(enum class EGrenadeThrowingType ThrowingType); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnChangeThrowingTypeDelegate_Event(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void OnCharacterGroundStateChangeDelegate(enum class ECharacterGroundState State); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnCharacterGroundStateChangeDelegate(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
