...
public:
	...
	struct FPointerToUberGraphFrame UberGraphFrame; // 0x1ED0 (8)
	struct UStaticMeshComponent StaticMesh_Ring; // 0x1ED8 (8)
	struct UStaticMeshComponent StaticMesh_Lever; // 0x1EE0 (8)
	float Timeline_0_Lerp_77CED3694A7ECD58C02266AF5F5B5991; // 0x1EE8 (4)
	char Timeline_0__Direction_77CED3694A7ECD58C02266AF5F5B5991; // 0x1EEC (1)
	struct UTimelineComponent Timeline_1; // 0x1EF0 (8)
	float Lerp_Lerp_EDD5977E4E850EC460B1E599F1FF45F8; // 0x1EF8 (4)
	char Lerp__Direction_EDD5977E4E850EC460B1E599F1FF45F8; // 0x1EFC (1)
	struct UTimelineComponent Lerp; // 0x1F00 (8)
	struct FVector InterpOffset; // 0x1F08 (12)
	struct FVector DesiredLocation; // 0x1F14 (12)
	struct FVector InitalLocalVelocity; // 0x1F20 (12)
	struct FVector DesiredLocation_Ing; // 0x1F2C (12)
	struct FVector InitalLocalVelocity_Ing; // 0x1F38 (12)
	enum class EThrowingWeaponState ThrowingWeaponState; // 0x1F44 (1)
	char ThrowingAction_Bool : 0; // 0x1F45 (1)
	struct FVector DesiredLocation_3; // 0x1F48 (12)
	struct FVector DesiredLocation_2_Ing; // 0x1F54 (12)
	struct FVector InitalLocalVelocity_3; // 0x1F60 (12)
	struct FVector InitalLocalVelocity_2_ing; // 0x1F6C (12)
	float PathLifeTime; // 0x1F78 (4)
	float TimeInterval; // 0x1F7C (4)
	struct UStaticMeshComponent IndicatorComponent_2; // 0x1F80 (8)
	struct UStaticMeshComponent IndicatorComponent_3; // 0x1F88 (8)
	struct UProjectileTrajectoryComponent_C TrajectoryComponent_2; // 0x1F90 (8)
	struct UProjectileTrajectoryComponent_C TrajectoryComponent_3; // 0x1F98 (8)

	struct UBravoHotelDebugInfo GetDebugInfo(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.GetDebugInfo(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CheckNeedDrawing(char& Need); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.CheckNeedDrawing(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void IsReplayTarget(char& IsReplayTarget); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.IsReplayTarget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void GetProjectileLocationAndVelocity(int32_t Index, struct FVector& Location, struct FVector& Velocity); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.GetProjectileLocationAndVelocity(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ThrowingAction(enum class EThrowingWeaponState ThrowingWeaponState, char Condition); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.ThrowingAction(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct USplineMeshComponent Add Spline Mesh(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.Add Spline Mesh(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CalcGrenadeWeaponLocationOffset(struct FVector Offest); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.CalcGrenadeWeaponLocationOffset(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Lerp__FinishedFunc(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.Lerp__FinishedFunc(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Lerp__UpdateFunc(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.Lerp__UpdateFunc(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Timeline_0__FinishedFunc(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.Timeline_0__FinishedFunc(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Timeline_0__UpdateFunc(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.Timeline_0__UpdateFunc(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void DrawProjectileTrajectory(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.DrawProjectileTrajectory(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ReceiveDestroyed(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.ReceiveDestroyed(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnChangeThrowingWeaponStateDelegate_Event(enum class EThrowingWeaponState ThrowingWeaponState); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnChangeThrowingWeaponStateDelegate_Event(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnChangeThrowingTypeDelegate_Event(enum class EGrenadeThrowingType ThrowingType); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnChangeThrowingTypeDelegate_Event(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void DrawProjectileTrajectory_ChangeType(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.DrawProjectileTrajectory_ChangeType(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnCharacterGroundStateChangeDelegate(enum class ECharacterGroundState State); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnCharacterGroundStateChangeDelegate(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void InitProjectileTrajectory(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.InitProjectileTrajectory(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnFire(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnFire(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ForceUpdateProjectileTrajectory(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.ForceUpdateProjectileTrajectory(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnChangedReplayViewMode_2(char IsPlayer); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.OnChangedReplayViewMode_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void K2_OnOwnerBecomeViewTarget(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.K2_OnOwnerBecomeViewTarget(Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void K2_OnOwnerEndViewTarget(); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.K2_OnOwnerEndViewTarget(Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ReceiveEndPlay(char EndPlayReason); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.ReceiveEndPlay(Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_BP-GrenadeWeaponBase(int32_t EntryPoint); // Function BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.ExecuteUbergraph_BP-GrenadeWeaponBase(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
