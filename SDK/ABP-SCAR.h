...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-SCAR.ABP-SCAR_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_ABP-SCAR(int32_t EntryPoint); // Function ABP-SCAR.ABP-SCAR_C.ExecuteUbergraph_ABP-SCAR(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
