...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-SCAR.ABP-SCAR_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_ABP-SCAR(int32_t EntryPoint); // Function ABP-SCAR.ABP-SCAR_C.ExecuteUbergraph_ABP-SCAR(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
