...
struct UNavArea : UNavAreaBase {
	...
	Unknown SupportedAgents; //  0x3c Size(4)
...
struct UNavAreaMeta_SwitchByAgent : UNavAreaMeta {
	Unknown Agent0Area; //  0x48 Size(8)
	Unknown Agent1Area; //  0x50 Size(8)
	Unknown Agent2Area; //  0x58 Size(8)
	Unknown Agent3Area; //  0x60 Size(8)
	Unknown Agent4Area; //  0x68 Size(8)
	Unknown Agent5Area; //  0x70 Size(8)
	Unknown Agent6Area; //  0x78 Size(8)
	Unknown Agent7Area; //  0x80 Size(8)
	Unknown Agent8Area; //  0x88 Size(8)
	Unknown Agent9Area; //  0x90 Size(8)
	Unknown Agent10Area; //  0x98 Size(8)
	Unknown Agent11Area; //  0xa0 Size(8)
	Unknown Agent12Area; //  0xa8 Size(8)
	Unknown Agent13Area; //  0xb0 Size(8)
	Unknown Agent14Area; //  0xb8 Size(8)
	Unknown Agent15Area; //  0xc0 Size(8)
};

// Class NavigationSystem.NavCollision
struct UNavCollision : UNavCollisionBase {
	Unknown CylinderCollision; //  0x80 Size(10)
	Unknown BoxCollision; //  0x90 Size(10)
	Unknown AreaClass; //  0xa0 Size(8)
...
struct UNavigationGraphNodeComponent : USceneComponent {
	Unknown Node; //  0x238 Size(18)
	Unknown NextNodeComponent; //  0x250 Size(8)
	Unknown PrevNodeComponent; //  0x258 Size(8)
};
...
struct UNavigationPath : Object {
	...
	Unknown PathPoints; //  0x38 Size(10)
	Unknown RecalculateOnInvalidation; //  0x48 Size(1)

	char IsValid(); // Function NavigationSystem.NavigationPath.IsValid(Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x3f0e600>
};

// Class NavigationSystem.NavigationQueryFilter
struct UNavigationQueryFilter : Object {
	Unknown Areas; //  0x28 Size(10)
	Unknown IncludeFlags; //  0x38 Size(4)
	Unknown ExcludeFlags; //  0x3c Size(4)
};

// Class NavigationSystem.NavigationSystemV1
struct UNavigationSystemV1 : UNavigationSystemBase {
	Unknown MainNavData; //  0x28 Size(8)
	Unknown AbstractNavData; //  0x30 Size(8)
	...
	char bAllowClientSideNav; //  0x68 Size(1)
	...
	Unknown DataGatheringMode; //  0x6c Size(1)
	char bGenerateNavigationOnlyAroundNavigationInvokers; //  0x70 Size(1)
	float ActiveTilesUpdateInterval; //  0x74 Size(4)
	Unknown SupportedAgents; //  0x78 Size(10)
	Unknown SupportedAgentsMask; //  0x88 Size(4)
	Unknown NavDataSet; //  0x90 Size(10)
	Unknown NavDataRegistrationQueue; //  0xa0 Size(10)
	struct FMulticastInlineDelegate OnNavDataRegisteredEvent; //  0xc0 Size(10)
	struct FMulticastInlineDelegate OnNavigationGenerationFinishedDelegate; //  0xd0 Size(10)
	Unknown OperationMode; //  0x1bc Size(1)
	float DirtyAreasUpdateFreq; //  0x514 Size(4)

	void UnregisterNavigationInvoker(Unknown Invoker); // Function NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker(Final|Native|Public|BlueprintCallable) // <Game+0x3f0f450>
};
...
struct UNavigationSystemModuleConfig : UNavigationSystemConfig {
	...
	char bAutoSpawnMissingNavData; //  0x50 Size(1)
...
struct ANavigationTestingActor : UActor {
	...
	Unknown InvokerComponent; //  0x328 Size(8)
	char bActAsNavigationInv; //  0x330 Size(1)
	Unknown NavAgentProps; //  0x338 Size(30)
	Unknown QueryingExtent; //  0x368 Size(c)
	Unknown MyNavData; //  0x378 Size(8)
	Unknown ProjectedLocation; //  0x380 Size(c)
	...
	Unknown CostDisplayMode; //  0x39c Size(1)
	Unknown TextCanvasOffset; //  0x3a0 Size(8)
	...
	Unknown OtherActor; //  0x3b8 Size(8)
	Unknown FilterClass; //  0x3c0 Size(8)
...
struct UNavLinkComponent : UPrimitiveComponent {
	Unknown LINKS; //  0x4c0 Size(10)
};

// Class NavigationSystem.NavRelevantComponent
struct UNavRelevantComponent : UActorComponent {
	char bAttachToOwnersRoot; //  0xd4 Size(1)
	Unknown CachedNavParent; //  0xd8 Size(8)

	void SetNavigationRelevancy(char bRelevant); // Function NavigationSystem.NavRelevantComponent.SetNavigationRelevancy(Final|Native|Public|BlueprintCallable) // <Game+0x3f11ae0>
};

// Class NavigationSystem.NavLinkCustomComponent
struct UNavLinkCustomComponent : UNavRelevantComponent {
	uint32_t NavLinkUserId; //  0xe8 Size(4)
	Unknown Enab; //  0xf0 Size(8)
	Unknown DisabledAreaClass; //  0xf8 Size(8)
	Unknown SupportedAgents; //  0x100 Size(4)
	Unknown LinkRelativeStart; //  0x104 Size(c)
	Unknown LinkRelativeEnd; //  0x110 Size(c)
	Unknown LinkDirection; //  0x11c Size(1)
	...
	Unknown ObstacleOffset; //  0x124 Size(c)
	Unknown ObstacleExtent; //  0x130 Size(c)
	Unknown ObstacleAreaClass; //  0x140 Size(8)
	float BroadcastRadius; //  0x148 Size(4)
	float BroadcastInterval; //  0x14c Size(4)
	Unknown BroadcastChannel; //  0x150 Size(1)
};

// Class NavigationSystem.NavMeshBoundsVolume
struct ANavMeshBoundsVolume : AVolume {
	Unknown SupportedAgents; //  0x348 Size(4)
};

// Class NavigationSystem.NavModifierComponent
struct UNavModifierComponent : UNavRelevantComponent {
	Unknown AreaClass; //  0xe0 Size(8)
	Unknown FailsafeExtent; //  0xe8 Size(c)
	char bIncludeAgentHeight; //  0xf4 Size(1)

	void SetAreaClass(Unknown NewAreaClass); // Function NavigationSystem.NavModifierComponent.SetAreaClass(Final|Native|Public|BlueprintCallable) // <Game+0x3f11a60>
};

// Class NavigationSystem.NavModifierVolume
struct ANavModifierVolume : AVolume {
	Unknown AreaClass; //  0x350 Size(8)

	void SetAreaClass(Unknown NewAreaClass); // Function NavigationSystem.NavModifierVolume.SetAreaClass(Final|Native|Public|BlueprintCallable) // <Game+0x3f119e0>
};

// Class NavigationSystem.NavSystemConfigOverride
struct ANavSystemConfigOverride : UActor {
	Unknown NavigationSystemConfig; //  0x310 Size(8)
	Unknown OverridePolicy; //  0x318 Size(1)
...
struct ARecastNavMesh : ANavigationData {
	...
	Unknown NavMeshOriginOffset; //  0x540 Size(c)
	...
	Unknown RegionPartitioning; //  0x558 Size(1)
	Unknown LayerPartitioning; //  0x559 Size(1)
	...
	char K2_ReplaceAreaInTileBounds(Unknown Bounds, Unknown OldArea, Unknown NewArea, char ReplaceLinks); // Function NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds(Final|Native|Public|HasDefaults|BlueprintCallable) // <Game+0x3f11850>
};
