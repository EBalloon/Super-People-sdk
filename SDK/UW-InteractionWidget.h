...
public:
	...
	void SetCompareFloatArrow(struct Unknown UpImgae, struct Unknown DownImgae, struct Unknown Text, struct Unknown CompareInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCompareFloatArrow(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeaponBuff(struct Unknown InventoryItemInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetWeaponBuff(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetCustomizedWidget(); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCustomizedWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRarityPickUp(enum class Unknow Rarity); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetRarityPickUp(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetCompareArrow(struct Unknown UpImgae, struct Unknown DownImgae, struct Unknown Text, struct Unknown CompareInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCompareArrow(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Set RarityWeapon(enum class Unknow Rarity); // Function UW-InteractionWidget.UW-InteractionWidget_C.Set RarityWeapon(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Reset(); // Function UW-InteractionWidget.UW-InteractionWidget_C.Reset(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Hide(); // Function UW-InteractionWidget.UW-InteractionWidget_C.Hide(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_2385A39542FE4E4DC3D8DA9A1DC61138(struct Unknown Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_2385A39542FE4E4DC3D8DA9A1DC61138(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_5F4D13BB46FAD58EF9E7D9B1EC284B61(struct Unknown Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_5F4D13BB46FAD58EF9E7D9B1EC284B61(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_AD9F8D574EE55C633D4CEBA11FC6FB36(struct Unknown Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_AD9F8D574EE55C633D4CEBA11FC6FB36(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_F76113C9404D07E2AAB61F936BF0F1DA(struct Unknown Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_F76113C9404D07E2AAB61F936BF0F1DA(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_2D7AC27D4A9340E37F63BDA517074AED(struct Unknown Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_2D7AC27D4A9340E37F63BDA517074AED(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetPickItem(struct Unknown& InteractionInfo, struct Unknown& NewPickItem); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetPickItem(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeapon(struct Unknown& InteractionInfo, struct Unknown& NewWeaponItem, struct Unknown& ItemInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetWeapon(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetCompareWeapon(struct Unknown& InteractionInfo, struct Unknown& NewWeaponItem, struct Unknown& ItemInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCompareWeapon(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AsyncLoadIconTexture(struct Unknown IconTexture); // Function UW-InteractionWidget.UW-InteractionWidget_C.AsyncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void PreConstruct(char IsDesignTime); // Function UW-InteractionWidget.UW-InteractionWidget_C.PreConstruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetAction(struct Unknown& InteractionInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetAction(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Set PaperSprite AsycLoad(struct Unknown IconTexture, struct Unknown TargetImage); // Function UW-InteractionWidget.UW-InteractionWidget_C.Set PaperSprite AsycLoad(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetHide(); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetHide(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetCustomMode(int32_t ModeNum); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCustomMode(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetNoHide(char NoHide); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetNoHide(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetInteractionInfo(struct Unknown InteractionInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetInteractionInfo(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-InteractionWidget(int32_t EntryPoint); // Function UW-InteractionWidget.UW-InteractionWidget_C.ExecuteUbergraph_UW-InteractionWidget(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
