...
public:
	...
	struct FBravoHotelWeaponInfo CompareWeaponInfo; // 0x5D0 (2864)
	char IsNoHide : 0; // 0x1100 (1)
	char bWeapon : 0; // 0x1101 (1)
	char bPlayAnimation_WeaponCompare : 0; // 0x1102 (1)
	struct FSlateColor VisibleTextColor; // 0x1108 (40)
	struct FSlateBrush BrushActionKeyWhite; // 0x1130 (136)
	struct FSlateBrush BrushActionKeyRed; // 0x11B8 (136)
	struct FName TempName; // 0x1240 (8)
	struct FText AvailableAmmoQuantity; // 0x1248 (24)

	void SetCompareFloatArrow(struct UImage UpImgae, struct UImage DownImgae, struct UTextBlock Text, struct FItemComparefloatInfo CompareInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCompareFloatArrow(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetWeaponBuff(struct FInventoryItemInfo InventoryItemInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetWeaponBuff(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetCustomizedWidget(); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCustomizedWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetRarityPickUp(enum class EItemRarity Rarity); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetRarityPickUp(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetCompareArrow(struct UImage UpImgae, struct UImage DownImgae, struct UTextBlock Text, struct FItemCompareInfo CompareInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCompareArrow(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set RarityWeapon(enum class EItemRarity Rarity); // Function UW-InteractionWidget.UW-InteractionWidget_C.Set RarityWeapon(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Reset(); // Function UW-InteractionWidget.UW-InteractionWidget_C.Reset(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Hide(); // Function UW-InteractionWidget.UW-InteractionWidget_C.Hide(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_2385A39542FE4E4DC3D8DA9A1DC61138(struct Object Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_2385A39542FE4E4DC3D8DA9A1DC61138(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_5F4D13BB46FAD58EF9E7D9B1EC284B61(struct Object Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_5F4D13BB46FAD58EF9E7D9B1EC284B61(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_AD9F8D574EE55C633D4CEBA11FC6FB36(struct Object Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_AD9F8D574EE55C633D4CEBA11FC6FB36(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_F76113C9404D07E2AAB61F936BF0F1DA(struct Object Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_F76113C9404D07E2AAB61F936BF0F1DA(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_2D7AC27D4A9340E37F63BDA517074AED(struct Object Loaded); // Function UW-InteractionWidget.UW-InteractionWidget_C.OnLoaded_2D7AC27D4A9340E37F63BDA517074AED(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetPickItem(struct FInteraction& InteractionInfo, struct FPickupItem& NewPickItem); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetPickItem(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetWeapon(struct FInteraction& InteractionInfo, struct FWeaponItem& NewWeaponItem, struct FInventoryItemInfo& ItemInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetWeapon(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetCompareWeapon(struct FInteraction& InteractionInfo, struct FWeaponCompare& NewWeaponItem, struct FInventoryItemInfo& ItemInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCompareWeapon(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void AsyncLoadIconTexture(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-InteractionWidget.UW-InteractionWidget_C.AsyncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void PreConstruct(char IsDesignTime); // Function UW-InteractionWidget.UW-InteractionWidget_C.PreConstruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetAction(struct FInteraction& InteractionInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetAction(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Set PaperSprite AsycLoad(struct TSoftObjectPtr<UPaperSprite> IconTexture, struct UImage TargetImage); // Function UW-InteractionWidget.UW-InteractionWidget_C.Set PaperSprite AsycLoad(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetHide(); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetHide(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetCustomMode(int32_t ModeNum); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetCustomMode(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetNoHide(char NoHide); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetNoHide(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetInteractionInfo(struct FInteraction InteractionInfo); // Function UW-InteractionWidget.UW-InteractionWidget_C.SetInteractionInfo(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-InteractionWidget(int32_t EntryPoint); // Function UW-InteractionWidget.UW-InteractionWidget_C.ExecuteUbergraph_UW-InteractionWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
