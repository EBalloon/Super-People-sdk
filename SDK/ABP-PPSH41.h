...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-PPSH41.ABP-PPSH41_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_ABP-PPSH41(int32_t EntryPoint); // Function ABP-PPSH41.ABP-PPSH41_C.ExecuteUbergraph_ABP-PPSH41(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
