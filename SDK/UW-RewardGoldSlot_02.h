...
public:
	...
	struct UWidgetAnimation Anim_Bouns; // 0x250 (8)
	struct UTextBlock 1; // 0x258 (8)
	struct UTextBlock 10; // 0x260 (8)
	struct UTextBlock 100; // 0x268 (8)
	struct UTextBlock 1000; // 0x270 (8)
	struct UTextBlock Empty; // 0x278 (8)
	struct UImage Image_7; // 0x280 (8)
	struct UImage Image_11; // 0x288 (8)
	struct UImage Image_14; // 0x290 (8)
	struct UImage Image_15; // 0x298 (8)
	struct UImage Image_16; // 0x2A0 (8)
	struct UImage Image_17; // 0x2A8 (8)
	struct UImage Image_18; // 0x2B0 (8)
	struct UImage Image_20; // 0x2B8 (8)
	struct UImage Image_21; // 0x2C0 (8)
	struct UImage Image_22; // 0x2C8 (8)
	struct UImage Image_23; // 0x2D0 (8)
	struct UImage Image_1473; // 0x2D8 (8)
	struct UTextBlock TextBlock_4; // 0x2E0 (8)
	struct UImage TextLight_3; // 0x2E8 (8)
	int32_t Save; // 0x2F0 (4)
	struct FAudioPlayingHandle LoopSound; // 0x2F4 (4)
	char IsStopSound : 0; // 0x2F8 (1)

	void Divide(int32_t Value, int32_t& RetS1, int32_t& RetS2); // Function UW-RewardGoldSlot_02.UW-RewardGoldSlot_02_C.Divide(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetGold(int32_t RandomGold); // Function UW-RewardGoldSlot_02.UW-RewardGoldSlot_02_C.SetGold(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void StopSound(); // Function UW-RewardGoldSlot_02.UW-RewardGoldSlot_02_C.StopSound(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void 鉹@t元_2(); // Function UW-RewardGoldSlot_02.UW-RewardGoldSlot_02_C.鉹@t元_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-RewardGoldSlot_02(int32_t EntryPoint); // Function UW-RewardGoldSlot_02.UW-RewardGoldSlot_02_C.ExecuteUbergraph_UW-RewardGoldSlot_02(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
