// UW-MatchEnd_Ranking2_C UW-MatchEnd_Ranking2.UW-MatchEnd_Ranking2_C
 struct UUW-MatchEnd_Ranking2_C : UUserWidget {
	...
	Unknown World; // 0x58(0x08)
	Unknown Format; // 0xd8(0x01)
	char bEnableCompression; // 0xd9(0x01)
	int32_t CompressionQuality; // 0xdc(0x04)
	char bUseCompression; // 0x68(0x01)
	float CompressionQuality; // 0x6c(0x04)
	char bWaitForMoviesToComplete; // 0x28(0x01)
	char bMoviesAreSkippable; // 0x29(0x01)
	Unknown StartupMovies; // 0x30(0x10)
	Unknown Image_2; // 0x248(0x08)
	Unknown InvalidationBox_1; // 0x250(0x08)
	Unknown Switcher; // 0x258(0x08)
	float OwnDirection; // 0x260(0x04)
	Unknown UberGraphFrame; // 0x330(0x08)
	Unknown AnimGraphNode_Root; // 0x338(0x30)
	Unknown AnimGraphNode_BlendListByEnum; // 0x368(0xb0)
	Unknown AnimGraphNode_SequencePlayer_3; // 0x418(0x78)
	...
	Unknown AnimGraphNode_BlendListByBool; // 0x870(0xa0)
	Unknown UberGraphFrame; // 0x318(0x08)
	Unknown TitleWidgetRef; // 0x320(0x08)
	Unknown LobbyWidgetRef; // 0x328(0x08)
	Unknown LobbyPawns; // 0x330(0x10)
	struct TSoftClassPtr<UObject> LobbyPawnClass; // 0x340(0x28)
	Unknown SkipKey; // 0x368(0x18)
	char bSkip; // 0x380(0x01)
	char bNotFirstTime; // 0x381(0x01)
	Unknown LobbyCustomizePawn; // 0x388(0x08)
	char IsCharacterAppearance; // 0x390(0x01)
	Unknown TargetWearableCamera; // 0x398(0x08)
	struct FString CurrentArmorySceneState; // 0x3a0(0x10)
	float SurveyUPanValue; // 0x3b0(0x04)
	float GunSurveyMovingValue; // 0x3b4(0x04)
	Unknown SurveyUPan; // 0x3b8(0x08)
	Unknown GunSurveyMoving; // 0x3c0(0x08)
	Unknown IdentifiedTimer; // 0x3c8(0x08)
	struct FString CurrentTab; // 0x3d0(0x10)
	Unknown PP-OutlineGlow; // 0x3e0(0x08)
	Unknown AudioIndex_BGM; // 0x3e8(0x04)
	Unknown AudioIndex_Ambience; // 0x3ec(0x04)
	Unknown AudioIndex_Analyze; // 0x3f0(0x04)
	char PendingPartyInfoChange; // 0x3f4(0x01)
	Unknown EnhanceTimerHandle; // 0x3f8(0x08)
	Unknown ProceedingTimerHandle; // 0x400(0x08)
	Unknown CreateCharacterRef; // 0x408(0x08)
	Unknown IntroBGWidget; // 0x410(0x08)
	Unknown MediaSoundComponent; // 0x418(0x08)
	char bPlaySoloSequencePlayer; // 0x420(0x01)
	struct FString CurrentArmoryTab; // 0x428(0x10)
	Unknown LoginWidget; // 0x438(0x08)
	char bFinished_SequencePlayer_Endgame; // 0x440(0x01)
	Unknown ANIM-Lobby01_5_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x448(0x08)
	Unknown ANIM-Lobby02_8_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x450(0x08)
	Unknown ANIM-Lobby03_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x458(0x08)
	Unknown ANIM-Lobby04_11_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x460(0x08)
	Unknown SK-Body_Female_5_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x468(0x08)
	Unknown Title_TowerBridge_Squard_5_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x470(0x08)
	Unknown SK-Body_Female_Ranking_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x478(0x08)
	Unknown Ak-LobbySound_1_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x480(0x08)
	Unknown Title_TowerBridge_Endgame_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x488(0x08)
	Unknown Title_TowerBridge_Readyshot_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x490(0x08)
	Unknown Character_Creation_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x498(0x08)
	Unknown ExponentialHeightFog3_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4a0(0x08)
	Unknown ExponentialHeightFog_1_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4a8(0x08)
	Unknown CineCameraActor_1_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4b0(0x08)
	Unknown CineCamera_Supplybox_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4b8(0x08)
	Unknown CineCamera_All_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4c0(0x08)
	Unknown Character_Customization_Face_3_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4c8(0x08)
	Unknown Supplybox_Lobby_4_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4d0(0x08)
	Unknown Supplybox_Lobby_3_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4d8(0x08)
	Unknown CineCamera_Target_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4e0(0x08)
	Unknown CineCamera_Rank_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4e8(0x08)
	Unknown Title_Rank_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4f0(0x08)
	Unknown Gun_Survey_Plane_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x4f8(0x08)
	Unknown Weapon_Lobby_01_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x500(0x08)
	Unknown CineCamera_Face3_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x508(0x08)
	Unknown Screen_Transition_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x510(0x08)
	Unknown Character_Fade_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x518(0x08)
	Unknown PS-LobbyRay1_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x520(0x08)
	Unknown PS-LobbyRay2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x528(0x08)
	Unknown PS-LobbyRay3_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x530(0x08)
	Unknown PS-LobbyRay4_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x538(0x08)
	Unknown PS-LobbyRay5_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x540(0x08)
	Unknown PS-LobbyRay6_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x548(0x08)
	Unknown PS-LobbyRay7_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x550(0x08)
	Unknown PS-LobbyRay8_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x558(0x08)
	Unknown Weapon_Lobby_Disassemble_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x560(0x08)
	Unknown Weapon_Lobby_Repair_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x568(0x08)
	Unknown CineCamera_Weapon_Customization02_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x570(0x08)
	Unknown CineCamera_Weapon_Customization_2_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x578(0x08)
	Unknown Weapon_Lobby_Custom_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x580(0x08)
	Unknown SK-Body_Female_Creation_ExecuteUbergraph_LV-Title_Alternative_RefProperty; // 0x588(0x08)
	Unknown CineCameraActor_1_EdGraph_4_RefProperty; // 0x590(0x08)
	Unknown Gun_Survey_Plane_EdGraph_11_RefProperty; // 0x598(0x08)
	Unknown Gun_Survey_Plane_EdGraph_12_RefProperty; // 0x5a0(0x08)
	Unknown Gun_Survey_Plane_EdGraph_13_RefProperty; // 0x5a8(0x08)
	Unknown PostProcessVolume2_EdGraph_14_RefProperty; // 0x5b0(0x08)
	Unknown PostProcessVolume2_EdGraph_15_RefProperty; // 0x5b8(0x08)
	Unknown Supplybox_Lobby_4_EdGraph_16_RefProperty; // 0x5c0(0x08)
	Unknown Title_Rank_2_EdGraph_16_RefProperty; // 0x5c8(0x08)
	Unknown Character_Customization_Face_3_EdGraph_16_RefProperty; // 0x5d0(0x08)
	Unknown Supplybox_Lobby_3_EdGraph_16_RefProperty; // 0x5d8(0x08)
	Unknown Plane_3_EdGraph_27_RefProperty; // 0x5e0(0x08)
	Unknown Plane_2_EdGraph_27_RefProperty; // 0x5e8(0x08)
	Unknown Plane_4_EdGraph_27_RefProperty; // 0x5f0(0x08)
	Unknown Overlays; // 0x28(0x10)
	Unknown DefaultOverlays; // 0x28(0x08)
	Unknown LocaleToOverlaysMap; // 0x30(0x50)
	Unknown ClothingWindMethod; // 0x28(0x01)
	Unknown VerticalConstraint; // 0x2c(0x10)
	Unknown HorizontalConstraint; // 0x3c(0x10)
	Unknown BendConstraint; // 0x4c(0x10)
	Unknown ShearConstraint; // 0x5c(0x10)
	float SelfCollisionRadius; // 0x6c(0x04)
	float SelfCollisionStiffness; // 0x70(0x04)
	float SelfCollisionCullScale; // 0x74(0x04)
	Unknown Damping; // 0x78(0x0c)
	float Friction; // 0x84(0x04)
	float WindDragCoefficient; // 0x88(0x04)
	float WindLiftCoefficient; // 0x8c(0x04)
	Unknown LinearDrag; // 0x90(0x0c)
	Unknown AngularDrag; // 0x9c(0x0c)
	Unknown LinearInertiaScale; // 0xa8(0x0c)
	Unknown AngularInertiaScale; // 0xb4(0x0c)
	Unknown CentrifugalInertiaScale; // 0xc0(0x0c)
	float SolverFrequency; // 0xcc(0x04)
	float StiffnessFrequency; // 0xd0(0x04)
	float GravityScale; // 0xd4(0x04)
	Unknown GravityOverride; // 0xd8(0x0c)
	char bUseGravityOverride; // 0xe4(0x01)
	...
	Unknown WindMethod; // 0xfc(0x01)
	Unknown VerticalConstraintConfig; // 0x100(0x10)
	Unknown HorizontalConstraintConfig; // 0x110(0x10)
	Unknown BendConstraintConfig; // 0x120(0x10)
	Unknown ShearConstraintConfig; // 0x130(0x10)
	Unknown MaxDistances; // 0xe0(0x10)
	Unknown BackstopDistances; // 0xf0(0x10)
	Unknown BackstopRadiuses; // 0x100(0x10)
	Unknown AnimDriveMultipliers; // 0x110(0x10)
	Unknown UberGraphFrame; // 0x720(0x08)
	Unknown BP-HUDInteractionComponentBase; // 0x728(0x08)
	struct FMulticastInlineDelegate EventDispatcher_PlayLobbySound; // 0x730(0x10)
	struct FMulticastInlineDelegate EventDispatcher_StopLobbySound; // 0x740(0x10)
	Unknown MediaSoundComponent; // 0x750(0x08)
	Unknown OperationMessageWidget; // 0x758(0x08)
	Unknown CurrentSceneType; // 0x760(0x01)
	Unknown LobbyWidgetRef; // 0x768(0x08)
	struct FName InstanceName; // 0x30(0x08)
	Unknown ResourceOverlapPolicy; // 0x3a(0x01)
	Unknown ChildTask; // 0x60(0x08)
	struct FMulticastInlineDelegate SUCCESS; // 0x68(0x10)
	struct FMulticastInlineDelegate DidNotSpawn; // 0x78(0x10)
	Unknown ClassToSpawn; // 0xa0(0x08)
	...
	char bManuallySetID; // 0x30(0x01)
	char bIsNetDirty; // 0xbc(0x01)
	Unknown SimulatedTasks; // 0xc0(0x10)
	Unknown TaskPriorityQueue; // 0xd0(0x10)
	Unknown TickingTasks; // 0xf0(0x10)
	Unknown KnownTasks; // 0x100(0x10)
	...
	Unknown popup-bg; // 0x270(0x08)
	Unknown txt_description; // 0x278(0x08)
	Unknown uw-bg; // 0x280(0x08)
	Unknown RenderingComp; // 0x318(0x08)
	Unknown NavDataConfig; // 0x320(0x78)
	char bEnableDrawing; // 0x398(0x01)
	char bForceRebuildOnLoad; // 0x398(0x01)
	char bAutoDestroyWhenNoNavigation; // 0x398(0x01)
	char bCanBeMainNavData; // 0x398(0x01)
	char bCanSpawnOnRebuild; // 0x398(0x01)
	char bRebuildAtRuntime; // 0x398(0x01)
	Unknown RuntimeGeneration; // 0x39c(0x01)
	float ObservedPathsTickInterval; // 0x3a0(0x04)
	uint32_t DataVersion; // 0x3a4(0x04)
	Unknown SupportedAreas; // 0x488(0x10)
	float DefaultCost; // 0x30(0x04)
	float FixedAreaEnteringCost; // 0x34(0x04)
	Unknown DrawColor; // 0x38(0x04)
	Unknown SupportedAgents; // 0x3c(0x04)
	char bSupportsAgent0; // 0x40(0x01)
	char bSupportsAgent1; // 0x40(0x01)
	char bSupportsAgent2; // 0x40(0x01)
	char bSupportsAgent3; // 0x40(0x01)
	char bSupportsAgent4; // 0x40(0x01)
	char bSupportsAgent5; // 0x40(0x01)
	char bSupportsAgent6; // 0x40(0x01)
	char bSupportsAgent7; // 0x40(0x01)
	char bSupportsAgent8; // 0x41(0x01)
	char bSupportsAgent9; // 0x41(0x01)
	char bSupportsAgent10; // 0x41(0x01)
	char bSupportsAgent11; // 0x41(0x01)
	char bSupportsAgent12; // 0x41(0x01)
	char bSupportsAgent13; // 0x41(0x01)
	char bSupportsAgent14; // 0x41(0x01)
	char bSupportsAgent15; // 0x41(0x01)
	Unknown Agent0Area; // 0x48(0x08)
	Unknown Agent1Area; // 0x50(0x08)
	Unknown Agent2Area; // 0x58(0x08)
	Unknown Agent3Area; // 0x60(0x08)
	Unknown Agent4Area; // 0x68(0x08)
	Unknown Agent5Area; // 0x70(0x08)
	Unknown Agent6Area; // 0x78(0x08)
	Unknown Agent7Area; // 0x80(0x08)
	Unknown Agent8Area; // 0x88(0x08)
	Unknown Agent9Area; // 0x90(0x08)
	Unknown Agent10Area; // 0x98(0x08)
	Unknown Agent11Area; // 0xa0(0x08)
	Unknown Agent12Area; // 0xa8(0x08)
	Unknown Agent13Area; // 0xb0(0x08)
	Unknown Agent14Area; // 0xb8(0x08)
	Unknown Agent15Area; // 0xc0(0x08)
	Unknown CylinderCollision; // 0x80(0x10)
	Unknown BoxCollision; // 0x90(0x10)
	Unknown AreaClass; // 0xa0(0x08)
	char bGatherConvexGeometry; // 0xa8(0x01)
	char bCreateOnClient; // 0xa8(0x01)
	Unknown Node; // 0x238(0x18)
	Unknown NextNodeComponent; // 0x250(0x08)
	Unknown PrevNodeComponent; // 0x258(0x08)
	...
	Unknown PathPoints; // 0x38(0x10)
	Unknown RecalculateOnInvalidation; // 0x48(0x01)
	Unknown Areas; // 0x28(0x10)
	Unknown IncludeFlags; // 0x38(0x04)
	Unknown ExcludeFlags; // 0x3c(0x04)
	Unknown MainNavData; // 0x28(0x08)
	Unknown AbstractNavData; // 0x30(0x08)
	struct FName DefaultAgentName; // 0x38(0x08)
	struct TSoftClassPtr<UObject> CrowdManagerClass; // 0x40(0x28)
	char bAutoCreateNavigationData; // 0x68(0x01)
	char bSpawnNavDataInNavBoundsLevel; // 0x68(0x01)
	char bAllowClientSideNavigation; // 0x68(0x01)
	char bShouldDiscardSubLevelNavData; // 0x68(0x01)
	char bTickWhilePaused; // 0x68(0x01)
	char bSupportRebuilding; // 0x68(0x01)
	char bInitialBuildingLocked; // 0x68(0x01)
	char bSkipAgentHeightCheckWhenPickingNavData; // 0x69(0x01)
	Unknown DataGatheringMode; // 0x6c(0x01)
	char bGenerateNavigationOnlyAroundNavigationInvokers; // 0x70(0x01)
	float ActiveTilesUpdateInterval; // 0x74(0x04)
	Unknown SupportedAgents; // 0x78(0x10)
	Unknown SupportedAgentsMask; // 0x88(0x04)
	Unknown NavDataSet; // 0x90(0x10)
	Unknown NavDataRegistrationQueue; // 0xa0(0x10)
	...
	Unknown OperationMode; // 0x1bc(0x01)
	float DirtyAreasUpdateFreq; // 0x514(0x04)
	char bStrictlyStatic; // 0x50(0x01)
	char bCreateOnClient; // 0x50(0x01)
	char bAutoSpawnMissingNavData; // 0x50(0x01)
	char bSpawnNavDataInNavBoundsLevel; // 0x50(0x01)
	Unknown CapsuleComponent; // 0x320(0x08)
	Unknown InvokerComponent; // 0x328(0x08)
	char bActAsNavigationInvoker; // 0x330(0x01)
	Unknown NavAgentProps; // 0x338(0x30)
	Unknown QueryingExtent; // 0x368(0x0c)
	Unknown MyNavData; // 0x378(0x08)
	Unknown ProjectedLocation; // 0x380(0x0c)
	char bProjectedLocationValid; // 0x38c(0x01)
	char bSearchStart; // 0x38c(0x01)
	float CostLimitFactor; // 0x390(0x04)
	float MinimumCostLimit; // 0x394(0x04)
	char bBacktracking; // 0x398(0x01)
	char bUseHierarchicalPathfinding; // 0x398(0x01)
	char bGatherDetailedInfo; // 0x398(0x01)
	char bDrawDistanceToWall; // 0x398(0x01)
	char bShowNodePool; // 0x398(0x01)
	char bShowBestPath; // 0x398(0x01)
	char bShowDiffWithPreviousStep; // 0x398(0x01)
	char bShouldBeVisibleInGame; // 0x398(0x01)
	Unknown CostDisplayMode; // 0x39c(0x01)
	Unknown TextCanvasOffset; // 0x3a0(0x08)
	char bPathExist; // 0x3a8(0x01)
	char bPathIsPartial; // 0x3a8(0x01)
	char bPathSearchOutOfNodes; // 0x3a8(0x01)
	float PathfindingTime; // 0x3ac(0x04)
	float PathCost; // 0x3b0(0x04)
	int32_t PathfindingSteps; // 0x3b4(0x04)
	Unknown OtherActor; // 0x3b8(0x08)
	Unknown FilterClass; // 0x3c0(0x08)
	int32_t ShowStepIndex; // 0x3c8(0x04)
	float OffsetFromCornersDistance; // 0x3cc(0x04)
	Unknown LINKS; // 0x4c0(0x10)
	char bAttachToOwnersRoot; // 0xd4(0x01)
	Unknown CachedNavParent; // 0xd8(0x08)
	uint32_t NavLinkUserId; // 0xe8(0x04)
	Unknown EnabledAreaClass; // 0xf0(0x08)
	Unknown DisabledAreaClass; // 0xf8(0x08)
	Unknown SupportedAgents; // 0x100(0x04)
	Unknown LinkRelativeStart; // 0x104(0x0c)
	Unknown LinkRelativeEnd; // 0x110(0x0c)
	Unknown LinkDirection; // 0x11c(0x01)
	char bLinkEnabled; // 0x120(0x01)
	char bNotifyWhenEnabled; // 0x120(0x01)
	char bNotifyWhenDisabled; // 0x120(0x01)
	char bCreateBoxObstacle; // 0x120(0x01)
	Unknown ObstacleOffset; // 0x124(0x0c)
	Unknown ObstacleExtent; // 0x130(0x0c)
	Unknown ObstacleAreaClass; // 0x140(0x08)
	float BroadcastRadius; // 0x148(0x04)
	float BroadcastInterval; // 0x14c(0x04)
	Unknown BroadcastChannel; // 0x150(0x01)
	Unknown SupportedAgents; // 0x348(0x04)
	Unknown AreaClass; // 0xe0(0x08)
	Unknown FailsafeExtent; // 0xe8(0x0c)
	char bIncludeAgentHeight; // 0xf4(0x01)
	Unknown AreaClass; // 0x350(0x08)
	Unknown NavigationSystemConfig; // 0x310(0x08)
	Unknown OverridePolicy; // 0x318(0x01)
	char bLoadOnClient; // 0x319(0x01)
	char bDrawTriangleEdges; // 0x4f0(0x01)
	char bDrawPolyEdges; // 0x4f0(0x01)
	char bDrawFilledPolys; // 0x4f0(0x01)
	char bDrawNavMeshEdges; // 0x4f0(0x01)
	char bDrawTileBounds; // 0x4f0(0x01)
	char bDrawPathCollidingGeometry; // 0x4f0(0x01)
	char bDrawTileLabels; // 0x4f0(0x01)
	char bDrawPolygonLabels; // 0x4f0(0x01)
	char bDrawDefaultPolygonCost; // 0x4f1(0x01)
	char bDrawLabelsOnPathNodes; // 0x4f1(0x01)
	char bDrawNavLinks; // 0x4f1(0x01)
	char bDrawFailedNavLinks; // 0x4f1(0x01)
	char bDrawClusters; // 0x4f1(0x01)
	char bDrawOctree; // 0x4f1(0x01)
	char bDrawOctreeDetails; // 0x4f1(0x01)
	char bDrawMarkedForbiddenPolys; // 0x4f1(0x01)
	char bDistinctlyDrawTilesBeingBuilt; // 0x4f2(0x01)
	char bDrawNavMesh; // 0x4f2(0x01)
	float DrawOffset; // 0x4f4(0x04)
	char bFixedTilePoolSize; // 0x4f8(0x01)
	int32_t TilePoolSize; // 0x4fc(0x04)
	float TileSizeUU; // 0x500(0x04)
	float CellSize; // 0x504(0x04)
	float CellHeight; // 0x508(0x04)
	float AgentRadius; // 0x50c(0x04)
	float AgentHeight; // 0x510(0x04)
	float AgentMaxHeight; // 0x514(0x04)
	float AgentMaxSlope; // 0x518(0x04)
	float AgentMaxStepHeight; // 0x51c(0x04)
	float MinRegionArea; // 0x520(0x04)
	float MergeRegionSize; // 0x524(0x04)
	float MaxSimplificationError; // 0x528(0x04)
	int32_t MaxSimultaneousTileGenerationJobsCount; // 0x52c(0x04)
	int32_t TileNumberHardLimit; // 0x530(0x04)
	int32_t PolyRefTileBits; // 0x534(0x04)
	int32_t PolyRefNavPolyBits; // 0x538(0x04)
	int32_t PolyRefSaltBits; // 0x53c(0x04)
	Unknown NavMeshOriginOffset; // 0x540(0x0c)
	float DefaultDrawDistance; // 0x54c(0x04)
	float DefaultMaxSearchNodes; // 0x550(0x04)
	float DefaultMaxHierarchicalSearchNodes; // 0x554(0x04)
	Unknown RegionPartitioning; // 0x558(0x01)
	Unknown LayerPartitioning; // 0x559(0x01)
	int32_t RegionChunkSplits; // 0x55c(0x04)
	int32_t LayerChunkSplits; // 0x560(0x04)
	char bSortNavigationAreasByCost; // 0x564(0x01)
	char bPerformVoxelFiltering; // 0x564(0x01)
	char bMarkLowHeightAreas; // 0x564(0x01)
	char bFilterLowSpanSequences; // 0x564(0x01)
	char bFilterLowSpanFromTileCache; // 0x564(0x01)
	char bDoFullyAsyncNavDataGathering; // 0x564(0x01)
	char bUseBetterOffsetsFromCorners; // 0x564(0x01)
	char bStoreEmptyTileLayers; // 0x564(0x01)
	char bUseVirtualFilters; // 0x565(0x01)
	char bAllowNavLinkAsPathEnd; // 0x565(0x01)
	char bUseVoxelCache; // 0x565(0x01)
	float TileSetUpdateInterval; // 0x568(0x04)
	float HeuristicScale; // 0x56c(0x04)
	float VerticalDeviationFromGroundCompensation; // 0x570(0x04)
	Unknown UberGraphFrame; // 0x2a0(0x08)
	Unknown VisualBorder; // 0x2a8(0x08)
	Unknown CollisionEventRegistrations; // 0x1c8(0x50)
	Unknown BreakEventRegistrations; // 0x218(0x50)
	float TimeStepMultiplier; // 0x310(0x04)
	int32_t CollisionIterations; // 0x314(0x04)
	int32_t PushOutIterations; // 0x318(0x04)
	int32_t PushOutPairIterations; // 0x31c(0x04)
	float ClusterConnectionFactor; // 0x320(0x04)
	Unknown ClusterUnionConnectionType; // 0x324(0x01)
	char DoGenerateCollisionData; // 0x325(0x01)
	Unknown CollisionFilterSettings; // 0x328(0x10)
	char DoGenerateBreakingData; // 0x338(0x01)
	Unknown BreakingFilterSettings; // 0x33c(0x10)
	char DoGenerateTrailingData; // 0x34c(0x01)
	Unknown TrailingFilterSettings; // 0x350(0x10)
	char bHasFloor; // 0x360(0x01)
	float FloorHeight; // 0x364(0x04)
	float MassScale; // 0x368(0x04)
	char bGenerateContactGraph; // 0x36c(0x01)
	Unknown ChaosDebugSubstepControl; // 0x36d(0x03)
	Unknown SpriteComponent; // 0x370(0x08)
	Unknown GameplayEventDispatcherComponent; // 0x390(0x08)
	Unknown DefaultChaosSolverActorClass; // 0x40(0x18)
	Unknown FieldSystemComponent; // 0x310(0x08)
	Unknown FieldSystem; // 0x4b8(0x08)
	Unknown SupportedSolvers; // 0x4d0(0x10)
	int32_t Iterations; // 0xb0(0x04)
	Unknown ResolutionType; // 0xb0(0x01)
	int32_t Magnitude; // 0xb0(0x04)
	float Radius; // 0xb0(0x04)
	Unknown Position; // 0xb4(0x0c)
	int32_t InteriorValue; // 0xc0(0x04)
	int32_t ExteriorValue; // 0xc4(0x04)
	Unknown SetMaskCondition; // 0xc8(0x01)
	...
	Unknown Position; // 0xc4(0x0c)
	Unknown Falloff; // 0xd0(0x01)
	float Magnitude; // 0xb0(0x04)
	float MinRange; // 0xb4(0x04)
	float MaxRange; // 0xb8(0x04)
	float Default; // 0xbc(0x04)
	...
	Unknown Position; // 0xc4(0x0c)
	Unknown Normal; // 0xd0(0x0c)
	Unknown Falloff; // 0xdc(0x01)
	float Magnitude; // 0xb0(0x04)
	float MinRange; // 0xb4(0x04)
	float MaxRange; // 0xb8(0x04)
	float Default; // 0xbc(0x04)
	Unknown Transform; // 0xc0(0x30)
	Unknown Falloff; // 0xf0(0x01)
	float MinRange; // 0xb0(0x04)
	float MaxRange; // 0xb4(0x04)
	Unknown Transform; // 0xc0(0x30)
	float Magnitude; // 0xb0(0x04)
	Unknown Direction; // 0xb4(0x0c)
	float Magnitude; // 0xb0(0x04)
	Unknown Position; // 0xb4(0x0c)
	float Magnitude; // 0xb0(0x04)
	float Magnitude; // 0xb0(0x04)
	Unknown RightField; // 0xb8(0x08)
	Unknown LeftField; // 0xc0(0x08)
	Unknown Operation; // 0xc8(0x01)
	Unknown FloatField; // 0xb0(0x08)
	Unknown IntField; // 0xb0(0x08)
	Unknown Culling; // 0xb0(0x08)
	Unknown Field; // 0xb8(0x08)
	Unknown Operation; // 0xc0(0x01)
	char bIsCollisionEventListeningEnabled; // 0x238(0x01)
	char bIsBreakingEventListeningEnabled; // 0x238(0x01)
	char bIsTrailingEventListeningEnabled; // 0x238(0x01)
	Unknown CollisionEventRequestSettings; // 0x23c(0x18)
	Unknown BreakingEventRequestSettings; // 0x254(0x18)
	Unknown TrailingEventRequestSettings; // 0x26c(0x18)
	Unknown ChaosSolverActors; // 0x288(0x50)
	Unknown GeometryCollectionActors; // 0x2d8(0x50)
	...
	Unknown GeometryCollectionComponent; // 0x310(0x08)
	Unknown GeometryCollectionDebugDrawComponent; // 0x318(0x08)
	Unknown RecordedData; // 0x28(0x10)
	Unknown SupportedCollection; // 0x38(0x08)
	Unknown CompatibleCollectionState; // 0x40(0x10)
	Unknown ChaosSolverActor; // 0x4f0(0x08)
	Unknown RestCollection; // 0x5d8(0x08)
	Unknown InitializationFields; // 0x5e0(0x10)
	char Simulating; // 0x5f0(0x01)
	Unknown ObjectType; // 0x5f8(0x01)
	char EnableClustering; // 0x5f9(0x01)
	int32_t ClusterGroupIndex; // 0x5fc(0x04)
	int32_t MaxClusterLevel; // 0x600(0x04)
	Unknown DamageThreshold; // 0x608(0x10)
	Unknown ClusterConnectionType; // 0x618(0x01)
	int32_t CollisionGroup; // 0x61c(0x04)
	float CollisionSampleFraction; // 0x620(0x04)
	float LinearEtherDrag; // 0x624(0x04)
	float AngularEtherDrag; // 0x628(0x04)
	Unknown PhysicalMaterial; // 0x630(0x08)
	Unknown InitialVelocityType; // 0x638(0x01)
	Unknown InitialLinearVelocity; // 0x63c(0x0c)
	Unknown InitialAngularVelocity; // 0x648(0x0c)
	Unknown CacheParameters; // 0x658(0x50)
	struct FMulticastInlineDelegate NotifyGeometryCollectionPhysicsStateChange; // 0x6a8(0x10)
	struct FMulticastInlineDelegate NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x6b8(0x10)
	struct FMulticastInlineDelegate OnChaosBreakEvent; // 0x6e0(0x10)
	float DesiredCacheTime; // 0x6f0(0x04)
	char CachePlayback; // 0x6f4(0x01)
	struct FMulticastInlineDelegate OnChaosPhysicsCollision; // 0x6f8(0x10)
	char bNotifyBreaks; // 0x708(0x01)
	char bNotifyCollisions; // 0x709(0x01)
	Unknown DummyBodySetup; // 0x968(0x08)
	Unknown WarningMessage; // 0x310(0x01)
	Unknown SelectedRigidBody; // 0x318(0x18)
	char bDebugDrawWholeCollection; // 0x330(0x01)
	char bDebugDrawHierarchy; // 0x331(0x01)
	char bDebugDrawClustering; // 0x332(0x01)
	Unknown HideGeometry; // 0x333(0x01)
	char bShowRigidBodyId; // 0x334(0x01)
	char bShowRigidBodyCollision; // 0x335(0x01)
	char bCollisionAtOrigin; // 0x336(0x01)
	char bShowRigidBodyTransform; // 0x337(0x01)
	char bShowRigidBodyInertia; // 0x338(0x01)
	char bShowRigidBodyVelocity; // 0x339(0x01)
	char bShowRigidBodyForce; // 0x33a(0x01)
	char bShowRigidBodyInfos; // 0x33b(0x01)
	char bShowTransformIndex; // 0x33c(0x01)
	char bShowTransform; // 0x33d(0x01)
	char bShowParent; // 0x33e(0x01)
	char bShowLevel; // 0x33f(0x01)
	char bShowConnectivityEdges; // 0x340(0x01)
	char bShowGeometryIndex; // 0x341(0x01)
	char bShowGeometryTransform; // 0x342(0x01)
	char bShowBoundingBox; // 0x343(0x01)
	char bShowFaces; // 0x344(0x01)
	char bShowFaceIndices; // 0x345(0x01)
	char bShowFaceNormals; // 0x346(0x01)
	char bShowSingleFace; // 0x347(0x01)
	int32_t SingleFaceIndex; // 0x348(0x04)
	char bShowVertices; // 0x34c(0x01)
	char bShowVertexIndices; // 0x34d(0x01)
	char bShowVertexNormals; // 0x34e(0x01)
	char bUseActiveVisualization; // 0x34f(0x01)
	float PointThickness; // 0x350(0x04)
	float LineThickness; // 0x354(0x04)
	char bTextShadow; // 0x358(0x01)
	float TextScale; // 0x35c(0x04)
	float NormalScale; // 0x360(0x04)
	float AxisScale; // 0x364(0x04)
	float ArrowScale; // 0x368(0x04)
	Unknown RigidBodyIdColor; // 0x36c(0x04)
	float RigidBodyTransformScale; // 0x370(0x04)
	Unknown RigidBodyCollisionColor; // 0x374(0x04)
	Unknown RigidBodyInertiaColor; // 0x378(0x04)
	Unknown RigidBodyVelocityColor; // 0x37c(0x04)
	Unknown RigidBodyForceColor; // 0x380(0x04)
	Unknown RigidBodyInfoColor; // 0x384(0x04)
	Unknown TransformIndexColor; // 0x388(0x04)
	float TransformScale; // 0x38c(0x04)
	Unknown LevelColor; // 0x390(0x04)
	Unknown ParentColor; // 0x394(0x04)
	float ConnectivityEdgeThickness; // 0x398(0x04)
	Unknown GeometryIndexColor; // 0x39c(0x04)
	float GeometryTransformScale; // 0x3a0(0x04)
	Unknown BoundingBoxColor; // 0x3a4(0x04)
	Unknown FaceColor; // 0x3a8(0x04)
	Unknown FaceIndexColor; // 0x3ac(0x04)
	Unknown FaceNormalColor; // 0x3b0(0x04)
	Unknown SingleFaceColor; // 0x3b4(0x04)
	Unknown VertexColor; // 0x3b8(0x04)
	Unknown VertexIndexColor; // 0x3bc(0x04)
	Unknown VertexNormalColor; // 0x3c0(0x04)
	Unknown SpriteComponent; // 0x3c8(0x08)
	Unknown GeometryCollectionDebugDrawActor; // 0xb0(0x08)
	Unknown GeometryCollectionRenderLevelSetActor; // 0xb8(0x08)
	Unknown Materials; // 0x30(0x10)
	Unknown CollisionType; // 0x40(0x01)
	Unknown ImplicitType; // 0x41(0x01)
	...
	Unknown SizeSpecificData; // 0x70(0x10)
	char EnableRemovePiecesOnFracture; // 0x80(0x01)
	Unknown RemoveOnFractureMaterials; // 0x88(0x10)
	Unknown PersistentGuid; // 0x98(0x10)
	Unknown StateGuid; // 0xa8(0x10)
	int32_t BoneSelectedMaterialIndex; // 0xb8(0x04)
	Unknown TargetVolumeTexture; // 0x310(0x08)
	Unknown RayMarchMaterial; // 0x318(0x08)
	float SurfaceTolerance; // 0x320(0x04)
	float Isovalue; // 0x324(0x04)
	char Enabled; // 0x328(0x01)
	char RenderVolumeBoundingBox; // 0x329(0x01)
	Unknown PhysicalMaterial; // 0xb8(0x08)
	Unknown ChaosSolverActor; // 0xc0(0x08)
	Unknown OverridePhysicsAsset; // 0xc8(0x08)
	char bSimulating; // 0xd0(0x01)
	char bNotifyCollisions; // 0xd1(0x01)
	Unknown ObjectType; // 0xd2(0x01)
	float Density; // 0xd4(0x04)
	float MinMass; // 0xd8(0x04)
	float MaxMass; // 0xdc(0x04)
	Unknown CollisionType; // 0xe0(0x01)
	...
	Unknown InitialVelocityType; // 0xfc(0x01)
	Unknown InitialLinearVelocity; // 0x100(0x0c)
	Unknown InitialAngularVelocity; // 0x10c(0x0c)
	struct FMulticastInlineDelegate OnChaosPhysicsCollision; // 0x118(0x10)
	char Simulating; // 0xb8(0x01)
	char bNotifyCollisions; // 0xb9(0x01)
	Unknown ObjectType; // 0xba(0x01)
	float Mass; // 0xbc(0x04)
	Unknown CollisionType; // 0xc0(0x01)
	Unknown ImplicitType; // 0xc1(0x01)
	int32_t MinLevelSetResolution; // 0xc4(0x04)
	int32_t MaxLevelSetResolution; // 0xc8(0x04)
	Unknown InitialVelocityType; // 0xcc(0x01)
	Unknown InitialLinearVelocity; // 0xd0(0x0c)
	Unknown InitialAngularVelocity; // 0xdc(0x0c)
	float DamageThreshold; // 0xe8(0x04)
	Unknown PhysicalMaterial; // 0xf0(0x08)
	Unknown ChaosSolverActor; // 0xf8(0x08)
	struct FMulticastInlineDelegate OnChaosPhysicsCollision; // 0x100(0x10)
	Unknown SimulatedComponents; // 0x120(0x10)
	Unknown InputBehaviors; // 0x30(0x08)
	Unknown AxisSource; // 0x48(0x10)
	Unknown AngleSource; // 0x58(0x10)
	Unknown HitTarget; // 0x68(0x10)
	Unknown StateTarget; // 0x78(0x10)
	char bInInteraction; // 0x88(0x01)
	Unknown RotationOrigin; // 0x8c(0x0c)
	Unknown RotationAxis; // 0x98(0x0c)
	Unknown RotationPlaneX; // 0xa4(0x0c)
	Unknown RotationPlaneY; // 0xb0(0x0c)
	Unknown InteractionStartPoint; // 0xbc(0x0c)
	Unknown InteractionCurPoint; // 0xc8(0x0c)
	float InteractionStartAngle; // 0xd4(0x04)
	float InteractionCurAngle; // 0xd8(0x04)
	Unknown AxisSource; // 0x48(0x10)
	Unknown ParameterSource; // 0x58(0x10)
	Unknown HitTarget; // 0x68(0x10)
	Unknown StateTarget; // 0x78(0x10)
	char bEnableSignedAxis; // 0x88(0x01)
	char bInInteraction; // 0x89(0x01)
	Unknown InteractionOrigin; // 0x8c(0x0c)
	Unknown InteractionAxis; // 0x98(0x0c)
	Unknown InteractionStartPoint; // 0xa4(0x0c)
	Unknown InteractionCurPoint; // 0xb0(0x0c)
	float InteractionStartParameter; // 0xbc(0x04)
	float InteractionCurParameter; // 0xc0(0x04)
	float ParameterSign; // 0xc4(0x04)
	Unknown Origin; // 0x30(0x0c)
	Unknown Direction; // 0x3c(0x0c)
	Unknown Origin; // 0x30(0x0c)
	Unknown Direction; // 0x3c(0x0c)
	Unknown TangentX; // 0x48(0x0c)
	Unknown TangentY; // 0x54(0x0c)
	Unknown Origin; // 0x30(0x0c)
	int32_t AxisIndex; // 0x3c(0x04)
	Unknown Component; // 0x30(0x08)
	int32_t AxisIndex; // 0x38(0x04)
	char bLocalAxes; // 0x3c(0x01)
	Unknown CachedProperties; // 0x40(0x08)
	char bIsPropertySetEnabled; // 0x48(0x01)
	float BrushSize; // 0x50(0x04)
	char bSpecifyRadius; // 0x54(0x01)
	float BrushRadius; // 0x58(0x04)
	float BrushStrength; // 0x5c(0x04)
	float BrushFalloffAmount; // 0x60(0x04)
	char bShowStrength; // 0x64(0x01)
	char bShowFalloff; // 0x65(0x01)
	Unknown InputBehaviors; // 0x48(0x08)
	Unknown ToolPropertyObjects; // 0x50(0x10)
	Unknown BrushProperties; // 0xc0(0x08)
	char bInBrushStroke; // 0xc8(0x01)
	Unknown LastBrushStamp; // 0xcc(0xa8)
	struct TSoftClassPtr<UObject> PropertyClass; // 0x188(0x28)
	Unknown BrushStampIndicator; // 0x1b0(0x08)
	float BrushRadius; // 0x38(0x04)
	float BrushFalloff; // 0x3c(0x04)
	Unknown BrushPosition; // 0x40(0x0c)
	Unknown BrushNormal; // 0x4c(0x0c)
	char bDrawIndicatorLines; // 0x58(0x01)
	char bDrawRadiusCircle; // 0x59(0x01)
	char bDrawFalloffCircle; // 0x5a(0x01)
	int32_t SampleStepCount; // 0x5c(0x04)
	Unknown LineColor; // 0x60(0x10)
	float LineThickness; // 0x70(0x04)
	char bDepthTested; // 0x74(0x01)
	char bDrawSecondaryLines; // 0x75(0x01)
	float SecondaryLineThickness; // 0x78(0x04)
	Unknown SecondaryLineColor; // 0x7c(0x10)
	Unknown AttachedComponent; // 0x90(0x08)
	char bUpdateModifiersDuringDrag; // 0x120(0x01)
	Unknown Color; // 0x4b8(0x10)
	float HoverSizeMultiplier; // 0x4c8(0x04)
	float PixelHitDistanceThreshold; // 0x4cc(0x04)
	Unknown Direction; // 0x4d8(0x0c)
	float Gap; // 0x4e4(0x04)
	float Length; // 0x4e8(0x04)
	float Thickness; // 0x4ec(0x04)
	Unknown Origin; // 0x4d8(0x0c)
	Unknown Rotation; // 0x4f0(0x10)
	Unknown Dimensions; // 0x500(0x0c)
	float LineThickness; // 0x50c(0x04)
	char bRemoveHiddenLines; // 0x510(0x01)
	char bEnableAxisFlip; // 0x511(0x01)
	Unknown Normal; // 0x4d8(0x0c)
	float Radius; // 0x4e4(0x04)
	float Thickness; // 0x4e8(0x04)
	int32_t NumSides; // 0x4ec(0x04)
	char bViewAligned; // 0x4f0(0x01)
	char bOnlyAllowFrontFacingHits; // 0x4f1(0x01)
	Unknown Normal; // 0x4d8(0x0c)
	float HandleSize; // 0x4e4(0x04)
	float Thickness; // 0x4e8(0x04)
	Unknown Direction; // 0x4ec(0x0c)
	float Length; // 0x4f8(0x04)
	char bImageScale; // 0x4fc(0x01)
	Unknown DirectionX; // 0x4d8(0x0c)
	Unknown DirectionY; // 0x4e4(0x0c)
	float OffsetX; // 0x4f0(0x04)
	float OffsetY; // 0x4f4(0x04)
	float LengthX; // 0x4f8(0x04)
	float LengthY; // 0x4fc(0x04)
	float Thickness; // 0x500(0x04)
	Unknown SegmentFlags; // 0x504(0x01)
	Unknown Component; // 0x30(0x08)
	Unknown Behaviors; // 0x28(0x10)
	char bAutoInvalidateOnHover; // 0x28(0x01)
	char bAutoInvalidateOnCapture; // 0x29(0x01)
	Unknown ActiveInputBehaviors; // 0x38(0x08)
	Unknown ActiveGizmos; // 0x30(0x10)
	Unknown GizmoBuilders; // 0x58(0x50)
	Unknown ActiveLeftTool; // 0x30(0x08)
	Unknown ActiveRightTool; // 0x38(0x08)
	Unknown ToolBuilders; // 0x90(0x50)
	Unknown InputRouter; // 0x58(0x08)
	Unknown ToolManager; // 0x60(0x08)
	Unknown GizmoManager; // 0x68(0x08)
	struct TSoftClassPtr<UObject> ToolManagerClass; // 0x70(0x28)
	Unknown UpIntervalComponent; // 0x310(0x08)
	Unknown DownIntervalComponent; // 0x318(0x08)
	Unknown ForwardIntervalComponent; // 0x320(0x08)
	Unknown StateTarget; // 0x38(0x08)
	Unknown TransformProxy; // 0x50(0x08)
	Unknown ActiveComponents; // 0x58(0x10)
	Unknown ActiveGizmos; // 0x68(0x10)
	Unknown AxisYSource; // 0x90(0x08)
	Unknown AxisZSource; // 0x98(0x08)
	Unknown FloatParameterSource; // 0x48(0x10)
	float MinParameter; // 0x58(0x04)
	float MaxParameter; // 0x5c(0x04)
	float Value; // 0x48(0x04)
	Unknown LastChange; // 0x4c(0x08)
	Unknown Value; // 0x48(0x08)
	Unknown LastChange; // 0x50(0x10)
	Unknown AxisSource; // 0x90(0x10)
	Unknown TransformSource; // 0xa0(0x10)
	float Parameter; // 0xb0(0x04)
	Unknown LastChange; // 0xb4(0x08)
	Unknown CurTranslationAxis; // 0xbc(0x0c)
	Unknown CurTranslationOrigin; // 0xc8(0x0c)
	Unknown InitialTransform; // 0xe0(0x30)
	Unknown AxisSource; // 0x90(0x10)
	Unknown TransformSource; // 0xa0(0x10)
	Unknown Parameter; // 0xb0(0x08)
	Unknown LastChange; // 0xb8(0x10)
	Unknown CurTranslationOrigin; // 0xc8(0x0c)
	Unknown CurTranslationNormal; // 0xd4(0x0c)
	Unknown CurTranslationAxisX; // 0xe0(0x0c)
	Unknown CurTranslationAxisY; // 0xec(0x0c)
	Unknown InitialTransform; // 0x100(0x30)
	Unknown AxisSource; // 0x48(0x10)
	Unknown TransformSource; // 0x58(0x10)
	float Angle; // 0x68(0x04)
	Unknown LastChange; // 0x6c(0x08)
	Unknown CurRotationAxis; // 0x74(0x0c)
	Unknown CurRotationOrigin; // 0x80(0x0c)
	Unknown InitialTransform; // 0x90(0x30)
	Unknown AxisSource; // 0x48(0x10)
	Unknown TransformSource; // 0x58(0x10)
	float ScaleMultiplier; // 0x68(0x04)
	Unknown Parameter; // 0x6c(0x08)
	Unknown LastChange; // 0x74(0x10)
	Unknown CurScaleOrigin; // 0x84(0x0c)
	Unknown CurScaleNormal; // 0x90(0x0c)
	Unknown CurScaleAxisX; // 0x9c(0x0c)
	Unknown CurScaleAxisY; // 0xa8(0x0c)
	Unknown InitialTransform; // 0xc0(0x30)
	Unknown AxisSource; // 0x48(0x10)
	Unknown TransformSource; // 0x58(0x10)
	float ScaleMultiplier; // 0x68(0x04)
	float Parameter; // 0x6c(0x04)
	Unknown LastChange; // 0x70(0x08)
	Unknown CurScaleAxis; // 0x78(0x0c)
	Unknown CurScaleOrigin; // 0x84(0x0c)
	Unknown InitialTransform; // 0x90(0x30)
	Unknown AxisSource; // 0x90(0x10)
	Unknown TransformSource; // 0xa0(0x10)
	float ScaleMultiplier; // 0xb0(0x04)
	Unknown Parameter; // 0xb4(0x08)
	Unknown LastChange; // 0xbc(0x10)
	Unknown CurScaleOrigin; // 0xcc(0x0c)
	Unknown CurScaleNormal; // 0xd8(0x0c)
	Unknown CurScaleAxisX; // 0xe4(0x0c)
	Unknown CurScaleAxisY; // 0xf0(0x0c)
	Unknown InitialTransform; // 0x100(0x30)
	Unknown AxisSource; // 0x48(0x10)
	Unknown ParameterSource; // 0x58(0x10)
	Unknown HitTarget; // 0x68(0x10)
	Unknown StateTarget; // 0x78(0x10)
	char bEnableSignedAxis; // 0x88(0x01)
	char bFlipX; // 0x89(0x01)
	char bFlipY; // 0x8a(0x01)
	char bInInteraction; // 0x8b(0x01)
	Unknown InteractionOrigin; // 0x8c(0x0c)
	Unknown InteractionNormal; // 0x98(0x0c)
	Unknown InteractionAxisX; // 0xa4(0x0c)
	Unknown InteractionAxisY; // 0xb0(0x0c)
	Unknown InteractionStartPoint; // 0xbc(0x0c)
	Unknown InteractionCurPoint; // 0xc8(0x0c)
	Unknown InteractionStartParameter; // 0xd4(0x08)
	Unknown InteractionCurParameter; // 0xdc(0x08)
	Unknown ParameterSigns; // 0xe4(0x08)
	Unknown Vertices; // 0x40(0x10)
	Unknown Edges; // 0x50(0x10)
	Unknown Faces; // 0x60(0x10)
	Unknown Groups; // 0x70(0x10)
	char HitTestOnRelease; // 0xc0(0x01)
	Unknown TransactionManager; // 0x50(0x10)
	Unknown TranslateX; // 0x310(0x08)
	Unknown TranslateY; // 0x318(0x08)
	Unknown TranslateZ; // 0x320(0x08)
	Unknown TranslateYZ; // 0x328(0x08)
	Unknown TranslateXZ; // 0x330(0x08)
	Unknown TranslateXY; // 0x338(0x08)
	Unknown RotateX; // 0x340(0x08)
	Unknown RotateY; // 0x348(0x08)
	Unknown RotateZ; // 0x350(0x08)
	Unknown UniformScale; // 0x358(0x08)
	Unknown AxisScaleX; // 0x360(0x08)
	Unknown AxisScaleY; // 0x368(0x08)
	Unknown AxisScaleZ; // 0x370(0x08)
	Unknown PlaneScaleYZ; // 0x378(0x08)
	Unknown PlaneScaleXZ; // 0x380(0x08)
	Unknown PlaneScaleXY; // 0x388(0x08)
	Unknown ActiveTarget; // 0x40(0x08)
	char bSnapToWorldGrid; // 0x48(0x01)
	char bUseContextCoordinateSystem; // 0x49(0x01)
	Unknown CurrentCoordinateSystem; // 0x4c(0x04)
	Unknown ActiveComponents; // 0xe0(0x10)
	Unknown NonuniformScaleComponents; // 0xf0(0x10)
	Unknown ActiveGizmos; // 0x100(0x10)
	Unknown CameraAxisSource; // 0x120(0x08)
	Unknown AxisXSource; // 0x128(0x08)
	Unknown AxisYSource; // 0x130(0x08)
	Unknown AxisZSource; // 0x138(0x08)
	Unknown UnitAxisXSource; // 0x140(0x08)
	Unknown UnitAxisYSource; // 0x148(0x08)
	Unknown UnitAxisZSource; // 0x150(0x08)
	Unknown StateTarget; // 0x158(0x08)
	Unknown ScaledTransformSource; // 0x160(0x08)
	char bRotatePerObject; // 0x70(0x01)
	char bSetPivotMode; // 0x71(0x01)
	Unknown SharedTransform; // 0x90(0x30)
	Unknown InitialSharedTransform; // 0xc0(0x30)
	Unknown Component; // 0x48(0x08)
	char bModifyComponentOnTransform; // 0x50(0x01)
	Unknown ChildTransformSource; // 0x48(0x10)
	Unknown Proxy; // 0x48(0x08)
	struct FString PackageName; // 0x28(0x10)
	struct FString ApplicationDisplayName; // 0x38(0x10)
	Unknown FrameTimingHint; // 0x48(0x01)
	char bProtectedContent; // 0x49(0x01)
	char bManualCallToAppReady; // 0x4a(0x01)
	char bUseMobileRendering; // 0x4b(0x01)
	char bUseVulkan; // 0x4c(0x01)
	Unknown Certificate; // 0x50(0x10)
	Unknown IconModelPath; // 0x60(0x10)
	Unknown IconPortalPath; // 0x70(0x10)
	Unknown LocalizedIconInfos; // 0x80(0x10)
	int32_t VersionCode; // 0x90(0x04)
	int32_t MinimumAPILevel; // 0x94(0x04)
	Unknown AppPrivileges; // 0x98(0x10)
	Unknown ExtraComponentSubElements; // 0xa8(0x10)
	Unknown ExtraComponentElements; // 0xb8(0x10)
	...
	char bRemoveDebugInfo; // 0xfc(0x01)
	Unknown VulkanValidationLayerLibs; // 0x100(0x10)
	char bFrameVignette; // 0x110(0x01)
	Unknown LocalizedAppNames; // 0x118(0x10)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Canvas; // 0x250(0x08)
	Unknown CenterCursor; // 0x258(0x08)
	Unknown DisplayText; // 0x260(0x08)
	Unknown Image; // 0x268(0x08)
	Unknown Image_2; // 0x270(0x08)
	Unknown Image_3; // 0x278(0x08)
	Unknown Image_4; // 0x280(0x08)
	Unknown Image_5; // 0x288(0x08)
	Unknown Image_6; // 0x290(0x08)
	Unknown Image_7; // 0x298(0x08)
	Unknown Image_274; // 0x2a0(0x08)
	Unknown Message0; // 0x2a8(0x08)
	Unknown Message2; // 0x2b0(0x08)
	Unknown Message3; // 0x2b8(0x08)
	Unknown Message3_1; // 0x2c0(0x08)
	Unknown Message3_2; // 0x2c8(0x08)
	Unknown Message3_3; // 0x2d0(0x08)
	Unknown Message3_4; // 0x2d8(0x08)
	Unknown Message3_5; // 0x2e0(0x08)
	Unknown Message3_6; // 0x2e8(0x08)
	Unknown Message3_7; // 0x2f0(0x08)
	Unknown Message3_8; // 0x2f8(0x08)
	Unknown Message4; // 0x300(0x08)
	Unknown Message5; // 0x308(0x08)
	Unknown Message6; // 0x310(0x08)
	Unknown Message7; // 0x318(0x08)
	Unknown Messgae1; // 0x320(0x08)
	Unknown Over1; // 0x328(0x08)
	Unknown Over2; // 0x330(0x08)
	Unknown Over3; // 0x338(0x08)
	Unknown Over4; // 0x340(0x08)
	Unknown Over5; // 0x348(0x08)
	Unknown Over6; // 0x350(0x08)
	Unknown Over7; // 0x358(0x08)
	Unknown Over8; // 0x360(0x08)
	Unknown Slot0; // 0x368(0x08)
	Unknown Slot1; // 0x370(0x08)
	Unknown Slot2; // 0x378(0x08)
	Unknown Slot3; // 0x380(0x08)
	Unknown Slot4; // 0x388(0x08)
	Unknown Slot5; // 0x390(0x08)
	Unknown Slot6; // 0x398(0x08)
	Unknown Slot7; // 0x3a0(0x08)
	Unknown Type; // 0x3a8(0x08)
	Unknown UW-PlayerMarkerWidget; // 0x3b0(0x08)
	Unknown WidgetSwitcher_133; // 0x3b8(0x08)
	Unknown SelectionWidgets; // 0x3c0(0x10)
	Unknown MenuCenter; // 0x3d0(0x08)
	Unknown ReferenceVector; // 0x3d8(0x0c)
	struct FMulticastInlineDelegate Selected; // 0x3e8(0x10)
	Unknown SmartPingComponent; // 0x3f8(0x08)
	Unknown RadialMenuMaterial; // 0x400(0x08)
	int32_t SelectedIndex; // 0x408(0x04)
	int32_t StartIndex; // 0x40c(0x04)
	float AngleSize; // 0x410(0x04)
	float DistanceFromCenter; // 0x414(0x04)
	int32_t Divisions; // 0x418(0x04)
	float SelectionToleranceFromCenter; // 0x41c(0x04)
	struct FMulticastInlineDelegate Hovered; // 0x420(0x10)
	struct FMulticastInlineDelegate ClearPing; // 0x430(0x10)
	char IsPingType; // 0x440(0x01)
	char Enable RequestMessage; // 0x441(0x01)
	Unknown Chat Scrollbox; // 0x248(0x08)
	struct FString Group; // 0x250(0x10)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown B_Value; // 0x250(0x08)
	Unknown Check; // 0x258(0x08)
	Unknown G_Value; // 0x260(0x08)
	Unknown Image_166; // 0x268(0x08)
	Unknown Land; // 0x270(0x08)
	Unknown Land_2; // 0x278(0x08)
	Unknown Land_3; // 0x280(0x08)
	Unknown Land_4; // 0x288(0x08)
	Unknown Land_5; // 0x290(0x08)
	Unknown Land_6; // 0x298(0x08)
	Unknown R_5; // 0x2a0(0x08)
	Unknown R_7; // 0x2a8(0x08)
	Unknown R_9; // 0x2b0(0x08)
	Unknown R_Value; // 0x2b8(0x08)
	Unknown TextBlock_4; // 0x2c0(0x08)
	Unknown TextBlock_5; // 0x2c8(0x08)
	Unknown TextBlock_6; // 0x2d0(0x08)
	Unknown TextBlock_8; // 0x2d8(0x08)
	Unknown TextBlock_9; // 0x2e0(0x08)
	Unknown TextBlock_10; // 0x2e8(0x08)
	Unknown Timer; // 0x2f0(0x08)
	Unknown UberGraphFrame; // 0x210(0x08)
	char NeedToChangeHand; // 0x218(0x01)
	float CrntAxisValue; // 0x21c(0x04)
	float GoalLocationZ; // 0x220(0x04)
	char NeedMoveOnLadder; // 0x224(0x01)
	float MotionMinAlpha; // 0x228(0x04)
	char CanStopMotion; // 0x22c(0x01)
	float DirectSnapLocZ; // 0x230(0x04)
	float DeltaSecond; // 0x234(0x04)
	float LastSecond; // 0x238(0x04)
	int32_t AdditionalStepCount; // 0x23c(0x04)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown CanvasPanel_1; // 0x250(0x08)
	Unknown Image; // 0x258(0x08)
	Unknown Image_2; // 0x260(0x08)
	...
	Unknown SeatIcons; // 0x270(0x08)
	Unknown WheelIcons; // 0x278(0x08)
	Unknown Image_362; // 0x248(0x08)
	Unknown Image_552; // 0x250(0x08)
	Unknown RichTextBlock_74; // 0x258(0x08)
	Unknown Tire_RL; // 0x460(0x08)
	Unknown Tire_FL; // 0x468(0x08)
	Unknown Tire_RR; // 0x470(0x08)
	Unknown Tire_FR; // 0x478(0x08)
	...
	Unknown DefaultSceneRoot; // 0x488(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Ani_Gold; // 0x250(0x08)
	Unknown 1; // 0x258(0x08)
	Unknown 10; // 0x260(0x08)
	Unknown 100; // 0x268(0x08)
	Unknown 1000; // 0x270(0x08)
	Unknown BonusBG; // 0x278(0x08)
	Unknown BrightSpot_01; // 0x280(0x08)
	Unknown BrightSpot_02; // 0x288(0x08)
	Unknown BrightSpot_03; // 0x290(0x08)
	Unknown BrightSpot_04; // 0x298(0x08)
	Unknown BrightSpot_05; // 0x2a0(0x08)
	Unknown Empty; // 0x2a8(0x08)
	Unknown Glow_01; // 0x2b0(0x08)
	Unknown Gold; // 0x2b8(0x08)
	Unknown Image_7; // 0x2c0(0x08)
	Unknown Image_11; // 0x2c8(0x08)
	Unknown Image_14; // 0x2d0(0x08)
	Unknown Image_15; // 0x2d8(0x08)
	Unknown Image_16; // 0x2e0(0x08)
	Unknown Image_17; // 0x2e8(0x08)
	Unknown Image_18; // 0x2f0(0x08)
	Unknown Image_20; // 0x2f8(0x08)
	Unknown Image_21; // 0x300(0x08)
	Unknown Image_22; // 0x308(0x08)
	Unknown Image_23; // 0x310(0x08)
	Unknown Image_335; // 0x318(0x08)
	Unknown Image_1473; // 0x320(0x08)
	Unknown Light; // 0x328(0x08)
	Unknown Light_01; // 0x330(0x08)
	Unknown Light_02; // 0x338(0x08)
	Unknown Light_03; // 0x340(0x08)
	Unknown Light_04; // 0x348(0x08)
	Unknown Light_05; // 0x350(0x08)
	Unknown Light_06; // 0x358(0x08)
	Unknown PickUpGold; // 0x360(0x08)
	Unknown RIng_Glow_01; // 0x368(0x08)
	Unknown TextBlock_4; // 0x370(0x08)
	Unknown TextLight_2; // 0x378(0x08)
	Unknown TextLight_3; // 0x380(0x08)
	int32_t Save; // 0x388(0x04)
	char NewVar_1; // 0x38c(0x01)
	char IsStopSound; // 0x38d(0x01)
	float LoopSountStartTime; // 0x390(0x04)
	Unknown LoopSound; // 0x394(0x04)
	float LoopSountEndTime; // 0x398(0x04)
	float 1StartTime; // 0x39c(0x04)
	float 10StartTime; // 0x3a0(0x04)
	float 100StartTime; // 0x3a4(0x04)
	float 1000StartTime; // 0x3a8(0x04)
	float FinStartTime; // 0x3ac(0x04)
	Unknown UberGraphFrame; // 0x258(0x08)
	Unknown Anim_Hide; // 0x260(0x08)
	Unknown Anim_Down; // 0x268(0x08)
	Unknown HorizontalBox_Killer; // 0x270(0x08)
	Unknown ScaleBox_KillerIcon; // 0x278(0x08)
	Unknown T_ClassIcon; // 0x280(0x08)
	Unknown T_Level; // 0x288(0x08)
	Unknown T_LV; // 0x290(0x08)
	Unknown T_Name; // 0x298(0x08)
	struct FMulticastInlineDelegate OnTimeOut; // 0x2a0(0x10)
	Unknown LocalPlayerState; // 0x2b0(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Anim_OnFire; // 0x250(0x08)
	Unknown FireLine; // 0x258(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Anim_MoveUp_HUD; // 0x250(0x08)
	Unknown Anim_MoveRight; // 0x258(0x08)
	Unknown Anim_MoveUp; // 0x260(0x08)
	Unknown UW-StatupWidget_Item_Attack; // 0x268(0x08)
	Unknown UW-StatupWidget_Item_Capacity; // 0x270(0x08)
	Unknown UW-StatupWidget_Item_Damage; // 0x278(0x08)
	Unknown UW-StatupWidget_Item_Decrement; // 0x280(0x08)
	Unknown UW-StatupWidget_Item_Health; // 0x288(0x08)
	Unknown UW-StatupWidget_Item_Speed; // 0x290(0x08)
	Unknown VerticalBox_Stats; // 0x298(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Button_1; // 0x250(0x08)
	Unknown death; // 0x258(0x08)
	Unknown Image_168; // 0x260(0x08)
	Unknown Image_216; // 0x268(0x08)
	Unknown Image_506; // 0x270(0x08)
	Unknown Image_623; // 0x278(0x08)
	Unknown Img_LogOut; // 0x280(0x08)
	Unknown Img_Voice; // 0x288(0x08)
	Unknown Img_Voice_2; // 0x290(0x08)
	Unknown Overlay_Death; // 0x298(0x08)
	Unknown Slider_139; // 0x2a0(0x08)
	Unknown T_PlayerIndex; // 0x2a8(0x08)
	Unknown T_PlayerName; // 0x2b0(0x08)
	Unknown TextBlock_209; // 0x2b8(0x08)
	Unknown VerticalBox_1; // 0x2c0(0x08)
	Unknown WidgetSwitcher; // 0x2c8(0x08)
	struct FMulticastInlineDelegate EventDispatcher_ChangeVolumeState; // 0x2d0(0x10)
	Unknown CurVoiceTalkState; // 0x2e0(0x20)
	Unknown PingImage; // 0x300(0x08)
	Unknown UberGraphFrame; // 0x1360(0x08)
	Unknown Anim_Material_Get; // 0x1368(0x08)
	Unknown Anim_Material_Hover; // 0x1370(0x08)
	Unknown Anim_Upgrade; // 0x1378(0x08)
	Unknown Anim_Progress; // 0x1380(0x08)
	Unknown Abillity; // 0x1388(0x08)
	Unknown AbillityBG; // 0x1390(0x08)
	Unknown AbillityValue; // 0x1398(0x08)
	Unknown Bg; // 0x13a0(0x08)
	Unknown Bg_3; // 0x13a8(0x08)
	Unknown BorderBG; // 0x13b0(0x08)
	Unknown BorderBG_3; // 0x13b8(0x08)
	Unknown btn_HelmetTree; // 0x13c0(0x08)
	Unknown ChoiceBG; // 0x13c8(0x08)
	Unknown ChoiceBG_3; // 0x13d0(0x08)
	Unknown DefenseBG; // 0x13d8(0x08)
	Unknown DefenseBG_3; // 0x13e0(0x08)
	Unknown DurabilityBar; // 0x13e8(0x08)
	Unknown DurabilityBar_3; // 0x13f0(0x08)
	Unknown EmptyBG; // 0x13f8(0x08)
	Unknown EmptyBG_3; // 0x1400(0x08)
	Unknown Image; // 0x1408(0x08)
	Unknown Image_197; // 0x1410(0x08)
	Unknown Image_234; // 0x1418(0x08)
	Unknown Image_279; // 0x1420(0x08)
	Unknown Image_491; // 0x1428(0x08)
	Unknown Image_682; // 0x1430(0x08)
	Unknown ItemImage; // 0x1438(0x08)
	Unknown ItemImage_3; // 0x1440(0x08)
	Unknown OverBG; // 0x1448(0x08)
	Unknown OverBG_3; // 0x1450(0x08)
	Unknown Overlay_1; // 0x1458(0x08)
	Unknown UW-Inventory_MaterialIconSlot; // 0x1460(0x08)
	Unknown UW-StatupWidget; // 0x1468(0x08)
	Unknown WidgetSwitcher_3; // 0x1470(0x08)
	Unknown WearableItemType; // 0x1478(0x01)
	char IsDefense; // 0x1479(0x01)
	Unknown HoverWidget; // 0x1480(0x08)
	Unknown HoverOwnerWidget; // 0x1488(0x08)
	int32_t SwitcherIndex; // 0x1490(0x04)
	Unknown UberGraphFrame; // 0x2e8(0x08)
	Unknown Anim_Glow; // 0x2f0(0x08)
	Unknown HideFreeSupply; // 0x2f8(0x08)
	Unknown ShowFreeSupply; // 0x300(0x08)
	Unknown LevelUp; // 0x308(0x08)
	Unknown Ability_Defense; // 0x310(0x08)
	Unknown Ability_Speed; // 0x318(0x08)
	Unknown Ability_Power; // 0x320(0x08)
	Unknown Survive_FadeInOut; // 0x328(0x08)
	Unknown Anim_LevelUpDefense; // 0x330(0x08)
	Unknown Anim_LevelUpSpeed; // 0x338(0x08)
	Unknown Anim_LevelUpPower; // 0x340(0x08)
	Unknown btn_ItemTree; // 0x348(0x08)
	Unknown btn_PerkDeckDisabled; // 0x350(0x08)
	Unknown btn_PerkDeckDisabled_2; // 0x358(0x08)
	Unknown btn_PerkDeckEnabled; // 0x360(0x08)
	Unknown btn_PerkDeckEnabled_2; // 0x368(0x08)
	Unknown Canvas_BG; // 0x370(0x08)
	Unknown Canvas_ChangeClass; // 0x378(0x08)
	Unknown Canvas_ChangeDisable; // 0x380(0x08)
	Unknown Canvas_ChangeDisable_2; // 0x388(0x08)
	Unknown Canvas_ChangeEnable; // 0x390(0x08)
	Unknown Canvas_ChangeEnable_2; // 0x398(0x08)
	Unknown Canvas_ChangeSupply; // 0x3a0(0x08)
	Unknown Canvas_LevelupEffect; // 0x3a8(0x08)
	Unknown Canvas_Main; // 0x3b0(0x08)
	Unknown Canvas_Perk; // 0x3b8(0x08)
	Unknown Canvas_SupplyButton; // 0x3c0(0x08)
	Unknown Canvas_UltimateEffect; // 0x3c8(0x08)
	Unknown Canvas_UltimateLightEffect; // 0x3d0(0x08)
	Unknown HorizontalBox_300; // 0x3d8(0x08)
	Unknown HorizontalBox_303; // 0x3e0(0x08)
	Unknown HorizontalBox_Stat; // 0x3e8(0x08)
	Unknown HorizontalBox_UnlockLevel; // 0x3f0(0x08)
	Unknown Image; // 0x3f8(0x08)
	Unknown Image_5; // 0x400(0x08)
	Unknown Image_86; // 0x408(0x08)
	Unknown Image_126; // 0x410(0x08)
	Unknown Image_163; // 0x418(0x08)
	Unknown Image_180; // 0x420(0x08)
	Unknown Image_200; // 0x428(0x08)
	Unknown Image_203; // 0x430(0x08)
	Unknown Image_222; // 0x438(0x08)
	Unknown Image_384; // 0x440(0x08)
	Unknown Image_387; // 0x448(0x08)
	Unknown Image_388; // 0x450(0x08)
	Unknown Image_389; // 0x458(0x08)
	Unknown Image_485; // 0x460(0x08)
	Unknown Image_571; // 0x468(0x08)
	Unknown Image_1098; // 0x470(0x08)
	Unknown Image_1100; // 0x478(0x08)
	Unknown Image_1104; // 0x480(0x08)
	Unknown Image_Cycle; // 0x488(0x08)
	Unknown Image_Cycle_2; // 0x490(0x08)
	Unknown IMG_ClassIcon; // 0x498(0x08)
	Unknown IMG_PerkDeckIcon; // 0x4a0(0x08)
	Unknown IMG_Supply; // 0x4a8(0x08)
	Unknown IMG_UltimatedSkill; // 0x4b0(0x08)
	Unknown InvalidationBox_1; // 0x4b8(0x08)
	Unknown KeyImageWidget; // 0x4c0(0x08)
	Unknown NotEnoughGold; // 0x4c8(0x08)
	Unknown Over_Ultimate; // 0x4d0(0x08)
	Unknown Overlay_UltimateKey; // 0x4d8(0x08)
	Unknown Spacer_251; // 0x4e0(0x08)
	Unknown T_ClassName; // 0x4e8(0x08)
	Unknown T_Defense; // 0x4f0(0x08)
	Unknown T_DefenseAnim; // 0x4f8(0x08)
	Unknown T_Power; // 0x500(0x08)
	Unknown T_PowerAnim; // 0x508(0x08)
	Unknown T_Speed; // 0x510(0x08)
	Unknown T_SpeedAnim; // 0x518(0x08)
	Unknown T_UltimateName; // 0x520(0x08)
	Unknown T_UnlockLevel; // 0x528(0x08)
	Unknown T_UnlockLevel2; // 0x530(0x08)
	Unknown T_WeaponName; // 0x538(0x08)
	Unknown TextBlock_2; // 0x540(0x08)
	Unknown TextBlock_3; // 0x548(0x08)
	Unknown TextBlock_4; // 0x550(0x08)
	Unknown TextBlock_9; // 0x558(0x08)
	Unknown TextBlock_ClassLevel; // 0x560(0x08)
	Unknown TextBlock_Count_Blue; // 0x568(0x08)
	Unknown TextBlock_Count_Green; // 0x570(0x08)
	Unknown TextBlock_Count_Red; // 0x578(0x08)
	Unknown TextBlock_Defense; // 0x580(0x08)
	Unknown TextBlock_Power; // 0x588(0x08)
	Unknown TextBlock_Price; // 0x590(0x08)
	Unknown TextBlock_Price_2; // 0x598(0x08)
	Unknown TextBlock_Select; // 0x5a0(0x08)
	Unknown TextBlock_Select_2; // 0x5a8(0x08)
	Unknown TextBlock_Speed; // 0x5b0(0x08)
	Unknown TextBlock_SurviveMessage01; // 0x5b8(0x08)
	Unknown TextBlock_SurviveMessage02; // 0x5c0(0x08)
	Unknown TextBlock_UltimateDesc; // 0x5c8(0x08)
	Unknown Title; // 0x5d0(0x08)
	Unknown UltiLight_001; // 0x5d8(0x08)
	Unknown UltiLight_002; // 0x5e0(0x08)
	Unknown UltiLight_003; // 0x5e8(0x08)
	Unknown UW-Inventory_PerkSlot; // 0x5f0(0x08)
	Unknown UW-Inventory_PerkSlot_2; // 0x5f8(0x08)
	Unknown UW-Inventory_PerkSlot_3; // 0x600(0x08)
	Unknown UW-Inventory_PerkSlot_4; // 0x608(0x08)
	Unknown UW-Inventory_PerkSlot_5; // 0x610(0x08)
	Unknown UW-Inventory_PerkSlot_6; // 0x618(0x08)
	Unknown UW-Inventory_PerkSlot_7; // 0x620(0x08)
	Unknown UW-Inventory_PerkSlot_8; // 0x628(0x08)
	Unknown UW-Inventory_PerkSlot_9; // 0x630(0x08)
	Unknown VB_Health; // 0x638(0x08)
	Unknown VB_Power; // 0x640(0x08)
	Unknown VB_Speed; // 0x648(0x08)
	Unknown VerticalBox_Blue; // 0x650(0x08)
	Unknown VerticalBox_Green; // 0x658(0x08)
	Unknown VerticalBox_Red; // 0x660(0x08)
	Unknown WidgetSwitcher_ChangeClass; // 0x668(0x08)
	Unknown WidgetSwitcher_ChangeSupply; // 0x670(0x08)
	Unknown WidgetSwitcher_TreeAndClass; // 0x678(0x08)
	Unknown WidgetSwitcher_Ultimate; // 0x680(0x08)
	struct FName CurrentPerkDeckName; // 0x688(0x08)
	Unknown CurrentPerkInfos; // 0x690(0x10)
	struct FName ExpertWeaponKey; // 0x6a0(0x08)
	Unknown CurrentPerkCells; // 0x6a8(0x50)
	int32_t PerkMode; // 0x6f8(0x04)
	Unknown HoverWidget; // 0x700(0x08)
	int32_t PowerValue; // 0x708(0x04)
	Unknown TimerHandle_Power; // 0x710(0x08)
	int32_t SpeedValue; // 0x718(0x04)
	Unknown TimerHandle_Speed; // 0x720(0x08)
	int32_t DefenseValue; // 0x728(0x04)
	Unknown TimerHandle_Defense; // 0x730(0x08)
	char bPlayAbilityCountSoundStart; // 0x738(0x01)
	char bPlayAbilityCountSoundEnd; // 0x739(0x01)
	Unknown LevelUpSound; // 0x740(0x08)
	char EnableSupplyBtn; // 0x748(0x01)
	Unknown FreeSupplyTimer; // 0x750(0x08)
	Unknown NotEnoughtGoldTimer; // 0x758(0x08)
	Unknown GainPerkPopups; // 0x760(0x10)
	char IsPlayingUltimateSound; // 0x770(0x01)
	int32_t LastLevel; // 0x774(0x04)
	Unknown PerkDeckClassInfo; // 0x778(0x28)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Button_OK; // 0x250(0x08)
	Unknown Image_337; // 0x258(0x08)
	Unknown Image_581; // 0x260(0x08)
	Unknown Image_583; // 0x268(0x08)
	Unknown Image_584; // 0x270(0x08)
	Unknown Slider_Gamma; // 0x278(0x08)
	Unknown TextBlock_Gamma; // 0x280(0x08)
	Unknown Game Settings; // 0x288(0x08)
	float Gamma Strength Slider Value; // 0x290(0x04)
	struct FText Gamma Strength Edit Value; // 0x298(0x18)
	struct FMulticastInlineDelegate ClosedWidgetDelegate; // 0x2b0(0x10)
	Unknown UberGraphFrame; // 0x298(0x08)
	Unknown ButtomButtonWidget; // 0x2a0(0x08)
	Unknown Image_154; // 0x2a8(0x08)
	Unknown Overlay_1; // 0x2b0(0x08)
	Unknown ScrollBox_55; // 0x2b8(0x08)
	Unknown UniformGridPanel_119; // 0x2c0(0x08)
	Unknown Begin; // 0x2c8(0x01)
	Unknown End; // 0x2c9(0x01)
	Unknown PreSubType; // 0x2ca(0x01)
	struct FMulticastInlineDelegate EventDispatcher_KeyNotiMessage; // 0x2d0(0x10)
	Unknown ScrollBarTimer; // 0x2e0(0x08)
	Unknown List; // 0x2e8(0x50)
	Unknown SubTypeSort; // 0x338(0x10)
	int32_t TempCount; // 0x348(0x04)
	Unknown Hot; // 0x350(0x50)
	float Size; // 0x3a0(0x04)
	Unknown Offset; // 0x3a8(0x50)
	Unknown UberGraphFrame; // 0xb0(0x08)
	Unknown BeamsArray; // 0xb8(0x10)
	Unknown Decal; // 0xc8(0x08)
	Unknown StartLocation; // 0xd0(0x0c)
	Unknown InitialVelocity; // 0xdc(0x0c)
	float PathLifeTime; // 0xe8(0x04)
	float TimeInterval; // 0xec(0x04)
	Unknown DrawingType; // 0xf0(0x01)
	Unknown DesiredStartLocation; // 0xf4(0x0c)
	Unknown InitialLocalVelocity; // 0x100(0x0c)
	Unknown BeamParticle; // 0x110(0x08)
	Unknown DebugColor; // 0x118(0x10)
	float DebugThickness; // 0x128(0x04)
	Unknown ParticleColor; // 0x12c(0x10)
	float ParticleColorMultipler; // 0x13c(0x04)
	Unknown DecalMaterial; // 0x140(0x08)
	Unknown DecalColor; // 0x148(0x10)
	Unknown DecalScale; // 0x158(0x0c)
	char ConstantScale?; // 0x164(0x01)
	Unknown ResizerTimer; // 0x168(0x08)
	Unknown DecalScaleMin; // 0x170(0x0c)
	Unknown DecalScaleMax; // 0x17c(0x0c)
	float ScaleTime; // 0x188(0x04)
	char ScaleStart?; // 0x18c(0x01)
	Unknown Gravity; // 0x190(0x0c)
	float InitXAxisValue; // 0x19c(0x04)
	char CreateBeam; // 0x1a0(0x01)
	int32_t HitBeamIndex; // 0x1a4(0x04)
	Unknown SplineStaticMesh; // 0x1a8(0x08)
	Unknown SplineMeshArray; // 0x1b0(0x10)
	Unknown SM-IndicatorScale; // 0x1c0(0x0c)
	Unknown SM-Indicator; // 0x1d0(0x08)
	char Hit; // 0x1d8(0x01)
	char bForceStop; // 0x1d9(0x01)
	char FPSMode; // 0x1da(0x01)
	char bHideWorkInProgress; // 0x28(0x01)
	...
	Unknown NewAnimation; // 0x248(0x08)
	Unknown Icon; // 0x250(0x08)
	Unknown ImageLine; // 0x258(0x08)
	Unknown Img_Color; // 0x260(0x08)
	Unknown Conflicting Combination; // 0x28(0x08)
	Unknown Conflict Type; // 0x30(0x01)
	...
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Button_Crapting_Btn; // 0x250(0x08)
	Unknown Button_Crapting_Btn_dis; // 0x258(0x08)
	Unknown Image_112; // 0x260(0x08)
	Unknown Img_Gold; // 0x268(0x08)
	Unknown Img_Gold_Inert; // 0x270(0x08)
	Unknown Img_Gold_Inert_2; // 0x278(0x08)
	Unknown RichTextBlock_578; // 0x280(0x08)
	Unknown T_GoldCost; // 0x288(0x08)
	Unknown T_GoldCost_2; // 0x290(0x08)
	Unknown UW-Lobby_Craft_GuideWidget; // 0x298(0x08)
	Unknown UW-Lobby_Craft_List; // 0x2a0(0x08)
	Unknown UW-Lobby_Weapon_Recipe; // 0x2a8(0x08)
	Unknown UW-Lobby_WeaponInfo; // 0x2b0(0x08)
	Unknown UW-Lobby_WeaponInfo_RandomOption; // 0x2b8(0x08)
	Unknown WidgetSwitcher_179; // 0x2c0(0x08)
	Unknown WidgetSwitcher_Gold; // 0x2c8(0x08)
	Unknown CraftingInfo; // 0x2d0(0x128)
	Unknown SelectedButton; // 0x3f8(0x08)
	Unknown UberGraphFrame; // 0x1360(0x08)
	Unknown Abillity; // 0x1368(0x08)
	Unknown AbillityBG; // 0x1370(0x08)
	Unknown AbillityValue; // 0x1378(0x08)
	Unknown Bg; // 0x1380(0x08)
	Unknown BorderBG; // 0x1388(0x08)
	Unknown ChoiceBG; // 0x1390(0x08)
	Unknown DefenseBG; // 0x1398(0x08)
	Unknown DurabilityBar; // 0x13a0(0x08)
	Unknown EmptyBG; // 0x13a8(0x08)
	Unknown ItemImage; // 0x13b0(0x08)
	Unknown OverBG; // 0x13b8(0x08)
	Unknown WearableItemType; // 0x13c0(0x01)
	char IsDefense; // 0x13c1(0x01)
	Unknown HoverWidget; // 0x13c8(0x08)
	Unknown HoverOwnerWidget; // 0x13d0(0x08)
	int32_t Index; // 0x13d8(0x04)
	Unknown UberGraphFrame; // 0x3d8(0x08)
	Unknown BTN-Menu02; // 0x3e0(0x08)
	Unknown CP-SlotInfo; // 0x3e8(0x08)
	Unknown IMG-BG; // 0x3f0(0x08)
	Unknown IMG-BG-Border; // 0x3f8(0x08)
	Unknown IMG-Item; // 0x400(0x08)
	Unknown IMG-Mask; // 0x408(0x08)
	Unknown IMG-Over; // 0x410(0x08)
	Unknown IMG-Over-Border; // 0x418(0x08)
	Unknown Menu02; // 0x420(0x08)
	Unknown Overlay_Mask; // 0x428(0x08)
	Unknown TXT-ItemName; // 0x430(0x08)
	Unknown TXT-Menu01; // 0x438(0x08)
	Unknown TXT-Menu02; // 0x440(0x08)
	Unknown Key Input; // 0x28(0x18)
	char Analog Use Negative Axis; // 0x40(0x01)
	float Analog Previous Axis Value; // 0x44(0x04)
	float Analog Current Axis Value; // 0x48(0x04)
	float World Delta Seconds; // 0x4c(0x04)
	char Input is Using Delta; // 0x50(0x01)
	struct FString Display Name; // 0x58(0x10)
	Unknown UberGraphFrame; // 0x320(0x08)
	Unknown Box2; // 0x328(0x08)
	Unknown Box1; // 0x330(0x08)
	Unknown BravoHotelAudioEmitter; // 0x338(0x08)
	Unknown Upper_Rear_Display_Sub; // 0x340(0x08)
	Unknown Upper_Front_Display_Sub; // 0x348(0x08)
	Unknown Lower_Rear_Display_Sub; // 0x350(0x08)
	Unknown Lower_Front_Display_Sub; // 0x358(0x08)
	Unknown PointBox; // 0x360(0x08)
	Unknown FloorBox; // 0x368(0x08)
	Unknown Main_Display; // 0x370(0x08)
	Unknown Box; // 0x378(0x08)
	Unknown TextRender5; // 0x380(0x08)
	Unknown TextRender7; // 0x388(0x08)
	Unknown TextRender6; // 0x390(0x08)
	Unknown TextRender1; // 0x398(0x08)
	Unknown TextRender4; // 0x3a0(0x08)
	Unknown TextRender3; // 0x3a8(0x08)
	Unknown TextRender; // 0x3b0(0x08)
	Unknown TextRender2; // 0x3b8(0x08)
	Unknown Upper_Front_Button_Area; // 0x3c0(0x08)
	Unknown Upper_Rear_Button_Area; // 0x3c8(0x08)
	Unknown Lower_Rear_Button_Area; // 0x3d0(0x08)
	Unknown Lower_Front_Button_Area; // 0x3d8(0x08)
	Unknown Main_Rear_Button_Area; // 0x3e0(0x08)
	Unknown Main_Front_Button_Area; // 0x3e8(0x08)
	Unknown Main_Front_Button; // 0x3f0(0x08)
	Unknown Main_Rear_Button; // 0x3f8(0x08)
	Unknown Upper_Rear_Display; // 0x400(0x08)
	Unknown Upper_Front_Display; // 0x408(0x08)
	Unknown Lower_Rear_Display; // 0x410(0x08)
	Unknown Lower_Front_Display; // 0x418(0x08)
	Unknown Upper_Rear_Button; // 0x420(0x08)
	Unknown Upper_Front_Button; // 0x428(0x08)
	Unknown Lower_Rear_Button; // 0x430(0x08)
	Unknown Lower_Front_Button; // 0x438(0x08)
	Unknown Upper_Rear_Left; // 0x440(0x08)
	Unknown Upper_Rear_Right; // 0x448(0x08)
	Unknown Upper_Front_Left; // 0x450(0x08)
	Unknown Upper_Front_Right; // 0x458(0x08)
	Unknown Lower_Rear_Right; // 0x460(0x08)
	Unknown Lower_Front_Right; // 0x468(0x08)
	Unknown Lower_Front_Left; // 0x470(0x08)
	Unknown Lower_Rear_Left; // 0x478(0x08)
	Unknown Upper_Rear; // 0x480(0x08)
	Unknown Upper_Front; // 0x488(0x08)
	Unknown Lower_Rear; // 0x490(0x08)
	Unknown Lower_Front; // 0x498(0x08)
	Unknown Upper_Floor; // 0x4a0(0x08)
	Unknown Front_Door; // 0x4a8(0x08)
	Unknown Rear_Door; // 0x4b0(0x08)
	Unknown Lower_Floor; // 0x4b8(0x08)
	Unknown Main_Front_Right; // 0x4c0(0x08)
	Unknown Main_Front_Left; // 0x4c8(0x08)
	Unknown Main_Body; // 0x4d0(0x08)
	Unknown Scene1; // 0x4d8(0x08)
	Unknown Main_Rear_Right; // 0x4e0(0x08)
	Unknown Main_Rear_Left; // 0x4e8(0x08)
	float ElevatorCloseDoor______0_70C4393D45E164D3C8B473964F68015B; // 0x4f0(0x04)
	Unknown ElevatorCloseDoor__Direction_70C4393D45E164D3C8B473964F68015B; // 0x4f4(0x01)
	Unknown ElevatorCloseDoor; // 0x4f8(0x08)
	float LowerMoving______0_95D3AE1045ABFF7C4CC7778EAC04BCDA; // 0x500(0x04)
	Unknown LowerMoving__Direction_95D3AE1045ABFF7C4CC7778EAC04BCDA; // 0x504(0x01)
	Unknown LowerMoving; // 0x508(0x08)
	float ElevatorOpenDoor______0_5DABF5354368A8D3121A6FB4685095FB; // 0x510(0x04)
	Unknown ElevatorOpenDoor__Direction_5DABF5354368A8D3121A6FB4685095FB; // 0x514(0x01)
	Unknown ElevatorOpenDoor; // 0x518(0x08)
	float UpperMoving______0_B6B6057A44D35DFC9C1FCDB8B065C5D0; // 0x520(0x04)
	Unknown UpperMoving__Direction_B6B6057A44D35DFC9C1FCDB8B065C5D0; // 0x524(0x01)
	Unknown UpperMoving; // 0x528(0x08)
	Unknown Upper_Location; // 0x530(0x0c)
	Unknown Body_Position; // 0x53c(0x0c)
	char IsLower; // 0x548(0x01)
	float DoorTravel; // 0x54c(0x04)
	float DoorMoveTime; // 0x550(0x04)
	char IsMoving; // 0x554(0x01)
	Unknown RoomPos; // 0x558(0x0c)
	Unknown MoveFloor; // 0x568(0x08)
	Unknown AddCharacters; // 0x570(0x10)
	float AddMoveOffest; // 0x580(0x04)
	Unknown OpenDoorCompleted; // 0x588(0x08)
	Unknown OpeningDoor; // 0x590(0x08)
	Unknown ClosingDoor; // 0x598(0x08)
	Unknown CloseDoorCompleted; // 0x5a0(0x08)
	Unknown SoundEventForMoved; // 0x5a8(0x08)
	Unknown SoundEventForMoving; // 0x5b0(0x08)
	char IsTraceMoving; // 0x5b8(0x01)
	Unknown TraceLocation; // 0x5bc(0x0c)
	Unknown AttachActors; // 0x5c8(0x10)
	char NewVar_1; // 0x5d8(0x01)
	char NewVar_2; // 0x5d9(0x01)
	Unknown ElevatorAKComponent; // 0x5e0(0x08)
	Unknown ButtonSound; // 0x5e8(0x08)
	Unknown Image_350; // 0x260(0x08)
	Unknown Image_409; // 0x268(0x08)
	Unknown Image_479; // 0x270(0x08)
	Unknown Image_564; // 0x278(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown FadeOut; // 0x250(0x08)
	Unknown HitImage; // 0x258(0x08)
	Unknown SizeBox_1; // 0x260(0x08)
	Unknown InstigatorLocation; // 0x268(0x0c)
	Unknown InstigatorCharacter; // 0x278(0x08)
	struct FString Name; // 0x28(0x10)
	Unknown Key Inputs; // 0x38(0x10)
	Unknown Default Combination; // 0x48(0x10)
	char Can't Be None; // 0x58(0x01)
	Unknown Conflicting Mappings Blocked; // 0x60(0x10)
	Unknown Conflicting Mappings Info; // 0x70(0x10)
	struct FMulticastInlineDelegate Combination Updated; // 0x80(0x10)
	Unknown Parent Mapping; // 0x90(0x08)
	struct FString Action Name; // 0x28(0x10)
	struct FString Category; // 0x38(0x10)
	Unknown Key Mappings; // 0x48(0x10)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Button; // 0x250(0x08)
	Unknown Button Text Block; // 0x258(0x08)
	struct FText Button Text; // 0x260(0x18)
	Unknown Active Text Color; // 0x278(0x10)
	Unknown Inactive Text Color; // 0x288(0x10)
	char Tab Is Active?; // 0x298(0x01)
	Unknown Current Text Color; // 0x29c(0x10)
	Unknown Parent Widget; // 0x2b0(0x08)
	Unknown Chat Switcher Widget; // 0x2b8(0x08)
	Unknown Notification Text Color; // 0x2c0(0x10)
	float Interp Time; // 0x2d0(0x04)
	float Notification Color Hold Time; // 0x2d4(0x04)
	float Notification Fade Time; // 0x2d8(0x04)
	char Fading to Notification?; // 0x2dc(0x01)
	Unknown UberGraphFrame; // 0x3d0(0x08)
	Unknown Camera; // 0x3d8(0x08)
	Unknown SpringArm; // 0x3e0(0x08)
	char bKillCam; // 0x3e8(0x01)
	Unknown UberGraphFrame; // 0x398(0x08)
	float TextureScale; // 0x3a0(0x04)
	float BurnArea; // 0x3a4(0x04)
	Unknown UberGraphFrame; // 0x3c0(0x08)
	Unknown FreeCam; // 0x3c8(0x08)
	Unknown SpringArm; // 0x3d0(0x08)
	Unknown ReplayMainWidget; // 0x3d8(0x08)
	Unknown ViewMode; // 0x3e0(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Disappear; // 0x250(0x08)
	Unknown Finish; // 0x258(0x08)
	Unknown Spin; // 0x260(0x08)
	Unknown Idle; // 0x268(0x08)
	Unknown Image_180; // 0x270(0x08)
	Unknown ItemImage_bg; // 0x278(0x08)
	Unknown ItemImage_Dummy1; // 0x280(0x08)
	Unknown ItemImage_Main; // 0x288(0x08)
	Unknown TextBlock_1; // 0x290(0x08)
	Unknown TextBlock_3; // 0x298(0x08)
	Unknown TextMountablewea; // 0x2a0(0x08)
	Unknown TextMountableweaLV1; // 0x2a8(0x08)
	Unknown PerkInfo; // 0x2b0(0x28)
	Unknown PerkData; // 0x2d8(0xe0)
	char bLevelUp; // 0x3b8(0x01)
	char bFinishing; // 0x3b9(0x01)
	float FinishTime; // 0x3bc(0x04)
	Unknown PerkSlot; // 0x3c0(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	...
	Unknown UberGraphFrame; // 0x4a0(0x08)
	float OverWater_CV_OverWater_77012AB948B572A268E63583418444D0; // 0x4a8(0x04)
	Unknown OverWater__Direction_77012AB948B572A268E63583418444D0; // 0x4ac(0x01)
	Unknown OverWater; // 0x4b0(0x08)
	float HittingWater_CV_OverWater_7E5F9D2E4D0DDDC70F2F67AD035A6212; // 0x4b8(0x04)
	Unknown HittingWater__Direction_7E5F9D2E4D0DDDC70F2F67AD035A6212; // 0x4bc(0x01)
	Unknown HittingWater; // 0x4c0(0x08)
	float LandingTimer; // 0x4c8(0x04)
	Unknown ItemResult; // 0x4d0(0x10)
	float ParachuteTimer; // 0x4e0(0x04)
	float LandingDelay; // 0x4e4(0x04)
	float ForceLandingDelaySeconds; // 0x4e8(0x04)
	char bLandedOnGround; // 0x4ec(0x01)
	Unknown UberGraphFrame; // 0x6d0(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Button_43; // 0x250(0x08)
	Unknown Image_43; // 0x258(0x08)
	struct FMulticastInlineDelegate SelectEventDispatcher; // 0x260(0x10)
	int32_t Index; // 0x270(0x04)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Image_51; // 0x250(0x08)
	float InitSize; // 0x258(0x04)
	Unknown StaticMesh; // 0x310(0x08)
	...
	Unknown UberGraphFrame; // 0x5b8(0x08)
	Unknown Widget_Screen; // 0x5c0(0x08)
	Unknown Widget_World; // 0x5c8(0x08)
	Unknown DefaultSceneRoot; // 0x5d0(0x08)
	Unknown SmartPingWidget_World; // 0x5d8(0x08)
	Unknown DeactivateTimer; // 0x5e0(0x08)
	Unknown SmartPingComponent; // 0x5e8(0x08)
	Unknown ScreenToWorldLocation; // 0x5f0(0x0c)
	float ScreenRotation; // 0x5fc(0x04)
	Unknown HoldSound; // 0x600(0x08)
	Unknown PhaseTimer; // 0x608(0x08)
	Unknown TempWidget; // 0x610(0x08)
	int32_t PingIndex; // 0x618(0x04)
	Unknown SaveTempPingInfo; // 0x620(0x38)
	Unknown LineActor; // 0x658(0x08)
	Unknown SmartPingWidget_Screen; // 0x660(0x08)
	char EnableShow; // 0x668(0x01)
	Unknown Image; // 0x248(0x08)
	Unknown Image_2; // 0x250(0x08)
	Unknown Image_3; // 0x258(0x08)
	Unknown Image_4; // 0x260(0x08)
	Unknown Image_5; // 0x268(0x08)
	Unknown Image_6; // 0x270(0x08)
	Unknown Image_7; // 0x278(0x08)
	Unknown Image_8; // 0x280(0x08)
	Unknown Image_9; // 0x288(0x08)
	Unknown Image_106; // 0x290(0x08)
	Unknown T_Accuracy; // 0x298(0x08)
	Unknown T_EffectiveRange; // 0x2a0(0x08)
	Unknown T_FireRate; // 0x2a8(0x08)
	Unknown T_MagSize; // 0x2b0(0x08)
	Unknown T_Power; // 0x2b8(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown BackgroundBlurFadeIn; // 0x250(0x08)
	Unknown Idle; // 0x258(0x08)
	Unknown BackgroundBlur_1; // 0x260(0x08)
	Unknown BTN-Exit; // 0x268(0x08)
	Unknown Btn-NextTarget; // 0x270(0x08)
	Unknown Btn-PreTarget; // 0x278(0x08)
	Unknown Btn-Replay; // 0x280(0x08)
	...
	Unknown UW-SpectatingTargetInfo; // 0x2a8(0x08)
	char bIsKillCam; // 0x2b0(0x01)
	Unknown MySeatColor; // 0x248(0x10)
	Unknown WheelGroup; // 0x258(0x08)
	Unknown SeatGroup; // 0x260(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Image_ClassIcon; // 0x250(0x08)
	Unknown TextBlock_ClassName; // 0x258(0x08)
	Unknown TextBlock_Count; // 0x260(0x08)
	Unknown UberGraphFrame; // 0x330(0x08)
	Unknown AnimGraphNode_Root; // 0x338(0x30)
	Unknown AnimGraphNode_Slot_3; // 0x368(0x48)
	Unknown AnimGraphNode_TwoWayBlend; // 0x3b0(0xc8)
	...
	Unknown AnimGraphNode_LocalRefPose; // 0x5d8(0x18)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown TextBlock; // 0x250(0x08)
	struct FText SetText; // 0x258(0x18)
	Unknown UberGraphFrame; // 0x1f20(0x08)
	Unknown StaticMesh_Ring; // 0x1f28(0x08)
	Unknown StaticMesh_Lever; // 0x1f30(0x08)
	float Timeline_0_Lerp_77CED3694A7ECD58C02266AF5F5B5991; // 0x1f38(0x04)
	Unknown Timeline_0__Direction_77CED3694A7ECD58C02266AF5F5B5991; // 0x1f3c(0x01)
	Unknown Timeline_1; // 0x1f40(0x08)
	float Lerp_Lerp_EDD5977E4E850EC460B1E599F1FF45F8; // 0x1f48(0x04)
	Unknown Lerp__Direction_EDD5977E4E850EC460B1E599F1FF45F8; // 0x1f4c(0x01)
	Unknown Lerp; // 0x1f50(0x08)
	Unknown InterpOffset; // 0x1f58(0x0c)
	Unknown DesiredLocation; // 0x1f64(0x0c)
	Unknown InitalLocalVelocity; // 0x1f70(0x0c)
	Unknown DesiredLocation_Ing; // 0x1f7c(0x0c)
	Unknown InitalLocalVelocity_Ing; // 0x1f88(0x0c)
	Unknown ThrowingWeaponState; // 0x1f94(0x01)
	char ThrowingAction_Bool; // 0x1f95(0x01)
	Unknown DesiredLocation_3; // 0x1f98(0x0c)
	Unknown DesiredLocation_2_Ing; // 0x1fa4(0x0c)
	Unknown InitalLocalVelocity_3; // 0x1fb0(0x0c)
	Unknown InitalLocalVelocity_2_ing; // 0x1fbc(0x0c)
	float PathLifeTime; // 0x1fc8(0x04)
	float TimeInterval; // 0x1fcc(0x04)
	Unknown IndicatorComponent_2; // 0x1fd0(0x08)
	Unknown IndicatorComponent_3; // 0x1fd8(0x08)
	Unknown TrajectoryComponent_2; // 0x1fe0(0x08)
	Unknown TrajectoryComponent_3; // 0x1fe8(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown WeaponPerk_ani; // 0x250(0x08)
	Unknown Image_102; // 0x258(0x08)
	Unknown Image_254; // 0x260(0x08)
	Unknown Image_Grade_Color_Line; // 0x268(0x08)
	Unknown UberGraphFrame; // 0xab0(0x08)
	Unknown BP-HUDInteractionComponent; // 0xab8(0x08)
	int32_t OpenedWidgetNum; // 0xac0(0x04)
	Unknown ViewMode; // 0xac4(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Bg; // 0x250(0x08)
	Unknown Button_Cancle; // 0x258(0x08)
	Unknown Button_OK; // 0x260(0x08)
	Unknown Image; // 0x268(0x08)
	Unknown Image_168; // 0x270(0x08)
	Unknown Image_423; // 0x278(0x08)
	Unknown Image_853; // 0x280(0x08)
	Unknown Image_1449; // 0x288(0x08)
	Unknown Image_1451; // 0x290(0x08)
	Unknown Image_1452; // 0x298(0x08)
	Unknown Image_1453; // 0x2a0(0x08)
	Unknown Image_1454; // 0x2a8(0x08)
	Unknown Image_1965; // 0x2b0(0x08)
	Unknown Image_1967; // 0x2b8(0x08)
	Unknown Image_1968; // 0x2c0(0x08)
	Unknown Image_1969; // 0x2c8(0x08)
	Unknown Image_1970; // 0x2d0(0x08)
	Unknown Image_1971; // 0x2d8(0x08)
	Unknown Image_1972; // 0x2e0(0x08)
	Unknown Image_1973; // 0x2e8(0x08)
	Unknown Image_1974; // 0x2f0(0x08)
	Unknown Image_1975; // 0x2f8(0x08)
	Unknown Image_1976; // 0x300(0x08)
	Unknown Image_1977; // 0x308(0x08)
	Unknown Image_1978; // 0x310(0x08)
	Unknown Image_2324; // 0x318(0x08)
	Unknown TextBlock_CurrentGold; // 0x320(0x08)
	Unknown TextBlock_Price; // 0x328(0x08)
	Unknown TargetCharacter; // 0x330(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown RichTextBlock_52; // 0x250(0x08)
	...
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Image_2; // 0x250(0x08)
	Unknown Notice; // 0x258(0x08)
	Unknown WidgetSwitcher_1; // 0x260(0x08)
	Unknown UberGraphFrame; // 0x260(0x08)
	Unknown PlayerIconOnDamagingAnimation; // 0x268(0x08)
	Unknown ShirinkingAnimation; // 0x270(0x08)
	Unknown AlertIcon; // 0x278(0x08)
	Unknown BP-CheckWeightMap; // 0x280(0x08)
	Unknown BP-MapComp; // 0x288(0x08)
	Unknown CircleInfoGroup; // 0x290(0x08)
	Unknown CP-MapComp; // 0x298(0x08)
	Unknown CurrentProgressBar; // 0x2a0(0x08)
	Unknown Image_174; // 0x2a8(0x08)
	Unknown Image_766; // 0x2b0(0x08)
	Unknown InvalidationBox_2; // 0x2b8(0x08)
	Unknown LulledGroup; // 0x2c0(0x08)
	Unknown PhaseText; // 0x2c8(0x08)
	Unknown PlayerIconGroup; // 0x2d0(0x08)
	Unknown SB-MapComp; // 0x2d8(0x08)
	Unknown SB_CircleInfo; // 0x2e0(0x08)
	Unknown ShrinkingGroup; // 0x2e8(0x08)
	Unknown Switcher; // 0x2f0(0x08)
	Unknown UW-Inventory_Recipe; // 0x2f8(0x08)
	Unknown UW-SearchingMaterial; // 0x300(0x08)
	int32_t State; // 0x308(0x04)
	Unknown MapSize_Default; // 0x30c(0x08)
	Unknown MapSize_Extend; // 0x314(0x08)
	int32_t InitializeCount; // 0x31c(0x04)
	char bExtendMode; // 0x320(0x01)
	int32_t RecipeCount; // 0x324(0x04)
	Unknown TargetCharacter; // 0x328(0x08)
	Unknown UberGraphFrame; // 0x258(0x08)
	Unknown UW-TeamInfoItemWidget; // 0x260(0x08)
	Unknown UW-TeamInfoItemWidget_C_2; // 0x268(0x08)
	...
	char bCanRequest; // 0x298(0x01)
	char bRequest; // 0x299(0x01)
	...
	Unknown UberGraphFrame; // 0x2e8(0x08)
	Unknown Anim_Healing; // 0x2f0(0x08)
	Unknown HorizontalBox_Health; // 0x2f8(0x08)
	Unknown Image_eager; // 0x300(0x08)
	Unknown SizeBox_main; // 0x308(0x08)
	Unknown Curve_ProgressMaxSizeRatio; // 0x310(0x08)
	float DefaultSlotSize; // 0x318(0x04)
	float MaxHealthSize; // 0x31c(0x04)
	float CurrentHealthSize; // 0x320(0x04)
	float CurrentMaxHealth; // 0x324(0x04)
	Unknown UberGraphFrame; // 0x2c0(0x08)
	Unknown KillMessageList; // 0x2c8(0x08)
	Unknown UW-KillMessageListWidget; // 0x2d0(0x08)
	Unknown UW-KillMessageListWidget_2; // 0x2d8(0x08)
	Unknown UW-KillMessageListWidget_3; // 0x2e0(0x08)
	Unknown UW-KillMessageListWidget_4; // 0x2e8(0x08)
	Unknown UW-KillMessageListWidget_5; // 0x2f0(0x08)
	Unknown UW-KillMessageListWidget_6; // 0x2f8(0x08)
	Unknown UW-KillMessageListWidget_7; // 0x300(0x08)
	Unknown UW-KillMessageListWidget_8; // 0x308(0x08)
	Unknown UW-KillMessageListWidget_9; // 0x310(0x08)
	Unknown UW-KillMessageListWidget_10; // 0x318(0x08)
	Unknown TmpInfoList; // 0x320(0x10)
	Unknown UberGraphFrame; // 0x248(0x08)
	struct FText My Tool Tip Text; // 0x250(0x18)
	...
	char IsActive; // 0x344(0x01)
	Unknown BoostBuffInfo; // 0x348(0x188)
	Unknown Image_1294; // 0x2f8(0x08)
	Unknown UberGraphFrame; // 0x3d8(0x08)
	Unknown BTN-Menu02; // 0x3e0(0x08)
	Unknown BTN-Menu03; // 0x3e8(0x08)
	Unknown BTN-Menu04; // 0x3f0(0x08)
	Unknown BTN-Menu05; // 0x3f8(0x08)
	Unknown BTN-Menu06; // 0x400(0x08)
	Unknown CP-SlotInfo; // 0x408(0x08)
	Unknown IMG-BG; // 0x410(0x08)
	Unknown IMG-BG-Border; // 0x418(0x08)
	Unknown IMG-Item; // 0x420(0x08)
	Unknown IMG-Mask; // 0x428(0x08)
	Unknown IMG-Over; // 0x430(0x08)
	Unknown IMG-Over-Border; // 0x438(0x08)
	Unknown Menu02; // 0x440(0x08)
	Unknown Menu03; // 0x448(0x08)
	Unknown Menu04; // 0x450(0x08)
	Unknown Menu05; // 0x458(0x08)
	Unknown Menu06; // 0x460(0x08)
	Unknown Overlay_Mask; // 0x468(0x08)
	Unknown TXT-Armor; // 0x470(0x08)
	Unknown TXT-Capacity; // 0x478(0x08)
	Unknown TXT-DecreaseReloadTime; // 0x480(0x08)
	Unknown TXT-ItemName; // 0x488(0x08)
	Unknown TXT-Menu01; // 0x490(0x08)
	Unknown TXT-Menu02; // 0x498(0x08)
	Unknown TXT-Menu03; // 0x4a0(0x08)
	Unknown TXT-Menu04; // 0x4a8(0x08)
	Unknown TXT-Menu05; // 0x4b0(0x08)
	Unknown TXT-Menu06; // 0x4b8(0x08)
	Unknown TXT-Type; // 0x4c0(0x08)
	Unknown UberGraphFrame; // 0x270(0x08)
	Unknown Parachute_Loop; // 0x278(0x08)
	Unknown Parachute_Open; // 0x280(0x08)
	Unknown Canvas; // 0x288(0x08)
	Unknown HorizontalBox_Ground; // 0x290(0x08)
	Unknown HorizontalBox_Parachute; // 0x298(0x08)
	Unknown HorizontalBox_Sea; // 0x2a0(0x08)
	Unknown Image_797; // 0x2a8(0x08)
	Unknown Image_798; // 0x2b0(0x08)
	Unknown Overlay_Speed; // 0x2b8(0x08)
	Unknown Parachute; // 0x2c0(0x08)
	Unknown Player; // 0x2c8(0x08)
	Unknown PlayerGroup; // 0x2d0(0x08)
	Unknown SeaHeight; // 0x2d8(0x08)
	Unknown Speed; // 0x2e0(0x08)
	Unknown TerrainHeight; // 0x2e8(0x08)
	char IsParachute; // 0x2f0(0x01)
	Unknown UberGraphFrame; // 0x330(0x08)
	Unknown AnimGraphNode_Root; // 0x338(0x30)
	Unknown AnimGraphNode_Slot_3; // 0x368(0x48)
	Unknown AnimGraphNode_TwoWayBlend; // 0x3b0(0xc8)
	...
	Unknown AnimGraphNode_LocalRefPose; // 0x538(0x18)
	Unknown AnimGraphNode_BlendListByBool; // 0x550(0xa0)
	Unknown UberGraphFrame; // 0xd18(0x08)
	Unknown AdditionalStuntRotation; // 0xd20(0x0c)
	char Pressed_Pitch; // 0xd2c(0x01)
	char Pressed_Roll; // 0xd2d(0x01)
	char AutoRotate_Roll; // 0xd2e(0x01)
	char CanStunt_Roll; // 0xd2f(0x01)
	float StuntValue_Pitch; // 0xd30(0x04)
	float StuntValue_Roll; // 0xd34(0x04)
	float StuntInterpSpeed_Pitch; // 0xd38(0x04)
	float StuntInterpSpeed_Roll; // 0xd3c(0x04)
	float StuntInterpSpeedRate; // 0xd40(0x04)
	float StuntDirection_Pitch; // 0xd44(0x04)
	float StuntDirection_Roll; // 0xd48(0x04)
	float TargetStunt_Pitch; // 0xd4c(0x04)
	float TargetStunt_Roll; // 0xd50(0x04)
	float ParkingForceValue; // 0xd54(0x04)
	float RaisingForceValue; // 0xd58(0x04)
	Unknown Handle_SetParkingForce; // 0xd60(0x08)
	Unknown UberGraphFrame; // 0x310(0x08)
	Unknown Widget; // 0x318(0x08)
	Unknown DefaultSceneRoot; // 0x320(0x08)
	Unknown TargetCharacter; // 0x328(0x08)
	Unknown LoudnessCurve; // 0x330(0x08)
	float HeartBeatSensorLength; // 0x338(0x04)
	Unknown TagetGroundState; // 0x33c(0x01)
	char IsFiring; // 0x33d(0x01)
	Unknown CurrentWeapon; // 0x340(0x08)
	Unknown SingleTimerEvent; // 0x348(0x08)
	char IsSingleFiring; // 0x350(0x01)
	Unknown UberGraphFrame; // 0x310(0x08)
	Unknown Widget; // 0x318(0x08)
	Unknown DefaultSceneRoot; // 0x320(0x08)
	Unknown TargetCharacter; // 0x328(0x08)
	Unknown LoudnessCurve; // 0x330(0x08)
	float AmplifierLength; // 0x338(0x04)
	Unknown TagetGroundState; // 0x33c(0x01)
	char IsFiring; // 0x33d(0x01)
	Unknown CurrentWeapon; // 0x340(0x08)
	Unknown SingleTimerEvent; // 0x348(0x08)
	...
	char IsAnyHit; // 0xd08(0x01)
	Unknown LastHitActor; // 0xd10(0x08)
	Unknown TextBlock_Gold; // 0x248(0x08)
	Unknown TextBlock_Title; // 0x250(0x08)
	Unknown ColorType1; // 0x258(0x28)
	Unknown ColorType2; // 0x280(0x28)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Anim_Show_classinfo; // 0x250(0x08)
	Unknown Button_SpreadList; // 0x258(0x08)
	Unknown Image_323; // 0x260(0x08)
	Unknown UW-ClassinfoitemWidget; // 0x268(0x08)
	Unknown UW-ClassinfoitemWidget_2; // 0x270(0x08)
	Unknown UW-ClassinfoitemWidget_3; // 0x278(0x08)
	Unknown UW-ClassinfoitemWidget_4; // 0x280(0x08)
	Unknown UW-ClassinfoitemWidget_5; // 0x288(0x08)
	Unknown UW-ClassinfoitemWidget_6; // 0x290(0x08)
	Unknown UW-ClassinfoitemWidget_7; // 0x298(0x08)
	Unknown UW-ClassinfoitemWidget_8; // 0x2a0(0x08)
	Unknown UW-ClassinfoitemWidget_9; // 0x2a8(0x08)
	Unknown UW-ClassinfoitemWidget_10; // 0x2b0(0x08)
	Unknown UW-ClassinfoitemWidget_11; // 0x2b8(0x08)
	Unknown UW-ClassinfoitemWidget_12; // 0x2c0(0x08)
	Unknown VerticalBox_ClassBox; // 0x2c8(0x08)
	Unknown VerticalBox_ClassList; // 0x2d0(0x08)
	Unknown VerticalBox_Description; // 0x2d8(0x08)
	Unknown VerticalBox_Main; // 0x2e0(0x08)
	int32_t LastTableRow; // 0x2e8(0x04)
	Unknown ClassInfoItemMap; // 0x2f0(0x50)
	char ListVisibility; // 0x340(0x01)
	Unknown UberGraphFrame; // 0x270(0x08)
	Unknown BT_PlayerName; // 0x278(0x08)
	Unknown PB_HP; // 0x280(0x08)
	Unknown T_PlayerName; // 0x288(0x08)
	Unknown T_PlayerNameHighlight; // 0x290(0x08)
	Unknown T_SortInfo; // 0x298(0x08)
	char bIsTargetPawn; // 0x2a0(0x01)
	char bIsAlive; // 0x2a1(0x01)
	Unknown UberGraphFrame; // 0x260(0x08)
	Unknown Img_TeamColor; // 0x268(0x08)
	Unknown T_TeamNum; // 0x270(0x08)
	Unknown VB_PlayerList; // 0x278(0x08)
	Unknown Image_91; // 0x248(0x08)
	Unknown InventoryCharacterRef; // 0x250(0x08)
	char Visible; // 0x258(0x01)
	Unknown UberGraphFrame; // 0x290(0x08)
	Unknown MarkerBorder; // 0x298(0x08)
	Unknown UberGraphFrame; // 0x3f8(0x08)
	Unknown Ani_PadOn; // 0x400(0x08)
	Unknown BG_Pad; // 0x408(0x08)
	Unknown btn_PerkDeckEnabled; // 0x410(0x08)
	Unknown Canvas_ChangeEnable; // 0x418(0x08)
	Unknown CanvasPanel; // 0x420(0x08)
	Unknown CanvasPanel_3; // 0x428(0x08)
	Unknown ComboBoxString_237; // 0x430(0x08)
	Unknown CurHaveGoldValue; // 0x438(0x08)
	Unknown CurPriceText; // 0x440(0x08)
	Unknown Down; // 0x448(0x08)
	Unknown EquipBg; // 0x450(0x08)
	Unknown Free; // 0x458(0x08)
	Unknown GoldImage; // 0x460(0x08)
	Unknown GoldImage_2; // 0x468(0x08)
	Unknown GoldLack; // 0x470(0x08)
	Unknown HaveWeaponText; // 0x478(0x08)
	Unknown HorizontalBox_1; // 0x480(0x08)
	Unknown Image; // 0x488(0x08)
	Unknown Image_2; // 0x490(0x08)
	Unknown Image_3; // 0x498(0x08)
	Unknown Image_4; // 0x4a0(0x08)
	Unknown Image_5; // 0x4a8(0x08)
	Unknown Image_91; // 0x4b0(0x08)
	Unknown Image_119; // 0x4b8(0x08)
	Unknown Image_172; // 0x4c0(0x08)
	Unknown Image_192; // 0x4c8(0x08)
	Unknown Image_251; // 0x4d0(0x08)
	Unknown Image_362; // 0x4d8(0x08)
	Unknown Image_400; // 0x4e0(0x08)
	Unknown Image_545; // 0x4e8(0x08)
	Unknown Image_552; // 0x4f0(0x08)
	Unknown Image_614; // 0x4f8(0x08)
	Unknown Image_722; // 0x500(0x08)
	Unknown Image_1025; // 0x508(0x08)
	Unknown Image_1262; // 0x510(0x08)
	Unknown ItemIcon; // 0x518(0x08)
	Unknown Items_1Text; // 0x520(0x08)
	Unknown ItemScroll; // 0x528(0x08)
	Unknown ItemsText; // 0x530(0x08)
	Unknown OkText; // 0x538(0x08)
	Unknown Overlay_4; // 0x540(0x08)
	Unknown Overlay_215; // 0x548(0x08)
	Unknown PriceBg; // 0x550(0x08)
	Unknown PriceBg_2; // 0x558(0x08)
	Unknown PriceText; // 0x560(0x08)
	Unknown PriceValue; // 0x568(0x08)
	Unknown RichTextBlock; // 0x570(0x08)
	Unknown RichTextBlock_74; // 0x578(0x08)
	Unknown SizeBox_4; // 0x580(0x08)
	Unknown SlotBg; // 0x588(0x08)
	Unknown SortText; // 0x590(0x08)
	Unknown SpecialWeaponText; // 0x598(0x08)
	Unknown TextBlock_3; // 0x5a0(0x08)
	Unknown Up; // 0x5a8(0x08)
	Unknown UW-PersonalSupplyBoxConsumableItemSlotWidget_2; // 0x5b0(0x08)
	Unknown UW-PersonalSupplyBoxConsumableItemSlotWidget_3; // 0x5b8(0x08)
	Unknown UW-PersonalSupplyBoxConsumableItemSlotWidget_4; // 0x5c0(0x08)
	Unknown UW-PersonalSupplyBoxConsumableItemSlotWidget_5; // 0x5c8(0x08)
	Unknown UW-PersonalSupplyBoxConsumableItemSlotWidget_6; // 0x5d0(0x08)
	Unknown UW-PersonalSupplyBoxWeaponInfoWidget_186; // 0x5d8(0x08)
	Unknown UW-SupplyToolTip; // 0x5e0(0x08)
	Unknown UW-Timer; // 0x5e8(0x08)
	Unknown VerticalBox_1; // 0x5f0(0x08)
	Unknown WeaponScroll; // 0x5f8(0x08)
	Unknown WidgetSwitcher_1; // 0x600(0x08)
	Unknown SortType; // 0x608(0x10)
	Unknown RarityList; // 0x618(0x10)
	Unknown ComboxList; // 0x628(0x50)
	struct FString SelectComboBox; // 0x678(0x10)
	char IsShowAni; // 0x688(0x01)
	char IsFree; // 0x689(0x01)
	Unknown SaveSupplyItem; // 0x690(0x100)
	int32_t CurOwnGold; // 0x790(0x04)
	int32_t TotalPrice; // 0x794(0x04)
	Unknown UberGraphFrame; // 0x2a0(0x08)
	...
	Unknown VisualBorder; // 0x2a8(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Ani_FadeOut; // 0x250(0x08)
	Unknown Ani_FadeIn; // 0x258(0x08)
	Unknown 1; // 0x260(0x08)
	Unknown 10; // 0x268(0x08)
	Unknown 2; // 0x270(0x08)
	Unknown 3; // 0x278(0x08)
	Unknown 4; // 0x280(0x08)
	Unknown 5; // 0x288(0x08)
	Unknown 6; // 0x290(0x08)
	Unknown 7; // 0x298(0x08)
	Unknown 8; // 0x2a0(0x08)
	Unknown 9; // 0x2a8(0x08)
	Unknown Button_GamePlayTutorial; // 0x2b0(0x08)
	Unknown Button_TutorialMovie; // 0x2b8(0x08)
	Unknown Image_62; // 0x2c0(0x08)
	Unknown Light1; // 0x2c8(0x08)
	Unknown Light2; // 0x2d0(0x08)
	Unknown red1; // 0x2d8(0x08)
	Unknown red2; // 0x2e0(0x08)
	Unknown RichTextBlock; // 0x2e8(0x08)
	...
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Canvas_Main; // 0x250(0x08)
	Unknown CB_DrawDeathPosition; // 0x258(0x08)
	Unknown CB_DrawFireDirection; // 0x260(0x08)
	Unknown CB_DrawHitted; // 0x268(0x08)
	Unknown CB_DrawPersonalSupplyBox; // 0x270(0x08)
	Unknown CB_TransportDropBox; // 0x278(0x08)
	Unknown ReplayController; // 0x280(0x08)
	Unknown MainWidget; // 0x288(0x08)
	Unknown PlayerHUD; // 0x290(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	...
	Unknown UberGraphFrame; // 0x360(0x08)
	Unknown Bg; // 0x368(0x08)
	Unknown Border_Timeline; // 0x370(0x08)
	Unknown Border_TimeToGo; // 0x378(0x08)
	Unknown BT_FreeCam; // 0x380(0x08)
	Unknown BT_ReplayPause; // 0x388(0x08)
	Unknown BT_ReplayResume; // 0x390(0x08)
	Unknown BT_SpeedDown; // 0x398(0x08)
	Unknown BT_SpeedUp; // 0x3a0(0x08)
	Unknown BT_TimelineScaleDown; // 0x3a8(0x08)
	Unknown BT_TimelineScaleUp; // 0x3b0(0x08)
	Unknown Canvas_EventMarkers; // 0x3b8(0x08)
	Unknown Chk_ShowKill; // 0x3c0(0x08)
	Unknown Chk_ShowKnockout; // 0x3c8(0x08)
	Unknown Chk_ShowMyKill; // 0x3d0(0x08)
	Unknown Chk_ShowMyKnockout; // 0x3d8(0x08)
	Unknown Chk_ShowMyResuscitated; // 0x3e0(0x08)
	Unknown Chk_ShowResuscitated; // 0x3e8(0x08)
	Unknown ReplayTimelineSlider; // 0x3f0(0x08)
	Unknown ScrollBox_Timeline; // 0x3f8(0x08)
	Unknown SizeBox_Timeline; // 0x400(0x08)
	Unknown Slider_TimelineScale; // 0x408(0x08)
	Unknown T_CameraType; // 0x410(0x08)
	Unknown T_CurrentTime; // 0x418(0x08)
	Unknown T_PlaySpeed; // 0x420(0x08)
	Unknown T_TimeToGo; // 0x428(0x08)
	Unknown T_TotalTime; // 0x430(0x08)
	float TimelineSizeBoxOffset; // 0x438(0x04)
	Unknown Class_EventMarker_Kill; // 0x440(0x08)
	Unknown Class_EventMarker_Knockout; // 0x448(0x08)
	float LastViewportSize; // 0x450(0x04)
	char IsMouseOnBorder; // 0x454(0x01)
	Unknown Class_EventMarker_Resuscitated; // 0x458(0x08)
	Unknown Class_EventMarker_WhenReported; // 0x460(0x08)
	Unknown CameraType; // 0x468(0x01)
	Unknown ViewMode; // 0x469(0x01)
	Unknown UberGraphFrame; // 0x2e0(0x08)
	Unknown Bt_ListNext; // 0x2e8(0x08)
	Unknown BT_ListPrev; // 0x2f0(0x08)
	Unknown ScrollBox_PlayerItem; // 0x2f8(0x08)
	Unknown T_SortType; // 0x300(0x08)
	Unknown VB_ListMain; // 0x308(0x08)
	Unknown Image_136; // 0x248(0x08)
	Unknown Slider_Speed; // 0x250(0x08)
	Unknown T_CamSpeed; // 0x258(0x08)
	Unknown Handle_HideFreeCamSpeed; // 0x260(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Button; // 0x250(0x08)
	Unknown Button_Text; // 0x258(0x08)
	Unknown Overlay_Button; // 0x260(0x08)
	...
	Unknown Image_81; // 0x248(0x08)
	Unknown Image_86; // 0x250(0x08)
	Unknown Image_88; // 0x258(0x08)
	Unknown Image_89; // 0x260(0x08)
	Unknown Image_90; // 0x268(0x08)
	Unknown Image_91; // 0x270(0x08)
	Unknown Image_92; // 0x278(0x08)
	Unknown Image_93; // 0x280(0x08)
	Unknown Image_94; // 0x288(0x08)
	Unknown Image_95; // 0x290(0x08)
	Unknown Image_96; // 0x298(0x08)
	Unknown Image_97; // 0x2a0(0x08)
	Unknown Image_98; // 0x2a8(0x08)
	Unknown Image_99; // 0x2b0(0x08)
	Unknown Image_100; // 0x2b8(0x08)
	Unknown Image_101; // 0x2c0(0x08)
	Unknown Image_102; // 0x2c8(0x08)
	Unknown Image_103; // 0x2d0(0x08)
	Unknown Image_104; // 0x2d8(0x08)
	Unknown Image_107; // 0x2e0(0x08)
	Unknown Image_108; // 0x2e8(0x08)
	Unknown Image_119; // 0x2f0(0x08)
	Unknown Image_120; // 0x2f8(0x08)
	Unknown Image_121; // 0x300(0x08)
	Unknown Image_122; // 0x308(0x08)
	Unknown Image_123; // 0x310(0x08)
	Unknown Image_134; // 0x318(0x08)
	Unknown Image_137; // 0x320(0x08)
	Unknown Image_138; // 0x328(0x08)
	Unknown Image_139; // 0x330(0x08)
	Unknown Image_140; // 0x338(0x08)
	Unknown Image_141; // 0x340(0x08)
	Unknown Image_142; // 0x348(0x08)
	Unknown Image_143; // 0x350(0x08)
	Unknown Image_144; // 0x358(0x08)
	Unknown Image_145; // 0x360(0x08)
	Unknown Image_146; // 0x368(0x08)
	Unknown Image_147; // 0x370(0x08)
	Unknown Image_148; // 0x378(0x08)
	Unknown Image_149; // 0x380(0x08)
	Unknown Image_152; // 0x388(0x08)
	Unknown Image_153; // 0x390(0x08)
	Unknown Image_154; // 0x398(0x08)
	Unknown Image_155; // 0x3a0(0x08)
	Unknown Image_156; // 0x3a8(0x08)
	Unknown Image_157; // 0x3b0(0x08)
	Unknown Image_158; // 0x3b8(0x08)
	Unknown Image_159; // 0x3c0(0x08)
	Unknown Image_160; // 0x3c8(0x08)
	Unknown Image_161; // 0x3d0(0x08)
	Unknown Image_162; // 0x3d8(0x08)
	Unknown Image_163; // 0x3e0(0x08)
	Unknown Image_164; // 0x3e8(0x08)
	Unknown WidgetSwitcher_1; // 0x3f0(0x08)
	Unknown UberGraphFrame; // 0x308(0x08)
	Unknown CoherentUIGTWidget_90; // 0x310(0x08)
	Unknown UW-CustomizedCharacter; // 0x318(0x08)
	Unknown CurrentSceneType; // 0x320(0x01)
	Unknown UberGraphFrame; // 0x250(0x08)
	Unknown btn_confirm; // 0x258(0x08)
	Unknown popup-bg; // 0x260(0x08)
	Unknown txt_description; // 0x268(0x08)
	Unknown uw-bg; // 0x270(0x08)
	struct FText DescriptionText; // 0x278(0x18)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Spectator_Ani; // 0x250(0x08)
	Unknown Button_Report; // 0x258(0x08)
	Unknown Canvas_Finding; // 0x260(0x08)
	Unknown Canvas_Target; // 0x268(0x08)
	Unknown Deco; // 0x270(0x08)
	Unknown Image_351; // 0x278(0x08)
	Unknown IMG_ClassIcon; // 0x280(0x08)
	Unknown NickName; // 0x288(0x08)
	Unknown Overlay_Report; // 0x290(0x08)
	Unknown ReportDescriptionText; // 0x298(0x08)
	Unknown Text_Report; // 0x2a0(0x08)
	Unknown TextBlock_3; // 0x2a8(0x08)
	Unknown TextBlock_208; // 0x2b0(0x08)
	Unknown VerticalBox_Report; // 0x2b8(0x08)
	Unknown WidgetSwitcher_136; // 0x2c0(0x08)
	char IsReportAbleDateTime; // 0x2c8(0x01)
	Unknown TargetPlayerState; // 0x2d0(0x08)
	Unknown UberGraphFrame; // 0x278(0x08)
	Unknown btn_Cancel; // 0x280(0x08)
	Unknown btn_report; // 0x288(0x08)
	...
	char CheckCloseComboArrow; // 0x330(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown CP-Login-FadeIn; // 0x250(0x08)
	Unknown Blink; // 0x258(0x08)
	Unknown Dot; // 0x260(0x08)
	Unknown MainCanvas-FadeIn; // 0x268(0x08)
	Unknown BTN-Login; // 0x270(0x08)
	Unknown CB-SaveUserName; // 0x278(0x08)
	Unknown CP-Dot; // 0x280(0x08)
	Unknown CP-ErrorMessage; // 0x288(0x08)
	Unknown CP-LOGIN; // 0x290(0x08)
	Unknown CP-MESSAGE; // 0x298(0x08)
	Unknown EDT-ID; // 0x2a0(0x08)
	Unknown EDT-PASSWORD; // 0x2a8(0x08)
	Unknown Image_1; // 0x2b0(0x08)
	Unknown Image_2; // 0x2b8(0x08)
	Unknown Image_3; // 0x2c0(0x08)
	Unknown Image_5; // 0x2c8(0x08)
	Unknown Image_10; // 0x2d0(0x08)
	Unknown Image_204; // 0x2d8(0x08)
	Unknown IMG-ErrorIcon; // 0x2e0(0x08)
	Unknown IMG-Logo; // 0x2e8(0x08)
	Unknown TXT-Connecting; // 0x2f0(0x08)
	Unknown TXT-Error_Message; // 0x2f8(0x08)
	Unknown TXT-Waitting; // 0x300(0x08)
	Unknown TXT_Connecting_Dot; // 0x308(0x08)
	Unknown UW-Exit_Popup; // 0x310(0x08)
	Unknown TitleWidgetRef; // 0x318(0x08)
	int32_t State; // 0x320(0x04)
	char bPlayOnce; // 0x324(0x01)
	char bPopupOpen; // 0x325(0x01)
	Unknown ExitPopupKey; // 0x328(0x18)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Anim_Bouns; // 0x250(0x08)
	Unknown 1; // 0x258(0x08)
	Unknown 10; // 0x260(0x08)
	Unknown 100; // 0x268(0x08)
	Unknown 1000; // 0x270(0x08)
	Unknown Empty; // 0x278(0x08)
	Unknown Image_7; // 0x280(0x08)
	Unknown Image_11; // 0x288(0x08)
	Unknown Image_14; // 0x290(0x08)
	Unknown Image_15; // 0x298(0x08)
	Unknown Image_16; // 0x2a0(0x08)
	Unknown Image_17; // 0x2a8(0x08)
	Unknown Image_18; // 0x2b0(0x08)
	Unknown Image_20; // 0x2b8(0x08)
	Unknown Image_21; // 0x2c0(0x08)
	Unknown Image_22; // 0x2c8(0x08)
	Unknown Image_23; // 0x2d0(0x08)
	Unknown Image_1473; // 0x2d8(0x08)
	Unknown TextBlock_4; // 0x2e0(0x08)
	Unknown TextLight_3; // 0x2e8(0x08)
	int32_t Save; // 0x2f0(0x04)
	Unknown LoopSound; // 0x2f4(0x04)
	char IsStopSound; // 0x2f8(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown FadeIn; // 0x250(0x08)
	Unknown FadeOut; // 0x258(0x08)
	Unknown Image_69; // 0x260(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown HorizontalBox_Next; // 0x250(0x08)
	Unknown ProgressBar_Current; // 0x258(0x08)
	Unknown ProgressBar_Down; // 0x260(0x08)
	Unknown ProgressBar_Up; // 0x268(0x08)
	Unknown TextBlock_Current; // 0x270(0x08)
	Unknown TextBlock_Max; // 0x278(0x08)
	Unknown TextBlock_Next; // 0x280(0x08)
	char EnableUpdate; // 0x288(0x01)
	float CurTime; // 0x28c(0x04)
	float ShowTime; // 0x290(0x04)
	float EndPoint; // 0x294(0x04)
	float ChangeValue; // 0x298(0x04)
	float StartPoint; // 0x29c(0x04)
	float Min; // 0x2a0(0x04)
	float MAX; // 0x2a4(0x04)
	char IsUPState; // 0x2a8(0x01)
	struct FMulticastInlineDelegate Dispatcher_ProgressBarDone; // 0x2b0(0x10)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown HorizontalBox; // 0x250(0x08)
	Unknown HorizontalBox_2; // 0x258(0x08)
	...
	Unknown Image_8; // 0x298(0x08)
	Unknown Image_9; // 0x2a0(0x08)
	Unknown Image_10; // 0x2a8(0x08)
	Unknown Image_11; // 0x2b0(0x08)
	Unknown Image_12; // 0x2b8(0x08)
	Unknown Image_13; // 0x2c0(0x08)
	Unknown Image_14; // 0x2c8(0x08)
	Unknown Image_15; // 0x2d0(0x08)
	Unknown Image_72; // 0x2d8(0x08)
	Unknown Image_164; // 0x2e0(0x08)
	Unknown Image_352; // 0x2e8(0x08)
	Unknown Image_659; // 0x2f0(0x08)
	Unknown Overlay_4; // 0x2f8(0x08)
	Unknown SizeBox; // 0x300(0x08)
	Unknown SizeBox_54; // 0x308(0x08)
	Unknown T_WeaponType; // 0x310(0x08)
	Unknown TextBlock_176; // 0x318(0x08)
	Unknown TextBlock_258; // 0x320(0x08)
	Unknown TextBlock_331; // 0x328(0x08)
	Unknown WidgetSwitcher_1; // 0x330(0x08)
	Unknown ItemInfo; // 0x338(0x08)
	Unknown ItemDetailInfo; // 0x340(0x490)
	struct FText LocalText; // 0x7d0(0x18)
	char bIsSmallIcon; // 0x7e8(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Hide; // 0x250(0x08)
	Unknown RankDown; // 0x258(0x08)
	Unknown RankUp; // 0x260(0x08)
	Unknown Anim_Reward; // 0x268(0x08)
	Unknown Arrow_3; // 0x270(0x08)
	Unknown ArrowLine_3; // 0x278(0x08)
	Unknown BottomLine_3; // 0x280(0x08)
	Unknown BrightSpot_01; // 0x288(0x08)
	Unknown BrightSpot_02; // 0x290(0x08)
	Unknown BrightSpot_03; // 0x298(0x08)
	Unknown BrightSpot_04; // 0x2a0(0x08)
	Unknown BrightSpot_05; // 0x2a8(0x08)
	Unknown Button_DeathCam; // 0x2b0(0x08)
	Unknown Button_DeathCam_2; // 0x2b8(0x08)
	Unknown Button_Exit; // 0x2c0(0x08)
	Unknown Button_Report; // 0x2c8(0x08)
	Unknown Button_Spectate; // 0x2d0(0x08)
	Unknown CanvasPanel_3; // 0x2d8(0x08)
	Unknown CanvasPanel_9; // 0x2e0(0x08)
	Unknown CanvasPanel_1174; // 0x2e8(0x08)
	Unknown CanvasPanel_1384; // 0x2f0(0x08)
	Unknown Glow1; // 0x2f8(0x08)
	Unknown Glow2; // 0x300(0x08)
	Unknown Glow3; // 0x308(0x08)
	Unknown Glow_01; // 0x310(0x08)
	Unknown GlowLine; // 0x318(0x08)
	Unknown Gold; // 0x320(0x08)
	Unknown Image_26; // 0x328(0x08)
	Unknown Image_27; // 0x330(0x08)
	Unknown Image_28; // 0x338(0x08)
	Unknown Image_29; // 0x340(0x08)
	Unknown Image_216; // 0x348(0x08)
	Unknown Image_223; // 0x350(0x08)
	Unknown Image_458; // 0x358(0x08)
	Unknown Image_559; // 0x360(0x08)
	Unknown Image_CurrentRANK; // 0x368(0x08)
	Unknown Image_DownRANK; // 0x370(0x08)
	Unknown Image_UpRANK; // 0x378(0x08)
	Unknown L_Wing01; // 0x380(0x08)
	Unknown L_Wing01_2; // 0x388(0x08)
	Unknown L_Wing01_5; // 0x390(0x08)
	Unknown L_Wing02; // 0x398(0x08)
	Unknown L_Wing02_2; // 0x3a0(0x08)
	Unknown L_Wing02_5; // 0x3a8(0x08)
	Unknown L_Wing03; // 0x3b0(0x08)
	Unknown L_Wing03_2; // 0x3b8(0x08)
	Unknown L_Wing03_5; // 0x3c0(0x08)
	Unknown L_WingLine; // 0x3c8(0x08)
	Unknown L_WingLine_3; // 0x3d0(0x08)
	Unknown Light_2; // 0x3d8(0x08)
	Unknown Light_01; // 0x3e0(0x08)
	Unknown Light_02; // 0x3e8(0x08)
	Unknown Light_03; // 0x3f0(0x08)
	Unknown Light_04; // 0x3f8(0x08)
	Unknown Light_05; // 0x400(0x08)
	Unknown Light_06; // 0x408(0x08)
	Unknown Overlay_2; // 0x410(0x08)
	Unknown Overlay_264; // 0x418(0x08)
	Unknown Overlay_Report; // 0x420(0x08)
	Unknown Overlay_Spectate; // 0x428(0x08)
	Unknown R_Wing01; // 0x430(0x08)
	Unknown R_Wing01_2; // 0x438(0x08)
	Unknown R_Wing01_5; // 0x440(0x08)
	Unknown R_Wing01_6; // 0x448(0x08)
	Unknown R_Wing02; // 0x450(0x08)
	Unknown R_Wing02_2; // 0x458(0x08)
	Unknown R_Wing02_5; // 0x460(0x08)
	Unknown R_Wing02_6; // 0x468(0x08)
	Unknown R_Wing03; // 0x470(0x08)
	Unknown R_Wing03_2; // 0x478(0x08)
	Unknown R_Wing03_5; // 0x480(0x08)
	Unknown R_Wing03_6; // 0x488(0x08)
	Unknown R_WingLine; // 0x490(0x08)
	Unknown R_WingLine_3; // 0x498(0x08)
	Unknown Ribbon; // 0x4a0(0x08)
	Unknown Ring; // 0x4a8(0x08)
	Unknown RIng_Glow_01; // 0x4b0(0x08)
	Unknown ScrollBox_2; // 0x4b8(0x08)
	Unknown ScrollBox_199; // 0x4c0(0x08)
	Unknown SizeBox_8; // 0x4c8(0x08)
	Unknown Spacer_6018; // 0x4d0(0x08)
	Unknown Spacer_6217; // 0x4d8(0x08)
	Unknown Spacer_Center; // 0x4e0(0x08)
	Unknown Spacer_Center_2; // 0x4e8(0x08)
	Unknown T_RemainTime_2; // 0x4f0(0x08)
	Unknown Text_Report; // 0x4f8(0x08)
	Unknown TextBlock_3; // 0x500(0x08)
	Unknown TextBlock_12; // 0x508(0x08)
	Unknown TextBlock_13; // 0x510(0x08)
	Unknown TextBlock_14; // 0x518(0x08)
	Unknown TextBlock_25; // 0x520(0x08)
	Unknown TextBlock_27; // 0x528(0x08)
	Unknown TextBlock_1425; // 0x530(0x08)
	Unknown TextBlock_2242; // 0x538(0x08)
	Unknown TextBlock_2769; // 0x540(0x08)
	Unknown TextBlock_3056; // 0x548(0x08)
	Unknown TextBlock_LocalMatchRP; // 0x550(0x08)
	Unknown TextGlow01; // 0x558(0x08)
	Unknown TextGlow02; // 0x560(0x08)
	Unknown TextGlow03; // 0x568(0x08)
	Unknown TopLine_3; // 0x570(0x08)
	Unknown UW-MatchEnd_GoldList; // 0x578(0x08)
	Unknown UW-MatchEnd_RewardSlot_02_2; // 0x580(0x08)
	Unknown UW-MatchEnd_RewardSlot_02_3; // 0x588(0x08)
	Unknown UW-MatchEnd_RewardSlot_02_4; // 0x590(0x08)
	Unknown UW-MatchEnd_RewardSlot_02_5; // 0x598(0x08)
	Unknown UW-MatchEnd_RewardSlot_02_369; // 0x5a0(0x08)
	Unknown UW-RankPoint; // 0x5a8(0x08)
	Unknown UW-RewardGoldSlot_02; // 0x5b0(0x08)
	Unknown VerticalBox_191; // 0x5b8(0x08)
	Unknown WidgetSwitcher_2; // 0x5c0(0x08)
	char MatchEnd; // 0x5c8(0x01)
	Unknown AnimationData; // 0x5c9(0x02)
	Unknown MatchEndWidgetRef; // 0x5d0(0x08)
	Unknown SimpleResult; // 0x5d8(0xa8)
	Unknown SimpleTimer; // 0x680(0x08)
	char IsWinningCam; // 0x688(0x01)
	Unknown StartSound; // 0x68c(0x04)
	Unknown GainGoldHandle; // 0x690(0x08)
	Unknown GoldHandle; // 0x698(0x08)
	Unknown FinalResultData; // 0x6a0(0x04)
	int32_t RandomGold; // 0x6a4(0x04)
	int32_t GainGoldValue; // 0x6a8(0x04)
	Unknown LocalWidget; // 0x6b0(0x08)
	Unknown PlayerState; // 0x6b8(0x08)
	Unknown Timehandle_Rank; // 0x6c0(0x08)
	char Increase; // 0x6c8(0x01)
	char bMaxPrograssbar; // 0x6c9(0x01)
	int32_t CurrentRP; // 0x6cc(0x04)
	int32_t PlayerOriRP; // 0x6d0(0x04)
	int32_t TargetRP; // 0x6d4(0x04)
	int32_t NextTireRP; // 0x6d8(0x04)
	int32_t CurrentTierID; // 0x6dc(0x04)
	char IsGiveUp; // 0x6e0(0x01)
	int32_t TempRank; // 0x6e4(0x04)
	int32_t TempKill; // 0x6e8(0x04)
	int32_t TempHit; // 0x6ec(0x04)
	int32_t TempSuvival; // 0x6f0(0x04)
	int32_t SeasonRP; // 0x6f4(0x04)
	int32_t GainedRP; // 0x6f8(0x04)
	int32_t AminRPText; // 0x6fc(0x04)
	int32_t StartRP; // 0x700(0x04)
	int32_t EndRP; // 0x704(0x04)
	float ShowTime; // 0x708(0x04)
	char IsTargetCameraKiller; // 0x70c(0x01)
	...
	char IsCaptureInProgress(); // IsCaptureInProgress MovieSceneCapture.MovieSceneCaptureEnvironment.IsCaptureInProgress // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3512620>
	...
	void WriteImageToDisk(Unknown& PixelData, Unknown& StreamID, Unknown& FrameMetrics, char bCopyImageData); // WriteImageToDisk MovieSceneCapture.UserDefinedImageCaptureProtocol.WriteImageToDisk // (Final|Native|Public|HasOutParms|BlueprintCallable) // <Game+0x3512b70>
	void Initialize(float Direction); // Initialize UW-CompassRulerWidget.UW-CompassRulerWidget_C.Initialize // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void AnimGraph(Unknown& AnimGraph); // AnimGraph ABP-Saiga12K.ABP-Saiga12K_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetSequecePanelColor(int32_t WeaponRarity); // SetSequecePanelColor LV-Title_Alternative.LV-Title_Alternative_C.SetSequecePanelColor // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetAnimDriveDamperStiffness(float InStiffness); // SetAnimDriveDamperStiffness ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness // (Final|Native|Public|BlueprintCallable) // <Game+0x3e535a0>
	void CanInput(char& bCheck); // CanInput BP-LobbyController.BP-LobbyController_C.CanInput // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	...
	Unknown ClaimResources(Unknown InTaskOwner, Unknown ResourceClasses, Unknown Priority, struct FName TaskInstanceName); // ClaimResources GameplayTasks.GameplayTask_ClaimResource.ClaimResources // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3eb37b0>
	Unknown SpawnActor(Unknown TaskOwner, Unknown SpawnLocation, Unknown SpawnRotation, Unknown Class, char bSpawnOnlyOnAuthority); // SpawnActor GameplayTasks.GameplayTask_SpawnActor.SpawnActor // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // <Game+0x3eb3cc0>
	Unknown TaskWaitDelay(Unknown TaskOwner, float Time, Unknown Priority); // TaskWaitDelay GameplayTasks.GameplayTask_WaitDelay.TaskWaitDelay // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3eb3e70>
	...
	void PreConstruct(char IsDesignTime); // PreConstruct UW-ReportUserConfirm.UW-ReportUserConfirm_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game+0x23ad490>
	char IsValid(); // IsValid NavigationSystem.NavigationPath.IsValid // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x3f16c40>
	void UnregisterNavigationInvoker(Unknown Invoker); // UnregisterNavigationInvoker NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker // (Final|Native|Public|BlueprintCallable) // <Game+0x3f17a90>
	void SetNavigationRelevancy(char bRelevant); // SetNavigationRelevancy NavigationSystem.NavRelevantComponent.SetNavigationRelevancy // (Final|Native|Public|BlueprintCallable) // <Game+0x3f1a130>
	void SetAreaClass(Unknown NewAreaClass); // SetAreaClass NavigationSystem.NavModifierComponent.SetAreaClass // (Final|Native|Public|BlueprintCallable) // <Game+0x3f1a0b0>
	void SetAreaClass(Unknown NewAreaClass); // SetAreaClass NavigationSystem.NavModifierVolume.SetAreaClass // (Final|Native|Public|BlueprintCallable) // <Game+0x3f1a030>
	char K2_ReplaceAreaInTileBounds(Unknown Bounds, Unknown OldArea, Unknown NewArea, char ReplaceLinks); // K2_ReplaceAreaInTileBounds NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds // (Final|Native|Public|HasDefaults|BlueprintCallable) // <Game+0x3f19ea0>
	...
	void OnListFileFound(struct FString Filename, int32_t ByteCount, struct FString FilePath); // OnListFileFound WindowsFileUtility.WFUFileListInterface.OnListFileFound // (Native|Event|Public|BlueprintEvent) // <Game+0x4001d30>
	void OnFileChanged(struct FString Filename, struct FString FilePath); // OnFileChanged WindowsFileUtility.WFUFolderWatchInterface.OnFileChanged // (Native|Event|Public|BlueprintEvent) // <Game+0x166e270>
	void WatchFolder(struct FString fullPath, Unknown WatcherDelegate); // WatchFolder WindowsFileUtility.WindowsFileUtilityFunctionLibrary.WatchFolder // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x4001f40>
	Unknown ConvertPhysicsCollisionToHitResult(Unknown& PhysicsCollision); // ConvertPhysicsCollisionToHitResult ChaosSolverEngine.ChaosSolverEngineBlueprintLibrary.ConvertPhysicsCollisionToHitResult // (Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <Game+0x4006270>
	void SetSolverActive(char bActive); // SetSolverActive ChaosSolverEngine.ChaosSolverActor.SetSolverActive // (Native|Public|BlueprintCallable) // <Game+0x4006380>
	...
	Unknown SetMetaDataIteration(int32_t Iterations); // SetMetaDataIteration FieldSystemEngine.FieldSystemMetaDataIteration.SetMetaDataIteration // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400e3a0>
	Unknown SetMetaDataaProcessingResolutionType(Unknown ResolutionType); // SetMetaDataaProcessingResolutionType FieldSystemEngine.FieldSystemMetaDataProcessingResolution.SetMetaDataaProcessingResolutionType // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400e430>
	Unknown SetUniformInteger(int32_t Magnitude); // SetUniformInteger FieldSystemEngine.UniformInteger.SetUniformInteger // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400e3a0>
	Unknown SetRadialIntMask(float Radius, Unknown Position, int32_t InteriorValue, int32_t ExteriorValue, Unknown SetMaskConditionIn); // SetRadialIntMask FieldSystemEngine.RadialIntMask.SetRadialIntMask // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x400ec30>
	Unknown SetUniformScalar(float Magnitude); // SetUniformScalar FieldSystemEngine.UniformScalar.SetUniformScalar // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400eed0>
	Unknown SetRadialFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Radius, Unknown Position, Unknown Falloff); // SetRadialFalloff FieldSystemEngine.RadialFalloff.SetRadialFalloff // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x400ea10>
	Unknown SetPlaneFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Distance, Unknown Position, Unknown Normal, Unknown Falloff); // SetPlaneFalloff FieldSystemEngine.PlaneFalloff.SetPlaneFalloff // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x400e790>
	Unknown SetBoxFalloff(float Magnitude, float MinRange, float MaxRange, float Default, Unknown Transform, Unknown Falloff); // SetBoxFalloff FieldSystemEngine.BoxFalloff.SetBoxFalloff // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x400e070>
	Unknown SetNoiseField(float MinRange, float MaxRange, Unknown Transform); // SetNoiseField FieldSystemEngine.NoiseField.SetNoiseField // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x400e4c0>
	Unknown SetUniformVector(float Magnitude, Unknown Direction); // SetUniformVector FieldSystemEngine.UniformVector.SetUniformVector // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x400edf0>
	Unknown SetRadialVector(float Magnitude, Unknown Position); // SetRadialVector FieldSystemEngine.RadialVector.SetRadialVector // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x400edf0>
	Unknown SetRandomVector(float Magnitude); // SetRandomVector FieldSystemEngine.RandomVector.SetRandomVector // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400eed0>
	Unknown SetOperatorField(float Magnitude, Unknown RightField, Unknown LeftField, Unknown Operation); // SetOperatorField FieldSystemEngine.OperatorField.SetOperatorField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400e640>
	Unknown SetToIntegerField(Unknown FloatField); // SetToIntegerField FieldSystemEngine.ToIntegerField.SetToIntegerField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400ef90>
	Unknown SetToFloatField(Unknown IntegerField); // SetToFloatField FieldSystemEngine.ToFloatField.SetToFloatField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400ef90>
	Unknown SetCullingField(Unknown Culling, Unknown Field, Unknown Operation); // SetCullingField FieldSystemEngine.CullingField.SetCullingField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400e2a0>
	Unknown SetReturnResultsTerminal(); // SetReturnResultsTerminal FieldSystemEngine.ReturnResultsTerminal.SetReturnResultsTerminal // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x400ef60>
	void SortTrailingEvents(Unknown& TrailingEvents, Unknown SortMethod); // SortTrailingEvents GeometryCollectionEngine.ChaosDestructionListener.SortTrailingEvents // (Final|Native|Public|HasOutParms|BlueprintCallable) // <Game+0x402bd90>
	char RaycastSingle(Unknown Start, Unknown End, Unknown& OutHit); // RaycastSingle GeometryCollectionEngine.GeometryCollectionActor.RaycastSingle // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // <Game+0x402b570>
	void SetNotifyBreaks(char bNewNotifyBreaks); // SetNotifyBreaks GeometryCollectionEngine.GeometryCollectionComponent.SetNotifyBreaks // (Final|Native|Public|BlueprintCallable) // <Game+0x402b9d0>
	void ReceivePhysicsCollision(Unknown& CollisionInfo); // ReceivePhysicsCollision GeometryCollectionEngine.SkeletalMeshSimulationComponent.ReceivePhysicsCollision // (Event|Public|HasOutParms|BlueprintEvent) // <Game+0x23ad490>
	void ReceivePhysicsCollision(Unknown& CollisionInfo); // ReceivePhysicsCollision GeometryCollectionEngine.StaticMeshSimulationComponent.ReceivePhysicsCollision // (Event|Public|HasOutParms|BlueprintEvent) // <Game+0x23ad490>
	void UpdateWorldLocalState(char bWorldIn); // UpdateWorldLocalState InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // <Game+0x40513a0>
	void SetTransform(Unknown& NewTransform); // SetTransform InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // <Game+0x40511a0>
	char HasTangentVectors(); // HasTangentVectors InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // <Game+0x4051060>
	void UpdateHoverState(char bHovering); // UpdateHoverState InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // <Game+0x4051280>
	void EndUpdate(); // EndUpdate InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // <Game+0x1e8d710>
	void SetParameter(float NewValue); // SetParameter InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // <Game+0x4051090>
	void SetParameter(Unknown& NewValue); // SetParameter InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // <Game+0x4051110>
	void GetRequestTextFromIndex(int32_t Index, Unknown& Text); // GetRequestTextFromIndex WBP_SPS_SelectionMenu.WBP_SPS_SelectionMenu_C.GetRequestTextFromIndex // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void OnLoaded_395796F147F051B7CCBB17B8AB7F3577(Unknown Loaded); // OnLoaded_395796F147F051B7CCBB17B8AB7F3577 BP-CheckWeightMap.BP-CheckWeightMap_C.OnLoaded_395796F147F051B7CCBB17B8AB7F3577 // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void SetScopeImageAngle(float NewAngle); // SetScopeImageAngle UW-Sight_4X.UW-Sight_4X_C.SetScopeImageAngle // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Setup(Unknown VehicleInstance); // Setup UW-VehicleSubInfo_Camaro.UW-VehicleSubInfo_Camaro_C.Setup // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void UserConstructionScript(); // UserConstructionScript BP-PlatedJeep_Blue_Appear.BP-PlatedJeep_Blue_Appear_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Divide(int32_t Value1, int32_t& RetS1, int32_t& RetS2); // Divide UW-RewardGoldSlot.UW-RewardGoldSlot_C.Divide // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void OnLoaded_9DF86FA64782B378E42DBB813545BD34(Unknown Loaded); // OnLoaded_9DF86FA64782B378E42DBB813545BD34 UW-KillMessageListItemWidget.UW-KillMessageListItemWidget_C.OnLoaded_9DF86FA64782B378E42DBB813545BD34 // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetLineInfo(float Angle, float Length); // SetLineInfo UW-PlayerIconWidget_OnFire.UW-PlayerIconWidget_OnFire_C.SetLineInfo // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetStatInfo(Unknown& StatupParams, char IsUpAnim); // SetStatInfo UW-StatupWidget.UW-StatupWidget_C.SetStatInfo // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetInfo(Unknown VoiceTalkState); // SetInfo UW-VoiceTalkSlot.UW-VoiceTalkSlot_C.SetInfo // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void IsDraging(char& bResult); // IsDraging UW-Inventory_EquippedSlot.UW-Inventory_EquippedSlot_C.IsDraging // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	...
	void EnableShowReplayType(char& bRet); // EnableShowReplayType KeyWidget.KeyWidget_C.EnableShowReplayType // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void InterpProjectileTrajectoryJumpState(char Jump, Unknown Location, Unknown Rotation, Unknown& StartLocation, Unknown& Velocity); // InterpProjectileTrajectoryJumpState ProjectileTrajectoryComponent.ProjectileTrajectoryComponent_C.InterpProjectileTrajectoryJumpState // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void InitIcon(Unknown PlayerState); // InitIcon UW-CompassWidget_Item_Resuscitation.UW-CompassWidget_Item_Resuscitation_C.InitIcon // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void ReceiveUnpossessed(Unknown OldController); // ReceiveUnpossessed BP-DefaultAmphibianVehicle.BP-DefaultAmphibianVehicle_C.ReceiveUnpossessed // (Event|Public|BlueprintEvent) // <Game+0x23ad490>
	void GetCraftingWeaponRarity(int32_t& OutRarity); // GetCraftingWeaponRarity UW-Lobby_Armory_Recipe.UW-Lobby_Armory_Recipe_C.GetCraftingWeaponRarity // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	void OnDragDetected(Unknown MyGeometry, Unknown& PointerEvent, Unknown& Operation); // OnDragDetected UW-Inventory_KeepedSlot.UW-Inventory_KeepedSlot_C.OnDragDetected // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetSlotInfo(Unknown BlackmarketDataInfo); // SetSlotInfo UW-BlackMarket_Slot_Custom.UW-BlackMarket_Slot_Custom_C.SetSlotInfo // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void SetScalarParameterList(Unknown& StaticMeshList, struct FName ParameterName, float ParameterValue); // SetScalarParameterList BP_MoveElevator.BP_MoveElevator_C.SetScalarParameterList // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Key Input Current State(Unknown Controller, float& Axis Value, char& Down, char& Just Pressed, char& Just Released); // Key Input Current State BP_KeyInput_Digital.BP_KeyInput_Digital_C.Key Input Current State // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Hide(); // Hide UW-HittedDamageWidget.UW-HittedDamageWidget_C.Hide // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Get Key Combination Display Name(struct FString Separator, struct FString No Key Display, Unknown Display Type, struct FString& Display Name); // Get Key Combination Display Name BP_KeyCombination.BP_KeyCombination_C.Get Key Combination Display Name // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Get Mapping(struct FString Mapping Name, Unknown& Mapping, char& SUCCESS); // Get Mapping BP_KeyAction.BP_KeyAction_C.Get Mapping // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	Unknown OnFocusReceived(Unknown MyGeometry, Unknown InFocusEvent); // OnFocusReceived Chat_Tab.Chat_Tab_C.OnFocusReceived // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void GetReplayWidget(Unknown& ReplayMainWidget); // GetReplayWidget BP-MK3DSpectatorPawn.BP-MK3DSpectatorPawn_C.GetReplayWidget // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	struct FText Get_TextBlock_1_Text_1(); // Get_TextBlock_1_Text_1 UW-PerkLevelUp.UW-PerkLevelUp_C.Get_TextBlock_1_Text_1 // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	...
	void ReceiveTick(float DeltaSeconds); // ReceiveTick BP-TransportAircraft.BP-TransportAircraft_C.ReceiveTick // (Event|Public|BlueprintEvent) // <Game+0x23ad490>
	...
	void SetLine(char Show, int32_t IconIndex); // SetLine Line_WidgetActor.Line_WidgetActor_C.SetLine // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void CheckNumeric(struct FString CheckString, char& CheckResult); // CheckNumeric UW-ItemDropPopup.UW-ItemDropPopup_C.CheckNumeric // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	void ConvertLoopAnimationType(Unknown In Type, Unknown __WorldContext, Unknown& Out Type); // ConvertLoopAnimationType BPF_SPS_Functions.BPF_SPS_Functions_C.ConvertLoopAnimationType // (Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	char SetExpertWeaponPing(Unknown& PingInfo); // SetExpertWeaponPing WBP_SPS_Icon.WBP_SPS_Icon_C.SetExpertWeaponPing // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void GetTeamColor(int32_t TeamIndex, Unknown& OutColor); // GetTeamColor BP_SPS_WidgetActor.BP_SPS_WidgetActor_C.GetTeamColor // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetWeaponStat(Unknown& WeaponInfo); // SetWeaponStat UW-Lobby_WeaponInfo_Stat.UW-Lobby_WeaponInfo_Stat_C.SetWeaponStat // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	Unknown GetInteractiveWidget(); // GetInteractiveWidget BP-SpectatorHUD.BP-SpectatorHUD_C.GetInteractiveWidget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Setup(Unknown VehicleInstance); // Setup UW-VehicleSubInfo_Base.UW-VehicleSubInfo_Base_C.Setup // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetClassCount(int32_t Count); // SetClassCount UW-ClassinfoitemWidget.UW-ClassinfoitemWidget_C.SetClassCount // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void AnimGraph(Unknown& AnimGraph); // AnimGraph ABP-DesertEagle.ABP-DesertEagle_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	Unknown GetDebugInfo(); // GetDebugInfo BP-GrenadeWeaponBase.BP-GrenadeWeaponBase_C.GetDebugInfo // (HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetBuffIcon(Unknown Icon, int32_t Rarity); // SetBuffIcon UW-Inventory_WeaponPerkSlot.UW-Inventory_WeaponPerkSlot_C.SetBuffIcon // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	Unknown GetHUDInteractionComponent(); // GetHUDInteractionComponent BP-MK3DReplayController.BP-MK3DReplayController_C.GetHUDInteractionComponent // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <Game+0x23ad490>
	...
	void SetMessage(struct FText Str); // SetMessage UW-GameNoticePopupWidget.UW-GameNoticePopupWidget_C.SetMessage // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	Unknown CreateSlot(); // CreateSlot UW-TeamInfoWidget.UW-TeamInfoWidget_C.CreateSlot // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void GetHealthPosition(float InHealth, float& PositionX); // GetHealthPosition UW-PlayerInfo_Progress_Renew.UW-PlayerInfo_Progress_Renew_C.GetHealthPosition // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	void AddKillMessage(Unknown& BroadCastInfo); // AddKillMessage UW-KillInfoWidget.UW-KillInfoWidget_C.AddKillMessage // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Set Tool Tip Text Design(struct FText Tool Tip, char& -); // Set Tool Tip Text Design WB_ToolTipDesign.WB_ToolTipDesign_C.Set Tool Tip Text Design // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetIsActive(char bActive); // SetIsActive UW-GameBuffSlot_Boost.UW-GameBuffSlot_Boost_C.SetIsActive // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	Unknown On_IMG-BG_MouseButtonDown_1(Unknown MyGeometry, Unknown& MouseEvent); // On_IMG-BG_MouseButtonDown_1 UW-BlackMarket_Slot_Gear.UW-BlackMarket_Slot_Gear_C.On_IMG-BG_MouseButtonDown_1 // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetParachuteInfo(Unknown SetParachuteInfo); // SetParachuteInfo UW-FallingWidget.UW-FallingWidget_C.SetParachuteInfo // (Event|Public|BlueprintEvent) // <Game+0x23ad490>
	void AnimGraph(Unknown& AnimGraph); // AnimGraph ABP-M40A1.ABP-M40A1_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Stunt(); // Stunt BP-DefaultTwoWheelVehicle.BP-DefaultTwoWheelVehicle_C.Stunt // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void ReceiveTick(float DeltaSeconds); // ReceiveTick BP-HeartBeatSensorEffect.BP-HeartBeatSensorEffect_C.ReceiveTick // (Event|Public|BlueprintEvent) // <Game+0x23ad490>
	void _1(float DeltaSeconds, Unknown OldLocation, Unknown OldVelocity); // _1 BP-AmplifierEffect.BP-AmplifierEffect_C._1 // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void CheckLastHitActor(); // CheckLastHitActor BP-DefaultWaterVehicle.BP-DefaultWaterVehicle_C.CheckLastHitActor // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Init(struct FText Title, int32_t Value); // Init UW-MatchEnd_GoldList.UW-MatchEnd_GoldList_C.Init // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	Unknown GetVisibility_1(); // GetVisibility_1 UW-Inventory_CharacterDragPanel.UW-Inventory_CharacterDragPanel_C.GetVisibility_1 // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x23ad490>
	void K2_SetKillEvent(char IsMyInfo); // K2_SetKillEvent UW-ReplayEventMarkerBasic.UW-ReplayEventMarkerBasic_C.K2_SetKillEvent // (Event|Public|BlueprintEvent) // <Game+0x23ad490>
	Unknown OnMouseButtonDown(Unknown MyGeometry, Unknown& MouseEvent); // OnMouseButtonDown UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.OnMouseButtonDown // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void SetPointAngle(float Angle); // SetPointAngle UW-RoutePingWidget_Point.UW-RoutePingWidget_Point_C.SetPointAngle // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void SetStatValue(int32_t Type, float Value); // SetStatValue UW-StatupWidget_Item.UW-StatupWidget_Item_C.SetStatValue // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	Unknown CreatePlayerListGroup(Unknown PlayerState); // CreatePlayerListGroup UW-ReplayPlayerListWidget.UW-ReplayPlayerListWidget_C.CreatePlayerListGroup // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void SetOpeningArrow(char InOpening); // SetOpeningArrow UW-ReportUser.UW-ReportUser_C.SetOpeningArrow // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void SetTitleWidget(Unknown TitleWidget); // SetTitleWidget UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.SetTitleWidget // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void Divide(int32_t Value, int32_t& RetS1, int32_t& RetS2); // Divide UW-RewardGoldSlot_02.UW-RewardGoldSlot_02_C.Divide // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	...
	void SetData(float StartPoint, float EndPoint, float Min, float MAX, float ShowTime, char Play); // SetData UW-RankPoint.UW-RankPoint_C.SetData // (BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
	void IsMaterialData(struct FName ItemKey, char& bRet, int32_t& Index); // IsMaterialData UW-MatchEnd_RewardSlot_02.UW-MatchEnd_RewardSlot_02_C.IsMaterialData // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23ad490>
