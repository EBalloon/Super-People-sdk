...
public:
	...
	void CheckCameraType(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.CheckCameraType(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FVector2D GetTimelineToolTipPositionBySlider(struct FString& ToolTipTime); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.GetTimelineToolTipPositionBySlider(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTimeToGo(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.SetTimeToGo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CheckTimeToGo(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.CheckTimeToGo(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CalcTimelineScale(char IsUpScale); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.CalcTimelineScale(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTimelineToolTipText(struct FString& Text); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.SetTimelineToolTipText(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void SetTickTime(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.SetTickTime(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FText Get_T_PlaySpeed_Text_1(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.Get_T_PlaySpeed_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FEventReply On_Border_Timeline_MouseMove_1(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.On_Border_Timeline_MouseMove_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FEventReply On_Border_Timeline_MouseEnter_1(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.On_Border_Timeline_MouseEnter_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct UBravoHotelReplayTimelineEventMarker CreateEventMarker(enum class EKillType killType); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.CreateEventMarker(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CheckChangeViewportSize(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.CheckChangeViewportSize(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetEventMarkersPos(enum class EKillType killType, float TotalTime); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.SetEventMarkersPos(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetTimelineScaleBoxWidth(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.SetTimelineScaleBoxWidth(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Init(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.Init(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void TogglePauseResumeButton(char PauseResume); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.TogglePauseResumeButton(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void ChangeCameraTypeDelegate_Event_1(enum class ECameraType CameraType, struct FString TargetPlayerName); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.ChangeCameraTypeDelegate_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void OnReplayJumpCompleteEvent_Event_1(char bSuccess); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.OnReplayJumpCompleteEvent_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void BPUpdateTimelineScale(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.BPUpdateTimelineScale(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void BndEvt__ScrollBox_Timeline_K2Node_ComponentBoundEvent_11_OnUserScrolledEvent__DelegateSignature(float CurrentOffset); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.BndEvt__ScrollBox_Timeline_K2Node_ComponentBoundEvent_11_OnUserScrolledEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void BPUpdateKillEventMarkersPos(enum class EKillType killType, float TotalTime); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.BPUpdateKillEventMarkersPos(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnReplayPauseEvent_Event_1(char bPaused); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.OnReplayPauseEvent_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Construct(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void ChangeViewModeDelegate_Event_1(char ViewMode); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.ChangeViewModeDelegate_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-ReplayTimelineBasic(int32_t EntryPoint); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.ExecuteUbergraph_UW-ReplayTimelineBasic(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
