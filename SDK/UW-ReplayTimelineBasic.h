...
public:
	...
	void BndEvt__BT_TimelineScaleDown_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.BndEvt__BT_TimelineScaleDown_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void BndEvt__BT_TimelineScaleUp_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature(); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.BndEvt__BT_TimelineScaleUp_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void ChangeViewModeDelegate_Event_1(char ViewMode); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.ChangeViewModeDelegate_Event_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_UW-ReplayTimelineBasic(int32_t EntryPoint); // Function UW-ReplayTimelineBasic.UW-ReplayTimelineBasic_C.ExecuteUbergraph_UW-ReplayTimelineBasic(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B80160>
};
