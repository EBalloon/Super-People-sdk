...
public:
	...
	struct FPointerToUberGraphFrame UberGraphFrame; // 0x3BD8 (8)
	struct USceneComponent Listener; // 0x3BE0 (8)
	float _P_Cam_Z_NewTrack_0_898B65D1462B08609DA61C81A7B52313; // 0x3BE8 (4)
	char _P_Cam_Z__Direction_898B65D1462B08609DA61C81A7B52313; // 0x3BEC (1)
	struct UTimelineComponent 3P_Cam_Z; // 0x3BF0 (8)
	struct FTimerHandle CriticalUITimeHandler; // 0x3BF8 (8)
	struct FTimerHandle DyingUITimeHandler; // 0x3C00 (8)
	struct UPhysicsHandleComponent ClothHandler; // 0x3C08 (8)
	struct USkeletalMeshComponent ClothBallObject; // 0x3C10 (8)
	struct FVector BallHandleLocation; // 0x3C18 (12)
	float GamepadInputModifier; // 0x3C24 (4)
	float BaseTurnRate; // 0x3C28 (4)
	float BaseLookUpRate; // 0x3C2C (4)
	struct TArray<struct UUW-PerkLevelUp_C> PerkLevelUpWidgets; // 0x3C30 (16)
	float PerkLevelUpWidthDepth; // 0x3C40 (4)
	struct ABP-AmplifierEffect_C AmplifierEffect; // 0x3C48 (8)
	float Cam_Shake_Radius; // 0x3C50 (4)
	struct UBravoHotelMainWidget MainWidget; // 0x3C58 (8)
	struct ABP-HeartBeatSensorEffect_C HeartBeatSensorEffect; // 0x3C60 (8)

	char IsEnableSpawnSupplyBox(struct UActor TargetActor, struct FString& OutResult); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.IsEnableSpawnSupplyBox(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	char IsInstancedFoliageActor(struct UActor TargetActor); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.IsInstancedFoliageActor(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void GetMainWidget(struct UBravoHotelMainWidget& MainWidget); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.GetMainWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 3P_Cam_Z__FinishedFunc(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.3P_Cam_Z__FinishedFunc(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 3P_Cam_Z__UpdateFunc(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.3P_Cam_Z__UpdateFunc(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_19(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_19(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_RightMouseButton_K2Node_InputKeyEvent_18(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_RightMouseButton_K2Node_InputKeyEvent_18(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_One_K2Node_InputKeyEvent_17(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_One_K2Node_InputKeyEvent_17(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Two_K2Node_InputKeyEvent_16(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Two_K2Node_InputKeyEvent_16(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Three_K2Node_InputKeyEvent_15(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Three_K2Node_InputKeyEvent_15(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Four_K2Node_InputKeyEvent_14(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Four_K2Node_InputKeyEvent_14(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Five_K2Node_InputKeyEvent_13(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Five_K2Node_InputKeyEvent_13(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Six_K2Node_InputKeyEvent_12(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Six_K2Node_InputKeyEvent_12(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Seven_K2Node_InputKeyEvent_11(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Seven_K2Node_InputKeyEvent_11(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Eight_K2Node_InputKeyEvent_10(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Eight_K2Node_InputKeyEvent_10(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_One_K2Node_InputKeyEvent_9(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_One_K2Node_InputKeyEvent_9(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_Two_K2Node_InputKeyEvent_8(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_Two_K2Node_InputKeyEvent_8(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_Three_K2Node_InputKeyEvent_7(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_Three_K2Node_InputKeyEvent_7(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_Four_K2Node_InputKeyEvent_6(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_Four_K2Node_InputKeyEvent_6(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_Five_K2Node_InputKeyEvent_5(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_Five_K2Node_InputKeyEvent_5(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_Six_K2Node_InputKeyEvent_4(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_Six_K2Node_InputKeyEvent_4(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_Seven_K2Node_InputKeyEvent_3(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_Seven_K2Node_InputKeyEvent_3(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_Ctrl_Eight_K2Node_InputKeyEvent_2(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_Ctrl_Eight_K2Node_InputKeyEvent_2(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InpActEvt_NumPadZero_K2Node_InputKeyEvent_1(struct FKey Key); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.InpActEvt_NumPadZero_K2Node_InputKeyEvent_1(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ReceiveBeginPlay(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.ReceiveBeginPlay(Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ReceiveTick(float DeltaSeconds); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.ReceiveTick(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetCharacterIntheWater(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.SetCharacterIntheWater(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnDeath(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.OnDeath(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnSaveInventoryData(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.OnSaveInventoryData(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AddPerkEvent(struct FPerkInfo& PerkInfo, struct FDisplayAbility& InCurrentDisplayAbility, int32_t LastLevel, int32_t ClassLevel, enum class EPerkLevelUpType LevelUpType); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.AddPerkEvent(Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void RemovePerkLevelUI(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.RemovePerkLevelUI(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CreatePerkLevelUI(int32_t Count); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.CreatePerkLevelUI(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void PerkSpinEvent(char bShow, int32_t Count, enum class EPerkSlotFlag Slot); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.PerkSpinEvent(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowAmplifierEffect(char IsAmplifierEffect, float AmplifierLength); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.ShowAmplifierEffect(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnLanded(struct FHitResult& Hit); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.OnLanded(Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ReadyGivePerkEvent(); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.ReadyGivePerkEvent(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void KillGivePerkEvent(int32_t KillCount); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.KillGivePerkEvent(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowHeartBeatSensorEffect(char IsHeartBeatSensorEffect, float HeartBeatSensorLength); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.ShowHeartBeatSensorEffect(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_BP-BattleRoyalePawn(int32_t EntryPoint); // Function BP-BattleRoyalePawn.BP-BattleRoyalePawn_C.ExecuteUbergraph_BP-BattleRoyalePawn(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
