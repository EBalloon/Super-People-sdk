...
public:
	...
	void OnClosePerkPopup(); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.OnClosePerkPopup(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetBlockInput(char bBlock); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.SetBlockInput(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void StartOpen(); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.StartOpen(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void CheckAllOpened(char& AllOpened); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.CheckAllOpened(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void OpenAllPerk(); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.OpenAllPerk(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void CreateOpenedPerkPopup(struct TArray<Unknown>& OptionList); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.CreateOpenedPerkPopup(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void EndOpen(struct Unknown ItemOption); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.EndOpen(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddPerkList(struct Unknown& ItemOption); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.AddPerkList(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetButtonList(struct TArray<Unknown>& OptionIDList); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.SetButtonList(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetWeaponInfo(struct Unknown CraftWeapon); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.SetWeaponInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Construct(); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	...
	void SetEventCreateOpenedPerkPopup(struct TArray<Unknown>& OptionList); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.SetEventCreateOpenedPerkPopup(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	...
	void ExecuteUbergraph_UW-Lobby_Craft_Success_PerkSelect(int32_t EntryPoint); // Function UW-Lobby_Craft_Success_PerkSelect.UW-Lobby_Craft_Success_PerkSelect_C.ExecuteUbergraph_UW-Lobby_Craft_Success_PerkSelect(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
