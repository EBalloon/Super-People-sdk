...
public:
	...
	void CheckLanguageIndex(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.CheckLanguageIndex(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnChangedArmoryTab(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.OnChangedArmoryTab(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnSelectedCrafting(int32_t CraftingID); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.OnSelectedCrafting(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void ClearCategory(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.ClearCategory(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
