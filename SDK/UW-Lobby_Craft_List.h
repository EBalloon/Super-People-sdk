...
public:
	...
	void CheckLanguageIndex(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.CheckLanguageIndex(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnChangedArmoryTab(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.OnChangedArmoryTab(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnSelectedCrafting(int32_t CraftingID); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.OnSelectedCrafting(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetOwn(char NewOwn, char NewOwnAny); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.SetOwn(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void DefaultSelectButton(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.DefaultSelectButton(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SelectCraftingInfo(int32_t CraftingID); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.SelectCraftingInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CheckLastCategory(struct UUW-Lobby_Craft_List_Category_C NewOpendWidget); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.CheckLastCategory(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ResetLastCategory(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.ResetLastCategory(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CheckOwn(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.CheckOwn(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnChangedWeaponType(struct FString WeaponType); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.OnChangedWeaponType(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ClearCategory(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.ClearCategory(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void InitCraftingCategory(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.InitCraftingCategory(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Construct(); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-Lobby_Craft_List(int32_t EntryPoint); // Function UW-Lobby_Craft_List.UW-Lobby_Craft_List_C.ExecuteUbergraph_UW-Lobby_Craft_List(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
