// AttackBomb_WeaponComponent_C AttackBomb_WeaponComponent.AttackBomb_WeaponComponent_C
// Size: 0x112 (Inherited: 0x1230)
struct UAttackBomb_WeaponComponent_C : UMaster_WeaponComponent_C {
	...
	None UberGraphFrame; // 0x520(0x08)
	None OnButtonHoverAnim; // 0x528(0x08)
	None Btn_BkgHoverGradient; // 0x530(0x08)
	None Btn_BkgPress; // 0x538(0x08)
	None Btn_Fill; // 0x540(0x08)
	None Btn_HoverStroke; // 0x548(0x08)
	None Btn_Stroke; // 0x550(0x08)
	None ButtonBackground; // 0x558(0x08)
	None CarouselControls; // 0x560(0x08)
	None CarouselHeaderWrapper; // 0x568(0x08)
	None Challenge0; // 0x570(0x08)
	None Challenge1; // 0x578(0x08)
	None Challenge2; // 0x580(0x08)
	None ContractsDisplay; // 0x588(0x08)
	None CTAWrapper; // 0x590(0x08)
	None HitTarget; // 0x598(0x08)
	None LeftNavPrompt_2; // 0x5a0(0x08)
	None NavLeftSwitcher; // 0x5a8(0x08)
	None NavRightSwitcher; // 0x5b0(0x08)
	None RightNavPrompt; // 0x5b8(0x08)
	None RotatorButtons; // 0x5c0(0x08)
	None ScrollLeftButton; // 0x5c8(0x08)
	None ScrollLeftButton_2; // 0x5d0(0x08)
	None WaitingForChallenges; // 0x5d8(0x08)
	None WBP_CallToAction; // 0x5e0(0x08)
	None WBP_Header3; // 0x5e8(0x08)
	None WBP_NewsRotatorButton; // 0x5f0(0x08)
	None ChallengeRenderers; // 0x5f8(0x10)
	None SceneOwner; // 0x608(0x08)
	None CompoundHover; // 0x610(0x01)
	None CurrentChallengeDataTableRow; // 0x614(0x08)
	None CurrentChallengeDataTableTag; // 0x61c(0x08)
	None ContractsTag; // 0x624(0x08)
	None UberGraphFrame; // 0x520(0x08)
	None OnClick; // 0x528(0x08)
	None Highlight; // 0x530(0x08)
	None BtnEdge; // 0x538(0x08)
	None BtnFill; // 0x540(0x08)
	None BtnFillGradient; // 0x548(0x08)
	None BtnFrame; // 0x550(0x08)
	None BtnShimmer; // 0x558(0x08)
	None BtnStandardWrapper; // 0x560(0x08)
	None ButtonText; // 0x568(0x08)
	None HitTarget; // 0x570(0x08)
	None KeyPrompt; // 0x578(0x08)
	None KeyPromptContainer; // 0x580(0x08)
	None SizeWrapper; // 0x588(0x08)
	None OnClicked; // 0x590(0x10)
	None OnHovered; // 0x5a0(0x10)
	None OnUnhovered; // 0x5b0(0x10)
	None ClickMedBtnSFX; // 0x5c0(0x08)
	None DefaultButtonText; // 0x5c8(0x18)
	None DefaultWidth; // 0x5e0(0x04)
	None ShowPromptOnFocus; // 0x5e4(0x01)
	None PromptKey; // 0x5e8(0x18)
	None HoverMedBtnSFX; // 0x600(0x08)
	None IsConfirm; // 0x608(0x01)
	None IsCancel; // 0x609(0x01)
	None UberGraphFrame; // 0x520(0x08)
	None BorderBackground; // 0x528(0x08)
	None Gradient; // 0x530(0x08)
	None ItemPreview2D; // 0x538(0x08)
	None RarityElementWrapper; // 0x540(0x08)
	None ScanLines; // 0x548(0x08)
	None SizeConstraint; // 0x550(0x08)
	None Title; // 0x558(0x08)
	None TitleDisplay; // 0x560(0x08)
	None WBP_ReactiveWrapStepPreview; // 0x568(0x08)
	None CharacterIndex; // 0x570(0x01)
	None ModelName; // 0x574(0x08)
	None JobItem; // 0x580(0x08)
	None PreviewActor; // 0x588(0x08)
	None DisplayReactiveDetails; // 0x590(0x01)
	None OwningSceneName; // 0x594(0x08)
	None WeaponOverride; // 0x5a0(0x08)
	None FOV; // 0x28(0x04)
	None StatsToCollect; // 0x30(0x10)
	None MapsToProfile; // 0x40(0x10)
	None StartingOffsetTime; // 0x50(0x04)
	None NumberOfSamples; // 0x54(0x04)
	None TimeBetweenSamples; // 0x58(0x04)
	None Profiles; // 0x60(0x10)
	None SplineCamPosComponent; // 0x220(0x08)
	None CamComponent; // 0x228(0x08)
	None SplineCamLookAtComponent; // 0x230(0x08)
	None SplineDuration; // 0x238(0x04)
	None NumOfCaptures; // 0x23c(0x04)
	None K2Node_Event_SkyDiver_3; // 0x1230(0x08)
	None CallFunc_DoesCharacterHaveHoverboard_Has_Hoverboard; // 0x1238(0x01)
	None K2Node_Event_SkyDiver_2; // 0x1240(0x08)
	None K2Node_Event_SkyDiver; // 0x1248(0x08)
	None K2Node_Event_OldState; // 0x1250(0x01)
	None K2Node_Event_NewState; // 0x1251(0x01)
	None K2Node_SwitchEnum_CmpSuccess; // 0x1252(0x01)
	None CallFunc_DoesCharacterHaveBackpack_HasBackpack; // 0x1253(0x01)
	None CallFunc_DoesCharacterHaveBackpack_HasBackpack_2; // 0x1254(0x01)
	...
	void InitializeChallengeData(); // InitializeChallengeData WBP_Challenge_Panel_v2.WBP_Challenge_Panel_v2_C.InitializeChallengeData // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x260f470>
	void GetGamepadPromptKey(None& HasValidKeyPrompt, None& GamepadKey); // GetGamepadPromptKey WBP_YellowButton.WBP_YellowButton_C.GetGamepadPromptKey // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game+0x260f470>
	void SetPreviewActor(); // SetPreviewActor WBP_ItemPreviewStack.WBP_ItemPreviewStack_C.SetPreviewActor // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x260f470>
	void InitPerfMovementAndCapture(); // InitPerfMovementAndCapture HiRezAutomation.PerfSpline.InitPerfMovementAndCapture // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x260f470>
	void OnSkyDiveStarted(None bpp__SkyDiver__pf); // OnSkyDiveStarted AttackBomb_WeaponComponent.AttackBomb_WeaponComponent_C.OnSkyDiveStarted // (Native|Event|Public) // <Game+0x192c8c0>
};
