...
public:
	...
	void Divide(int32_t Value1, int32_t& RetS1, int32_t& RetS2); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.Divide(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void StopSound(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.StopSound(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void 鉹@t元_7(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_7(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void 鉹@t元_8(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_8(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void CustomEvent(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void CustomEvent_2(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void CustomEvent_3(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_3(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void CustomEvent_4(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_4(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void SetGold(int32_t AddGold, int32_t GetGold); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.SetGold(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void CustomEvent_5(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_5(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void 鉹@t元_1(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void 鉹@t元_2(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_UW-RewardGoldSlot(int32_t EntryPoint); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.ExecuteUbergraph_UW-RewardGoldSlot(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
