...
public:
	...
	struct UWidgetAnimation Ani_Gold; // 0x250 (8)
	struct UTextBlock 1; // 0x258 (8)
	struct UTextBlock 10; // 0x260 (8)
	struct UTextBlock 100; // 0x268 (8)
	struct UTextBlock 1000; // 0x270 (8)
	struct UImage BonusBG; // 0x278 (8)
	struct UImage BrightSpot_01; // 0x280 (8)
	struct UImage BrightSpot_02; // 0x288 (8)
	struct UImage BrightSpot_03; // 0x290 (8)
	struct UImage BrightSpot_04; // 0x298 (8)
	struct UImage BrightSpot_05; // 0x2A0 (8)
	struct UTextBlock Empty; // 0x2A8 (8)
	struct UImage Glow_01; // 0x2B0 (8)
	struct UImage Gold; // 0x2B8 (8)
	struct UImage Image_7; // 0x2C0 (8)
	struct UImage Image_11; // 0x2C8 (8)
	struct UImage Image_14; // 0x2D0 (8)
	struct UImage Image_15; // 0x2D8 (8)
	struct UImage Image_16; // 0x2E0 (8)
	struct UImage Image_17; // 0x2E8 (8)
	struct UImage Image_18; // 0x2F0 (8)
	struct UImage Image_20; // 0x2F8 (8)
	struct UImage Image_21; // 0x300 (8)
	struct UImage Image_22; // 0x308 (8)
	struct UImage Image_23; // 0x310 (8)
	struct UImage Image_335; // 0x318 (8)
	struct UImage Image_1473; // 0x320 (8)
	struct UImage Light; // 0x328 (8)
	struct UImage Light_01; // 0x330 (8)
	struct UImage Light_02; // 0x338 (8)
	struct UImage Light_03; // 0x340 (8)
	struct UImage Light_04; // 0x348 (8)
	struct UImage Light_05; // 0x350 (8)
	struct UImage Light_06; // 0x358 (8)
	struct UTextBlock PickUpGold; // 0x360 (8)
	struct UImage RIng_Glow_01; // 0x368 (8)
	struct UTextBlock TextBlock_4; // 0x370 (8)
	struct UImage TextLight_2; // 0x378 (8)
	struct UImage TextLight_3; // 0x380 (8)
	int32_t Save; // 0x388 (4)
	char NewVar_1 : 0; // 0x38C (1)
	char IsStopSound : 0; // 0x38D (1)
	float LoopSountStartTime; // 0x390 (4)
	struct FAudioPlayingHandle LoopSound; // 0x394 (4)
	...
	void Divide(int32_t Value1, int32_t& RetS1, int32_t& RetS2); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.Divide(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void StopSound(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.StopSound(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 鉹@t元_7(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_7(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 鉹@t元_8(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_8(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CustomEvent(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CustomEvent_2(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CustomEvent_3(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_3(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CustomEvent_4(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_4(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetGold(int32_t AddGold, int32_t GetGold); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.SetGold(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CustomEvent_5(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.CustomEvent_5(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 鉹@t元_1(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 鉹@t元_2(); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.鉹@t元_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-RewardGoldSlot(int32_t EntryPoint); // Function UW-RewardGoldSlot.UW-RewardGoldSlot_C.ExecuteUbergraph_UW-RewardGoldSlot(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
