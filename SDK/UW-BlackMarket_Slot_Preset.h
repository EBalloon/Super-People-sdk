...
public:
	...
	void SetIconTexture(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void OnLoaded_B9C38FBE4303B12CB7C28ABE281A371A(struct Object Loaded); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.OnLoaded_B9C38FBE4303B12CB7C28ABE281A371A(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void AysncLoading(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
