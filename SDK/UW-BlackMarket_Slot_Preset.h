...
public:
	...
	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	struct Unknown On_IMG-Over-Border_MouseButtonDown_1(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.On_IMG-Over-Border_MouseButtonDown_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnLoaded_B9C38FBE4303B12CB7C28ABE281A371A(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.OnLoaded_B9C38FBE4303B12CB7C28ABE281A371A(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Construct(); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_30_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.BndEvt__BTN-Menu02_K2Node_ComponentBoundEvent_30_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void RunCommand(); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.RunCommand(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_UW-BlackMarket_Slot_Preset(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Preset.UW-BlackMarket_Slot_Preset_C.ExecuteUbergraph_UW-BlackMarket_Slot_Preset(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B80160>
};
