...
public:
	...
	void SetMyKillMessage(struct FText Message); // Function UW-ListWidget_MyKillMessage.UW-ListWidget_MyKillMessage_C.SetMyKillMessage(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void PlayKillMessageAnim(); // Function UW-ListWidget_MyKillMessage.UW-ListWidget_MyKillMessage_C.PlayKillMessageAnim(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-ListWidget_MyKillMessage(int32_t EntryPoint); // Function UW-ListWidget_MyKillMessage.UW-ListWidget_MyKillMessage_C.ExecuteUbergraph_UW-ListWidget_MyKillMessage(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
