...
public:
	...
	void OnLoaded_42EA96274FA324743778DBBB16312B12(struct Unknown Loaded); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.OnLoaded_42EA96274FA324743778DBBB16312B12(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetData(struct Unknown Data, char SetEmpty); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.SetData(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetEmpty(); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.SetEmpty(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	...
	void OnDragLeave(struct Unknown PointerEvent, struct Unknown Operation); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.OnDragLeave(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void CheckClick(); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.CheckClick(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-PersonalSupplyBoxConsumableItemSlotWidget(int32_t EntryPoint); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.ExecuteUbergraph_UW-PersonalSupplyBoxConsumableItemSlotWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void OnRightClickEventDispatcher__DelegateSignature(struct Unknown Slot); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.OnRightClickEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void OnChangeSlotEventDispatcher__DelegateSignature(struct Unknown Source, struct Unknown Target); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.OnChangeSlotEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ShowToolTipEventDispatcher__DelegateSignature(char IsShow, struct Unknown Slot); // Function UW-PersonalSupplyBoxConsumableItemSlotWidget.UW-PersonalSupplyBoxConsumableItemSlotWidget_C.ShowToolTipEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
