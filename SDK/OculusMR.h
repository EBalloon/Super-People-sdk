...
public:
	...
	struct UOculusMR_BoundaryMeshComponent BoundaryMeshComponent; // 0x318 (8)
};
...
public:
	...
	struct UVRNotificationsComponent VRNotificationComponent; // 0x330 (8)
	struct UTexture2D CameraColorTexture; // 0x338 (8)
	struct UTexture2D CameraDepthTexture; // 0x340 (8)
	struct UOculusMR_PlaneMeshComponent PlaneMeshComponent; // 0x348 (8)
	struct UMaterial ChromaKeyMaterial; // 0x350 (8)
	struct UMaterial ChromaKeyLitMaterial; // 0x358 (8)
	struct UMaterial OpaqueColoredMaterial; // 0x360 (8)
	struct UMaterialInstanceDynamic ChromaKeyMaterialInstance; // 0x368 (8)
	struct UMaterialInstanceDynamic ChromaKeyLitMaterialInstance; // 0x370 (8)
	struct UMaterialInstanceDynamic CameraFrameMaterialInstance; // 0x378 (8)
	struct UMaterialInstanceDynamic BackdropMaterialInstance; // 0x380 (8)
	struct AOculusMR_BoundaryActor BoundaryActor; // 0x388 (8)
	struct ASceneCapture2D BoundarySceneCaptureActor; // 0x390 (8)
	struct UTexture2D DefaultTexture_White; // 0x398 (8)
	struct TArray<struct UTextureRenderTarget2D> BackgroundRenderTargets; // 0x3F8 (16)
	struct ASceneCapture2D ForegroundCaptureActor; // 0x408 (8)
	struct TArray<struct UTextureRenderTarget2D> ForegroundRenderTargets; // 0x410 (16)
	struct UOculusMR_Settings MRSettings; // 0x420 (8)
	struct UOculusMR_State MRState; // 0x428 (8)
};
