...
public:
	...
	void Construct(); // Function UW-LoadingRichText.UW-LoadingRichText_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-LoadingRichText(int32_t EntryPoint); // Function UW-LoadingRichText.UW-LoadingRichText_C.ExecuteUbergraph_UW-LoadingRichText(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
