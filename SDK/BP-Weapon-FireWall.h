...
public:
	...
	void K2_OnEquip(); // Function BP-Weapon-FireWall.BP-Weapon-FireWall_C.K2_OnEquip(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void K2_OnUnEquip(); // Function BP-Weapon-FireWall.BP-Weapon-FireWall_C.K2_OnUnEquip(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_BP-Weapon-FireWall(int32_t EntryPoint); // Function BP-Weapon-FireWall.BP-Weapon-FireWall_C.ExecuteUbergraph_BP-Weapon-FireWall(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
