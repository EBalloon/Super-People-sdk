...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M9.ABP-M9_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_ABP-M9(int32_t EntryPoint); // Function ABP-M9.ABP-M9_C.ExecuteUbergraph_ABP-M9(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
