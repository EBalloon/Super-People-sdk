...
public:
	...
	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void OnLoaded_9CBCD238440D1A899A0522A5A29885AA(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.OnLoaded_9CBCD238440D1A899A0522A5A29885AA(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void SetData(struct Unknown Data); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.SetData(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void BndEvt__BTN-Menu03_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.BndEvt__BTN-Menu03_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.BndEvt__BTN-Menu04_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-BlackMarket_Slot_Perk(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Perk.UW-BlackMarket_Slot_Perk_C.ExecuteUbergraph_UW-BlackMarket_Slot_Perk(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
