...
public:
	...
	void AnimGraph(struct Unknown InPose, struct Unknown& AnimGraph); // Function ABP-Mannequin-PostProcess.ABP-Mannequin-PostProcess_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
