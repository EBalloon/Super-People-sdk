...
public:
	...
	void Set SubType(enum class EKeySettingSubType SubType); // Function SubTitleSlotWidget.SubTitleSlotWidget_C.Set SubType(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
