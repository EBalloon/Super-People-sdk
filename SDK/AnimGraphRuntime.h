...
struct UAnimNotify_PlayMontageNotify : UAnimNotify {
	struct FName NotifyName; //  0x38 Size(8)
};

// Class AnimGraphRuntime.AnimNotify_PlayMontageNotifyWindow
struct UAnimNotify_PlayMontageNotifyWindow : UAnimNotifyState {
	struct FName NotifyName; //  0x30 Size(8)
};

// Class AnimGraphRuntime.PlayMontageCallbackProxy
struct UPlayMontageCallbackProxy : Object {
	struct FMulticastInlineDelegate OnCompleted; //  0x28 Size(10)
	struct FMulticastInlineDelegate OnBlendOut; //  0x38 Size(10)
	struct FMulticastInlineDelegate OnInterrupted; //  0x48 Size(10)
