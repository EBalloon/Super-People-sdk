...
public:
	...
	void UserConstructionScript(); // Function BP-Camaro_Disappear.BP-Camaro_Disappear_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
};
