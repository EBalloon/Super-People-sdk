...
public:
	...
	void UserConstructionScript(); // Function BP-Camaro_Disappear.BP-Camaro_Disappear_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
