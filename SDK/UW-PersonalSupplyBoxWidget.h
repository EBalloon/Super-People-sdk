...
public:
	...
	void GetEmptySlot(char& bRet, struct Unknown& Slot); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.GetEmptySlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	char OnDrop(struct Unknown MyGeometry, struct Unknown PointerEvent, struct Unknown Operation); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.OnDrop(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void GetConsumableItemSlot(int32_t Index, struct Unknown& Widget); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.GetConsumableItemSlot(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	struct Unknown OnGenerateWidget_2(struct FString Item); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.OnGenerateWidget_2(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	struct Unknown OnGenerateWidget_1(struct FString Item); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.OnGenerateWidget_1(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	struct Unknown CraeteWeaponItemSlots(); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.CraeteWeaponItemSlots(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	struct Unknown CraeteConsumableItemSlots(); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.CraeteConsumableItemSlots(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Construct(); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	...
	void 鉹@t元_1(struct Unknown ConsumalbeItemDat, int32_t SlotIndex); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetConsumableItemData(int32_t SlotIndex, struct Unknown& ConsumableItem, char SetEmpty); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.SetConsumableItemData(Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetWeaponData(struct Unknown& WeaponItem, char IsDefaultWeapon); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.SetWeaponData(Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_2(struct Unknown WeaponData); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Destruct(); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.Destruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetTotalPrice(int32_t Price); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.SetTotalPrice(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetFree(char IsFree, int32_t FreeCount); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.SetFree(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetOwnGold(int32_t OwnGold); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.SetOwnGold(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_3(char IsShow, struct Unknown Slot); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_3(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	...
	void 鉹@t元_4(char IsShow, struct Unknown Widget); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_4(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_5(enum class Unknow PrevState, enum class Unknow CurrentState); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_5(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Close(); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.Close(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_6(); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_6(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_7(); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_7(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ShowConsumableSlotHoverEffect(char IsHover); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.ShowConsumableSlotHoverEffect(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void EquipSlot(struct Unknown Slot); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.EquipSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_8(struct Unknown Source, struct Unknown Target); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_8(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_9(struct Unknown Slot); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_9(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void EquipWeaponSlot(struct Unknown Slot); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.EquipWeaponSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void 鉹@t元_10(struct Unknown Weapon); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.鉹@t元_10(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetEnoughtGold(char IsEnought); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.SetEnoughtGold(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-PersonalSupplyBoxWidget(int32_t EntryPoint); // Function UW-PersonalSupplyBoxWidget.UW-PersonalSupplyBoxWidget_C.ExecuteUbergraph_UW-PersonalSupplyBoxWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
