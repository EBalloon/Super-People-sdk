...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-SKS.ABP-SKS_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_ABP-SKS(int32_t EntryPoint); // Function ABP-SKS.ABP-SKS_C.ExecuteUbergraph_ABP-SKS(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
