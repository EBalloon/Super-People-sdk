...
public:
	...
	void Destory(); // Function UW-CompanyLogo.UW-CompanyLogo_C.Destory(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void MoveNextScene(); // Function UW-CompanyLogo.UW-CompanyLogo_C.MoveNextScene(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Construct(); // Function UW-CompanyLogo.UW-CompanyLogo_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void 鉹@t元_1(); // Function UW-CompanyLogo.UW-CompanyLogo_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-CompanyLogo(int32_t EntryPoint); // Function UW-CompanyLogo.UW-CompanyLogo_C.ExecuteUbergraph_UW-CompanyLogo(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
