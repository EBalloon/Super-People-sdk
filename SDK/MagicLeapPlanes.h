...
struct UMagicLeapPlanesComponent : USceneComponent {
	...
	char RequestPlanesAsync(); // Function MagicLeapPlanes.MagicLeapPlanesComponent.RequestPlanesAsync(Final|Native|Public|BlueprintCallable) // <Game+0x17ee730>
};
