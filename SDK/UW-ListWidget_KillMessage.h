...
public:
	...
	void PlayUpDownAnim(); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.PlayUpDownAnim(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ResetInfos(); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.ResetInfos(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetBroadcastTypeIcon(enum class EBroadCastKillMessageType MessageType); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.SetBroadcastTypeIcon(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void GetTeamType(struct ABravoHotelPlayerState PlayerState, enum class EBroadCastTeamType& TeamType); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.GetTeamType(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	...
	void SetBGColor(enum class EBroadCastKillMessageType MessageType); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.SetBGColor(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void OnLoaded_E905D98740C8E2F4A90B4C89D663ACAA(struct Object Loaded); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.OnLoaded_E905D98740C8E2F4A90B4C89D663ACAA(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void OnLoaded_342F68DF4CB26590AC0C9EA8C343CCF1(struct Object Loaded); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.OnLoaded_342F68DF4CB26590AC0C9EA8C343CCF1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void SetKillMessageInfo(struct FKillBroadcastUIInfo& Info); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.SetKillMessageInfo(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_UW-ListWidget_KillMessage(int32_t EntryPoint); // Function UW-ListWidget_KillMessage.UW-ListWidget_KillMessage_C.ExecuteUbergraph_UW-ListWidget_KillMessage(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
