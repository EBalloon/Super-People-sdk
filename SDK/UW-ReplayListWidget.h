...
public:
	...
	void GetBattleModeString(int32_t Idx, struct FText& Str); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.GetBattleModeString(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Activate(enum class Unknow Visibility); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.Activate(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void UpdateKeep(); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.UpdateKeep(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void UpdateTotalSize(); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.UpdateTotalSize(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SelectedListItem(struct Unknown ItemInfo); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.SelectedListItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_40713CDC488A1CF8D5EDBDBAEA95837C(struct Unknown Loaded); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.OnLoaded_40713CDC488A1CF8D5EDBDBAEA95837C(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_167167B5465D6F8A61D1C89B5E25D686(struct Unknown Loaded); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.OnLoaded_167167B5465D6F8A61D1C89B5E25D686(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_2738E50F4D6EF574498E78A88D8D1A93(struct Unknown Loaded); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.OnLoaded_2738E50F4D6EF574498E78A88D8D1A93(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_945B406843BC9B1A380D21ACD9EE830F(struct Unknown Loaded); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.OnLoaded_945B406843BC9B1A380D21ACD9EE830F(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_F91776604E3BB97FDD80308C25A54425(struct Unknown Loaded); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.OnLoaded_F91776604E3BB97FDD80308C25A54425(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_156EB2D94B8C00F9352201B8E4AAD20A(struct Unknown Loaded); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.OnLoaded_156EB2D94B8C00F9352201B8E4AAD20A(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void UpdateReplayListItems(); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.UpdateReplayListItems(Event|Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void CustomEvent_2(struct Unknown ItemInfo); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.CustomEvent_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncIcon1(struct Unknown Image, struct Unknown Target); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.AsyncIcon1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncClassIcon(struct Unknown Image, struct Unknown Target); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.AsyncClassIcon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncMapImage(struct Unknown Image, struct Unknown Target); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.AsyncMapImage(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncIcon2(struct Unknown Image, struct Unknown Target); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.AsyncIcon2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncIcon3(struct Unknown Image, struct Unknown Target); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.AsyncIcon3(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncIcon4(struct Unknown Image, struct Unknown Target); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.AsyncIcon4(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-ReplayListWidget(int32_t EntryPoint); // Function UW-ReplayListWidget.UW-ReplayListWidget_C.ExecuteUbergraph_UW-ReplayListWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
