...
public:
	...
	void SetTutorialInfo(enum class Unknow SkillType); // Function UW-Radar_tutorial.UW-Radar_tutorial_C.SetTutorialInfo(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnLoaded_22BC0859447517E514C09EA47A9A913D(struct Unknown Loaded); // Function UW-Radar_tutorial.UW-Radar_tutorial_C.OnLoaded_22BC0859447517E514C09EA47A9A913D(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void SetGuideIconAsyncLoad(struct Unknown Image); // Function UW-Radar_tutorial.UW-Radar_tutorial_C.SetGuideIconAsyncLoad(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
