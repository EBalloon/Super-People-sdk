...
public:
	...
	void Get Key Combination Display Name(struct FString Separator, struct FString No Key Display, char Display Type, struct FString& Display Name); // Function BP_KeyCombination.BP_KeyCombination_C.Get Key Combination Display Name(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Add Key Input(struct Unknown InputPin, struct Unknown& Input); // Function BP_KeyCombination.BP_KeyCombination_C.Add Key Input(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Equal All Keys(struct TArray<Unknown>& Combination, char& Result); // Function BP_KeyCombination.BP_KeyCombination_C.Equal All Keys(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Equal All Conflicts(struct TArray<Unknown>& Conflicts, char& Result); // Function BP_KeyCombination.BP_KeyCombination_C.Equal All Conflicts(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Evaluate Blocking Combinations(struct Unknown Player Controller, char& Is Active, char& Just Pressed, char& Just Released); // Function BP_KeyCombination.BP_KeyCombination_C.Evaluate Blocking Combinations(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Clear Conflicting Combinations(); // Function BP_KeyCombination.BP_KeyCombination_C.Clear Conflicting Combinations(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Add Conflicting Combination(struct Unknown Conflicted Combination, char Conflicted ); // Function BP_KeyCombination.BP_KeyCombination_C.Add Conflicting Combination(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Detect Conflict(struct Unknown Input Combination, char& Conflict Type); // Function BP_KeyCombination.BP_KeyCombination_C.Detect Conflict(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Replace Key Combination(struct TArray<Unknown>& Key Combination); // Function BP_KeyCombination.BP_KeyCombination_C.Replace Key Combination(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Load Key Combination(struct Unknown Game Settings, struct FString Action Name, struct FString Category, struct FString Name, char Primary); // Function BP_KeyCombination.BP_KeyCombination_C.Load Key Combination(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Save Key Combination(struct Unknown Game Settings, struct Unknown& KeySave); // Function BP_KeyCombination.BP_KeyCombination_C.Save Key Combination(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Key Combination Current State(struct Unknown Player Controller, char Ignore Conflicts, float& Axis Value, char& Is Active, char& Just Pressed, char& Just Released); // Function BP_KeyCombination.BP_KeyCombination_C.Key Combination Current State(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Init Key Combination(struct FString Name, char Can't Be None, struct TArray<Unknown>& Key Combination, struct Unknown& Combination); // Function BP_KeyCombination.BP_KeyCombination_C.Init Key Combination(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Combination Updated__DelegateSignature(struct Unknown Combination); // Function BP_KeyCombination.BP_KeyCombination_C.Combination Updated__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
