...
public:
	...
	void StackDamageLog(struct Unknown& DamageLogInfo); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.StackDamageLog(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void CheckCanStackDamage Log(struct Unknown& DamageLogInfo, char& CanStack); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.CheckCanStackDamage Log(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetHitDamageLogInfo(struct Unknown& DamageLogInfo); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetHitDamageLogInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void SetCoreInfoResuscitation(struct Unknown PlayerState); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetCoreInfoResuscitation(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetRequestMessageInfo(struct Unknown PlayerState, struct FText Message); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetRequestMessageInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetRequestMessage(struct Unknown Player State, struct FText Message); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetRequestMessage(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void SetCoreInfoRoutePing(struct Unknown PlayerState); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetCoreInfoRoutePing(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void SetPlayerInfo(struct Unknown PlayerState); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetPlayerInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetPingType(struct Unknown PingInfo); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetPingType(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetCoreInfoSmartping(struct Unknown PlayerState); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.SetCoreInfoSmartping(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnAnimationFinished(struct Unknown Animation); // Function UW-CoreInfoWidgetItem.UW-CoreInfoWidgetItem_C.OnAnimationFinished(BlueprintCosmetic|Event|Protected|BlueprintEvent) // <Game_BE.exe+0x2B80160>
