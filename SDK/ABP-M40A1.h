...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-M40A1.ABP-M40A1_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_ABP-M40A1(int32_t EntryPoint); // Function ABP-M40A1.ABP-M40A1_C.ExecuteUbergraph_ABP-M40A1(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
