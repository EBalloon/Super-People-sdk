...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-RPG.ABP-RPG_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_ABP-RPG(int32_t EntryPoint); // Function ABP-RPG.ABP-RPG_C.ExecuteUbergraph_ABP-RPG(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
