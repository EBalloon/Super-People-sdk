...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-RPG.ABP-RPG_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_ABP-RPG(int32_t EntryPoint); // Function ABP-RPG.ABP-RPG_C.ExecuteUbergraph_ABP-RPG(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
