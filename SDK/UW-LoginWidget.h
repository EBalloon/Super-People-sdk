...
public:
	...
	struct UWidgetAnimation Blink; // 0x250 (8)
	struct UWidgetAnimation FadeIn; // 0x258 (8)
	struct UButton Button_480; // 0x260 (8)
	struct UButton Button_482; // 0x268 (8)
	struct UButton Button_483; // 0x270 (8)
	struct UButton Button_484; // 0x278 (8)
	struct UButton Button_485; // 0x280 (8)
	struct UButton Button_486; // 0x288 (8)
	struct UButton Button_ExitGame; // 0x290 (8)
	struct UButton Button_Retry; // 0x298 (8)
	struct UCanvasPanel CanvasPanel_10; // 0x2A0 (8)
	struct UCanvasPanel CanvasPanel_143; // 0x2A8 (8)
	struct UCanvasPanel CanvasPanel_Default; // 0x2B0 (8)
	struct UCanvasPanel CanvasPanel_JuvenileRestricted; // 0x2B8 (8)
	struct UCanvasPanel CanvasPanel_RestrictedUser; // 0x2C0 (8)
	struct UCanvasPanel CanvasPanel_ServerInspection; // 0x2C8 (8)
	struct UCanvasPanel CanvasPanel_UnableToConnectServer; // 0x2D0 (8)
	struct UCanvasPanel CanvasPanel_WaitingServer; // 0x2D8 (8)
	struct UHorizontalBox HorizontalBox_1; // 0x2E0 (8)
	struct UHorizontalBox HorizontalBox_2; // 0x2E8 (8)
	struct UImage Image_122; // 0x2F0 (8)
	struct UImage Image_123; // 0x2F8 (8)
	struct UImage Image_309; // 0x300 (8)
	struct UImage Image_bg; // 0x308 (8)
	struct USizeBox SizeBox; // 0x310 (8)
	struct USizeBox SizeBox_2; // 0x318 (8)
	struct USizeBox SizeBox_85; // 0x320 (8)
	struct UTextBlock TextBlock; // 0x328 (8)
	struct UTextBlock TextBlock_2; // 0x330 (8)
	struct UTextBlock TextBlock_3; // 0x338 (8)
	struct UTextBlock TextBlock_4; // 0x340 (8)
	struct UTextBlock TextBlock_544; // 0x348 (8)
	struct UTextBlock TextBlock_546; // 0x350 (8)
	struct UTextBlock TextBlock_Desc; // 0x358 (8)
	struct UTextBlock TextBlock_EndTime; // 0x360 (8)
	struct UThrobber Throbber_1; // 0x368 (8)
	struct UThrobber Throbber_979; // 0x370 (8)
	struct UTextBlock TXT-Waitting; // 0x378 (8)
	struct UWidgetSwitcher WidgetSwitcher_1; // 0x380 (8)
	struct UBP-TitleWidget_C TitleWidgetRef; // 0x388 (8)
	struct FString ErrorID; // 0x390 (16)
	int32_t ErrorIndex; // 0x3A0 (4)
	struct FString ErrorParameters; // 0x3A8 (16)
	struct UMediaPlayer MediaPlayer; // 0x3B8 (8)
	struct UFileMediaSource Media; // 0x3C0 (8)
	struct UMediaTexture MediaTexture; // 0x3C8 (8)
	struct UMediaSoundComponent MediaSoundComp; // 0x3D0 (8)
	int32_t ApplyUserInfoCount; // 0x3D8 (4)
	char bServicePlatformFlow : 0; // 0x3DC (1)

	void DefaultMessage(); // Function UW-LoginWidget.UW-LoginWidget_C.DefaultMessage(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ServicePlatformLogin(); // Function UW-LoginWidget.UW-LoginWidget_C.ServicePlatformLogin(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowBlock(); // Function UW-LoginWidget.UW-LoginWidget_C.ShowBlock(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void UodateWaitingUser(int32_t UserCount, int32_t Time); // Function UW-LoginWidget.UW-LoginWidget_C.UodateWaitingUser(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ShowNotice(int32_t Idx); // Function UW-LoginWidget.UW-LoginWidget_C.ShowNotice(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UW-LoginWidget.UW-LoginWidget_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_479_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-LoginWidget.UW-LoginWidget_C.BndEvt__Button_479_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_481_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(); // Function UW-LoginWidget.UW-LoginWidget_C.BndEvt__Button_481_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_485_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(); // Function UW-LoginWidget.UW-LoginWidget_C.BndEvt__Button_485_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_482_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature(); // Function UW-LoginWidget.UW-LoginWidget_C.BndEvt__Button_482_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_484_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature(); // Function UW-LoginWidget.UW-LoginWidget_C.BndEvt__Button_484_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnLoginSucceeded(); // Function UW-LoginWidget.UW-LoginWidget_C.OnLoginSucceeded(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnCreateCharacter_Event_1(); // Function UW-LoginWidget.UW-LoginWidget_C.OnCreateCharacter_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void WaitingUserDelegate_Event_1(int32_t WaitingUserCount, int32_t WaitingTime); // Function UW-LoginWidget.UW-LoginWidget_C.WaitingUserDelegate_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature(); // Function UW-LoginWidget.UW-LoginWidget_C.BndEvt__Button_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Destruct(); // Function UW-LoginWidget.UW-LoginWidget_C.Destruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Construct(); // Function UW-LoginWidget.UW-LoginWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CustomEvent_1(int32_t ErrorIndex, struct FString ErrorID, struct FString Parameters); // Function UW-LoginWidget.UW-LoginWidget_C.CustomEvent_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Login(); // Function UW-LoginWidget.UW-LoginWidget_C.Login(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void PressAnyKeyDelayTime(); // Function UW-LoginWidget.UW-LoginWidget_C.PressAnyKeyDelayTime(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void BndEvt__Button_1_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature(); // Function UW-LoginWidget.UW-LoginWidget_C.BndEvt__Button_1_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CustomEvent_2(struct FString Parameters); // Function UW-LoginWidget.UW-LoginWidget_C.CustomEvent_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void QuitGame(float DelayTime); // Function UW-LoginWidget.UW-LoginWidget_C.QuitGame(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-LoginWidget(int32_t EntryPoint); // Function UW-LoginWidget.UW-LoginWidget_C.ExecuteUbergraph_UW-LoginWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
...
inline void UUW-LoginWidget_C::Tick(struct FGeometry MyGeometry, float InDeltaTime) {
