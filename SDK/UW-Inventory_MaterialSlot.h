...
public:
	...
	struct UWidgetAnimation Anim_LoopHintMaterial; // 0x1368 (8)
	struct UWidgetAnimation Anim_Upgrade; // 0x1370 (8)
	struct UWidgetAnimation P_Upgrade_Arrow; // 0x1378 (8)
	struct UWidgetAnimation C_SlotHover_ItemState_Hide; // 0x1380 (8)
	struct UWidgetAnimation C_SlotHover_ItemState_Show; // 0x1388 (8)
	struct UWidgetAnimation Hover_Gold; // 0x1390 (8)
	struct UWidgetAnimation P_SlotHover; // 0x1398 (8)
	struct UImage BGImage; // 0x13A0 (8)
	struct UCanvasPanel CanvasPanel_ITemState; // 0x13A8 (8)
	struct UCanvasPanel CanvasPanel_Unnecessary; // 0x13B0 (8)
	struct UTextBlock Count; // 0x13B8 (8)
	struct UTextBlock Count_Icon; // 0x13C0 (8)
	struct UImage fill; // 0x13C8 (8)
	struct UImage Hint; // 0x13D0 (8)
	struct UImage HoverImage; // 0x13D8 (8)
	struct UImage HoverImage_Gold; // 0x13E0 (8)
	struct UImage Image_1; // 0x13E8 (8)
	struct UImage Image_2; // 0x13F0 (8)
	struct UImage Image_95; // 0x13F8 (8)
	struct UImage ItemImage; // 0x1400 (8)
	struct UTextBlock ItemNameName; // 0x1408 (8)
	struct UTextBlock ItemState_Text; // 0x1410 (8)
	struct UImage LvColor; // 0x1418 (8)
	struct UImage NeedMaterial; // 0x1420 (8)
	struct UImage OverBG_3; // 0x1428 (8)
	struct UProgressBar ProgressBar_136; // 0x1430 (8)
	struct USizeBox SizeBox_1; // 0x1438 (8)
	...
	void Get Weapon Infoby Inventory Item Info(char& bResult, struct FBravoHotelWeaponInfo& WeaponInfo); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.Get Weapon Infoby Inventory Item Info(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CanChange(char& Result); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.CanChange(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void DropQuantity(int32_t Quantity); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.DropQuantity(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetInfo(struct FInventoryItemInfo ItemInfo, int32_t SlotIndex); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.SetInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetItemRarityColor(enum class EItemRarity CurrentSlot, struct UImage ImageWidget); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.SetItemRarityColor(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void MouseEnterImpl(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.MouseEnterImpl(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetWeaponImage_Internal(struct UPaperSprite IconTexture); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.SetWeaponImage_Internal(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FSlateBrush Set Item Image Internal(struct UPaperSprite IconTexture); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.Set Item Image Internal(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void IsDraging(char& bResult); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.IsDraging(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	...
	void OnRButtonClick(char& bResult); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.OnRButtonClick(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FSlateBrush Set_BGImage_Brush_1(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.Set_BGImage_Brush_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	struct FSlateBrush SetItemImage(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.SetItemImage(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_844D1FE84342B1FFB080F8A6CC651A2C(struct Object Loaded); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.OnLoaded_844D1FE84342B1FFB080F8A6CC651A2C(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Construct(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void AsyncLoadIconTexture(struct TSoftObjectPtr<UPaperSprite> IconTexture); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.AsyncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnUpdateCastingDelegateEvent(struct FCastingInfo& CastingInfo, float CastingPercent); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.OnUpdateCastingDelegateEvent(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Enable(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.Enable(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Disable(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.Disable(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CompleteCombine(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.CompleteCombine(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void HoverRecipeTree(); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.HoverRecipeTree(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnDragEnter(struct FGeometry MyGeometry, struct FPointerEvent PointerEvent, struct UDragDropOperation Operation); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.OnDragEnter(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnDragLeave(struct FPointerEvent PointerEvent, struct UDragDropOperation Operation); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.OnDragLeave(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-Inventory_MaterialSlot(int32_t EntryPoint); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.ExecuteUbergraph_UW-Inventory_MaterialSlot(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetSlotInfo__DelegateSignature(struct UActor TargetActor, struct FInventoryItemInfo ItemInfo); // Function UW-Inventory_MaterialSlot.UW-Inventory_MaterialSlot_C.SetSlotInfo__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
