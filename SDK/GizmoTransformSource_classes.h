// GizmoTransformSource InteractiveToolsFramework.GizmoTransformSource
 struct UGizmoTransformSource : UInterface {
	...
	Unknown bIsCapturedSlider; // 0x254(0x01)
	...
	Unknown bShowKillChkBox; // 0x2d8(0x01)
	Unknown bShowMyKillChkBox; // 0x2d9(0x01)
	Unknown bShowKnockChkBox; // 0x2da(0x01)
	Unknown bShowMyKnockChkBox; // 0x2db(0x01)
	Unknown bShowResusChkBox; // 0x2dc(0x01)
	Unknown bShowMyResusChkBox; // 0x2dd(0x01)
	...
	Unknown bActiveOnStart; // 0x338(0x01)
	struct FMulticastInlineDelegate Finished; // 0x28(0x10)
	...
	Unknown ChangingTotalGraphic; // 0x3c0(0x01)
	Unknown IsInitState; // 0x3c1(0x01)
	...
	Unknown bSpawnLastShotOnly; // 0x4e8(0x01)
	Unknown WeaponSight; // 0x310(0x08)
	Unknown bUpdateScopeWidgetScaling; // 0x318(0x01)
	...
	Unknown bUseHighMagnificationMesh; // 0x37c(0x01)
	...
	Unknown bIsADSMode; // 0x3f4(0x01)
	float ScaleMultiplier_ZoomInOut; // 0x3f8(0x04)
	Unknown bKeepMagnifierIndex; // 0x3fc(0x01)
	...
	Unknown bBroadcastNuclear; // 0x354(0x01)
	Unknown LocationActor; // 0x310(0x08)
	Unknown LightPoleMesh; // 0x318(0x08)
	Unknown IsBook; // 0x320(0x01)
	Unknown IsTempActor; // 0x321(0x01)
	Unknown IsPersonalSupplyBoxActor; // 0x322(0x01)
	Unknown IsMaterialItemActor; // 0x323(0x01)
	Unknown bIsExpertWeaponItemActor; // 0x324(0x01)
	Unknown bIsLocalActor; // 0x325(0x01)
	...
	Unknown Active; // 0x4c4(0x01)
	Unknown PingWidget; // 0x4c8(0x08)
	float WidgetSize; // 0x4d0(0x04)
	Unknown ShowLine; // 0x4d4(0x01)
	Unknown InNm; // 0x4d5(0x01)
	...
	Unknown CompleteBindingOptin; // 0x57a(0x01)
	...
	Unknown TimerHandle_OnActiv; // 0x2c8(0x08)
	...
	Unknown EnableAnimation; // 0x438(0x01)
	Unknown IgnoreScale; // 0x439(0x01)
	Unknown bEnableShowDebugLightPole; // 0x43a(0x01)
	...
	Unknown bIsLifeSpanExpired; // 0x320(0x01)
	...
	Unknown bPlayingFireAnimation; // 0x2ec(0x01)
	...
	Unknown bUseSpawnBound; // 0x394(0x01)
	...
	Unknown bIsLocalPlayer; // 0x288(0x01)
	Unknown bIsInViewport; // 0x289(0x01)
	Unknown IsDisconnected; // 0x28a(0x01)
	...
	Unknown bIsSimulating; // 0x3a4(0x01)
	...
	Unknown bPerkDeckInitialized; // 0x270(0x01)
	Unknown bCanDrawTrajectory; // 0xb0(0x01)
	Unknown bUseDebugLine; // 0xb1(0x01)
	Unknown bIsTrajectorySegmentsCreated; // 0xb2(0x01)
	...
	Unknown CurrentDrop; // 0x391(0x01)
	Unknown bLandedOnWater; // 0x392(0x01)
	...
	Unknown MasterVolumeOnOff; // 0x158(0x01)
	...
	Unknown bUsingDetailSensitivity; // 0x194(0x01)
	...
	Unknown bReverseLeftAndRight; // 0x1b0(0x01)
	Unknown bReverseUpAndDown; // 0x1b1(0x01)
	int32_t CrossHairIndex; // 0x1b4(0x04)
	Unknown FireModeSettings; // 0x1b8(0x50)
	Unknown autoReload; // 0x208(0x01)
	Unknown ImmediateAttachment; // 0x209(0x01)
	Unknown InheritAttachment; // 0x20a(0x01)
	Unknown ShowPerkSlot; // 0x20b(0x01)
	Unknown ShowSmartPing; // 0x20c(0x01)
	Unknown ShowSmartPingSupplyBox; // 0x20d(0x01)
	int32_t ShowSmartPingLightPole; // 0x210(0x04)
	Unknown NetworkDebugStatistics; // 0x214(0x01)
	Unknown EnableShowClassUI; // 0x215(0x01)
	Unknown bShowUseaableItemEffect; // 0x216(0x01)
	...
	Unknown AutoUseItem_MedicalLv1; // 0x234(0x01)
	Unknown AutoUseItem_MedicalLv2; // 0x235(0x01)
	Unknown AutoUseItem_MedicalLv3; // 0x236(0x01)
	Unknown AutoLadder; // 0x237(0x01)
	Unknown ShowGuideWidget; // 0x238(0x01)
	Unknown SearchMaterialItem; // 0x239(0x01)
	Unknown SearchExpertWeaponItem; // 0x23a(0x01)
	Unknown ShowDamageLog; // 0x23b(0x01)
	...
	Unknown ToggleCrouch; // 0x25c(0x01)
	Unknown ToggleWalk; // 0x25d(0x01)
	Unknown ToggleSprint; // 0x25e(0x01)
	Unknown ToggleFreeLook; // 0x25f(0x01)
	Unknown ToggleSteadyAim; // 0x260(0x01)
	int32_t ToggleExLean; // 0x264(0x04)
	Unknown ToggleAOS; // 0x268(0x01)
	Unknown ToggleADS; // 0x269(0x01)
	...
	struct FMulticastInlineDelegate OnGameUserSettingsApply_C; // 0x448(0x10)
	...
	Unknown bCheckValidSettingDataFromTable; // 0x508(0x01)
	Unknown bNeedDefaultSettingWithTabelData; // 0x509(0x01)
	Unknown bCheckLoadComplete; // 0x50a(0x01)
	...
	Unknown bIsFlameDamaged; // 0x504(0x01)
	Unknown FlameDamageInfos; // 0x508(0x10)
	Unknown PostPhysicsTick; // 0x518(0x30)
	Unknown ReplicatedBaseAimRotation; // 0x554(0x0c)
	Unknown bUseInterpCameraRot; // 0x568(0x01)
	Unknown bUseInterpCameraRot_Pitch; // 0x569(0x01)
	Unknown OccupiedLocalPawn; // 0x590(0x08)
	Unknown bOverridePhysicsErrorCorrection; // 0x5a0(0x01)
	Unknown VehicleErrorCorrection; // 0x5a4(0x34)
	Unknown bIsFPPMode; // 0x5d8(0x01)
	...
	Unknown bResetPhysicsOnWater; // 0x649(0x01)
	Unknown bIsOnTheWater; // 0x64a(0x01)
	Unknown bAllOfWheelsInTheWater; // 0x64b(0x01)
	float ModeChangingTime; // 0x660(0x04)
	Unknown bIsAmphibiousMode; // 0x665(0x01)
	float HealthPoint; // 0x678(0x04)
	Unknown IsHandlebar; // 0x67c(0x01)
	...
	Unknown TiringResumeAudioEv; // 0x778(0x08)
	...
	Unknown bIsNitroJumping; // 0x9d4(0x01)
	...
	Unknown bIsMoving; // 0x9a4(0x01)
	Unknown TwoWheelVehicleWheelRotation_Fr; // 0x9a8(0x0c)
	Unknown TwoWheelVehicleWheelRotation_Rear; // 0x9b4(0x0c)
	Unknown TwoWheelVehicleWheelLocation_Fr; // 0x9c0(0x0c)
	...
	Unknown bIsFPPMode; // 0xa10(0x01)
	Unknown bIsLeftSteering; // 0xa11(0x01)
	Unknown bIsRightSteering; // 0xa12(0x01)
	float LeftSteeringPlayRate; // 0xa14(0x04)
	float RightSteeringPlayRate; // 0xa18(0x04)
	Unknown bIsIdleSteering; // 0xa1c(0x01)
	Unknown bHoldUpdateTransition; // 0xa1d(0x01)
	...
	Unknown bCanDriverUseWeapon; // 0xa4(0x01)
	...
	Unknown bUseAutoEscape; // 0x204(0x01)
	...
	Unknown bUseAirControl; // 0x500(0x01)
	float InAirRollForce; // 0x504(0x04)
	float InAirPitchForce; // 0x508(0x04)
	Unknown bIsInWater; // 0x522(0x01)
	Unknown bOverridesPhysicsNetCorrection; // 0x523(0x01)
	...
	Unknown bUseBooster; // 0x5e0(0x01)
	Unknown MinNormalizedTireloadFilteredCurveOnj; // 0x5e8(0x08)
	Unknown MaxNormalizedTireloadFilteredCurveOn; // 0x5f0(0x08)
	float TorqueScaleOnBoosting; // 0x5f8(0x04)
	float MaxRPMOnBoosting; // 0x5fc(0x04)
	Unknown bIsBoosting; // 0x600(0x01)
	...
	Unknown bShouldUseTwoHandIK; // 0x30(0x01)
	...
	Unknown bCreateAudioPortal; // 0x340(0x01)
	...
	Unknown bUseRedZone; // 0x498(0x01)
	float SeaLevelZ; // 0x49c(0x04)
	float ProjectileHeightLimit; // 0x4a0(0x04)
	Unknown bUseMatchEndSequence; // 0x4a4(0x01)
	...
	Unknown bBindItem; // 0xc0(0x01)
	Unknown bKeepItem; // 0xc1(0x01)
	...
	Unknown Replication; // 0x190(0x10)
	float CurrentlyLoaded; // 0x1a0(0x04)
	int32_t SortType; // 0x1a4(0x04)
	Unknown bNoDropItem; // 0x1a8(0x01)
	Unknown bNoDropYesBox; // 0x1a9(0x01)
	...
	Unknown MoveWorldMapToPlayer; // 0xb8(0x01)
	...
	Unknown IsPawnOnLadder; // 0xd8(0x01)
	Unknown IsTopStart; // 0xd9(0x01)
	...
	Unknown IsSnapping; // 0x11c(0x01)
	Unknown IsDirectSnap; // 0x11d(0x01)
	...
	Unknown IsMoveInMotion; // 0x160(0x01)
	...
	Unknown DrawDebugTrace; // 0xb1(0x01)
	Unknown ShowLog; // 0xb2(0x01)
	Unknown ParkourDebugTypes; // 0xb3(0x01)
	Unknown bNoCameraMove; // 0xb4(0x01)
	Unknown DefaultParkourWindowComponent; // 0xb8(0x08)
	Unknown bOffReplicateMovement; // 0xc0(0x01)
	Unknown bEnableMidJump; // 0xc1(0x01)
	Unknown bNoInputMove; // 0xc2(0x01)
	...
	Unknown bClimbing; // 0x1b4(0x01)
	Unknown bRevertingClimb; // 0x1b5(0x01)
	Unknown bCanRevertClimb; // 0x1b6(0x01)
	Unknown bBreakWindow; // 0x1b7(0x01)
	Unknown bCanJump; // 0x1b8(0x01)
	Unknown bArmIK; // 0x1b9(0x01)
	...
	Unknown bUseFootInParkour; // 0x388(0x01)
	Unknown bUseDummyInParkour; // 0x389(0x01)
	Unknown bIsSlideOn; // 0x38a(0x01)
	...
	Unknown bPendingEquipWeapon; // 0x5b8(0x01)
	Unknown bPendingUnEquipWeapon; // 0x5b9(0x01)
	Unknown bEquippingWeapon; // 0x5ba(0x01)
	...
	Unknown bIsPlayingEquipAnimMontage; // 0x610(0x01)
	...
	Unknown bDropWeaponWithAttachment; // 0x728(0x01)
	Unknown bDropAttachmentToGroundWhenDropWeapon; // 0x729(0x01)
	...
	Unknown bRotationFollowsVelocity; // 0x1d0(0x01)
	Unknown AngularVelocityMin; // 0x1d4(0x0c)
	Unknown AngularVelocityMax; // 0x1e0(0x0c)
	Unknown ProjectileBehavior; // 0x1ec(0x01)
	Unknown bInitialVelocityInLocalSpace; // 0x1f0(0x01)
	Unknown bForceSubStepping; // 0x1f0(0x01)
	Unknown bDrawDebugLine; // 0x1f0(0x01)
	Unknown bDebugLineColorFromVelocity; // 0x1f0(0x01)
	...
	Unknown bUseFriction; // 0x204(0x01)
	...
	struct FMulticastInlineDelegate OnComponent; // 0x278(0x10)
	Unknown RandStream; // 0x288(0x08)
	Unknown bIsFluidFriction; // 0x290(0x01)
	Unknown bInFluid; // 0x291(0x01)
	...
	Unknown bIsInitialized; // 0x258(0x01)
	...
	Unknown bLockMountPitch; // 0x31c(0x01)
	Unknown bLockMountYaw; // 0x31d(0x01)
	...
	Unknown bLockOrientationToRail; // 0x314(0x01)
	Unknown TransformComponent; // 0x318(0x08)
	Unknown RailSplineComponent; // 0x320(0x08)
	Unknown RailCameraMount; // 0x328(0x08)
	Unknown LookatTrackingSettings; // 0x900(0x50)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown ADS_Pannel; // 0x250(0x08)
	Unknown ADSZoom; // 0x258(0x08)
	Unknown CanvasPanel_Main; // 0x260(0x08)
	Unknown Descent; // 0x268(0x08)
	Unknown Descent_Pannel; // 0x270(0x08)
	Unknown Drive; // 0x278(0x08)
	Unknown Drive_Pannel; // 0x280(0x08)
	Unknown Key_ADSZeroingM; // 0x288(0x08)
	Unknown Key_ADSZeroingP; // 0x290(0x08)
	Unknown Key_ADSZoomIn; // 0x298(0x08)
	Unknown Key_ADSZoomOut; // 0x2a0(0x08)
	Unknown Ladder; // 0x2a8(0x08)
	Unknown Ladder_Pannel; // 0x2b0(0x08)
	Unknown Parachuting; // 0x2b8(0x08)
	Unknown Parachuting_Pannel; // 0x2c0(0x08)
	Unknown SmartPing; // 0x2c8(0x08)
	Unknown SmartPing_Pannel; // 0x2d0(0x08)
	Unknown Spectate; // 0x2d8(0x08)
	Unknown Spectate_Pannel; // 0x2e0(0x08)
	Unknown Swim; // 0x2e8(0x08)
	Unknown Swim_Pannel; // 0x2f0(0x08)
	Unknown T_ADSZeroingM; // 0x2f8(0x08)
	Unknown T_ADSZeroingP; // 0x300(0x08)
	Unknown T_ADSZoomIn; // 0x308(0x08)
	Unknown T_ADSZoomOut; // 0x310(0x08)
	Unknown UseItem; // 0x318(0x08)
	Unknown UseItem_Pannel; // 0x320(0x08)
	Unknown WidgetSwitcher_Guide; // 0x328(0x08)
	Unknown WorldMap; // 0x330(0x08)
	Unknown WorldMap_Always; // 0x338(0x08)
	Unknown WorldMap_Pannel; // 0x340(0x08)
	Unknown PatchService; // 0x268(0x08)
	Unknown UberGraphFrame; // 0x2c0(0x08)
	Unknown KillMessageList; // 0x2c8(0x08)
	Unknown U; // 0x2d0(0x08)
	Unknown U_2; // 0x2d8(0x08)
	Unknown U_3; // 0x2e0(0x08)
	Unknown U_4; // 0x2e8(0x08)
	Unknown U_5; // 0x2f0(0x08)
	Unknown U_6; // 0x2f8(0x08)
	Unknown U_7; // 0x300(0x08)
	Unknown U_8; // 0x308(0x08)
	Unknown U_9; // 0x310(0x08)
	Unknown U_10; // 0x318(0x08)
	...
	Unknown Ani_Complete; // 0x248(0x08)
	Unknown Ani_BG; // 0x250(0x08)
	Unknown Bg; // 0x258(0x08)
	Unknown Complete; // 0x260(0x08)
	Unknown TextBlock_QuestDesc; // 0x268(0x08)
	Unknown TextBlock_QuestTitle; // 0x270(0x08)
	Unknown U; // 0x278(0x08)
	Unknown U; // 0x280(0x08)
	Unknown U_2; // 0x288(0x08)
	Unknown U_3; // 0x290(0x08)
	Unknown TaskInfo; // 0x298(0x20)
	Unknown TaskData; // 0x2b8(0xb0)
	...
	Unknown bExplicitCanvasChildZOrder; // 0x28(0x01)
	...
	Unknown bOrderTopTo; // 0x54(0x01)
	Unknown bDisplayHelpInAutoComplete; // 0x55(0x01)
	...
	Unknown bUseSplitscreen; // 0x50(0x01)
	...
	Unknown bOffsetPlayerGamepadIds; // 0x54(0x01)
	...
	Unknown bIsStandbyCheckingEnabled; // 0x38(0x01)
	...
	Unknown bRequiresPushToTalk; // 0x30(0x01)
	...
	Unknown bShouldWindowPreserveAspectRatio; // 0x108(0x01)
	Unknown bUseBorderlessWindow; // 0x109(0x01)
	Unknown bStartInVR; // 0x10a(0x01)
	Unknown bStartInAR; // 0x10b(0x01)
	Unknown bSupportAR; // 0x10c(0x01)
	Unknown bAllowWindowResize; // 0x10d(0x01)
	Unknown bAllowClose; // 0x10e(0x01)
	Unknown bAllowMaximize; // 0x10f(0x01)
	Unknown bAllowMinimize; // 0x110(0x01)
	Unknown bShowHUD; // 0x28(0x01)
	Unknown DebugDisplay; // 0x30(0x10)
	Unknown UberGraphFrame; // 0x270(0x08)
	Unknown AnimGraphNode_AnimDynamics_11; // 0x280(0x440)
	Unknown AnimGraphNode_AnimDynamics_10; // 0x6c0(0x440)
	Unknown AnimGraphNode_ComponentToLocalSpace; // 0xb00(0x20)
	Unknown AnimGraphNode_AnimDynamics_9; // 0xb20(0x440)
	Unknown AnimGraphNode_AnimDynamics_8; // 0xf60(0x440)
	Unknown AnimGraphNode_AnimDynamics_7; // 0x13a0(0x440)
	Unknown AnimGraphNode_AnimDynamics_6; // 0x17e0(0x440)
	Unknown AnimGraphNode_AnimDynamics_5; // 0x1c20(0x440)
	Unknown AnimGraphNode_AnimDynamics_4; // 0x2060(0x440)
	Unknown AnimGraphNode_AnimDynamics_3; // 0x24a0(0x440)
	Unknown AnimGraphNode_LocalToComponentSpace; // 0x28e0(0x20)
	Unknown AnimGraphNode_SequencePlayer_12; // 0x2900(0x78)
	Unknown AnimGraphNode_TransitionResult_4; // 0x2978(0x28)
	Unknown AnimGraphNode_TransitionResult_3; // 0x29a0(0x28)
	Unknown AnimGraphNode_TransitionResult_2; // 0x29c8(0x28)
	Unknown AnimGraphNode_TransitionResult; // 0x29f0(0x28)
	Unknown AnimGraphNode_SequencePlayer_11; // 0x2a18(0x78)
	Unknown AnimGraphNode_StateResult_4; // 0x2a90(0x30)
	Unknown AnimGraphNode_SequencePlayer_10; // 0x2ac0(0x78)
	Unknown AnimGraphNode_StateResult_3; // 0x2b38(0x30)
	Unknown AnimGraphNode_SequencePlayer_9; // 0x2b68(0x78)
	Unknown AnimGraphNode_StateResult_2; // 0x2be0(0x30)
	Unknown AnimGraphNode_SequencePlayer_8; // 0x2c10(0x78)
	Unknown AnimGraphNode_StateResult; // 0x2c88(0x30)
	Unknown AnimGraphNode_StateMachine; // 0x2cb8(0xb0)
	Unknown AnimGraphNode_SaveCachedPose_3; // 0x2d68(0xb8)
	Unknown AnimGraphNode_UseCachedPose_6; // 0x2e20(0x28)
	Unknown AnimGraphNode_UseCachedPose_5; // 0x2e48(0x28)
	Unknown AnimGraphNode_UseCachedPose_4; // 0x2e70(0x28)
	Unknown AnimGraphNode_UseCachedPose_3; // 0x2e98(0x28)
	Unknown AnimGraphNode_AnimDynamics_2; // 0x2ec0(0x440)
	Unknown AnimGraphNode_AnimDynamics; // 0x3300(0x440)
	Unknown AnimGraphNode_KawaiiPhysics_12; // 0x3740(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_11; // 0x3990(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_10; // 0x3be0(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_9; // 0x3e30(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_8; // 0x4080(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_7; // 0x42d0(0x250)
	Unknown AnimGraphNode_BoneDrivenC_8; // 0x4520(0x118)
	Unknown AnimGraphNode_BoneDrivenCcs_7; // 0x4638(0x118)
	Unknown AnimGraphNode_BoneDrivenC_6; // 0x4750(0x118)
	Unknown AnimGraphNode_BoneDrivenCcs_5; // 0x4868(0x118)
	Unknown AnimGraphNode_BoneDrivenC_4; // 0x4980(0x118)
	Unknown AnimGraphNode_BoneDrivenCcs_3; // 0x4a98(0x118)
	Unknown AnimGraphNode_BoneDrivenC_2; // 0x4bb0(0x118)
	Unknown AnimGraphNode_BoneDrivenCcs; // 0x4cc8(0x118)
	Unknown AnimGraphNode_SaveCachedPose_2; // 0x4de0(0xb8)
	Unknown AnimGraphNode_BlendListByEnum; // 0x4e98(0xb0)
	Unknown AnimGraphNode_SequencePlayer_7; // 0x4f48(0x78)
	Unknown AnimGraphNode_LayeredBoneBlend_2; // 0x4fc0(0xc0)
	Unknown AnimGraphNode_SequencePlayer_6; // 0x5080(0x78)
	Unknown AnimGraphNode_SequencePlayer_5; // 0x50f8(0x78)
	Unknown AnimGraphNode_LayeredBoneBlend; // 0x5170(0xc0)
	Unknown AnimGraphNode_SequencePlayer_4; // 0x5230(0x78)
	Unknown AnimGraphNode_SequencePlayer_3; // 0x52a8(0x78)
	Unknown AnimGraphNode_SequencePlayer_2; // 0x5320(0x78)
	Unknown AnimGraphNode_ApplyAdditive; // 0x5398(0xc8)
	Unknown AnimGraphNode_UseCachedPose_2; // 0x5460(0x28)
	Unknown AnimGraphNode_UseCachedPose; // 0x5488(0x28)
	Unknown AnimGraphNode_SaveCachedPose; // 0x54b0(0xb8)
	Unknown AnimGraphNode_BlendListByBool; // 0x5568(0xa0)
	Unknown AnimGraphNode_SequencePlayer; // 0x5608(0x78)
	Unknown AnimGraphNode_BlendListByInt; // 0x5680(0xa0)
	Unknown AnimGraphNode_Root; // 0x5720(0x30)
	Unknown AnimGraphNode_KawaiiPhysics_6; // 0x5750(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_5; // 0x59a0(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_4; // 0x5bf0(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_3; // 0x5e40(0x250)
	Unknown AnimGraphNode_KawaiiPhysics_2; // 0x6090(0x250)
	Unknown AnimGraphNode_KawaiiPhysics; // 0x62e0(0x250)
	int32_t PawnIndex; // 0x6530(0x04)
	int32_t IdleNum; // 0x6534(0x04)
	Unknown IdleAnimSequence; // 0x6538(0x08)
	Unknown CharacterRef; // 0x6540(0x08)
	Unknown bIsMale; // 0x6548(0x01)
	Unknown bIsEquippingWeapon; // 0x6549(0x01)
	Unknown WeaponAnimType; // 0x654a(0x01)
	Unknown HandAnim; // 0x6550(0x08)
	Unknown GripType; // 0x6558(0x01)
	Unknown bIsEquippingNormalGrip; // 0x6559(0x01)
	Unknown HandL_Location; // 0x655c(0x0c)
	Unknown HandL_Rotation; // 0x6568(0x0c)
	float LeftHandIK_Alpha; // 0x6574(0x04)
	Unknown AnimDynamicsForce; // 0x6578(0x0c)
	float PrevCharacterRotationYaw; // 0x6584(0x04)
	float RightHandIK_Alpha; // 0x6588(0x04)
	Unknown bReady; // 0x658c(0x01)
	Unknown ReadyAnimSequence; // 0x6590(0x08)
	Unknown Readyon_AnimSequence; // 0x6598(0x08)
	Unknown Readyoff_AnimSequence; // 0x65a0(0x08)
	float DeltaTimeX; // 0x65a8(0x04)
	float HairAnimDynamicsAlpha; // 0x65ac(0x04)
	Unknown UberGraphFrame; // 0x1360(0x08)
	Unknown Ani_Tutorial_Glow; // 0x1368(0x08)
	Unknown P_Upgrade_Arrow; // 0x1370(0x08)
	Unknown C_SlotHover_ItemState_Hide; // 0x1378(0x08)
	Unknown C_SlotHover_ItemState_Show; // 0x1380(0x08)
	Unknown Hover_Gold; // 0x1388(0x08)
	Unknown P_SlotHover; // 0x1390(0x08)
	Unknown BGImage; // 0x1398(0x08)
	Unknown CanvasPanel_ITemState; // 0x13a0(0x08)
	Unknown Count; // 0x13a8(0x08)
	Unknown Effect_Craft; // 0x13b0(0x08)
	Unknown HorizontalBox_Rarity; // 0x13b8(0x08)
	Unknown HoverImage; // 0x13c0(0x08)
	Unknown HoverImage_Gold; // 0x13c8(0x08)
	Unknown IconRepair; // 0x13d0(0x08)
	Unknown Image_1; // 0x13d8(0x08)
	Unknown Image_2; // 0x13e0(0x08)
	Unknown Image_222; // 0x13e8(0x08)
	Unknown ItemImage; // 0x13f0(0x08)
	Unknown ItemNameName; // 0x13f8(0x08)
	Unknown ItemState_Text; // 0x1400(0x08)
	Unknown NeedMaterial; // 0x1408(0x08)
	Unknown Overlay_Key; // 0x1410(0x08)
	Unknown ProgressBar_475; // 0x1418(0x08)
	Unknown SizeBox_1; // 0x1420(0x08)
	Unknown TextBlock_ShortCut; // 0x1428(0x08)
	Unknown Tutorial_Glow; // 0x1430(0x08)
	Unknown U; // 0x1438(0x08)
	Unknown U; // 0x1440(0x08)
	Unknown WeaponItemImage; // 0x1448(0x08)
	Unknown bGold; // 0x1450(0x01)
	Unknown SelectedHoverImage; // 0x1458(0x08)
	Unknown MedicalBGColor; // 0x1460(0x10)
	struct FMulticastInlineDelegate SetSlotInfo; // 0x1470(0x10)
	int32_t SlotIndex; // 0x1480(0x04)
	struct FName RecipeKey; // 0x1484(0x08)
	Unknown RecipeData; // 0x1490(0x38)
	Unknown bLeftClicked; // 0x14c8(0x01)
	Unknown CanCraft; // 0x14c9(0x01)
	struct FMulticastInlineDelegate OnMeshTrackerUpdated; // 0x238(0x10)
	Unknown ScanWorld; // 0x248(0x01)
	Unknown RequestNormals; // 0x249(0x01)
	Unknown RequestVertexConfidence; // 0x24a(0x01)
	...
	Unknown bCreateMeshProxySections; // 0x4c8(0x01)
	Unknown bUpdateNavMeshOnMeshUpdate; // 0x4c9(0x01)
	Unknown bNeverCreateCollisionMesh; // 0x4ca(0x01)
	Unknown CachedBodySetup; // 0x4d0(0x08)
	Unknown BodySetups; // 0x4d8(0x10)
	Unknown WireframeMaterial; // 0x4e8(0x08)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Canvas_Charge; // 0x250(0x08)
	Unknown ChargeIndicator; // 0x258(0x08)
	Unknown Image_LeanDamageBg; // 0x260(0x08)
	Unknown IMG_Gauge1; // 0x268(0x08)
	Unknown IMG_Gauge2; // 0x270(0x08)
	Unknown IMG_Gauge3; // 0x278(0x08)
	Unknown IMG_Gauge4; // 0x280(0x08)
	Unknown IMG_Gauge5; // 0x288(0x08)
	Unknown IMG_Gauge6; // 0x290(0x08)
	Unknown LeftTime; // 0x298(0x08)
	Unknown Overlay_Gauge; // 0x2a0(0x08)
	Unknown T_BulletsPerShot; // 0x2a8(0x08)
	Unknown T_Damage; // 0x2b0(0x08)
	Unknown T_RPM; // 0x2b8(0x08)
	Unknown VerticalBox_Damage; // 0x2c0(0x08)
	Unknown BravoHotelCharacter; // 0x2c8(0x08)
	Unknown GaugeIMGArray; // 0x2d0(0x10)
	int32_t LastGauge; // 0x2e0(0x04)
	Unknown Timer_; // 0x2e4(0x01)
	Unknown Timer_UpdateInfos; // 0x2e8(0x08)
	Unknown ChargeIndicatorDynamicMaterial; // 0x2f0(0x08)
	Unknown ManifestFileVersion; // 0x28(0x01)
	Unknown bIsFileData; // 0x29(0x01)
	...
	Unknown IsParachute; // 0x2f0(0x01)
	...
	Unknown bSingleInstanceModeOverrideRadius; // 0x44(0x01)
	...
	Unknown VertexColorMaskInvert; // 0xa0(0x01)
	Unknown ZOffset; // 0xa4(0x08)
	Unknown AlignToNormal; // 0xac(0x01)
	float AlignMaxAngle; // 0xb0(0x04)
	Unknown RandomYaw; // 0xb4(0x01)
	...
	Unknown CollisionWithWorld; // 0x104(0x01)
	...
	Unknown bOverrideCullDistance; // 0x13e(0x01)
	Unknown CullDistance; // 0x140(0x08)
	float MinScreenSizeScale; // 0x148(0x04)
	Unknown bEnableStaticLighting; // 0x14c(0x01)
	Unknown CastShadow; // 0x14c(0x01)
	Unknown bAffectDynamicIndirectLighting; // 0x14c(0x01)
	Unknown bAffectDistanceFieldLighting; // 0x14c(0x01)
	Unknown bCastDynamicShadow; // 0x14c(0x01)
	Unknown bCastStaticShadow; // 0x14c(0x01)
	Unknown bCastShadowAsTwoSided; // 0x14c(0x01)
	Unknown bReceivesDecals; // 0x14c(0x01)
	Unknown bOverrideLightMapRes; // 0x14d(0x01)
	int32_t OverriddenLightMapRes; // 0x150(0x04)
	Unknown LightmapType; // 0x154(0x01)
	Unknown bUseAsOccluder; // 0x158(0x01)
	...
	Unknown bRenderCustomDepth; // 0x2f4(0x01)
	...
	Unknown bCanGrowInShade; // 0x324(0x01)
	Unknown bSpawnsInShade; // 0x325(0x01)
	...
	Unknown ReapplyDensity; // 0x3cc(0x01)
	Unknown ReapplyRadius; // 0x3cc(0x01)
	Unknown ReapplyAlignToNormal; // 0x3cc(0x01)
	Unknown ReapplyRandomYaw; // 0x3cc(0x01)
	Unknown ReapplyScaling; // 0x3cc(0x01)
	Unknown ReapplyScaleX; // 0x3cc(0x01)
	Unknown ReapplyScaleY; // 0x3cc(0x01)
	Unknown ReapplyScaleZ; // 0x3cc(0x01)
	Unknown ReapplyRandomPitchAngle; // 0x3cd(0x01)
	Unknown ReapplyGroundSlope; // 0x3cd(0x01)
	Unknown ReapplyHeight; // 0x3cd(0x01)
	Unknown ReapplyLandscapeLayers; // 0x3cd(0x01)
	Unknown ReapplyZOffset; // 0x3cd(0x01)
	Unknown ReapplyCollisionWithWorld; // 0x3cd(0x01)
	Unknown ReapplyVertexColorMask; // 0x3cd(0x01)
	Unknown bEnableDensityScaling; // 0x3cd(0x01)
	...
	Unknown bShouldAttachToBaseComponent; // 0x3f0(0x01)
	...
	Unknown UseTessellationComponentScreenSizeFalloff; // 0x360(0x01)
	...
	Unknown bHasLandscapeGrass; // 0x484(0x01)
	float StaticLightingResolution; // 0x488(0x04)
	Unknown bCastStaticShadow; // 0x48c(0x01)
	Unknown bCastShadowAsTwoSided; // 0x48c(0x01)
	Unknown bCastFarShadow; // 0x48c(0x01)
	Unknown bAffectDistanceFieldLighting; // 0x490(0x01)
	Unknown LightingChannels; // 0x491(0x01)
	Unknown bUseMaterialPositionOffsetInStaticLighting; // 0x494(0x01)
	Unknown bRenderCustomDepth; // 0x494(0x01)
	...
	Unknown bGenerateOverlapEvents; // 0x658(0x01)
	Unknown bBakeMaterialPositionOffsetIntoCollision; // 0x658(0x01)
	int32_t ComponentSizeQuads; // 0x65c(0x04)
	int32_t SubsectionSizeQuads; // 0x660(0x04)
	int32_t NumSubsections; // 0x664(0x04)
	Unknown bUsedForNavigation; // 0x668(0x01)
	Unknown bFillCollisionUnderLandscapeFor; // 0x668(0x01)
	Unknown bUseDynamicMaterialInstance; // 0x66c(0x01)
	Unknown NavigationGeometryGatheringMode; // 0x66d(0x01)
	Unknown bUseLandscapeForCullingInvisibleHLODVer; // 0x66e(0x01)
	Unknown bHasLayersContent; // 0x66f(0x01)
	...
	Unknown CachedLocal; // 0x570(0x1c)
	...
	Unknown bEnableDensityScaling; // 0x38(0x01)
	...
	Unknown RandomRotation; // 0x58(0x01)
	Unknown AlignToSurface; // 0x59(0x01)
	...
	Unknown CachedLocal; // 0x500(0x1c)
	...
	Unknown bIsLayerThumbnail; // 0x420(0x01)
	Unknown bDisableTessellation; // 0x420(0x01)
	Unknown bMobile; // 0x420(0x01)
	Unknown bEditorToolUsage; // 0x420(0x01)
	...
	Unknown bUseForSynchronization; // 0x28(0x01)
	...
	Unknown IsFiring; // 0x33d(0x01)
	Unknown CurrentWeapon; // 0x340(0x08)
	Unknown SingleTimerEvent; // 0x348(0x08)
	Unknown IsSingleFiring; // 0x350(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Action; // 0x250(0x08)
	Unknown Image_14; // 0x258(0x08)
	Unknown LeftBtn; // 0x260(0x08)
	Unknown MidBtn; // 0x268(0x08)
	Unknown Mouse; // 0x270(0x08)
	Unknown RightBtn; // 0x278(0x08)
	Unknown ScaleBox_2; // 0x280(0x08)
	Unknown SideDown; // 0x288(0x08)
	Unknown SideUp; // 0x290(0x08)
	Unknown Text_Action; // 0x298(0x08)
	Unknown Text_Action_UsingAlphaBg; // 0x2a0(0x08)
	Unknown Turn; // 0x2a8(0x08)
	Unknown WheelDown; // 0x2b0(0x08)
	Unknown WheelUp; // 0x2b8(0x08)
	Unknown WidgetSwitcher_TextStyle; // 0x2c0(0x08)
	Unknown X; // 0x2c8(0x08)
	Unknown Y; // 0x2d0(0x08)
	Unknown Temp; // 0x2d8(0x08)
	Unknown NewVar_1; // 0x2e0(0x01)
	float DefalutScale; // 0x2e4(0x04)
	...
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Character_BG_Motion; // 0x250(0x08)
	Unknown Image_308; // 0x258(0x08)
	Unknown ScrollBox_KeepedList; // 0x260(0x08)
	Unknown TextBlock_Count; // 0x268(0x08)
	Unknown PlayerController; // 0x270(0x08)
	...
	Unknown ImportTagsFromConfig; // 0x48(0x01)
	Unknown WarnOnInvalidTags; // 0x49(0x01)
	Unknown FastReplication; // 0x4a(0x01)
	...
	Unknown bLandedOnGround; // 0x4ec(0x01)
	Unknown UberGraphFrame; // 0x248(0x08)
	Unknown Infos_ani; // 0x250(0x08)
	Unknown SimpleResult_Events; // 0x258(0x08)
	Unknown Lose_ani; // 0x260(0x08)
	Unknown Win_ani; // 0x268(0x08)
	Unknown Lose_Events; // 0x270(0x08)
	Unknown Win_Events; // 0x278(0x08)
	Unknown ClassName; // 0x280(0x08)
	Unknown ClassWeaponName; // 0x288(0x08)
	Unknown HeadShot; // 0x290(0x08)
	Unknown HorizontalBox_KillerWeaponInfo; // 0x298(0x08)
	Unknown HorizontalBox_Rarity; // 0x2a0(0x08)
	Unknown Icon_KillerClass; // 0x2a8(0x08)
	Unknown Image_894; // 0x2b0(0x08)
	Unknown Image_2002; // 0x2b8(0x08)
	Unknown Level; // 0x2c0(0x08)
	Unknown LoseMessage; // 0x2c8(0x08)
	Unknown Overlay_DropItems; // 0x2d0(0x08)
	Unknown Overlay_KillerInfo; // 0x2d8(0x08)
	Unknown Overlay_WeaponLevel; // 0x2e0(0x08)
	Unknown T_DamageType; // 0x2e8(0x08)
	Unknown T_WeaponLevel; // 0x2f0(0x08)
	Unknown TextBlock_ItemCount; // 0x2f8(0x08)
	Unknown Uniform_ItemList; // 0x300(0x08)
	Unknown UserName; // 0x308(0x08)
	Unknown U_1; // 0x310(0x08)
	Unknown U; // 0x318(0x08)
	Unknown WeaponName; // 0x320(0x08)
	Unknown WidgetSwitcher_DamageCauser; // 0x328(0x08)
	Unknown AnimationData; // 0x330(0x02)
	Unknown MatchEndWidgetRef; // 0x338(0x08)
	Unknown SimpleResult; // 0x340(0xa8)
	Unknown MatchEnd; // 0x3e8(0x01)
	...
	Unknown bAutoPlay; // 0x380(0x01)
	Unknown bOverrideInstanceData; // 0x380(0x01)
	Unknown bReplicatePlayback; // 0x380(0x01)
	Unknown DefaultInstanceData; // 0x388(0x08)
	Unknown BurnInInstance; // 0x390(0x08)
	Unknown bShowBurnin; // 0x398(0x01)
	...
	Unknown bUseSeparateProcess; // 0xe8(0x01)
	Unknown bCloseEditorWhenCaptureStarts; // 0xe9(0x01)
	struct FString AdditionalCommandLineArguments; // 0xf0(0x10)
	struct FString InheritedCommandLineArguments; // 0x100(0x10)
	Unknown bAutoStartCapture; // 0x220(0x01)
	Unknown PrerequisiteActorId; // 0x22c(0x10)
	Unknown World; // 0x58(0x08)
	Unknown Format; // 0xd8(0x01)
	Unknown bEnableCompression; // 0xd9(0x01)
	int32_t CompressionQuality; // 0xdc(0x04)
	Unknown bUseCompression; // 0x68(0x01)
	float CompressionQuality; // 0x6c(0x04)
	Unknown bWaitForMoviesToComplete; // 0x28(0x01)
	Unknown bMoviesAreSkippable; // 0x29(0x01)
	Unknown StartupMovies; // 0x30(0x10)
	Unknown Key; // 0x28(0x18)
	Unknown Analog; // 0x40(0x01)
	float Analog; // 0x44(0x04)
	float Analog; // 0x48(0x04)
	float World; // 0x4c(0x04)
	Unknown Input; // 0x50(0x01)
	struct FString Display; // 0x58(0x10)
	...
	Unknown bUseGravityOverride; // 0xe4(0x01)
	...
	Unknown bManuallySetID; // 0x30(0x01)
	Unknown bIsNetDirty; // 0xbc(0x01)
	...
	Unknown bEnableDrawing; // 0x398(0x01)
	Unknown bForceRebuildOnLoad; // 0x398(0x01)
	Unknown bAutoDestroyWhenNoNavigation; // 0x398(0x01)
	Unknown bCanBeMainNavData; // 0x398(0x01)
	Unknown bCanSpawnOnRebuild; // 0x398(0x01)
	Unknown bRebuildAtRuntime; // 0x398(0x01)
	...
	Unknown bSupportsAgent0; // 0x40(0x01)
	Unknown bSupportsAgent1; // 0x40(0x01)
	Unknown bSupportsAgent2; // 0x40(0x01)
	Unknown bSupportsAgent3; // 0x40(0x01)
	Unknown bSupportsAgent4; // 0x40(0x01)
	Unknown bSupportsAgent5; // 0x40(0x01)
	Unknown bSupportsAgent6; // 0x40(0x01)
	Unknown bSupportsAgent7; // 0x40(0x01)
	Unknown bSupportsAgent8; // 0x41(0x01)
	Unknown bSupportsAgent9; // 0x41(0x01)
	Unknown bSupportsAgent10; // 0x41(0x01)
	Unknown bSupportsAgent11; // 0x41(0x01)
	Unknown bSupportsAgent12; // 0x41(0x01)
	Unknown bSupportsAgent13; // 0x41(0x01)
	Unknown bSupportsAgent14; // 0x41(0x01)
	Unknown bSupportsAgent15; // 0x41(0x01)
	...
	Unknown bGatherConvexGeometry; // 0xa8(0x01)
	Unknown bCreateOnClient; // 0xa8(0x01)
	...
	Unknown bAutoCreateNavigationData; // 0x68(0x01)
	Unknown bSpawnNavDataInNavBoundsLevel; // 0x68(0x01)
	Unknown bAllowClientSideNav; // 0x68(0x01)
	Unknown bShouldDiscardSubLevelNavData; // 0x68(0x01)
	Unknown bTickWhilePaused; // 0x68(0x01)
	Unknown bSupportRebuilding; // 0x68(0x01)
	Unknown bInitialBuildingLocked; // 0x68(0x01)
	Unknown bSkipAgentHeightCheckWhenPickingNavData; // 0x69(0x01)
	Unknown DataGatheringMode; // 0x6c(0x01)
	Unknown bGenerateNavigationOnlyAroundNavigationInvokers; // 0x70(0x01)
	...
	Unknown bStrictlyStatic; // 0x50(0x01)
	Unknown bCreateOnClient; // 0x50(0x01)
	Unknown bAutoSpawnMissingNavData; // 0x50(0x01)
	Unknown bSpawnNavDataInNavBoundsLevel; // 0x50(0x01)
	Unknown CapsuleComponent; // 0x320(0x08)
	Unknown InvokerComponent; // 0x328(0x08)
	Unknown bActAsNavigationInv; // 0x330(0x01)
	...
	Unknown bProjectedLocationValid; // 0x38c(0x01)
	Unknown bSearchStart; // 0x38c(0x01)
	float CostLimitFactor; // 0x390(0x04)
	float MinimumCostLimit; // 0x394(0x04)
	Unknown bBacktracking; // 0x398(0x01)
	Unknown bUseHierarchicalPathfinding; // 0x398(0x01)
	Unknown bGatherDetailedInfo; // 0x398(0x01)
	Unknown bDrawDistanceToWall; // 0x398(0x01)
	Unknown bShowNodePool; // 0x398(0x01)
	Unknown bShowBestPath; // 0x398(0x01)
	Unknown bShowDiffWithPreviousStep; // 0x398(0x01)
	Unknown bShouldBeVisibleInGame; // 0x398(0x01)
	Unknown CostDisplayMode; // 0x39c(0x01)
	Unknown TextCanvasOffset; // 0x3a0(0x08)
	Unknown bPathExist; // 0x3a8(0x01)
	Unknown bPathIsPartial; // 0x3a8(0x01)
	Unknown bPathSearchOutOfNodes; // 0x3a8(0x01)
	...
	Unknown bAttachToOwnersRoot; // 0xd4(0x01)
	...
	Unknown bLinkEnabled; // 0x120(0x01)
	Unknown bNotifyWhenEnabled; // 0x120(0x01)
	Unknown bNotifyWhenDisabled; // 0x120(0x01)
	Unknown bCreateBoxObstacle; // 0x120(0x01)
	...
	Unknown bIncludeAgentHeight; // 0xf4(0x01)
	Unknown AreaClass; // 0x350(0x08)
	Unknown NavigationSystemConfig; // 0x310(0x08)
	Unknown OverridePolicy; // 0x318(0x01)
	Unknown bLoadOnClient; // 0x319(0x01)
	Unknown bDrawTriangleEdges; // 0x4f0(0x01)
	Unknown bDrawPolyEdges; // 0x4f0(0x01)
	Unknown bDrawFilledPolys; // 0x4f0(0x01)
	Unknown bDrawNavMeshEdges; // 0x4f0(0x01)
	Unknown bDrawTileBounds; // 0x4f0(0x01)
	Unknown bDrawPathCollidingGeometry; // 0x4f0(0x01)
	Unknown bDrawTileLabels; // 0x4f0(0x01)
	Unknown bDrawPolygonLabels; // 0x4f0(0x01)
	Unknown bDrawDefaultPolygonCost; // 0x4f1(0x01)
	Unknown bDrawLabelsOnPathNodes; // 0x4f1(0x01)
	Unknown bDrawNavLinks; // 0x4f1(0x01)
	Unknown bDrawFailedNavLinks; // 0x4f1(0x01)
	Unknown bDrawClusters; // 0x4f1(0x01)
	Unknown bDrawOctree; // 0x4f1(0x01)
	Unknown bDrawOctreeDetails; // 0x4f1(0x01)
	Unknown bDrawMarkedForbiddenPolys; // 0x4f1(0x01)
	Unknown bDistinctlyDrawTilesBeingBuilt; // 0x4f2(0x01)
	Unknown bDrawNavMesh; // 0x4f2(0x01)
	float DrawOffset; // 0x4f4(0x04)
	Unknown bFixedTilePoolSize; // 0x4f8(0x01)
	...
	int32_t PolyRefTile; // 0x534(0x04)
	int32_t PolyRefNavPolyBits; // 0x538(0x04)
	int32_t PolyRefSalt; // 0x53c(0x04)
	...
	Unknown bSortNavigationAreasByCost; // 0x564(0x01)
	Unknown bPerformVoxelFiltering; // 0x564(0x01)
	Unknown bMarkLowHeightAreas; // 0x564(0x01)
	Unknown bFilterLowSpanSequences; // 0x564(0x01)
	Unknown bFilterLowSpanFromTileCache; // 0x564(0x01)
	Unknown bDoFullyAsyncNavDataGathering; // 0x564(0x01)
	Unknown bUseBetterOffsetsFromCorners; // 0x564(0x01)
	Unknown bStoreEmptyTileLayers; // 0x564(0x01)
	Unknown bUseVirtualFilters; // 0x565(0x01)
	Unknown bAllowNavLinkAsPathEnd; // 0x565(0x01)
	Unknown bUseVoxelCache; // 0x565(0x01)
	float TileSetUpdateInterv; // 0x568(0x04)
	...
	Unknown DoGenerateCollisionData; // 0x325(0x01)
	Unknown CollisionFilterSettings; // 0x328(0x10)
	Unknown DoGenerateBreakingData; // 0x338(0x01)
	Unknown BreakingFilterSettings; // 0x33c(0x10)
	Unknown DoGenerateTrailingData; // 0x34c(0x01)
	Unknown TrailingFilterSettings; // 0x350(0x10)
	Unknown bHasFloor; // 0x360(0x01)
	float FloorHeight; // 0x364(0x04)
	float MassScale; // 0x368(0x04)
	Unknown bGenerateContactGraph; // 0x36c(0x01)
	...
	Unknown bIsCollisionEventListeningEnabled; // 0x238(0x01)
	Unknown bIsBreakingEventListeningEnabled; // 0x238(0x01)
	Unknown bIsTrailingEventListeningEnabled; // 0x238(0x01)
	...
	Unknown Simulating; // 0x5f0(0x01)
	Unknown ObjectType; // 0x5f8(0x01)
	Unknown EnableClustering; // 0x5f9(0x01)
	...
	Unknown CachePlayback; // 0x6f4(0x01)
	struct FMulticastInlineDelegate OnChaosPhysicsCollision; // 0x6f8(0x10)
	Unknown bNotifyBreaks; // 0x708(0x01)
	Unknown bNotifyCollisions; // 0x709(0x01)
	Unknown DummyBodySetup; // 0x968(0x08)
	Unknown WarningMessage; // 0x310(0x01)
	Unknown SelectedRigidBody; // 0x318(0x18)
	Unknown bDebugDrawWholeCollection; // 0x330(0x01)
	Unknown bDebugDrawHierarchy; // 0x331(0x01)
	Unknown bDebugDrawClustering; // 0x332(0x01)
	Unknown HideGeometry; // 0x333(0x01)
	Unknown bShowRigidBodyId; // 0x334(0x01)
	Unknown bShowRigidBodyCollision; // 0x335(0x01)
	Unknown bCollisionAtOrigin; // 0x336(0x01)
	Unknown bShowRigidBodyTransform; // 0x337(0x01)
	Unknown bShowRigidBodyInertia; // 0x338(0x01)
	Unknown bShowRigidBodyVelocity; // 0x339(0x01)
	Unknown bShowRigidBodyForce; // 0x33a(0x01)
	Unknown bShowRigidBodyInfos; // 0x33b(0x01)
	Unknown bShowTransformIndex; // 0x33c(0x01)
	Unknown bShowTransform; // 0x33d(0x01)
	Unknown bShowParent; // 0x33e(0x01)
	Unknown bShowLevel; // 0x33f(0x01)
	Unknown bShowConnectivityEdges; // 0x340(0x01)
	Unknown bShowGeometryIndex; // 0x341(0x01)
	Unknown bShowGeometryTransform; // 0x342(0x01)
	Unknown bShowBoundingBox; // 0x343(0x01)
	Unknown bShowFaces; // 0x344(0x01)
	Unknown bShowFaceIndices; // 0x345(0x01)
	Unknown bShowFaceNormals; // 0x346(0x01)
	Unknown bShowSingleFace; // 0x347(0x01)
	int32_t SingleFaceIndex; // 0x348(0x04)
	Unknown bShowVertices; // 0x34c(0x01)
	Unknown bShowVertexIndices; // 0x34d(0x01)
	Unknown bShowVertexNormals; // 0x34e(0x01)
	Unknown bUseActiveVisualization; // 0x34f(0x01)
	float PointThickness; // 0x350(0x04)
	float LineThickness; // 0x354(0x04)
	Unknown bTextShadow; // 0x358(0x01)
	...
	Unknown bMassAsDensity; // 0x58(0x01)
	...
	Unknown EnableRemovePiecesOnFracture; // 0x80(0x01)
	...
	Unknown Enabled; // 0x328(0x01)
	Unknown RenderVolumeBoundingBox; // 0x329(0x01)
	Unknown PhysicalMaterial; // 0xb8(0x08)
	Unknown ChaosSolverActor; // 0xc0(0x08)
	Unknown OverridePhysicsAsset; // 0xc8(0x08)
	Unknown bSimulating; // 0xd0(0x01)
	Unknown bNotifyCollisions; // 0xd1(0x01)
	...
	float ImplicitShapeParticlesPerUnitAr; // 0xe4(0x04)
	...
	Unknown Simulating; // 0xb8(0x01)
	Unknown bNotifyCollisions; // 0xb9(0x01)
	...
	Unknown UberGraphFrame; // 0x298(0x08)
	Unknown ButtonClearStats; // 0x2a0(0x08)
	Unknown ButtonDebugVehicle; // 0x2a8(0x08)
	Unknown ButtonEngine; // 0x2b0(0x08)
	Unknown ButtonFPS; // 0x2b8(0x08)
	Unknown ButtonGameplayTick; // 0x2c0(0x08)
	Unknown ButtonMemory; // 0x2c8(0x08)
	Unknown ButtonNetwork; // 0x2d0(0x08)
	Unknown ButtonParticles; // 0x2d8(0x08)
	Unknown ButtonSceneRendering; // 0x2e0(0x08)
	Unknown ButtonStatSlow; // 0x2e8(0x08)
	Unknown ButtonUnitGraph; // 0x2f0(0x08)
	Unknown ComboBoxViewModes; // 0x2f8(0x08)
	Unknown ComboBoxViewModes1; // 0x300(0x08)
	Unknown DeleteSettingsSaveFile; // 0x308(0x08)
	Unknown GameSpeed; // 0x310(0x08)
	Unknown GameSpeedEdit; // 0x318(0x08)
	Unknown HorizontalBox_8; // 0x320(0x08)
	Unknown HorizontalBox_9; // 0x328(0x08)
	Unknown HorizontalBox_10; // 0x330(0x08)
	Unknown HorizontalBox_11; // 0x338(0x08)
	Unknown HorizontalBox_12; // 0x340(0x08)
	Unknown HorizontalBox_13; // 0x348(0x08)
	Unknown PauseGame; // 0x350(0x08)
	Unknown TemporalAACatmullRomCheck; // 0x358(0x08)
	Unknown TemporalAACurrentFrameWeightEdit; // 0x360(0x08)
	Unknown TemporalAAFilterSizeEdit; // 0x368(0x08)
	Unknown TemporalAAPauseCorrectChek; // 0x370(0x08)
	Unknown TemporalAASamplesEdit; // 0x378(0x08)
	Unknown TonemapperSharpenEdit; // 0x380(0x08)
	Unknown ToolTip_DeleteSettings; // 0x388(0x08)
	Unknown ToolTip_GameSpeed; // 0x390(0x08)
	Unknown ToolTip_PauseGame; // 0x398(0x08)
	Unknown ToolTip_StatCommands; // 0x3a0(0x08)
	Unknown ToolTip_ViewModes; // 0x3a8(0x08)
	Unknown ToolTip_ViewModes_2; // 0x3b0(0x08)
	Unknown Game; // 0x3b8(0x08)
	float Time; // 0x3c0(0x04)
	struct FText Time; // 0x3c8(0x18)
	struct FMulticastInlineDelegate Settings; // 0x3e0(0x10)
	struct FMulticastInlineDelegate Pause; // 0x3f0(0x10)
	struct FText TemporalAAFilterSizeTextBinding; // 0x400(0x18)
	struct FText TemporalAACurrentFrameWeightTextBinding; // 0x418(0x18)
	struct FText TemporalAASamplesTextBinding; // 0x430(0x18)
	struct FText TonemapperSharpenTextBinding; // 0x448(0x18)
	float TemporalAAFilterSizeValue; // 0x460(0x04)
	float TemporalAACurrentFrameWeightValue; // 0x464(0x04)
	int32_t TemporalAASamplesValue; // 0x468(0x04)
	float TonemapperSharpenValue; // 0x46c(0x04)
	struct FName TempKey; // 0x470(0x08)
	Unknown Temp; // 0x478(0x50)
	Unknown Type; // 0x4c8(0x01)
	float TempValue2; // 0x4cc(0x04)
	Unknown IsOnDebugVehicle; // 0x4d0(0x01)
	...
	Unknown bInInteraction; // 0x88(0x01)
	...
	Unknown HitTarget; // 0x68(0x10)
	Unknown StateTarget; // 0x78(0x10)
	Unknown bEnableSignedAxis; // 0x88(0x01)
	Unknown bInInteraction; // 0x89(0x01)
	...
	Unknown bDrawIndicatorLines; // 0x58(0x01)
	Unknown bDrawRadiusCircle; // 0x59(0x01)
	Unknown bDrawFalloffCircle; // 0x5a(0x01)
	int32_t SampleStepCount; // 0x5c(0x04)
	Unknown LineColor; // 0x60(0x10)
	float LineThickness; // 0x70(0x04)
	Unknown bDepthTested; // 0x74(0x01)
	Unknown bDrawSecondaryLines; // 0x75(0x01)
	float SecondaryLineThickness; // 0x78(0x04)
	Unknown SecondaryLineColor; // 0x7c(0x10)
	Unknown AttachedComponent; // 0x90(0x08)
	Unknown bUpdateModifiersDuringDrag; // 0x120(0x01)
	...
	Unknown bRemoveHiddenLines; // 0x510(0x01)
	Unknown bEnableAxisFlip; // 0x511(0x01)
	Unknown Normal; // 0x4d8(0x0c)
	float Radius; // 0x4e4(0x04)
	float Thickness; // 0x4e8(0x04)
	int32_t NumSides; // 0x4ec(0x04)
	Unknown bViewAligned; // 0x4f0(0x01)
	Unknown bOnlyAllowFrontFacingHits; // 0x4f1(0x01)
	...
	void SetPlayerInfo(); // SetPlayerInfo BravoHotelGame.BravoHotelReplayPlayerListItem.SetPlayerInfo // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb1f90>
	void ShowPlayerList(); // ShowPlayerList BravoHotelGame.BravoHotelReplayPlayerListWidget.ShowPlayerList // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb2490>
	void SetKillEvent(Unknown& InKillEvent, Unknown IsMyInfo); // SetKillEvent BravoHotelGame.BravoHotelReplayTimelineEventMarker.SetKillEvent // (Final|Native|Public|HasOutParms|BlueprintCallable) // <Game+0x1fb2c40>
	void UpdateTimelineScale(); // UpdateTimelineScale BravoHotelGame.BravoHotelReplayTimelineWidget.UpdateTimelineScale // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb3cf0>
	void UpdateCameraState(Unknown Inside); // UpdateCameraState BravoHotelGame.BravoHotelReplayZone.UpdateCameraState // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void OnClickedConfirm(); // OnClickedConfirm BravoHotelGame.BravoHotelReportUserCompletedWidget.OnClickedConfirm // (Final|Native|Public) // <Game+0x1fb46d0>
	void OnReportSended(Unknown InWidgetType); // OnReportSended BravoHotelGame.BravoHotelReportUserConfirmWidget.OnReportSended // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void SetSelectedUserNickName(struct FString InUserNickName); // SetSelectedUserNickName BravoHotelGame.BravoHotelReportUserProgramWidget.SetSelectedUserNickName // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb4e50>
	void SetSelectedUserNickName(struct FString InUserNickName); // SetSelectedUserNickName BravoHotelGame.BravoHotelReportUserWidget.SetSelectedUserNickName // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb4e50>
	void UpdateRoutePing(Unknown MapCompWidget, Unknown& Positions, Unknown IsUpdate); // UpdateRoutePing BravoHotelGame.BravoHotelRoutePingWidget.UpdateRoutePing // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void K2_StopScenario(); // K2_StopScenario BravoHotelGame.BravoHotelScenarioBase.K2_StopScenario // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void OnActorActived__DelegateSignature(Unknown ChangedActor); // OnActorActived__DelegateSignature BravoHotelGame.BravoHotelScenarioActor.OnActorActived__DelegateSignature // (MulticastDelegate|Public|Delegate) // <Game+0x23a73f0>
	void DoDeactive(); // DoDeactive BravoHotelGame.BravoHotelScenarioActorInterface.DoDeactive // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x1e8a420>
	void OnTriggerFinished(Unknown OverlappedComponent, Unknown OtherActor, Unknown OtherComp, int32_t OtherBodyIndex, Unknown bFromSweep, Unknown& SweepResult); // OnTriggerFinished BravoHotelGame.BravoHotelScenarioCallbackProxy.OnTriggerFinished // (Final|Native|Private|HasOutParms) // <Game+0x1fb6610>
	void StopScenario(); // StopScenario BravoHotelGame.BravoHotelScenarioComponent.StopScenario // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb7140>
	void OnUpdateScenarioQuest(Unknown& QuestInfo); // OnUpdateScenarioQuest BravoHotelGame.BravoHotelScenarioWidget.OnUpdateScenarioQuest // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void ResizeTextureTarget(int32_t InSizeX, int32_t InSizeY); // ResizeTextureTarget BravoHotelGame.BravoHotelSceneCaptureComponent2D.ResizeTextureTarget // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb8480>
	void K2_OnSetAllowdAmmo(Unknown WeaponType, struct FName& AllowdAmmoName); // K2_OnSetAllowdAmmo BravoHotelGame.BravoHotelScopeWidget.K2_OnSetAllowdAmmo // (Event|Public|HasOutParms|BlueprintEvent) // <Game+0x23a73f0>
	void Broadcast_DelegateShowInfo(Unknown TargetSlot); // Broadcast_DelegateShowInfo BravoHotelGame.BravoHotelSettingBaseWidget.Broadcast_DelegateShowInfo // (Final|Native|Public|BlueprintCallable) // <Game+0x1fb93b0>
	float ValueToPercent(float InValue); // ValueToPercent BravoHotelGame.BravoHotelSettingSlotWidget.ValueToPercent // (Final|Native|Public|BlueprintCallable) // <Game+0x1fbb1f0>
	void SetScrollLock(Unknown Lock); // SetScrollLock BravoHotelGame.BravoHotelSettingSubWidget.SetScrollLock // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void UpdateVideoMemoryUsageGraph(int32_t UsedVideoMemory, int32_t TotalVideoMemory, int32_t CurrentProcessUsage, int32_t OtherProcessUsage); // UpdateVideoMemoryUsageGraph BravoHotelGame.BravoHotelSettingWidget.UpdateVideoMemoryUsageGraph // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void SpawnShellCasing(Unknown& TargetSpawnTransform); // SpawnShellCasing BravoHotelGame.BravoHotelShellCasingArrowComponent.SpawnShellCasing // (Final|Native|Public|HasOutParms|HasDefaults) // <Game+0x1fbd640>
	float ZoomOut(); // ZoomOut BravoHotelGame.BravoHotelSightAttachment.ZoomOut // (Final|Native|Public|BlueprintCallable) // <Game+0x1fbe250>
	void UpdateTargetSize(); // UpdateTargetSize BravoHotelGame.BravoHotelSkillTargetingBase.UpdateTargetSize // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x1e4be10>
	void OnRep_BroadcastNuclear(); // OnRep_BroadcastNuclear BravoHotelGame.BravoHotelSkillTargetingNuclear.OnRep_BroadcastNuclear // (Final|Native|Public) // <Game+0x1fbf3e0>
	void UpdateRotation(float NewLineRate); // UpdateRotation BravoHotelGame.BravoHotelSmartPingActor.UpdateRotation // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void SetWidgetComponentsRenderScale(float ScaleRate); // SetWidgetComponentsRenderScale BravoHotelGame.BravoHotelSmartPingIconWidget.SetWidgetComponentsRenderScale // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	Unknown TraceInteractionableActor(Unknown& EndLocation, Unknown& OutFindActor, Unknown& outList); // TraceInteractionableActor BravoHotelGame.BravoHotelSmartPingSystem.TraceInteractionableActor // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <Game+0x1fc3e40>
	void SetCurrentReplayTimeToSeconds(int32_t Seconds); // SetCurrentReplayTimeToSeconds BravoHotelGame.BravoHotelSpectatorController.SetCurrentReplayTimeToSeconds // (Final|Native|Public|BlueprintCallable) // <Game+0x1fc4580>
	void SetTargetVehicle(Unknown Vehicle, Unknown bDrive); // SetTargetVehicle BravoHotelGame.BravoHotelSpectatorPawn.SetTargetVehicle // (Final|Native|Public) // <Game+0x1fc4b70>
	void OnRep_ImpactPointOnDestruct(); // OnRep_ImpactPointOnDestruct BravoHotelGame.BravoHotelSuperBarrier.OnRep_ImpactPointOnDestruct // (Final|Native|Protected) // <Game+0x1fc5300>
	void AddSupplyBox(Unknown World); // AddSupplyBox BravoHotelGame.BravoHotelSupplyBoxSpawn.AddSupplyBox // (Final|Native|Public|BlueprintCallable) // <Game+0x1fc6070>
	void UpdateInvalidationbox(); // UpdateInvalidationbox BravoHotelGame.BravoHotelTeamInfoSlotWidget.UpdateInvalidationbox // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void Init(); // Init BravoHotelGame.BravoHotelTeamInfoWidget.Init // (Final|Native|Public|BlueprintCallable) // <Game+0x1fc6fd0>
	Unknown GetUseSpawnB(); // GetUseSpawnBoHot BravoHotelGame.BravoHotelTeamPlayerStart.GetUseSpawn // (Final|Native|Public|BlueprintCallable) // <Game+0x1fc7380>
	void K2_OnChangedPlayerState(); // K2_OnChangedPlayerState BravoHotelGame.BravoHotelTeamPositionWidget.K2_OnChangedPlayerState // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void ResetFilterLevels(); // ResetFilterLevels BravoHotelGame.BravoHotelTestCheatWidget.ResetFilterLevels // (Final|Native|Public|BlueprintCallable) // <Game+0x1fc8340>
	void TestLog(struct FString Log, int32_t Index); // TestLog BravoHotelGame.BravoHotelTestWidget.TestLog // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void UpdateSimulation(); // UpdateSimulation BravoHotelGame.BravoHotelTimeOfDay.UpdateSimulation // (Final|Native|Protected) // <Game+0x1fca550>
	void UpdateUserCount(); // UpdateUserCount BravoHotelGame.BravoHotelTitleHUD.UpdateUserCount // (Final|Native|Public) // <Game+0x1fcad50>
	void SlashLogMessage(struct FString Message, Unknown Warning); // SlashLogMessage BravoHotelGame.BravoHotelTopInfoInterface.SlashLogMessage // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void UpdateDamageLogVisibility(); // UpdateDamageLogVisibility BravoHotelGame.BravoHotelTopInfoWidget.UpdateDamageLogVisibility // (Final|Native|Public) // <Game+0x1fcd7c0>
	void StopDraw(); // StopDraw BravoHotelGame.BravoHotelTrajectoryComponent.StopDraw // (Final|Native|Protected|BlueprintCallable) // <Game+0x1fcddd0>
	void SetDropBoxState(Unknown NewState); // SetDropBoxState BravoHotelGame.BravoHotelTransportDropBoxActor.SetDropBoxState // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // <Game+0x1fcea10>
	int32_t GetDisplayRateofFire(); // GetDisplayRateofFire BravoHotelGame.BravoHotelUIWeaponInterface.GetDisplayRateofFire // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // <Game+0x2017a90>
	void SetToDefaultSettingsWithTabelData(); // SetToDefaultSettingsWithTabelData BravoHotelGame.BravoHotelUserSettings.SetToDefaultSettingsWithTabelData // (Final|Native|Public|BlueprintCallable) // <Game+0x2018300>
	void WheelWrecked__DelegateSignature(int32_t WheelIndex); // WheelWrecked__DelegateSignature BravoHotelGame.BravoHotelVehicle.WheelWrecked__DelegateSignature // (MulticastDelegate|Public|Delegate) // <Game+0x23a73f0>
	Unknown Transition_RightSteering_ToLeftSteering(int32_t MachineIndex, int32_t StateIndex); // Transition_RightSteering_ToLeftSteering BravoHotelGame.BravoHotelVehicleAnimInstance.Transition_RightSteering_ToLeftSteering // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x201e760>
	float GetRandomDefaultFuel(); // GetRandomDefaultFuel BravoHotelGame.BravoHotelVehicleData.GetRandomDefaultFuel // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x201ee10>
	void WheelTypeChanged__DelegateSignature(int32_t WheelIndex, Unknown PreviousWheel, Unknown CurrentWheel); // WheelTypeChanged__DelegateSignature BravoHotelGame.BravoHotelVehicleMovementComponent.WheelTypeChanged__DelegateSignature // (MulticastDelegate|Public|Delegate) // <Game+0x23a73f0>
	int32_t GetSeatNum(); // GetSeatNum BravoHotelGame.BravoHotelVehicleSeatCollisionCompon.GetSeatNum // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x20208b0>
	void SetSeatSocketName(struct FName NewSocketName); // SetSeatSocketName BravoHotelGame.BravoHotelVehicleSeatComponent.SetSeatSocketName // (Final|Native|Public|BlueprintCallable) // <Game+0x2020f90>
	void SpawnVehicle(Unknown SpawnInstigator, struct FString ParentActorName); // SpawnVehicle BravoHotelGame.BravoHotelVehicleSpawnBoxComponent.SpawnVehicle // (Final|Native|Public) // <Game+0x2021910>
	Unknown SpawnVehicles(); // SpawnVehicles BravoHotelGame.BravoHotelVehicleSpawner.SpawnVehicles // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void ShowVehicle(); // ShowVehicle BravoHotelGame.BravoHotelVehicleWidget.ShowVehicle // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void ServerTeamPlayerVoice(Unknown pController, struct FName Idx); // ServerTeamPlayerVoice BravoHotelGame.BravoHotelVoiceComponent.ServerTeamPlayerVoice // (Net|NetReliableNative|Event|Public|NetServer|NetValidate) // <Game+0x2023300>
	void OnViewCameraOutWater(); // OnViewCameraOutWater BravoHotelGame.BravoHotelWaterActor.OnViewCameraOutWater // (Final|Native|Public) // <Game+0x2023810>
	void NativeGetWeaponDetailsByItemInfo(Unknown& InInventoryItemInfo, Unknown& ReturnValue, Unknown& WeaponInfoOut); // NativeGetWeaponDetailsByItemInfo BravoHotelGame.BravoHotelWeaponFunctionLibrary.NativeGetWeaponDetailsByItemInfo // (Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <Game+0x2026030>
	Unknown IsEnablePersonalBoxSpawn(Unknown& WolrdCurPos, struct FString& outErrorMessage); // IsEnablePersonalBoxSpawn BravoHotelGame.BravoHotelWeightMapData.IsEnablePersonalBoxSpawn // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <Game+0x203dc80>
	void UpdateLocation(); // UpdateLocation BravoHotelGame.BravoHotelWorldMapAreaWidget.UpdateLocation // (Final|Native|Public) // <Game+0x203eca0>
	void UpdateWorldMapClassInfo(); // UpdateWorldMapClassInfo BravoHotelGame.BravoHotelWorldMapInterface.UpdateWorldMapClassInfo // (Event|Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void SetWorldPos(Unknown& StartPos, Unknown& EndPos); // SetWorldPos BravoHotelGame.BravoHotelWorldMapWidget.SetWorldPos // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	Unknown ConvertPosWorldtoMap_Impl(Unknown WorldPos); // ConvertPosWorldtoMap_Impl BravoHotelGame.BravoHotelWorldTeleportWidget.ConvertPosWorldtoMap_Impl // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // <Game+0x1f4bf20>
	int32_t GetMaterialCount(); // GetMaterialCount BravoHotelGame.CameraPostProcessPreset.GetMaterialCount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x20413a0>
	void SetReplicationItems(Unknown ItemListType, Unknown& ItemList); // SetReplicationItems BravoHotelGame.InventoryComponent.SetReplicationItems // (Final|Native|Public|HasOutParms) // <Game+0x2046100>
	void AddItemsToBox(Unknown& ItemsToSpawn); // AddItemsToBox BravoHotelGame.DropBoxInventoryComponent.AddItemsToBox // (Final|Native|Public|HasOutParms|BlueprintCallable) // <Game+0x20417f0>
	void OnRep_OwningPawn(); // OnRep_OwningPawn BravoHotelGame.EquippableComponent.OnRep_OwningPawn // (Final|Native|Private) // <Game+0x2041e40>
	void StopListeningForAllInputActions(Unknown Widget); // StopListeningForAllInputActions BravoHotelGame.HUDInteractionComponent.StopListeningForAllInputActions // (Final|Native|Public|BlueprintCallable) // <Game+0x2042720>
	void OnAnimNotifyTriggered(Unknown InAudioEvent, Unknown& InConditions); // OnAnimNotifyTriggered BravoHotelGame.BravoHotelAudioConditionProvider.OnAnimNotifyTriggered // (Native|Public|HasOutParms) // <Game+0x2042a40>
	void EndInDoorVolume(Unknown OverlappedComponent, Unknown OtherActor, Unknown OtherComp, int32_t OtherBodyIndex); // EndInDoorVolume BravoHotelGame.InDoorVolumeComponent.EndInDoorVolume // (Final|Native|Public) // <Game+0x2043020>
	void SyncActorLocation(); // SyncActorLocation BravoHotelGame.LadderComponent.SyncActorLocation // (Final|Native|Public|BlueprintCallable) // <Game+0x2047590>
	void SetVectorParameter(struct FName Name, Unknown Value); // SetVectorParameter BravoHotelGame.MaterialControllableInterface.SetVectorParameter // (Native|Public|HasDefaults|BlueprintCallable) // <Game+0x2047cb0>
	void SetVectorParameter(struct FName Name, Unknown Value); // SetVectorParameter BravoHotelGame.MaterialController.SetVectorParameter // (Native|Public|HasDefaults|BlueprintCallable) // <Game+0x2048500>
	void SetAttachTime(float AttachTime); // SetAttachTime BravoHotelGame.ParkourComponent.SetAttachTime // (Final|Native|Public|BlueprintCallable) // <Game+0x204a650>
	void UseThrowingWeapon(int32_t WeaponSlotIndex, float DestroyDelay); // UseThrowingWeapon BravoHotelGame.PlayerInventoryComponent.UseThrowingWeapon // (Final|Native|Public) // <Game+0x2052200>
	void StopSimulating(Unknown& HitResult); // StopSimulating BravoHotelGame.RealisticProjectileComponent.StopSimulating // (Native|Public|HasOutParms|BlueprintCallable) // <Game+0x2053480>
	struct FString Conv_STIntToString(Unknown& Obj); // Conv_STIntToString BravoHotelGame.STypeBlueprintFunctionLibrary.Conv_STIntToString // (Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <Game+0x2054570>
	Unknown RequestSteamFriendsList(Unknown WorldContextObject, Unknown PlayerController); // RequestSteamFriendsList BravoHotelGame.SteamGetFriendsCallbackProxy.RequestSteamFriendsList // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x2054830>
	void OnRep_HealthPoint(float PreviousHealthPoint); // OnRep_HealthPoint BravoHotelGame.TransportAircraftPawn.OnRep_HealthPoint // (Final|Native|Public) // <Game+0x2054ea0>
	void OnCompleteAsyncLoad(); // OnCompleteAsyncLoad BravoHotelGame.AsyncStaticMeshComponent.OnCompleteAsyncLoad // (Final|Native|Protected) // <Game+0x20561b0>
	void OnCompleteAsyncLoad(); // OnCompleteAsyncLoad BravoHotelGame.AsyncSkeletalMeshComponent.OnCompleteAsyncLoad // (Final|Native|Protected) // <Game+0x2056190>
	void UnequipAttachment_Multicast(Unknown AttachmentType); // UnequipAttachment_Multicast BravoHotelGame.WeaponAttachmentComponent.UnequipAttachment_Multicast // (Net|NetReliableNative|Event|NetMulticast|Public) // <Game+0x2056410>
	void OnRep_ChangeAttachments(); // OnRep_ChangeAttachments BravoHotelGame.WeaponReplicatedComponent.OnRep_ChangeAttachments // (Final|Native|Private) // <Game+0x11f7330>
	void SetLensPresetByName(struct FString InPresetName); // SetLensPresetByName CinematicCamera.CineCameraComponent.SetLensPresetByName // (Final|Native|Public|BlueprintCallable) // <Game+0x3390f80>
	Unknown GetRailSplineComponent(); // GetRailSplineComponent CinematicCamera.CameraRig_Rail.GetRailSplineComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x3390df0>
	Unknown GetCineCameraComponent(); // GetCineCameraComponent CinematicCamera.CineCameraActor.GetCineCameraComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x3390af0>
	void UpdateWorldMapGuideOpacity(int32_t PreZoomLevel, int32_t NewZoomLevel); // UpdateWorldMapGuideOpacity U.U.UpdateWorldMapGuideOpacity // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void StartInstall(); // StartInstall BravoHotelPatch.BravoHotelPatchServ.StartInstall // (Final|Native|Public|BlueprintCallable) // <Game+0x205b830>
	void StartPatchService(); // StartPatchService BravoHotelPatch.BravoHotelPatchWidget.StartPatchService // (Final|Native|Public|BlueprintCallable) // <Game+0x205be40>
	void AddKillMessage(Unknown& BroadCastInfo); // AddKillMessage U.U.AddKillMessage // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void ChangeOption(Unknown& ChangeTypeList); // ChangeOption BravoHotelClient.BravoHotelClientInstance.ChangeOption // (Final|Native|Public|HasOutParms) // <Game+0x20793d0>
	void ReceiveBeginPlay(); // ReceiveBeginPlay B.B.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // <Game+0x23a73f0>
	void SetTaskInfo(Unknown TaskInfo); // SetTaskInfo U.U.SetTaskInfo // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void ExportToDisk(Unknown Texture, struct FString Filename, Unknown& options); // ExportToDisk ImageWriteQueue.ImageWriteBlueprintLibrary.ExportToDisk // (Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable) // <Game+0x272bdf0>
	void SetSkipAssigningGamepadToPlayer(Unknown bSkipFirstPlayer); // SetSkipAssigningGamepadToPlayer EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer // (Final|Native|Public|BlueprintCallable) // <Game+0x2c1ea90>
	void AnimGraph(Unknown& AnimGraph); // AnimGraph Character.AB.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void Get(Unknown& bResult, Unknown& WeaponInfo); // Get Inven.U.Get // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void StopReconstruction(); // StopReconstruction MRMesh.MeshReconstructorBase.StopReconstruction // (Native|Public|BlueprintCallable) // <Game+0x2ed6e60>
	void OnMockDataMeshTrackerUpdated__DelegateSignature(int32_t Index, Unknown& Vertices, Unknown& Triangles, Unknown& Normals, Unknown& Confidence); // OnMockDataMeshTrackerUpdated__DelegateSignature MRMesh.MockDataMeshTrackerComponent.OnMockDataMeshTrackerUpdated__DelegateSignature // (MulticastDelegate|Public|Delegate|HasOutParms) // <Game+0x23a73f0>
	Unknown IsConnected(); // IsConnected MRMesh.MRMeshComponent.IsConnected // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x2ed6d80>
	void HideChargeInfo(); // HideChargeInfo U.U.HideChargeInfo // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void SetParachuteInfo(Unknown SetParachuteInfo); // SetParachuteInfo U.U.SetParachuteInfo // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	int32_t FoliageOverlappingSphere(Unknown WorldContextObject, Unknown StaticMesh, Unknown CenterPosition, float Radius); // FoliageOverlappingSphere Foliage.FoliageStatistics.FoliageOverlappingSphere // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // <Game+0x3111940>
	void CapsuleTouched(Unknown OverlappedComp, Unknown Other, Unknown OtherComp, int32_t OtherBodyIndex, Unknown bFromSweep, Unknown& OverlapInfo); // CapsuleTouched Foliage.InteractiveFoliageActor.CapsuleTouched // (Final|Native|Protected|HasOutParms) // <Game+0x3111610>
	void Simulate(int32_t NumSteps); // Simulate Foliage.ProceduralFoliageSpawner.Simulate // (Final|Native|Public|BlueprintCallable) // <Game+0x3111a90>
	void SetLandscapeMaterialVectorParameterValue(struct FName ParameterName, Unknown Value); // SetLandscapeMaterialVectorParameterValue Landscape.LandscapeProxy.SetLandscapeMaterialVectorParameterValue // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // <Game+0x3151ad0>
	void RequestLandscapeUpdate(); // RequestLandscapeUpdate Landscape.LandscapeBlueprintBrushBase.RequestLandscapeUpdate // (Final|Native|Public|BlueprintCallable) // <Game+0x151a800>
	Unknown GetMaterialInstanceDynamic(int32_t InIndex); // GetMaterialInstanceDynamic Landscape.LandscapeComponent.GetMaterialInstanceDynamic // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x314f000>
	Unknown GetRenderComponent(); // GetRenderComponent Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x3151910>
	Unknown GetSplineMeshComponents(); // GetSplineMeshComponents Landscape.LandscapeSplinesComponent.GetSplineMeshComponents // (Final|Native|Public|BlueprintCallable) // <Game+0x3154a90>
	void SetMessage(struct FText Str); // SetMessage U.U.SetMessage // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void OnLoaded_9DF86FA64782B378E42DBB813545BD34(Unknown Loaded); // OnLoaded_9DF86FA64782B378E42DBB813545BD34 U.U.OnLoaded_9DF86FA64782B378E42DBB813545BD34 // (BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	Unknown TransformTime(Unknown& SourceTime, Unknown& SourceRate, Unknown& DestinationRate); // TransformTime TimeManagement.TimeManagementBlueprintLibrary.TransformTime // (Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <Game+0x3156f10>
	void ReceiveTick(float DeltaSeconds); // ReceiveTick B.B.ReceiveTick // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void SetFontSize(int32_t Size); // SetFontSize U.U.SetFontSize // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void ReceiveBeginPlay(); // ReceiveBeginPlay B.B.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // <Game+0x23a73f0>
	void K2_TwoBoneIK(Unknown& RootPos, Unknown& JointPos, Unknown& EndPos, Unknown& JointTarget, Unknown& Effector, Unknown& OutJointPos, Unknown& OutEndPos, Unknown bAllowStretching, float StartStretchRatio, float MaxStretchScale); // K2_TwoBoneIK AnimGraphRuntime.KismetAnimationLibrary.K2_TwoBoneIK // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x322fa80>
	void OnNotifyEndReceived(struct FName NotifyName, Unknown& BranchingPointNotifyPayload); // OnNotifyEndReceived AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyEndReceived // (Final|Native|Protected|HasOutParms) // <Game+0x3230030>
	void HoverRecipeItems(Unknown& ItemKeys); // HoverRecipeItems Inven.U.HoverRecipeItems // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	Unknown ToSoftObjectPath(Unknown& InAssetData); // ToSoftObjectPath AssetRegistry.AssetRegistryHelpers.ToSoftObjectPath // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x343fb30>
	void UseFilterToExcludeAssets(Unknown& AssetDataList, Unknown& Filter); // UseFilterToExcludeAssets AssetRegistry.AssetRegistry.UseFilterToExcludeAssets // (Native|Public|HasOutParms|BlueprintCallable|Const) // <Game+0x343fc80>
	Unknown RemoveGameplayTag(Unknown& TagContainer, Unknown Tag); // RemoveGameplayTag GameplayTags.BlueprintGameplayTagLibrary.RemoveGameplayTag // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // <Game+0x3453050>
	Unknown HasMatchingGameplayTag(Unknown TagToCheck); // HasMatchingGameplayTag GameplayTags.GameplayTagAssetInterface.HasMatchingGameplayTag // (Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x34521d0>
	void SetVertexPosition(Unknown VertexID, Unknown& Position); // SetVertexPosition MeshDescription.MeshDescriptionBase.SetVertexPosition // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // <Game+0x3471060>
	void UserConstructionScript(); // UserConstructionScript B.B.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void SetVertexInstanceUV(Unknown VertexInstanceID, Unknown UV, int32_t UVIndex); // SetVertexInstanceUV StaticMeshDescription.StaticMeshDescription.SetVertexInstanceUV // (Final|Native|Public|HasDefaults|BlueprintCallable) // <Game+0x34799a0>
	void SetEyeTrackedPlayer(Unknown PlayerController); // SetEyeTrackedPlayer EyeTracker.EyeTrackerFunctionLibrary.SetEyeTrackedPlayer // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x34cbe20>
	void SequenceEvent__ENTRYPOINTU_10(); // SequenceEvent__ENTRYPOINTU_10 U.U.SequenceEvent__ENTRYPOINTU_10 // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void RemoveMetaDataByClass(Unknown InClass); // RemoveMetaDataByClass LevelSequence.LevelSequence.RemoveMetaDataByClass // (Final|Native|Public|BlueprintCallable) // <Game+0x34f7e60>
	void SetBurnIn(Unknown InBurnInClass); // SetBurnIn LevelSequence.LevelSequenceBurnInOptions.SetBurnIn // (Final|Native|Public|HasDefaults|BlueprintCallable) // <Game+0x34f8220>
	void ShowBurnin(); // ShowBurnin LevelSequence.LevelSequenceActor.ShowBurnin // (Final|Native|Public|BlueprintCallable) // <Game+0x34f8580>
	void SetSettings(Unknown InSettings); // SetSettings LevelSequence.LevelSequenceBurnIn.SetSettings // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	void OnCreated(); // OnCreated LevelSequence.LevelSequenceDirector.OnCreated // (Event|Public|BlueprintEvent) // <Game+0x23a73f0>
	Unknown GetActiveCameraComponent(); // GetActiveCameraComponent LevelSequence.LevelSequencePlayer.GetActiveCameraComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x34f7b40>
	void SynchronizeToServer(float DesyncThresholdSeconds); // SynchronizeToServer LevelSequence.LevelSequenceMediaController.SynchronizeToServer // (Final|Native|Public|BlueprintCallable) // <Game+0x34f85a0>
	void AnimGraph(Unknown& AnimGraph); // AnimGraph AB.AB.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	Unknown IsCapturing(); // IsCapturing MovieSceneCapture.MovieSceneCaptureProtocolBase.IsCapturing // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x350bbb0>
	void SetImageCaptureProtocolType(Unknown ProtocolType); // SetImageCaptureProtocolType MovieSceneCapture.MovieSceneCapture.SetImageCaptureProtocolType // (Final|Native|Public|BlueprintCallable) // <Game+0x350bea0>
	Unknown IsCaptureInProgress(); // IsCaptureInProgress MovieSceneCapture.MovieSceneCaptureEnvironment.IsCaptureInProgress // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x350bb80>
	void StopCapturingFinalPixels(); // StopCapturingFinalPixels MovieSceneCapture.UserDefinedCaptureProtocol.StopCapturingFinalPixels // (Final|Native|Public|BlueprintCallable) // <Game+0x350c0b0>
	void WriteImageToDisk(Unknown& PixelData, Unknown& StreamID, Unknown& FrameMetrics, Unknown bCopyImageData); // WriteImageToDisk MovieSceneCapture.UserDefinedImageCaptureProtocol.WriteImageToDisk // (Final|Native|Public|HasOutParms|BlueprintCallable) // <Game+0x350c0d0>
	void Generate(); // Generate BP_KeyInput.BP_KeyInput_C.Generate // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void SetAnimDriveDamperStiffness(float InStiffness); // SetAnimDriveDamperStiffness ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness // (Final|Native|Public|BlueprintCallable) // <Game+0x3e4aff0>
	void ReadyForActivation(); // ReadyForActivation GameplayTasks.GameplayTask.ReadyForActivation // (Final|Native|Public|BlueprintCallable) // <Game+0x3eab6a0>
	Unknown ClaimResources(Unknown InTaskOwner, Unknown ResourceClasses, Unknown Priority, struct FName TaskInstanceName); // ClaimResources GameplayTasks.GameplayTask_ClaimResource.ClaimResources // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3eab1b0>
	Unknown SpawnActor(Unknown TaskOwner, Unknown SpawnLocation, Unknown SpawnRotation, Unknown Class, Unknown bSpawnOnlyOnAuthority); // SpawnActor GameplayTasks.GameplayTask_SpawnActor.SpawnActor // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // <Game+0x3eab6c0>
	Unknown TaskWaitDelay(Unknown TaskOwner, float Time, Unknown Priority); // TaskWaitDelay GameplayTasks.GameplayTask_WaitDelay.TaskWaitDelay // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3eab870>
	void OnRep_SimulatedTasks(); // OnRep_SimulatedTasks GameplayTasks.GameplayTasksComponent.OnRep_SimulatedTasks // (Final|Native|Public) // <Game+0x3eab680>
	void SetLineInfo(float Angle, float Length); // SetLineInfo U.U.SetLineInfo // (Public|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	Unknown IsValid(); // IsValid NavigationSystem.NavigationPath.IsValid // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // <Game+0x3f0e600>
	void UnregisterNavigationInvoker(Unknown Invoker); // UnregisterNavigationInvoker NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker // (Final|Native|Public|BlueprintCallable) // <Game+0x3f0f450>
	void SetNavigationRelevancy(Unknown bRelevant); // SetNavigationRelevancy NavigationSystem.NavRelevantComponent.SetNavigationRelevancy // (Final|Native|Public|BlueprintCallable) // <Game+0x3f11ae0>
	void SetAreaClass(Unknown NewAreaClass); // SetAreaClass NavigationSystem.NavModifierComponent.SetAreaClass // (Final|Native|Public|BlueprintCallable) // <Game+0x3f11a60>
	void SetAreaClass(Unknown NewAreaClass); // SetAreaClass NavigationSystem.NavModifierVolume.SetAreaClass // (Final|Native|Public|BlueprintCallable) // <Game+0x3f119e0>
	Unknown K2_ReplaceAreaInTileBounds(Unknown Bounds, Unknown OldArea, Unknown NewArea, Unknown ReplaceLinks); // K2_ReplaceAreaInTileBounds NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds // (Final|Native|Public|HasDefaults|BlueprintCallable) // <Game+0x3f11850>
	void OnListFileFound(struct FString Filename, int32_t ByteCount, struct FString FilePath); // OnListFileFound WindowsFileUtility.WFUFileListInterface.OnListFileFound // (Native|Event|Public|BlueprintEvent) // <Game+0x3ff9520>
	void OnFileChanged(struct FString Filename, struct FString FilePath); // OnFileChanged WindowsFileUtility.WFUFolderWatchInterface.OnFileChanged // (Native|Event|Public|BlueprintEvent) // <Game+0x166d340>
	void WatchFolder(struct FString fullPath, Unknown WatcherDelegate); // WatchFolder WindowsFileUtility.WindowsFileUtilityFunctionLibrary.WatchFolder // (Final|Native|Static|Public|BlueprintCallable) // <Game+0x3ff9730>
	Unknown ConvertPhysicsCollisionToHitResult(Unknown& PhysicsCollision); // ConvertPhysicsCollisionToHitResult ChaosSolverEngine.ChaosSolverEngineBlueprintLibrary.ConvertPhysicsCollisionToHitResult // (Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure) // <Game+0x3ffda30>
	void SetSolverActive(Unknown bActive); // SetSolverActive ChaosSolverEngine.ChaosSolverActor.SetSolverActive // (Native|Public|BlueprintCallable) // <Game+0x3ffdb40>
	void ResetFieldSystem(); // ResetFieldSystem FieldSystemEngine.FieldSystemComponent.ResetFieldSystem // (Final|Native|Public|BlueprintCallable) // <Game+0x4005810>
	Unknown SetMetaDataIteration(int32_t Iterations); // SetMetaDataIteration FieldSystemEngine.FieldSystemMetaDataIteration.SetMetaDataIteration // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4005b60>
	Unknown SetMetaDataaProcessingResolutionType(Unknown ResolutionType); // SetMetaDataaProcessingResolutionType FieldSystemEngine.FieldSystemMetaDataProcessingResolution.SetMetaDataaProcessingResolutionType // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4005bf0>
	Unknown SetUniformInteger(int32_t Magnitude); // SetUniformInteger FieldSystemEngine.UniformInteger.SetUniformInteger // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4005b60>
	Unknown SetRadialIntMask(float Radius, Unknown Position, int32_t InteriorValue, int32_t ExteriorValue, Unknown SetMaskConditionIn); // SetRadialIntMask FieldSystemEngine.RadialIntMask.SetRadialIntMask // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x40063f0>
	Unknown SetUniformScalar(float Magnitude); // SetUniformScalar FieldSystemEngine.UniformScalar.SetUniformScalar // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4006690>
	Unknown SetRadialFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Radius, Unknown Position, Unknown Falloff); // SetRadialFalloff FieldSystemEngine.RadialFalloff.SetRadialFalloff // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x40061d0>
	Unknown SetPlaneFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Distance, Unknown Position, Unknown Normal, Unknown Falloff); // SetPlaneFalloff FieldSystemEngine.PlaneFalloff.SetPlaneFalloff // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x4005f50>
	Unknown SetBoxFalloff(float Magnitude, float MinRange, float MaxRange, float Default, Unknown Transform, Unknown Falloff); // SetBoxFalloff FieldSystemEngine.BoxFalloff.SetBoxFalloff // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x4005830>
	Unknown SetNoiseField(float MinRange, float MaxRange, Unknown Transform); // SetNoiseField FieldSystemEngine.NoiseField.SetNoiseField // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x4005c80>
	Unknown SetUniformVector(float Magnitude, Unknown Direction); // SetUniformVector FieldSystemEngine.UniformVector.SetUniformVector // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x40065b0>
	Unknown SetRadialVector(float Magnitude, Unknown Position); // SetRadialVector FieldSystemEngine.RadialVector.SetRadialVector // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure) // <Game+0x40065b0>
	Unknown SetRandomVector(float Magnitude); // SetRandomVector FieldSystemEngine.RandomVector.SetRandomVector // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4006690>
	Unknown SetOperatorField(float Magnitude, Unknown RightField, Unknown LeftField, Unknown Operation); // SetOperatorField FieldSystemEngine.OperatorField.SetOperatorField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4005e00>
	Unknown SetToIntegerField(Unknown FloatField); // SetToIntegerField FieldSystemEngine.ToIntegerField.SetToIntegerField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4006750>
	Unknown SetToFloatField(Unknown IntegerField); // SetToFloatField FieldSystemEngine.ToFloatField.SetToFloatField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4006750>
	Unknown SetCullingField(Unknown Culling, Unknown Field, Unknown Operation); // SetCullingField FieldSystemEngine.CullingField.SetCullingField // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4005a60>
	Unknown SetReturnResultsTerminal(); // SetReturnResultsTerminal FieldSystemEngine.ReturnResultsTerminal.SetReturnResultsTerminal // (Final|Native|Public|BlueprintCallable|BlueprintPure) // <Game+0x4006720>
	void SortTrailingEvents(Unknown& TrailingEvents, Unknown SortMethod); // SortTrailingEvents GeometryCollectionEngine.ChaosDestructionListener.SortTrailingEvents // (Final|Native|Public|HasOutParms|BlueprintCallable) // <Game+0x4023530>
	Unknown RaycastSingle(Unknown Start, Unknown End, Unknown& OutHit); // RaycastSingle GeometryCollectionEngine.GeometryCollectionActor.RaycastSingle // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // <Game+0x4022d10>
	void SetNotifyBreaks(Unknown bNewNotifyBreaks); // SetNotifyBreaks GeometryCollectionEngine.GeometryCollectionComponent.SetNotifyBreaks // (Final|Native|Public|BlueprintCallable) // <Game+0x4023170>
	void ReceivePhysicsCollision(Unknown& CollisionInfo); // ReceivePhysicsCollision GeometryCollectionEngine.SkeletalMeshSimulationComponent.ReceivePhysicsCollision // (Event|Public|HasOutParms|BlueprintEvent) // <Game+0x23a73f0>
	void ReceivePhysicsCollision(Unknown& CollisionInfo); // ReceivePhysicsCollision GeometryCollectionEngine.StaticMeshSimulationComponent.ReceivePhysicsCollision // (Event|Public|HasOutParms|BlueprintEvent) // <Game+0x23a73f0>
	Unknown Generate(struct FString Item); // Generate DevWidget.DevWidget_C.Generate // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game+0x23a73f0>
	void UpdateWorldLocalState(Unknown bWorldIn); // UpdateWorldLocalState InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // <Game+0x4048b10>
	void SetTransform(Unknown& NewTransform); // SetTransform InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // <Game+0x4048910>
};
