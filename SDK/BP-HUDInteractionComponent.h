...
public:
	...
	void CheckAnyAction(char& AnyAction); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.CheckAnyAction(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void CheckAnyCloseUI(char& AnyClosed); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.CheckAnyCloseUI(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	struct UUserWidget GetSightInfoWidget(); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.GetSightInfoWidget(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void GetReplayWidget(char WantsToCreateIfNull, struct UUW-ReplayMainWidget_C& Widget); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.GetReplayWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void GetSpectatorWidget(char WantsToCreateIfNull, struct UUserWidget& Widget); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.GetSpectatorWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void GetInventoryWidget(char WantsToCreateIfNull, struct UUserWidget& Widget); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.GetInventoryWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void GetPlayerSpectatorHUD(struct ABravoHotelPlayerHUD& RefSpectatorHUD); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.GetPlayerSpectatorHUD(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void IsReplay(char& IsReplay); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.IsReplay(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void IsOpenSystemPopup(char& bResult); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.IsOpenSystemPopup(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void GetPlayerMainWidget(char WantsToCreateIfNull, struct UBravoHotelMainWidget& Widget); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.GetPlayerMainWidget(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void IsMatchEnd(char& State); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.IsMatchEnd(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void InputMiniMap(); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.InputMiniMap(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void InputWorldMap(); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.InputWorldMap(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void InputToggleIngameHUD(); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.InputToggleIngameHUD(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_BP-HUDInteractionComponent(int32_t EntryPoint); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.ExecuteUbergraph_BP-HUDInteractionComponent(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
