...
public:
	...
	void InputToggleIngameHUD(); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.InputToggleIngameHUD(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_BP-HUDInteractionComponent(int32_t EntryPoint); // Function BP-HUDInteractionComponent.BP-HUDInteractionComponent_C.ExecuteUbergraph_BP-HUDInteractionComponent(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
