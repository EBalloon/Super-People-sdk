...
public:
	...
	struct Unknown On_IMG-BG_MouseButtonDown_1(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Consumable.UW-BlackMarket_Slot_Consumable_C.On_IMG-BG_MouseButtonDown_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetIconTexture(struct Unknown ItemTexture); // Function UW-BlackMarket_Slot_Consumable.UW-BlackMarket_Slot_Consumable_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnLoaded_5699AF624A3322545E5B4781A35497A4(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Consumable.UW-BlackMarket_Slot_Consumable_C.OnLoaded_5699AF624A3322545E5B4781A35497A4(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	...
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Consumable.UW-BlackMarket_Slot_Consumable_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Consumable.UW-BlackMarket_Slot_Consumable_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Consumable.UW-BlackMarket_Slot_Consumable_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
