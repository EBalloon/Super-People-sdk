...
public:
	...
	struct Unknown Searching_ani; // 0x1360 (8)
	struct Unknown Blank_SkillBG; // 0x1368 (8)
	struct Unknown Border_507; // 0x1370 (8)
	struct Unknown Button_332; // 0x1378 (8)
	struct Unknown Get_SkillBG; // 0x1380 (8)
	struct Unknown Get_SkillBG_lv5; // 0x1388 (8)
	struct Unknown Get_SkillBG_lv6; // 0x1390 (8)
	struct Unknown Get_SkillBG_lv7; // 0x1398 (8)
	struct Unknown HorizontalBox_Rarity; // 0x13A0 (8)
	struct Unknown Image; // 0x13A8 (8)
	struct Unknown Image_2; // 0x13B0 (8)
	struct Unknown Image_3; // 0x13B8 (8)
	struct Unknown Image_4; // 0x13C0 (8)
	struct Unknown Image_5; // 0x13C8 (8)
	struct Unknown Image_6; // 0x13D0 (8)
	struct Unknown Image_7; // 0x13D8 (8)
	struct Unknown Image_8; // 0x13E0 (8)
	struct Unknown Image_9; // 0x13E8 (8)
	struct Unknown Image_10; // 0x13F0 (8)
	struct Unknown Image_12; // 0x13F8 (8)
	struct Unknown Image_16; // 0x1400 (8)
	struct Unknown Image_332; // 0x1408 (8)
	struct Unknown Image_689; // 0x1410 (8)
	struct Unknown Image_690; // 0x1418 (8)
	struct Unknown Image_Full; // 0x1420 (8)
	struct Unknown Image_Have; // 0x1428 (8)
	struct Unknown Img_Active; // 0x1430 (8)
	struct Unknown IMG_Complete; // 0x1438 (8)
	struct Unknown IMG_ItemIcon; // 0x1440 (8)
	struct Unknown MouseHover_2; // 0x1448 (8)
	struct Unknown MouseHover_; // 0x1450 (8)
	struct Unknown MousePress_2; // 0x1458 (8)
	struct Unknown MousePress_; // 0x1460 (8)
	struct Unknown MyWeapon; // 0x1468 (8)
	struct Unknown Searching; // 0x1470 (8)
	struct Unknown Searching_; // 0x1478 (8)
	struct Unknown SizeBox_1; // 0x1480 (8)
	struct Unknown SizeBox_8; // 0x1488 (8)
	struct Unknown T_PerkName; // 0x1490 (8)
	struct Unknown T_PerkName_2; // 0x1498 (8)
	struct Unknown T_PerkName_3; // 0x14A0 (8)
	struct Unknown T_PerkName_4; // 0x14A8 (8)
	struct Unknown VerticalBox_1; // 0x14B0 (8)
	struct Unknown HoverWidget; // 0x14B8 (8)
	char Selected : 0; // 0x14C0 (1)
	struct Unknown SelectItem; // 0x14C4 (16)
	struct Unknown NewVar_1; // 0x14D8 (8)
	char EnableSearch : 0; // 0x14E0 (1)
	struct Unknown TempData; // 0x14E4 (16)
	char IsComplete : 0; // 0x14F4 (1)

	struct Unknown OnMouseButtonDown(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.OnMouseButtonDown(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown OnMouseButtonUp(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.OnMouseButtonUp(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetOpacity(char bActive, char bComplete); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.SetOpacity(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void MouseEnterImpl(); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.MouseEnterImpl(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRarity(enum class Unknow Rarity, char bStar); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.SetRarity(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetMaterialInfo(struct FName ItemKey, int32_t Count, char Complete, char Having, struct Unknown HoverWidget, struct FName TopItem); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.SetMaterialInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_B0A3D28F44780582B366508928D8D420(struct Unknown Loaded); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.OnLoaded_B0A3D28F44780582B366508928D8D420(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_331_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.BndEvt__Button_331_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_331_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.BndEvt__Button_331_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_331_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature(); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.BndEvt__Button_331_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_331_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.BndEvt__Button_331_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Set Selecte(char Select); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.Set Selecte(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Destruct(); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.Destruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void 鉹@t元_2(struct Unknown MaterialItemKey, char IsSelect); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.鉹@t元_2(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void 鉹@t元_1(char EnableMaterialSearch); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AsyncLoadIconTexture(struct Unknown IconTexture); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.AsyncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-ItemRecipeTreeSlot(int32_t EntryPoint); // Function UW-ItemRecipeTreeSlot.UW-ItemRecipeTreeSlot_C.ExecuteUbergraph_UW-ItemRecipeTreeSlot(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
