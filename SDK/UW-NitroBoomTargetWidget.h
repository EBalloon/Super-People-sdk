...
public:
	...
	void Construct(); // Function UW-NitroBoomTargetWidget.UW-NitroBoomTargetWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-NitroBoomTargetWidget(int32_t EntryPoint); // Function UW-NitroBoomTargetWidget.UW-NitroBoomTargetWidget_C.ExecuteUbergraph_UW-NitroBoomTargetWidget(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
