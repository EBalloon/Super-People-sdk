...
public:
	...
	void Construct(); // Function UW-NitroBoomTargetWidget.UW-NitroBoomTargetWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-NitroBoomTargetWidget(int32_t EntryPoint); // Function UW-NitroBoomTargetWidget.UW-NitroBoomTargetWidget_C.ExecuteUbergraph_UW-NitroBoomTargetWidget(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
