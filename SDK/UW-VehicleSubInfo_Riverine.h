...
public:
	...
	void Setup(struct ABravoHotelVehicle VehicleInstance); // Function UW-VehicleSubInfo_Riverine.UW-VehicleSubInfo_Riverine_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-VehicleSubInfo_Riverine(int32_t EntryPoint); // Function UW-VehicleSubInfo_Riverine.UW-VehicleSubInfo_Riverine_C.ExecuteUbergraph_UW-VehicleSubInfo_Riverine(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
