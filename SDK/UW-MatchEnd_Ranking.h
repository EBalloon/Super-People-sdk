...
public:
	...
	void SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_4(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_4(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_3(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_3(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_2(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_2(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_1(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SequenceEvent__ENTRYPOINTUW-MatchEnd_Ranking_1(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateInputMode(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.UpdateInputMode(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Check Report Enablefrom User Name(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.Check Report Enablefrom User Name(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Check Exist Report User(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.Check Exist Report User(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ReportSended(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.ReportSended(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetAllWidgetVisiblility(char IsShow); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetAllWidgetVisiblility(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HideSimpleWidget(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.HideSimpleWidget(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HideSimpleWidgetSlowly(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.HideSimpleWidgetSlowly(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRankImage(int32_t ID, struct Unknown Widget); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetRankImage(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetNextRank(int32_t TierID); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetNextRank(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void PlayRankDown(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.PlayRankDown(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void PlayRankUp(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.PlayRankUp(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Init(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.Init(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void PlayRankAnimation(int32_t StartRP, int32_t MatchRP, int32_t MaxRP); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.PlayRankAnimation(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void UpdateRank(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.UpdateRank(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetColorTextWidget(struct Unknown Widget, int32_t Value, struct Unknown Color); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetColorTextWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetPlayInfo(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetPlayInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetItem(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetItem(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetRank(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetRank(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetGold(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.SetGold(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_5C9A4A6341FF221002168F953DF28124(struct Unknown Loaded); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.OnLoaded_5C9A4A6341FF221002168F953DF28124(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_161_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_161_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Spectate_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_Spectate_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Exit_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_Exit_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_DeathCam_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_DeathCam_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Spectate_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_Spectate_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Exit_K2Node_ComponentBoundEvent_5_OnButtonHoverEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_Exit_K2Node_ComponentBoundEvent_5_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void EventRankAnimation(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.EventRankAnimation(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CustomEvent_1(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.CustomEvent_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AsyncLoadTexture(struct Unknown Imge, struct Unknown Widget); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.AsyncLoadTexture(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Report_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_Report_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_Report_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.BndEvt__Button_Report_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Close(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.Close(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowDeathCam(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.ShowDeathCam(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ShowGold(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.ShowGold(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Destruct(); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.Destruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-MatchEnd_Ranking(int32_t EntryPoint); // Function UW-MatchEnd_Ranking.UW-MatchEnd_Ranking_C.ExecuteUbergraph_UW-MatchEnd_Ranking(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
