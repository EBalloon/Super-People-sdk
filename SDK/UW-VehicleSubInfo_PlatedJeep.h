...
public:
	...
	void Setup(struct Unknown VehicleInstance); // Function UW-VehicleSubInfo_PlatedJeep.UW-VehicleSubInfo_PlatedJeep_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
	void ExecuteUbergraph_UW-VehicleSubInfo_PlatedJeep(int32_t EntryPoint); // Function UW-VehicleSubInfo_PlatedJeep.UW-VehicleSubInfo_PlatedJeep_C.ExecuteUbergraph_UW-VehicleSubInfo_PlatedJeep(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6DD70>
};
