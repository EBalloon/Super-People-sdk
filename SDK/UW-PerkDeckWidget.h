...
public:
	...
	void SequenceEvent__ENTRYPOINTUW-PerkDeckWidget_3(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SequenceEvent__ENTRYPOINTUW-PerkDeckWidget_3(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SequenceEvent__ENTRYPOINTUW-PerkDeckWidget_2(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SequenceEvent__ENTRYPOINTUW-PerkDeckWidget_2(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SequenceEvent__ENTRYPOINTUW-PerkDeckWidget_1(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SequenceEvent__ENTRYPOINTUW-PerkDeckWidget_1(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkDeckReOpenCheck(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetPerkDeckReOpenCheck(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetComingSoonClass(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetComingSoonClass(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetComingSoonClass(struct FName& ClassRow); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.GetComingSoonClass(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void UpdateNewbieAdvantage(struct Unknown& PerkDeckData); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.UpdateNewbieAdvantage(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void DisableClassButtonWithoutSelected(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.DisableClassButtonWithoutSelected(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkInfoByHoverClassButton(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetPerkInfoByHoverClassButton(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void PlayChangeDeckSound(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.PlayChangeDeckSound(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void PlayChooseSound(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.PlayChooseSound(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void PlayClickSound(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.PlayClickSound(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void PlayHoverSound(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.PlayHoverSound(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void HasPerkDeckClassInfo(char& NewParam); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.HasPerkDeckClassInfo(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetButtonInfo(struct Unknown Button, struct Unknown TextPrice, int32_t Price, struct Unknown TextRemainCount, int32_t RemainCount); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetButtonInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void UpdateButtonInfos(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.UpdateButtonInfos(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CanUseButton(char& Enabled); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.CanUseButton(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetButtonEnabled(char IsEnabled); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetButtonEnabled(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkDeckSelectInfo(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetPerkDeckSelectInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ChooseClassButton(int32_t ClassIndex); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.ChooseClassButton(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void HoverClassButton(int32_t ClassIndex, char IsHoverd); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.HoverClassButton(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ResetSelectedClassInfo(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.ResetSelectedClassInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void RefreshSelectedClassInfo(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.RefreshSelectedClassInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetClassList(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetClassList(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkModeInfo(int32_t PerkMode); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetPerkModeInfo(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown OnMouseButtonDown(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnMouseButtonDown(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetClassVideoSource(int32_t PerkDeckID, struct Unknown& VideoSource); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.GetClassVideoSource(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ReadyMovie(int32_t PerkDeckID); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.ReadyMovie(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CloseMovie(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.CloseMovie(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	enum class Unknow GetVisibility_RemainTime(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.GetVisibility_RemainTime(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void GetInventoryItemDetailInfo(struct FName Name, struct Unknown& Info); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.GetInventoryItemDetailInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct FText Get_TextBlock_RemailTime_Text_1(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.Get_TextBlock_RemailTime_Text_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetServerWaiting(char bWait); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetServerWaiting(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetGoldInfo(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetGoldInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkInfo(char UseLocalPlayerInfo, struct Unknown PerkDeckClassInfo); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetPerkInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CheckInfos(char ForceUpdate); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.CheckInfos(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void InitInfos(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.InitInfos(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	struct Unknown OnMouseWheel(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnMouseWheel(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Hide(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.Hide(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Show(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.Show(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_A83B5F164320A0E753E9088699009EB0(struct Unknown Loaded); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnLoaded_A83B5F164320A0E753E9088699009EB0(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Finished_68D0074544AABC70455E90A37E1ED67B(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.Finished_68D0074544AABC70455E90A37E1ED67B(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_C916107845AEFBC703CB8F9D00DAC0F0(struct Unknown Loaded); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnLoaded_C916107845AEFBC703CB8F9D00DAC0F0(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnLoaded_19FB202A430BEE3458DBA2B7F1362CC8(struct Unknown Loaded); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnLoaded_19FB202A430BEE3458DBA2B7F1362CC8(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadingWeapon(struct Unknown IconTexture); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.AsyncLoadingWeapon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadingClass(struct Unknown Texture); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.AsyncLoadingClass(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnDelegatePayGoldOnChangeDeck(char bSuccess); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnDelegatePayGoldOnChangeDeck(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnAnimationFinished(struct Unknown Animation); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnAnimationFinished(BlueprintCosmetic|Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void BndEvt__Button_Movie_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.BndEvt__Button_Movie_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void Destruct(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.Destruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnBattleRoyalStateChanged(enum class Unknow PrevState, enum class Unknow CurrentState); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnBattleRoyalStateChanged(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void ClosePopup(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.ClosePopup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void CustomEvent_1(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.CustomEvent_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ChangeClassOnScenario(int32_t DeckIndex); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.ChangeClassOnScenario(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void BndEvt__btn_OK_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.BndEvt__btn_OK_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AsyncLoadingClassIcon(struct Unknown Texture); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.AsyncLoadingClassIcon(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void HideAnim(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.HideAnim(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ShowAnim(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.ShowAnim(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnChangePerkModeDelegate_Event_1(int32_t PerkMode); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnChangePerkModeDelegate_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OpenPopup(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OpenPopup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void BndEvt__btn_OK_5_K2Node_ComponentBoundEvent_12_OnButtonClickedEvent__DelegateSignature(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.BndEvt__btn_OK_5_K2Node_ComponentBoundEvent_12_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void DelegatePayGoldOnSelectDeck_Event_1(char bSuccess); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.DelegatePayGoldOnSelectDeck_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnChangedTeamPlayerClass(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnChangedTeamPlayerClass(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetPerkInfoImpl(char bUseLocalPlayerInfo, struct Unknown& PerkDeckClassInfo); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.SetPerkInfoImpl(Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnChangedCurrentPerkDeckSelectInfo(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.OnChangedCurrentPerkDeckSelectInfo(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CheckSelectMode(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.CheckSelectMode(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void DelegateChoosePerkDeck_Event_1(char bSuccess); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.DelegateChoosePerkDeck_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void PlayMovie(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.PlayMovie(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void DelegatePayGoldOnChangeDeckList_Event_1(char bSuccess); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.DelegatePayGoldOnChangeDeckList_Event_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void BndEvt__btn_OK_5_K2Node_ComponentBoundEvent_13_OnButtonHoverEvent__DelegateSignature(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.BndEvt__btn_OK_5_K2Node_ComponentBoundEvent_13_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void TryChangeSelectDeck(); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.TryChangeSelectDeck(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void ExecuteUbergraph_UW-PerkDeckWidget(int32_t EntryPoint); // Function UW-PerkDeckWidget.UW-PerkDeckWidget_C.ExecuteUbergraph_UW-PerkDeckWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
