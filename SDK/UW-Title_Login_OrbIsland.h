...
public:
	...
	void SetTitleWidget(struct Unknown TitleWidget); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.SetTitleWidget(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ProcessExitPopup(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ProcessExitPopup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CheckKeyUp(struct Unknown InputKey, char& bResult); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.CheckKeyUp(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void CheckKeyDown(struct Unknown InputKey, char& bResult); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.CheckKeyDown(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ProcessInput(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ProcessInput(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ProcessLogin(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ProcessLogin(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Init(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.Init(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ShowPressAnyKey(struct Unknown BPTitleWidget); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ShowPressAnyKey(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ShowLoginError(int32_t ErrorCode, struct FString ExtraDescription); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ShowLoginError(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void HIdeLoginError(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.HIdeLoginError(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void BndEvt__BTN-Login_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.BndEvt__BTN-Login_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void PreConstruct(char IsDesignTime); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.PreConstruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ShowServerConnecting(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ShowServerConnecting(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ShowLoginUI(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ShowLoginUI(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void InputOpen(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.InputOpen(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SetLoginState(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.SetLoginState(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void ExecuteUbergraph_UW-Title_Login_OrbIsland(int32_t EntryPoint); // Function UW-Title_Login_OrbIsland.UW-Title_Login_OrbIsland_C.ExecuteUbergraph_UW-Title_Login_OrbIsland(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
