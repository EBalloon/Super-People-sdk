...
public:
	...
	void CustomEvent_1(struct UBravoHotelSettingSlotWidget Value); // Function GraphicWidget.GraphicWidget_C.CustomEvent_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
