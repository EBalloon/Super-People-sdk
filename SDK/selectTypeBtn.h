...
public:
	...
	void BndEvt__Button_42_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(); // Function selectTypeBtn.selectTypeBtn_C.BndEvt__Button_42_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SelectIndex(int32_t Index); // Function selectTypeBtn.selectTypeBtn_C.SelectIndex(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_selectTypeBtn(int32_t EntryPoint); // Function selectTypeBtn.selectTypeBtn_C.ExecuteUbergraph_selectTypeBtn(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
	void SelectEventDispatcher__DelegateSignature(int32_t Index); // Function selectTypeBtn.selectTypeBtn_C.SelectEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
};
