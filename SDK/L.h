...
public:
	...
	struct TArray<Unknown> LobbyPawns; // 0x330 (16)
	struct TSoftClassPtr<UObject> LobbyPawnClass; // 0x340 (40)
	struct Unknown SkipKey; // 0x368 (24)
	char bSkip : 0; // 0x380 (1)
	char bNotFirstTime : 0; // 0x381 (1)
	struct Unknown LobbyCustomizePawn; // 0x388 (8)
	char IsCharacterAppearance : 0; // 0x390 (1)
	struct Unknown TargetWearableCamera; // 0x398 (8)
	struct FString CurrentArmorySceneState; // 0x3A0 (16)
	float SurveyUPanValue; // 0x3B0 (4)
	float GunSurveyMovingValue; // 0x3B4 (4)
	struct Unknown SurveyUPan; // 0x3B8 (8)
	struct Unknown GunSurveyMoving; // 0x3C0 (8)
	struct Unknown IdentifiedTimer; // 0x3C8 (8)
	struct FString CurrentTab; // 0x3D0 (16)
	struct Unknown P; // 0x3E0 (8)
	struct Unknown AudioIndex_BGM; // 0x3E8 (4)
	struct Unknown AudioIndex_Ambience; // 0x3EC (4)
	struct Unknown AudioIndex_Analyze; // 0x3F0 (4)
	char PendingPartyInfoChange : 0; // 0x3F4 (1)
	struct Unknown EnhanceTimerHandle; // 0x3F8 (8)
	struct Unknown ProceedingTimerHandle; // 0x400 (8)
	struct Unknown CreateCharacterRef; // 0x408 (8)
	struct Unknown IntroBGWidget; // 0x410 (8)
	struct Unknown MediaSoundComponent; // 0x418 (8)
	...
	struct Unknown Title_TowerBridge_Readyshot_2_ExecuteUbergraph_L; // 0x490 (8)
	struct Unknown Character_Creation_2_ExecuteUbergraph_L; // 0x498 (8)
	struct Unknown ExponentialHeightFog3_ExecuteUbergraph_L; // 0x4A0 (8)
	struct Unknown ExponentialHeightFog_1_ExecuteUbergraph_L; // 0x4A8 (8)
	struct Unknown CineCameraActor_1_ExecuteUbergraph_L; // 0x4B0 (8)
	struct Unknown CineCamera_Supplybox_ExecuteUbergraph_L; // 0x4B8 (8)
	struct Unknown CineCamera_All_ExecuteUbergraph_L; // 0x4C0 (8)
	struct Unknown Character_Customization_Face_3_ExecuteUbergraph_L; // 0x4C8 (8)
	struct Unknown Supplybox_Lobby_4_ExecuteUbergraph_L; // 0x4D0 (8)
	struct Unknown Supplybox_Lobby_3_ExecuteUbergraph_L; // 0x4D8 (8)
	struct Unknown CineCamera_Target_ExecuteUbergraph_L; // 0x4E0 (8)
	struct Unknown CineCamera_Rank_ExecuteUbergraph_L; // 0x4E8 (8)
	struct Unknown Title_Rank_2_ExecuteUbergraph_L; // 0x4F0 (8)
	struct Unknown Gun_Survey_Plane_ExecuteUbergraph_L; // 0x4F8 (8)
	struct Unknown Weapon_Lobby_01_2_ExecuteUbergraph_L; // 0x500 (8)
	struct Unknown CineCamera_Face3_ExecuteUbergraph_L; // 0x508 (8)
	struct Unknown Screen_Transition_ExecuteUbergraph_L; // 0x510 (8)
	struct Unknown Character_Fade_2_ExecuteUbergraph_L; // 0x518 (8)
	struct Unknown P; // 0x520 (8)
	struct Unknown P; // 0x528 (8)
	struct Unknown P; // 0x530 (8)
	struct Unknown P; // 0x538 (8)
	struct Unknown P; // 0x540 (8)
	struct Unknown P; // 0x548 (8)
	struct Unknown P; // 0x550 (8)
	struct Unknown P; // 0x558 (8)
	struct Unknown Weapon_Lobby_Disassemble_ExecuteUbergraph_L; // 0x560 (8)
	struct Unknown Weapon_Lobby_Repair_ExecuteUbergraph_L; // 0x568 (8)
	struct Unknown CineCamera_Weapon_Customization02_ExecuteUbergraph_L; // 0x570 (8)
	struct Unknown CineCamera_Weapon_Customization_2_ExecuteUbergraph_L; // 0x578 (8)
	struct Unknown Weapon_Lobby_Custom_ExecuteUbergraph_L; // 0x580 (8)
	struct Unknown S; // 0x588 (8)
	struct Unknown CineCameraActor_1_EdGraph_4_RefProperty; // 0x590 (8)
	struct Unknown Gun_Survey_Plane_EdGraph_11_RefProperty; // 0x598 (8)
	struct Unknown Gun_Survey_Plane_EdGraph_12_RefProperty; // 0x5A0 (8)
	struct Unknown Gun_Survey_Plane_EdGraph_13_RefProperty; // 0x5A8 (8)
