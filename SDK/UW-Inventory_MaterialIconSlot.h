...
public:
	...
	enum class Unknow Get_Image_Full_Visibility_1(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Get_Image_Full_Visibility_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <Game_BE.exe+0x2B812B0>
	void MouseEnterImpl(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.MouseEnterImpl(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetMaterialInfo(struct FName ItemKey, int32_t Count, struct FName TopKey); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.SetMaterialInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.BndEvt__Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.BndEvt__Button_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.BndEvt__Button_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void BndEvt__Button_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.BndEvt__Button_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature(BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Destruct(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Destruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void 鉹@t元_2(struct Unknown MaterialItemKey, char IsSelect); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.鉹@t元_2(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Set Selecte(char Select); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Set Selecte(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void 鉹@t元_1(char EnableMaterialSearch); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Inventory_MaterialIconSlot(int32_t EntryPoint); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.ExecuteUbergraph_UW-Inventory_MaterialIconSlot(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
};
