...
public:
	...
	struct UWidgetAnimation Serching_ani; // 0x1368 (8)
	struct UButton Button; // 0x1370 (8)
	struct UImage IconBox; // 0x1378 (8)
	struct UImage Image; // 0x1380 (8)
	struct UImage Image_2; // 0x1388 (8)
	struct UImage Image_3; // 0x1390 (8)
	struct UImage Image_4; // 0x1398 (8)
	struct UImage Image_5; // 0x13A0 (8)
	struct UImage Image_6; // 0x13A8 (8)
	struct UImage Image_7; // 0x13B0 (8)
	struct UImage Image_8; // 0x13B8 (8)
	struct UImage Image_9; // 0x13C0 (8)
	struct UImage Image_10; // 0x13C8 (8)
	struct UImage Image_149; // 0x13D0 (8)
	struct UImage Image_170; // 0x13D8 (8)
	struct UImage Image_253; // 0x13E0 (8)
	struct UImage Image_305; // 0x13E8 (8)
	struct UImage Image_Full; // 0x13F0 (8)
	struct UImage IMG_ItemIcon; // 0x13F8 (8)
	struct UImage MaterialIcon; // 0x1400 (8)
	struct USizeBox MouseHover_2; // 0x1408 (8)
	struct USizeBox MouseHover_; // 0x1410 (8)
	struct USizeBox MousePress_2; // 0x1418 (8)
	struct USizeBox MousePress_; // 0x1420 (8)
	struct USizeBox Searching_; // 0x1428 (8)
	struct UImage Stroke; // 0x1430 (8)
	struct UImage Stroke_2; // 0x1438 (8)
	struct UImage Stroke_3; // 0x1440 (8)
	struct UImage Stroke_4; // 0x1448 (8)
	struct UWidget PreHoveredWidget; // 0x1450 (8)
	enum class ItemWidgetDragType PreDragType; // 0x1458 (1)
	char Selected : 0; // 0x1459 (1)
	int32_t NeedCount; // 0x145C (4)
	struct FName ItemKey; // 0x1460 (8)
	struct FSelecteSearchMaterialItemInfo SelectItem; // 0x1468 (16)
	char BindSelectSearch : 0; // 0x1478 (1)
	char EnableSearch : 0; // 0x1479 (1)

	enum class ESlateVisibility Get_Image_Full_Visibility_1(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Get_Image_Full_Visibility_1(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void MouseEnterImpl(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.MouseEnterImpl(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetMaterialInfo(struct FName ItemKey, int32_t Count, struct FName TopKey); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.SetMaterialInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void Construct(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Destruct(); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Destruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 鉹@t元_2(struct FSelecteSearchMaterialItemInfo MaterialItemKey, char IsSelect); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.鉹@t元_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Set Selecte(char Select); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.Set Selecte(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void 鉹@t元_1(char EnableMaterialSearch); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.鉹@t元_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-Inventory_MaterialIconSlot(int32_t EntryPoint); // Function UW-Inventory_MaterialIconSlot.UW-Inventory_MaterialIconSlot_C.ExecuteUbergraph_UW-Inventory_MaterialIconSlot(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
