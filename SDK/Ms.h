// AnimBlueprintGeneratedClass Massg.AB
...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function Mr.AB.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B3180>
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function Mr.AB.BlueprintUpdateAnimation(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B3180>
	void ExecuteUbergraph_AB(int32_t EntryPoint); // Function .AB.ExecuteUbergraph_AB(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B3180>
};

// Function Mr.AB.AnimGraph
inline void UAB::AnimGraph(struct Unknown& AnimGraph) {
	static auto fn = UObject::FindObject<UFunction>("Function Mr.AB.AnimGraph");
...
// Function Mr.AB.BlueprintUpdateAnimation
inline void UAB::BlueprintUpdateAnimation(float DeltaTimeX) {
	static auto fn = UObject::FindObject<UFunction>("Function Mr.AB.BlueprintUpdateAnimation");
...
// Function .AB.ExecuteUbergraph_AB
inline void UAB::ExecuteUbergraph_AB(int32_t EntryPoint) {
	static auto fn = UObject::FindObject<UFunction>("Function .AB.ExecuteUbergraph_AB");
