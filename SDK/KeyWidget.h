...
class UKeyWidget_C : UBravoHotelSettingSubWidget {
	...
	void EnableShowReplayType(char& bRet); // Function KeyWidget.KeyWidget_C.EnableShowReplayType(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B1E70>
	...
	void m_2(struct Unknown InKey, struct Unknown Slot); // Function KeyWidget.KeyWidget_C.m_2(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B1E70>
	void m_3(char bIsDuplicate, struct Unknown InKey, struct FText KeyName); // Function KeyWidget.KeyWidget_C.m_3(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B1E70>
	...
	void m_1(); // Function KeyWidget.KeyWidget_C.m_1(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B1E70>
	void m_4(struct Unknown Widget); // Function KeyWidget.KeyWidget_C.m_4(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B1E70>
