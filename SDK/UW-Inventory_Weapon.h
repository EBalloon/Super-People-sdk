...
public:
	...
	void ShowStatupAnim(struct FStatupAnimParameters& StatParams, enum class EStatupAnimType StatType); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.ShowStatupAnim(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverRecipeTree(struct FName ItemKey); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverRecipeTree(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CompleteItems(struct TArray<struct FName>& ItemKeys); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.CompleteItems(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverItems(struct TArray<struct FName>& ItemKeys); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverItems(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void NotifyNewWeapon(struct TArray<int32_t>& SlotArray); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.NotifyNewWeapon(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void CheckCanEquipRangedWeapon(enum class EWeaponType WeaponType); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.CheckCanEquipRangedWeapon(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetDragFromCarriedSlot(struct FInventoryItemInfo InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromCarriedSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetDragFromEquippedSlot(struct FInventoryItemInfo InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromEquippedSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetDragFromWeaponSlot(struct FBravoHotelWeaponInfo WeaponInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetDragFromProximitySlot(struct FInventoryItemInfo InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromProximitySlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void DragFindCanEquipAttachItemSlot(struct FInventoryItemInfo InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.DragFindCanEquipAttachItemSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverResetEquipAttachItemSlot(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverResetEquipAttachItemSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void HoverResetEquipWeaponSlot(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverResetEquipWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverSelectAttachItemSlot(struct FInventoryItemInfo InventoryItemInfo, char& bResult); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverSelectAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverSelectEquipAttachItemSlot(struct FInventoryItemInfo InventoryItemInfo, char& bResult); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverSelectEquipAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverSelectEquipWeaponSlot(enum class EWeaponType WeaponType); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverSelectEquipWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void GetInventoryItemDetailInfo(struct FInventoryItemInfo InventoryItemInfo, char& bResult, struct FInventoryItemDetailInfo& InventoryItemDetailInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.GetInventoryItemDetailInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void HoverWeaponSlotList(struct FInventoryItemInfo InventoryItemInfo, char& bResult); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverWeaponSlotList(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void GetInventoryComponent(char& Result, struct UPlayerInventoryComponent& InventoryComponentRef); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.GetInventoryComponent(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Reset(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.Reset(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void SetWeaponSlot(struct UUW-InventoryWidget_C InventoryWidget, int32_t SlotIndex, struct ABravoHotelWeaponBase WeaponBaseObject, struct FInventoryItemInfo InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetWeaponSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Construct(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void Event_WeaponInfo(int32_t Idx, int32_t Ammo, int32_t MaxAmmo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.Event_WeaponInfo(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-Inventory_Weapon(int32_t EntryPoint); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.ExecuteUbergraph_UW-Inventory_Weapon(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
