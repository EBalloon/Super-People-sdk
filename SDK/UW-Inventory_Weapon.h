...
public:
	...
	void ShowStatupAnim(struct Unknown& StatParams, enum class Unknow StatType); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.ShowStatupAnim(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverRecipeTree(struct FName ItemKey); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverRecipeTree(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CompleteItems(struct TArray<Unknown>& ItemKeys); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.CompleteItems(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverItems(struct TArray<Unknown>& ItemKeys); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverItems(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void NotifyNewWeapon(struct TArray<Unknown>& SlotArray); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.NotifyNewWeapon(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckCanEquipRangedWeapon(enum class Unknow WeaponType); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.CheckCanEquipRangedWeapon(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragFromCarriedSlot(struct Unknown InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromCarriedSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragFromEquippedSlot(struct Unknown InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromEquippedSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragFromWeaponSlot(struct Unknown WeaponInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetDragFromProximitySlot(struct Unknown InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetDragFromProximitySlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DragFindCanEquipAttachItemSlot(struct Unknown InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.DragFindCanEquipAttachItemSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetEquipAttachItemSlot(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverResetEquipAttachItemSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void DragEquipWeaponSlot(char ItemDragSlotType, struct Unknown InventoryItemInfo, struct Unknown WeaponInfo, char& bResult); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.DragEquipWeaponSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverResetEquipWeaponSlot(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverResetEquipWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverSelectAttachItemSlot(struct Unknown InventoryItemInfo, char& bResult); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverSelectAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverSelectEquipAttachItemSlot(struct Unknown InventoryItemInfo, char& bResult); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverSelectEquipAttachItemSlot(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverSelectEquipWeaponSlot(enum class Unknow WeaponType); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverSelectEquipWeaponSlot(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetInventoryItemDetailInfo(struct Unknown InventoryItemInfo, char& bResult, struct Unknown& InventoryItemDetailInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.GetInventoryItemDetailInfo(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void HoverWeaponSlotList(struct Unknown InventoryItemInfo, char& bResult); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.HoverWeaponSlotList(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void GetInventoryComponent(char& Result, struct Unknown& InventoryComponentRef); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.GetInventoryComponent(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Reset(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.Reset(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeaponSlot(struct Unknown InventoryWidget, int32_t SlotIndex, struct Unknown WeaponBaseObject, struct Unknown InventoryItemInfo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.SetWeaponSlot(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Event_WeaponInfo(int32_t Idx, int32_t Ammo, int32_t MaxAmmo); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.Event_WeaponInfo(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-Inventory_Weapon(int32_t EntryPoint); // Function UW-Inventory_Weapon.UW-Inventory_Weapon_C.ExecuteUbergraph_UW-Inventory_Weapon(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
