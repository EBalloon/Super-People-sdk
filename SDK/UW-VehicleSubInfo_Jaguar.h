...
public:
	...
	void Setup(struct Unknown VehicleInstance); // Function UW-VehicleSubInfo_Jaguar.UW-VehicleSubInfo_Jaguar_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void ExecuteUbergraph_UW-VehicleSubInfo_Jaguar(int32_t EntryPoint); // Function UW-VehicleSubInfo_Jaguar.UW-VehicleSubInfo_Jaguar_C.ExecuteUbergraph_UW-VehicleSubInfo_Jaguar(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
