...
public:
	...
	void Setup(struct Unknown VehicleInstance); // Function UW-VehicleSubInfo_Jaguar.UW-VehicleSubInfo_Jaguar_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_UW-VehicleSubInfo_Jaguar(int32_t EntryPoint); // Function UW-VehicleSubInfo_Jaguar.UW-VehicleSubInfo_Jaguar_C.ExecuteUbergraph_UW-VehicleSubInfo_Jaguar(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
