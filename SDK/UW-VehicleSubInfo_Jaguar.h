...
public:
	...
	void Setup(struct ABravoHotelVehicle VehicleInstance); // Function UW-VehicleSubInfo_Jaguar.UW-VehicleSubInfo_Jaguar_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_UW-VehicleSubInfo_Jaguar(int32_t EntryPoint); // Function UW-VehicleSubInfo_Jaguar.UW-VehicleSubInfo_Jaguar_C.ExecuteUbergraph_UW-VehicleSubInfo_Jaguar(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
