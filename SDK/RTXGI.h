...
public:
	...
	enum class Unknow RaysPerProbe; // 0x238 (1)
	struct Unknown ProbeCounts; // 0x23C (12)
	...
	struct Unknown LightingChannels; // 0x260 (1)
	...
	struct Unknown LastOrigin; // 0x2A0 (12)
	struct Unknown ProbeScrollOffset; // 0x2AC (12)

	void DDGIClearVolumes(); // Function RTXGI.DDGIVolumeComponent.DDGIClearVolumes(Final|Exec|Native|Public) // <BravoHotelClient-Win64-Shipping.protected.exe+0x165C800>
};
