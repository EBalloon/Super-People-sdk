...
public:
	...
	void SetScopeImageAngle(float NewAngle); // Function UW-Sight_Digital.UW-Sight_Digital_C.SetScopeImageAngle(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void K2_OnEnterADS(); // Function UW-Sight_Digital.UW-Sight_Digital_C.K2_OnEnterADS(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void K2_OnExitADS(); // Function UW-Sight_Digital.UW-Sight_Digital_C.K2_OnExitADS(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-Sight_Digital(int32_t EntryPoint); // Function UW-Sight_Digital.UW-Sight_Digital_C.ExecuteUbergraph_UW-Sight_Digital(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
