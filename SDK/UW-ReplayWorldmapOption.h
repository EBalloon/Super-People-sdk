...
public:
	...
	void Init(); // Function UW-ReplayWorldmapOption.UW-ReplayWorldMapOption_C.Init(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	...
	void ExecuteUbergraph_UW-ReplayWorldMapOption(int32_t EntryPoint); // Function UW-ReplayWorldmapOption.UW-ReplayWorldMapOption_C.ExecuteUbergraph_UW-ReplayWorldMapOption(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};
