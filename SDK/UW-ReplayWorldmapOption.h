...
public:
	...
	void Init(); // Function UW-ReplayWorldmapOption.UW-ReplayWorldMapOption_C.Init(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	...
	void ExecuteUbergraph_UW-ReplayWorldMapOption(int32_t EntryPoint); // Function UW-ReplayWorldmapOption.UW-ReplayWorldMapOption_C.ExecuteUbergraph_UW-ReplayWorldMapOption(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
