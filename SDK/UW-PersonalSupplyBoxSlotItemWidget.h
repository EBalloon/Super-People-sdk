...
public:
	...
	struct Unknown OnMouseButtonUp(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnMouseButtonUp(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	struct Unknown OnMouseButtonDown(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnMouseButtonDown(BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	...
	void OnLoaded_2F164CF142966D9481C26D9FAFCD6B3E(struct Unknown Loaded); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnLoaded_2F164CF142966D9481C26D9FAFCD6B3E(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_470CC2A647398584A781D89997DE829A(struct Unknown Loaded); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnLoaded_470CC2A647398584A781D89997DE829A(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnLoaded_B44424C84F36CE653BE71591D8E4AA63(struct Unknown Loaded); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnLoaded_B44424C84F36CE653BE71591D8E4AA63(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetConsumableItemInfo(struct Unknown& NewConsumableItemData); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetConsumableItemInfo(Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void AysncLoadIconTexture(struct Unknown IconTexture); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.AysncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetLockState(char IsLock); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetLockState(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetEquipState(char IsUnEquip); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetEquipState(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void SetWeaponInfo(struct Unknown& NewWeaponItemData); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetWeaponInfo(Event|Public|HasOutParms|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void Construct(); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void CheckClick(); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.CheckClick(BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_UW-PersonalSupplyBoxSlotItemWidget(int32_t EntryPoint); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.ExecuteUbergraph_UW-PersonalSupplyBoxSlotItemWidget(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B812B0>
	void OnRightClickEventDispatcher__DelegateSignature(struct Unknown Slot); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnRightClickEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void OnHoverStateEventDispatcher__DelegateSignature(char IsHover); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnHoverStateEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
};
