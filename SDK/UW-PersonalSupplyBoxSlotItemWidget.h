...
public:
	...
	void OnLoaded_2F164CF142966D9481C26D9FAFCD6B3E(struct Object Loaded); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnLoaded_2F164CF142966D9481C26D9FAFCD6B3E(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_470CC2A647398584A781D89997DE829A(struct Object Loaded); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnLoaded_470CC2A647398584A781D89997DE829A(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnLoaded_B44424C84F36CE653BE71591D8E4AA63(struct Object Loaded); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnLoaded_B44424C84F36CE653BE71591D8E4AA63(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetConsumableItemInfo(struct FSupplyItem& NewConsumableItemData); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetConsumableItemInfo(Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void AysncLoadIconTexture(struct TSoftObjectPtr<Object> IconTexture); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.AysncLoadIconTexture(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetLockState(char IsLock); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetLockState(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetEquipState(char IsUnEquip); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetEquipState(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void SetWeaponInfo(struct FInventoryItemInfo& NewWeaponItemData); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.SetWeaponInfo(Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void Construct(); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void CheckClick(); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.CheckClick(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_UW-PersonalSupplyBoxSlotItemWidget(int32_t EntryPoint); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.ExecuteUbergraph_UW-PersonalSupplyBoxSlotItemWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnRightClickEventDispatcher__DelegateSignature(struct UUW-PersonalSupplyBoxSlotItemWidget_C Slot); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnRightClickEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnHoverStateEventDispatcher__DelegateSignature(char IsHover); // Function UW-PersonalSupplyBoxSlotItemWidget.UW-PersonalSupplyBoxSlotItemWidget_C.OnHoverStateEventDispatcher__DelegateSignature(Public|Delegate|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
