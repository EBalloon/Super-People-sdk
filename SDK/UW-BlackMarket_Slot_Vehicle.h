...
public:
	...
	void SetIconTexture(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.SetIconTexture(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void OnLoaded_65481F2E4FBDAFF739C1CA99F79D422C(struct Unknown Loaded); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.OnLoaded_65481F2E4FBDAFF739C1CA99F79D422C(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void Construct(); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void AysncLoading(struct Unknown IconTexture); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.AysncLoading(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseEnter(struct Unknown MyGeometry, struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.OnMouseEnter(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void OnMouseLeave(struct Unknown& MouseEvent); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.OnMouseLeave(BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SwitchMenu(); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.SwitchMenu(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	void SwitchSlot(); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.SwitchSlot(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
	...
	void ExecuteUbergraph_UW-BlackMarket_Slot_Vehicle(int32_t EntryPoint); // Function UW-BlackMarket_Slot_Vehicle.UW-BlackMarket_Slot_Vehicle_C.ExecuteUbergraph_UW-BlackMarket_Slot_Vehicle(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B6E050>
};
