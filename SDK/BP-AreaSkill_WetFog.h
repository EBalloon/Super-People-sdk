...
public:
	...
	void ActivateEffect(struct Unknown Character); // Function BP-AreaSkill_WetFog.BP-AreaSkill_WetFog_C.ActivateEffect(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void DeactivateEffect(struct Unknown Character); // Function BP-AreaSkill_WetFog.BP-AreaSkill_WetFog_C.DeactivateEffect(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void BPSetAreaSkillInfo(); // Function BP-AreaSkill_WetFog.BP-AreaSkill_WetFog_C.BPSetAreaSkillInfo(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void StartDestroy(); // Function BP-AreaSkill_WetFog.BP-AreaSkill_WetFog_C.StartDestroy(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_BP-AreaSkill_WetFog(int32_t EntryPoint); // Function BP-AreaSkill_WetFog.BP-AreaSkill_WetFog_C.ExecuteUbergraph_BP-AreaSkill_WetFog(Final|UbergraphFunction|HasDefaults) // <Game_BE.exe+0x2B80160>
};
