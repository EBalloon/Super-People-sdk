// AnimBlueprintGeneratedClass ABP-MP5.ABP-MP5_C
class UABP-MP5_C : public UBravoHotelAnimInstanceWeapon {
...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-MP5.ABP-MP5_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_ABP-MP5(int32_t EntryPoint); // Function ABP-MP5.ABP-MP5_C.ExecuteUbergraph_ABP-MP5(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};

// Function ABP-MP5.ABP-MP5_C.AnimGraph
inline void UABP-MP5_C::AnimGraph(struct FPoseLink& AnimGraph) {
	static auto fn = UObject::FindObject<UFunction>("Function ABP-MP5.ABP-MP5_C.AnimGraph");
...
// Function ABP-MP5.ABP-MP5_C.ExecuteUbergraph_ABP-MP5
inline void UABP-MP5_C::ExecuteUbergraph_ABP-MP5(int32_t EntryPoint) {
	static auto fn = UObject::FindObject<UFunction>("Function ABP-MP5.ABP-MP5_C.ExecuteUbergraph_ABP-MP5");

	struct ExecuteUbergraph_ABP-MP5_Params {
		int32_t EntryPoint;
	}; ExecuteUbergraph_ABP-MP5_Params Params;
