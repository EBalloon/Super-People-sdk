...
public:
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-MP5.ABP-MP5_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_ABP-MP5(int32_t EntryPoint); // Function ABP-MP5.ABP-MP5_C.ExecuteUbergraph_ABP-MP5(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
