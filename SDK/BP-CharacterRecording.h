...
public:
	...
	struct UPointLightComponent PointLight3; // 0x308 (8)
	struct UPointLightComponent PointLight2; // 0x310 (8)
	struct USpotLightComponent SpotLight; // 0x318 (8)
	struct UPointLightComponent PointLight1; // 0x320 (8)
	struct UBravoHotelSceneCaptureComponent2D BravoHotelSceneCaptureComponent2D; // 0x328 (8)
	struct UPointLightComponent PointLight; // 0x330 (8)
	struct USpotLightComponent SpotLight2; // 0x338 (8)
	struct UStaticMeshComponent Cube; // 0x340 (8)
	struct UCustomizableSkeletalComponent CustomizableSkeletal; // 0x348 (8)
	struct USkeletalMeshComponent SkeletalMesh; // 0x350 (8)
	struct UCameraComponent Camera; // 0x358 (8)
	struct USceneComponent Scene; // 0x360 (8)
	struct ABravoHotelCharacter CharacterRef; // 0x368 (8)
	struct TArray<struct ABravoHotelWeaponBase> PreviewWeapons; // 0x370 (16)
	char EnableTick : 0; // 0x380 (1)
	struct FRotator TargetAccel; // 0x384 (12)
	struct FRotator CurrentAccel; // 0x390 (12)

	void Resize Render Target(int32_t SizeX, int32_t SizeY); // Function BP-CharacterRecording.BP-CharacterRecording_C.Resize Render Target(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void AddRotation(float Delta); // Function BP-CharacterRecording.BP-CharacterRecording_C.AddRotation(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ReceiveBeginPlay(); // Function BP-CharacterRecording.BP-CharacterRecording_C.ReceiveBeginPlay(Event|Protected|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ReceiveTick(float DeltaSeconds); // Function BP-CharacterRecording.BP-CharacterRecording_C.ReceiveTick(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void OnUpdatedMutable(struct UCustomizableObjectInstance Instance); // Function BP-CharacterRecording.BP-CharacterRecording_C.OnUpdatedMutable(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
	void ExecuteUbergraph_BP-CharacterRecording(int32_t EntryPoint); // Function BP-CharacterRecording.BP-CharacterRecording_C.ExecuteUbergraph_BP-CharacterRecording(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B86EC0>
};
