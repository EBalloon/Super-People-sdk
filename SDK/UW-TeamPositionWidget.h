...
public:
	...
	void Move Parameter(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.Move Parameter(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void CheckRequestResuscitation(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.CheckRequestResuscitation(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void GetHealthPercent(float& Percent); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.GetHealthPercent(Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void UpdateKnockOutHealth(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.UpdateKnockOutHealth(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void UpdateCastingGauge(char& IsCasting); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.UpdateCastingGauge(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetNameVisibility(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.SetNameVisibility(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetTeamNumInfo(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.SetTeamNumInfo(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void UpdateRevivalGauge(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.UpdateRevivalGauge(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void UpdateKnockOutGauge(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.UpdateKnockOutGauge(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void UpdateGauge(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.UpdateGauge(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetIconSwitcher(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.SetIconSwitcher(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetRotationVisibility(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.SetRotationVisibility(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetTeamColorVisibility(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.SetTeamColorVisibility(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void SetPlayerName(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.SetPlayerName(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void K2_OnChangedBehavior(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.K2_OnChangedBehavior(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void K2_OnChangedDisconnect(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.K2_OnChangedDisconnect(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void K2_OnChangedIconIndex(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.K2_OnChangedIconIndex(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void K2_OnChangedIsInViewport(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.K2_OnChangedIsInViewport(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void K2_OnChangedPlayerState(); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.K2_OnChangedPlayerState(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void Tick(struct Unknown MyGeometry, float InDeltaTime); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.Tick(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-TeamPositionWidget(int32_t EntryPoint); // Function UW-TeamPositionWidget.UW-TeamPositionWidget_C.ExecuteUbergraph_UW-TeamPositionWidget(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
