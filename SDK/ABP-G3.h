...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-G3.ABP-G3_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_ABP-G3(int32_t EntryPoint); // Function ABP-G3.ABP-G3_C.ExecuteUbergraph_ABP-G3(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};

// Function ABP-G3.ABP-G3_C.AnimGraph
inline void UABP-G3_C::AnimGraph(struct Unknown& AnimGraph) {
