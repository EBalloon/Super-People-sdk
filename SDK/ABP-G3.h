...
public:
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function ABP-G3.ABP-G3_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B812B0>
	void ExecuteUbergraph_ABP-G3(int32_t EntryPoint); // Function ABP-G3.ABP-G3_C.ExecuteUbergraph_ABP-G3(Final|UbergraphFunction) // <Game_BE.exe+0x2B812B0>
};
