...
struct UEnvelopeFollowerListener : UActorComponent {
	struct FMulticastInlineDelegate OnEnvelopeFollowerUpdate; //  0xb0 Size(10)
};
...
struct USynth2DSlider : UWidget {
	...
	char IsFocusable; //  0x400 Size(1)
	struct FMulticastInlineDelegate OnMouseCaptureBegin; //  0x408 Size(10)
	struct FMulticastInlineDelegate OnMouseCaptureEnd; //  0x418 Size(10)
	struct FMulticastInlineDelegate OnControllerCaptureBegin; //  0x428 Size(10)
	struct FMulticastInlineDelegate OnControllerCaptureEnd; //  0x438 Size(10)
...
struct UMonoWaveTableSynthPreset : Object {
	struct FString PresetName; //  0x28 Size(10)
...
struct USynthKnob : UWidget {
	...
	float StepSize; //  0x10c Size(4)
	float MouseSpeed; //  0x110 Size(4)
	float MouseFineTuneSpeed; //  0x114 Size(4)
	char ShowTooltipInfo; //  0x118 Size(1)
	...
	struct FMulticastInlineDelegate OnMouseCaptureEnd; //  0x3b0 Size(10)
	struct FMulticastInlineDelegate OnControllerCaptureBegin; //  0x3c0 Size(10)
