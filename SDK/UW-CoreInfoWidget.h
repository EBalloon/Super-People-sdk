...
public:
	...
	void CheckCanStackDamageLog(struct Unknown& DamageLogInfo, char& CanStack); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.CheckCanStackDamageLog(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddCoreInfoDamageLog(struct Unknown& DamageLogInfo); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.AddCoreInfoDamageLog(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddMyKillMessage(struct FText Message); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.AddMyKillMessage(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddCoreInfoRequestResuscitation(struct Unknown PlayerState); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.AddCoreInfoRequestResuscitation(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddRequestMessage(struct FText Message, struct Unknown PlayerState); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.AddRequestMessage(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddCoreInfoRouteping(struct Unknown PlayerState); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.AddCoreInfoRouteping(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddCoreInfoMessage(struct FText Message, struct FString Type); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.AddCoreInfoMessage(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void AddCoreInfoSmartping(struct Unknown PlayerState); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.AddCoreInfoSmartping(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ShowNewWidget(float RemainTime, struct Unknown& CoreInfoItemWidget); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.ShowNewWidget(Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void InitChildCoreWidget(); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.InitChildCoreWidget(Public|HasDefaults|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void PreConstruct(char IsDesignTime); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.PreConstruct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
	void ExecuteUbergraph_UW-CoreInfoWidget(int32_t EntryPoint); // Function UW-CoreInfoWidget.UW-CoreInfoWidget_C.ExecuteUbergraph_UW-CoreInfoWidget(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B812B0>
};
