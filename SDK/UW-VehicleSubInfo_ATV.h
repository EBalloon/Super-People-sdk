...
public:
	...
	void Setup(struct ABravoHotelVehicle VehicleInstance); // Function UW-VehicleSubInfo_ATV.UW-VehicleSubInfo_ATV_C.Setup(Public|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-VehicleSubInfo_ATV(int32_t EntryPoint); // Function UW-VehicleSubInfo_ATV.UW-VehicleSubInfo_ATV_C.ExecuteUbergraph_UW-VehicleSubInfo_ATV(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
