...
public:
	...
	void Construct(); // Function UW-ReplayEventMarker_WhenReported.UW-ReplayEventMarker_WhenReported_C.Construct(BlueprintCosmetic|Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void K2_SetKillEvent(char IsMyInfo); // Function UW-ReplayEventMarker_WhenReported.UW-ReplayEventMarker_WhenReported_C.K2_SetKillEvent(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_UW-ReplayEventMarker_WhenReported(int32_t EntryPoint); // Function UW-ReplayEventMarker_WhenReported.UW-ReplayEventMarker_WhenReported_C.ExecuteUbergraph_UW-ReplayEventMarker_WhenReported(Final|UbergraphFunction|HasDefaults) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
