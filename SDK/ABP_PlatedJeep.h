...
public:
	...
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_16; // 0xA68 (240)
	struct FAnimNode_LookAt AnimGraphNode_LookAt_2; // 0xB60 (432)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_15; // 0xD10 (240)
	struct FAnimNode_MeshSpaceRefPose AnimGraphNode_MeshRefPose_2; // 0xE00 (16)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_14; // 0xE10 (240)
	struct FAnimNode_LookAt AnimGraphNode_LookAt; // 0xF00 (432)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_13; // 0x10B0 (240)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool_2; // 0x11A0 (160)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_12; // 0x1240 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_11; // 0x1330 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_10; // 0x1420 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_9; // 0x1510 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_8; // 0x1600 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_7; // 0x16F0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_6; // 0x17E0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_5; // 0x18D0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_4; // 0x19C0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_3; // 0x1AB0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_2; // 0x1BA0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone; // 0x1C90 (240)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_2; // 0x1D80 (32)
	struct FAnimNode_Root AnimGraphNode_Root; // 0x1DA0 (48)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_12; // 0x1DD0 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_11; // 0x1DF8 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_10; // 0x1E20 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_9; // 0x1E48 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_8; // 0x1E70 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_7; // 0x1E98 (40)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_6; // 0x1EC0 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_6; // 0x1F38 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_5; // 0x1F68 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_5; // 0x1FE0 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_4; // 0x2010 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_4; // 0x2088 (48)
	struct FAnimNode_StateMachine AnimGraphNode_StateMachine_2; // 0x20B8 (176)
	struct FAnimNode_SaveCachedPose AnimGraphNode_SaveCachedPose_2; // 0x2168 (184)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace; // 0x2220 (32)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_6; // 0x2240 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_5; // 0x2268 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_4; // 0x2290 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_3; // 0x22B8 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_2; // 0x22E0 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult; // 0x2308 (40)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_3; // 0x2330 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_3; // 0x23A8 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x23D8 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_2; // 0x2450 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x2480 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult; // 0x24F8 (48)
	struct FAnimNode_StateMachine AnimGraphNode_StateMachine; // 0x2528 (176)
	struct FAnimNode_SaveCachedPose AnimGraphNode_SaveCachedPose; // 0x25D8 (184)
	struct FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend_2; // 0x2690 (192)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_4; // 0x2750 (40)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool; // 0x2778 (160)
	struct FAnimNode_TwoWayBlend AnimGraphNode_TwoWayBlend; // 0x2818 (200)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_3; // 0x28E0 (40)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_2; // 0x2908 (40)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose; // 0x2930 (40)
	struct FAnimNode_WheelHandler AnimGraphNode_WheelHandler; // 0x2958 (224)
	struct FAnimNode_MeshSpaceRefPose AnimGraphNode_MeshRefPose; // 0x2A38 (16)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace; // 0x2A48 (32)
	struct FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend; // 0x2A68 (192)

	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.BlueprintUpdateAnimation(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void AnimNotify_FPP_Entered_Idle(); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.AnimNotify_FPP_Entered_Idle(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void AnimNotify_FPP_Left_Idle(); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.AnimNotify_FPP_Left_Idle(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
	void ExecuteUbergraph_ABP_PlatedJeep(int32_t EntryPoint); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.ExecuteUbergraph_ABP_PlatedJeep(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2BA5C80>
};

// Function ABP_PlatedJeep.ABP_PlatedJeep_C.AnimGraph
inline void UABP_PlatedJeep_C::AnimGraph(struct FPoseLink& AnimGraph) {
...
// Function ABP_PlatedJeep.ABP_PlatedJeep_C.EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_9A78FECE47813364C3FDD694B3984F8F
inline void UABP_PlatedJeep_C::EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_9A78FECE47813364C3FDD694B3984F8F() {
	static auto fn = UObject::FindObject<UFunction>("Function ABP_PlatedJeep.ABP_PlatedJeep_C.EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_9A78FECE47813364C3FDD694B3984F8F");

	struct EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_9A78FECE47813364C3FDD694B3984F8F_Params {
		
	}; EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_9A78FECE47813364C3FDD694B3984F8F_Params Params;
...
// Function ABP_PlatedJeep.ABP_PlatedJeep_C.EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_998504DC4FD39C23DC9DD29930162666
inline void UABP_PlatedJeep_C::EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_998504DC4FD39C23DC9DD29930162666() {
	static auto fn = UObject::FindObject<UFunction>("Function ABP_PlatedJeep.ABP_PlatedJeep_C.EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_998504DC4FD39C23DC9DD29930162666");

	struct EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_998504DC4FD39C23DC9DD29930162666_Params {
		
	}; EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_PlatedJeep_AnimGraphNode_TransitionResult_998504DC4FD39C23DC9DD29930162666_Params Params;
