...
public:
	...
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_16; // 0xA58 (240)
	struct FAnimNode_LookAt AnimGraphNode_LookAt_2; // 0xB50 (432)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_15; // 0xD00 (240)
	struct FAnimNode_MeshSpaceRefPose AnimGraphNode_MeshRefPose_2; // 0xDF0 (16)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_14; // 0xE00 (240)
	struct FAnimNode_LookAt AnimGraphNode_LookAt; // 0xEF0 (432)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_13; // 0x10A0 (240)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool_2; // 0x1190 (160)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_12; // 0x1230 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_11; // 0x1320 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_10; // 0x1410 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_9; // 0x1500 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_8; // 0x15F0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_7; // 0x16E0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_6; // 0x17D0 (240)
	struct FAnimNode_CopyBone AnimGraphNode_CopyBone_5; // 0x18C0 (240)
	...
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_2; // 0x1D70 (32)
	struct FAnimNode_Root AnimGraphNode_Root; // 0x1D90 (48)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_12; // 0x1DC0 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_11; // 0x1DE8 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_10; // 0x1E10 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_9; // 0x1E38 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_8; // 0x1E60 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_7; // 0x1E88 (40)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_6; // 0x1EB0 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_6; // 0x1F28 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_5; // 0x1F58 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_5; // 0x1FD0 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_4; // 0x2000 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_4; // 0x2078 (48)
	struct FAnimNode_StateMachine AnimGraphNode_StateMachine_2; // 0x20A8 (176)
	struct FAnimNode_SaveCachedPose AnimGraphNode_SaveCachedPose_2; // 0x2158 (184)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace; // 0x2210 (32)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_6; // 0x2230 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_5; // 0x2258 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_4; // 0x2280 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_3; // 0x22A8 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult_2; // 0x22D0 (40)
	struct FAnimNode_TransitionResult AnimGraphNode_TransitionResult; // 0x22F8 (40)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_3; // 0x2320 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_3; // 0x2398 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x23C8 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_2; // 0x2440 (48)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x2470 (120)
	struct FAnimNode_StateResult AnimGraphNode_StateResult; // 0x24E8 (48)
	struct FAnimNode_StateMachine AnimGraphNode_StateMachine; // 0x2518 (176)
	struct FAnimNode_SaveCachedPose AnimGraphNode_SaveCachedPose; // 0x25C8 (184)
	struct FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend_2; // 0x2680 (192)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_4; // 0x2740 (40)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool; // 0x2768 (160)
	struct FAnimNode_TwoWayBlend AnimGraphNode_TwoWayBlend; // 0x2808 (200)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_3; // 0x28D0 (40)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_2; // 0x28F8 (40)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose; // 0x2920 (40)
	struct FAnimNode_WheelHandler AnimGraphNode_WheelHandler; // 0x2948 (224)
	struct FAnimNode_MeshSpaceRefPose AnimGraphNode_MeshRefPose; // 0x2A28 (16)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace; // 0x2A38 (32)
	struct FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend; // 0x2A58 (192)

	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.BlueprintUpdateAnimation(Event|Public|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AnimNotify_FPP_Entered_Idle(); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.AnimNotify_FPP_Entered_Idle(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void AnimNotify_FPP_Left_Idle(); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.AnimNotify_FPP_Left_Idle(BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
	void ExecuteUbergraph_ABP_PlatedJeep(int32_t EntryPoint); // Function ABP_PlatedJeep.ABP_PlatedJeep_C.ExecuteUbergraph_ABP_PlatedJeep(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x2B87A30>
};
