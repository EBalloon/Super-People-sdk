...
public:
	...
	struct Unknown MaterialBillboard; // 0x320 (8)
	struct Unknown InternalPP; // 0x328 (8)
	struct Unknown Bounding Box; // 0x330 (8)
	char Bleach Bypass : 0; // 0x338 (1)
	char Distance Fog : 0; // 0x339 (1)
	char Channel Clamper : 0; // 0x33A (1)
	struct Unknown mChannelClamper; // 0x340 (8)
	struct Unknown iChannelClamper; // 0x348 (8)
	...
	char Blur : 0; // 0x356 (1)
	struct Unknown mBleachBypass; // 0x358 (8)
	struct Unknown mDistanceFog; // 0x360 (8)
	struct Unknown mChannelSwapper; // 0x368 (8)
	struct Unknown mScreenDrops; // 0x370 (8)
	struct Unknown mAlcohol; // 0x378 (8)
	struct Unknown mDrug; // 0x380 (8)
	struct Unknown mMosaic; // 0x388 (8)
	struct Unknown mPixelDissolve; // 0x390 (8)
	struct Unknown mBlur; // 0x398 (8)
	...
	struct Unknown iBleachBypass; // 0x3B0 (8)
	struct Unknown iDistanceFog; // 0x3B8 (8)
	struct Unknown iChannelSwapper; // 0x3C0 (8)
	char Channel Swapper Red; // 0x3C8 (1)
	char Channel Swapper Green; // 0x3C9 (1)
	char Channel Swapper Blue; // 0x3CA (1)
	struct Unknown iScreenDrops; // 0x3D0 (8)
	struct Unknown iAlcohol; // 0x3D8 (8)
	struct Unknown iDrug; // 0x3E0 (8)
	struct Unknown iMosaic; // 0x3E8 (8)
	struct Unknown iPixelDissolve; // 0x3F0 (8)
	struct Unknown iBlur; // 0x3F8 (8)
	struct Unknown Screen Drops Layer 1 Map; // 0x400 (8)
	...
	struct Unknown mAscii; // 0x428 (8)
	struct Unknown iAscii; // 0x430 (8)
	char Colorize : 0; // 0x438 (1)
	struct Unknown mColorize; // 0x440 (8)
	struct Unknown iColorize; // 0x448 (8)
	float Colorize Detail; // 0x450 (4)
	char Comic : 0; // 0x454 (1)
	struct Unknown mComic; // 0x458 (8)
	struct Unknown iComic; // 0x460 (8)
	struct Unknown Comic Blend Color; // 0x468 (16)
	float Comic Threshold; // 0x478 (4)
	char Edge Detect : 0; // 0x47C (1)
	struct Unknown mEdgeDetect; // 0x480 (8)
	struct Unknown iEdgeDetect; // 0x488 (8)
	char Emboss : 0; // 0x490 (1)
	struct Unknown mEmboss; // 0x498 (8)
	struct Unknown iEmboss; // 0x4A0 (8)
	char Glitch : 0; // 0x4A8 (1)
	struct Unknown mGlitch; // 0x4B0 (8)
	struct Unknown iGlitch; // 0x4B8 (8)
	float Glitch Speed; // 0x4C0 (4)
	float Glitch Lines; // 0x4C4 (4)
	float Glitch Blocking; // 0x4C8 (4)
	char Monitor Effects : 0; // 0x4CC (1)
	struct Unknown mGrainNLines; // 0x4D0 (8)
	struct Unknown iGrainNLines; // 0x4D8 (8)
	...
	struct Unknown mHardEmboss; // 0x4F0 (8)
	struct Unknown iHardEmboss; // 0x4F8 (8)
	char Hue Panner : 0; // 0x500 (1)
	struct Unknown mHuePanner; // 0x508 (8)
	struct Unknown iHuePanner; // 0x510 (8)
	float Hue Panner Speed; // 0x518 (4)
	char Monochrome : 0; // 0x51C (1)
	struct Unknown mMonochrome; // 0x520 (8)
	struct Unknown iMonochrome; // 0x528 (8)
	struct Unknown Monochrome Color; // 0x530 (16)
	char Radial Blur : 0; // 0x540 (1)
	struct Unknown mRadialBlur; // 0x548 (8)
	struct Unknown iRadialBlur; // 0x550 (8)
	float Radial Blur Width; // 0x558 (4)
	int32_t Radial Blur Samples; // 0x55C (4)
	char Scratches : 0; // 0x560 (1)
	struct Unknown mScratches; // 0x568 (8)
	struct Unknown iScratches; // 0x570 (8)
	char Screen Waves : 0; // 0x578 (1)
	struct Unknown mScreenWaves; // 0x580 (8)
	struct Unknown iScreenWaves; // 0x588 (8)
	...
	struct Unknown Distance Fog Near Color; // 0x5A4 (16)
	struct Unknown Distance Fog Far Color; // 0x5B4 (16)
	float Distance Fog Distance; // 0x5C4 (4)
	struct Unknown Scratches Distortion Map; // 0x5C8 (8)
	float Scratches Distortion Amount; // 0x5D0 (4)
	struct Unknown Scratches Color; // 0x5D4 (16)
	float Screen Drops Layer 1 Speed; // 0x5E4 (4)
	float Screen Drops Layer 1 Noise; // 0x5E8 (4)
	struct Unknown Screen Drops Layer 2 Map; // 0x5F0 (8)
	...
	struct Unknown Screen Drops Layer 3 Map; // 0x608 (8)
	float Screen Drops Layer 3 Intensity; // 0x610 (4)
	float Screen Drops Layer 3 Speed; // 0x614 (4)
	char Invert : 0; // 0x618 (1)
	struct Unknown mInvert; // 0x620 (8)
	struct Unknown iInvert; // 0x628 (8)
	char Iridescent : 0; // 0x630 (1)
	struct Unknown mIridescent; // 0x638 (8)
	struct Unknown iIridescent; // 0x640 (8)
	float Iridescent Iridescence; // 0x648 (4)
	char Kuwahara : 0; // 0x64C (1)
	struct Unknown mKuwahara; // 0x650 (8)
	struct Unknown iKuwahara; // 0x658 (8)
	int32_t Kuwahara Amount; // 0x660 (4)
	char Pulse : 0; // 0x664 (1)
	struct Unknown mPulse; // 0x668 (8)
	struct Unknown iPulse; // 0x670 (8)
	...
	struct Unknown mSquares; // 0x690 (8)
	struct Unknown iSquares; // 0x698 (8)
	...
	struct Unknown mTiles; // 0x6B8 (8)
	struct Unknown iTiles; // 0x6C0 (8)
	char Tiles Centered : 0; // 0x6C8 (1)
	float Tiles Count; // 0x6CC (4)
	char TV Noise : 0; // 0x6D0 (1)
	struct Unknown mTVNoise; // 0x6D8 (8)
	struct Unknown iTVNoise; // 0x6E0 (8)
	...
	void Create Effect Material Instance(struct Unknown Material, struct Unknown& Instance); // Function Chameleon.Chameleon_C.Create Effect Material Instance(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Mojo Func(char IsEnabled); // Function Chameleon.Chameleon_C.Mojo Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Pyramid Func(char IsEnabled); // Function Chameleon.Chameleon_C.Pyramid Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Zone Func(char IsEnabled); // Function Chameleon.Chameleon_C.Zone Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Lens Func(char IsEnabled); // Function Chameleon.Chameleon_C.Lens Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Grid Cell Func(char IsEnabled); // Function Chameleon.Chameleon_C.Grid Cell Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Haunted Func(char IsEnabled); // Function Chameleon.Chameleon_C.Haunted Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Screen Fire Func(char IsEnabled); // Function Chameleon.Chameleon_C.Screen Fire Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Selective Color Func(char IsEnabled); // Function Chameleon.Chameleon_C.Selective Color Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Melted World Func(char IsEnabled); // Function Chameleon.Chameleon_C.Melted World Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Hazy Lights Func(char IsEnabled); // Function Chameleon.Chameleon_C.Hazy Lights Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Disco Ball Func(char IsEnabled); // Function Chameleon.Chameleon_C.Disco Ball Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Camera Shake Func(char IsEnabled); // Function Chameleon.Chameleon_C.Camera Shake Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Colored AO Func(char IsEnabled); // Function Chameleon.Chameleon_C.Colored AO Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Infected Func(char IsEnabled); // Function Chameleon.Chameleon_C.Infected Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Actor Featurette Func(char IsEnabled); // Function Chameleon.Chameleon_C.Actor Featurette Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Set Advanced Effect Features (No Custom Depth)(struct Unknown Features, struct Unknown Material, struct Unknown Dynamic Material Instance); // Function Chameleon.Chameleon_C.Set Advanced Effect Features (No Custom Depth)(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Set Advanced Effect Features(struct Unknown Features, struct Unknown Material, struct Unknown Dynamic Material Instance); // Function Chameleon.Chameleon_C.Set Advanced Effect Features(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Wired Func(char IsEnabled); // Function Chameleon.Chameleon_C.Wired Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Sketch Func(char IsEnabled); // Function Chameleon.Chameleon_C.Sketch Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Alarm Func(char IsEnabled); // Function Chameleon.Chameleon_C.Alarm Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Digitize Func(char IsEnabled); // Function Chameleon.Chameleon_C.Digitize Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void World Glitch Func(char IsEnabled); // Function Chameleon.Chameleon_C.World Glitch Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void World Splash Func(char IsEnabled); // Function Chameleon.Chameleon_C.World Splash Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Snow Func(char IsEnabled); // Function Chameleon.Chameleon_C.Snow Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Letterboxing Func(char IsEnabled); // Function Chameleon.Chameleon_C.Letterboxing Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Kaleidescope Func(char IsEnabled); // Function Chameleon.Chameleon_C.Kaleidescope Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void 2D Transform Func(char IsEnabled); // Function Chameleon.Chameleon_C.2D Transform Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void SetEffectPriority(int32_t Priority, struct Unknown Material); // Function Chameleon.Chameleon_C.SetEffectPriority(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ApplyChameleonSettings(); // Function Chameleon.Chameleon_C.ApplyChameleonSettings(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Custom Depth Highlighter (NC) Func(char IsEnabled); // Function Chameleon.Chameleon_C.Custom Depth Highlighter (NC) Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Custom Depth Highlighter Func(char IsEnabled); // Function Chameleon.Chameleon_C.Custom Depth Highlighter Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Neon Func(char IsEnabled); // Function Chameleon.Chameleon_C.Neon Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Frost Func(char IsEnabled); // Function Chameleon.Chameleon_C.Frost Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Anamorphic Lens Flares Func(char IsEnabled); // Function Chameleon.Chameleon_C.Anamorphic Lens Flares Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Toon Shading Func(char IsEnabled); // Function Chameleon.Chameleon_C.Toon Shading Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Sharpen Func(char IsEnabled); // Function Chameleon.Chameleon_C.Sharpen Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Screen Decals Func(char IsEnabled); // Function Chameleon.Chameleon_C.Screen Decals Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Screen Damage Func(char IsEnabled); // Function Chameleon.Chameleon_C.Screen Damage Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Magic Transitions Func(char IsEnabled); // Function Chameleon.Chameleon_C.Magic Transitions Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Drawing Func(char IsEnabled); // Function Chameleon.Chameleon_C.Drawing Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Distance Distortion Func(char Condition); // Function Chameleon.Chameleon_C.Distance Distortion Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Sonar Func(char Condition); // Function Chameleon.Chameleon_C.Sonar Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Circles Func(char Condition); // Function Chameleon.Chameleon_C.Circles Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void LOOK Func(char Condition); // Function Chameleon.Chameleon_C.LOOK Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void TV Noise Func(char& IsEnabled); // Function Chameleon.Chameleon_C.TV Noise Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Tiles Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Tiles Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Squares Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Squares Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Pulse Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Pulse Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Kuwahara Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Kuwahara Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Iridescent Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Iridescent Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Invert Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Invert Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Hard Emboss Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Hard Emboss Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Emboss Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Emboss Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Edge Detect Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Edge Detect Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ASCII Func(char& IsEnabled); // Function Chameleon.Chameleon_C.ASCII Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Bleach Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Bleach Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Scratches Func(char IsEnabled); // Function Chameleon.Chameleon_C.Scratches Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Distance Fog Func(char IsEnabled); // Function Chameleon.Chameleon_C.Distance Fog Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Screen Waves Func(char IsEnabled); // Function Chameleon.Chameleon_C.Screen Waves Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Radial Blur Func(char IsEnabled); // Function Chameleon.Chameleon_C.Radial Blur Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Monochrome Func(char IsEnabled); // Function Chameleon.Chameleon_C.Monochrome Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Hue Panner Func(char IsEnabled); // Function Chameleon.Chameleon_C.Hue Panner Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void MonitorFX Func(char IsEnabled); // Function Chameleon.Chameleon_C.MonitorFX Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Glitch Func(char IsEnabled); // Function Chameleon.Chameleon_C.Glitch Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Comic Func(char IsEnabled); // Function Chameleon.Chameleon_C.Comic Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Colorize Func(char Condition); // Function Chameleon.Chameleon_C.Colorize Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Blur Func(char IsEnabled); // Function Chameleon.Chameleon_C.Blur Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Pixel Dissolve Func(char IsEnabled); // Function Chameleon.Chameleon_C.Pixel Dissolve Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Drug Func(char IsEnabled); // Function Chameleon.Chameleon_C.Drug Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Alcohol Func(char IsEnabled); // Function Chameleon.Chameleon_C.Alcohol Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Mosaic Func(char IsEnabled); // Function Chameleon.Chameleon_C.Mosaic Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Screen Drops Func(char IsEnabled); // Function Chameleon.Chameleon_C.Screen Drops Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void InitChameleon(); // Function Chameleon.Chameleon_C.InitChameleon(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Channel Swapper Func(char IsEnabled); // Function Chameleon.Chameleon_C.Channel Swapper Func(Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void Channel Clamper Func(char& IsEnabled); // Function Chameleon.Chameleon_C.Channel Clamper Func(Public|HasOutParms|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void UserConstructionScript(); // Function Chameleon.Chameleon_C.UserConstructionScript(Event|Public|BlueprintCallable|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ReceiveActorBeginOverlap(struct Unknown OtherActor); // Function Chameleon.Chameleon_C.ReceiveActorBeginOverlap(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ReceiveTick(float DeltaSeconds); // Function Chameleon.Chameleon_C.ReceiveTick(Event|Public|BlueprintEvent) // <Game_BE.exe+0x2B80160>
	void ExecuteUbergraph_Chameleon(int32_t EntryPoint); // Function Chameleon.Chameleon_C.ExecuteUbergraph_Chameleon(Final|UbergraphFunction) // <Game_BE.exe+0x2B80160>
};
