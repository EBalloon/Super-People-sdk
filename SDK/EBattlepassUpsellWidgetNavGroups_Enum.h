// EBattlepassUpsellWidgetNavGroups KillstreakUINew.EBattlepassUpsellWidgetNavGroups
enum class EBattlepassUpsellWidgetNavGroups : uint8 {
	None = 0,
	SentJoinRequest = 1,
	...
	VMI_WorldNormals = 29,
	VMI_CollisionResponses = 30,
	VMI_ShadowInShadow = 31,
	VMI_Max = 32,
	VMI_Unknown = 255,
	Generic = 0,
	DemoNotFound = 1,
	...
	IgnoreZAccumulate = 4,
	ApplyRootMotionRotation = 8,
	ERootMotionSourceSettingsFlags_MAX = 9,
	Prepared = 1,
	Finished = 2,
	MarkedForRemoval = 4,
