// AnimBlueprintGeneratedClass F.AB
struct UAB : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct Unknown& AnimGraph); // Function .AB.AnimGraph(HasOutParms|BlueprintCallable|BlueprintEvent) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B1E70>
	void ExecuteUbergraph_AB(int32_t EntryPoint); // Function .AB.ExecuteUbergraph_AB(Final|UbergraphFunction) // <BravoHotelClient-Win64-Shipping.protected.exe+0x23B1E70>
};
